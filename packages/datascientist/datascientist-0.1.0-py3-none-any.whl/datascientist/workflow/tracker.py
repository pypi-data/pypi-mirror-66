...
with a different name OR manually delete the existing stuff locally.
    ...
    def load_references(self, run):
        ...
        @args: run is a str of the run ID
               verbose is a boolean flag for whether or not to print status
    ...
    def store_data(self, data, set_type="X_train", index=False):
        """
    ...
    def load_data(self, run=None, set_type="X_train", delim=",", skiprows=0):
        """
