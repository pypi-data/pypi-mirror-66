...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dms", "1.33.1", __name__, "aws-dms@1.33.1.jsii.tgz")
...
class CfnEndpoint(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-dms.CfnEndpoint"):
    ...
    class KafkaSettingsProperty():
        def __init__(self, *, broker: typing.Optional[str]=None, topic: typing.Optional[str]=None):
            """
