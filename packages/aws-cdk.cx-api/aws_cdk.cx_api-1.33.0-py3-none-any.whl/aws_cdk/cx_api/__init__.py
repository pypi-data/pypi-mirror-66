...
class AmiContextQuery():
    def __init__(self, *, filters: typing.Mapping[str, typing.List[str]], owners: typing.Optional[typing.List[str]]=None) -> None:
...
class AwsCloudFormationStackProperties():
    def __init__(self, *, template_file: str, parameters: typing.Optional[typing.Mapping[str, str]]=None, stack_name: typing.Optional[str]=None) -> None:
...
class HostedZoneContextQuery():
    def __init__(self, *, domain_name: str, account: typing.Optional[str]=None, private_zone: typing.Optional[bool]=None, region: typing.Optional[str]=None, vpc_id: typing.Optional[str]=None) -> None:
        """Query to hosted zone context provider.
...
class SSMParameterContextQuery():
    def __init__(self, *, account: typing.Optional[str]=None, parameter_name: typing.Optional[str]=None, region: typing.Optional[str]=None) -> None:
        """Query to hosted zone context provider.
...
class VpcContextQuery():
    def __init__(self, *, filter: typing.Mapping[str, str], account: typing.Optional[str]=None, region: typing.Optional[str]=None, return_asymmetric_subnets: typing.Optional[bool]=None, subnet_group_name_tag: typing.Optional[str]=None) -> None:
