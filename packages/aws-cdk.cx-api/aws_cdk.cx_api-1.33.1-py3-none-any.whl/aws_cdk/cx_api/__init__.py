...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/cx-api", "1.33.1", __name__, "cx-api@1.33.1.jsii.tgz")
...
class CloudArtifact(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/cx-api.CloudArtifact"):
    ...
    :stability: experimental
    """
    def __init__(self, assembly: "CloudAssembly", id: str, *, type: aws_cdk.cloud_assembly_schema.ArtifactType, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str,typing.List[aws_cdk.cloud_assembly_schema.MetadataEntry]]]=None, properties: typing.Optional[typing.Mapping[str,typing.Any]]=None) -> None:
        """
        :param assembly: -
        :param id: -
    ...
    def from_manifest(cls, assembly: "CloudAssembly", id: str, *, type: aws_cdk.cloud_assembly_schema.ArtifactType, dependencies: typing.Optional[typing.List[str]]=None, environment: typing.Optional[str]=None, metadata: typing.Optional[typing.Mapping[str,typing.List[aws_cdk.cloud_assembly_schema.MetadataEntry]]]=None, properties: typing.Optional[typing.Mapping[str,typing.Any]]=None) -> typing.Optional["CloudArtifact"]:
...
class MetadataEntry(aws_cdk.cloud_assembly_schema.MetadataEntry):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[typing.Optional[str], typing.Optional[aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry], typing.Optional[aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry], typing.Optional[typing.List[aws_cdk.cloud_assembly_schema.Tag]]]]=None, trace: typing.Optional[typing.List[str]]=None):
...
class MetadataEntryResult(aws_cdk.cloud_assembly_schema.MetadataEntry):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[typing.Optional[str], typing.Optional[aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry], typing.Optional[aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry], typing.Optional[typing.List[aws_cdk.cloud_assembly_schema.Tag]]]]=None, trace: typing.Optional[typing.List[str]]=None, path: str):
        """
        :param type: The type of the metadata entry.
        :param data: The data. Default: - no data.
        :param trace: A stack trace for when the entry was created. Default: - no trace.
...
@jsii.data_type(jsii_type="@aws-cdk/cx-api.MissingContext", jsii_struct_bases=[aws_cdk.cloud_assembly_schema.MissingContext], name_mapping={'key': 'key', 'props': 'props', 'provider': 'provider'})
class MissingContext(aws_cdk.cloud_assembly_schema.MissingContext):
...
class SynthesisMessage():
    def __init__(self, *, entry: aws_cdk.cloud_assembly_schema.MetadataEntry, id: str, level: "SynthesisMessageLevel"):
        """
        :param entry: 
        :param id: 
        :param level: 
