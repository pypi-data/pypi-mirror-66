...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-stepfunctions", "1.33.1", __name__, "aws-stepfunctions@1.33.1.jsii.tgz")
...
class CfnStateMachine(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions.CfnStateMachine"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, definition_string: str, role_arn: str, logging_configuration: typing.Optional[typing.Union[typing.Optional["LoggingConfigurationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional[str]=None, tags: typing.Optional[typing.List["TagsEntryProperty"]]=None, tracing_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["TracingConfigurationProperty"]]]=None) -> None:
        ...
        """
        props = CfnStateMachineProps(definition_string=definition_string, role_arn=role_arn, logging_configuration=logging_configuration, state_machine_name=state_machine_name, state_machine_type=state_machine_type, tags=tags, tracing_configuration=tracing_configuration)
    ...
    def tracing_configuration(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["TracingConfigurationProperty"]]]:
    ...
    def tracing_configuration(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["TracingConfigurationProperty"]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions.CfnStateMachine.TracingConfigurationProperty", jsii_struct_bases=[], name_mapping={'enabled': 'enabled'})
    class TracingConfigurationProperty():
        def __init__(self, *, enabled: typing.Union[bool, aws_cdk.core.IResolvable]):
            """
        ...
        def __repr__(self) -> str:
            return 'TracingConfigurationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions.CfnStateMachineProps", jsii_struct_bases=[], name_mapping={'definition_string': 'definitionString', 'role_arn': 'roleArn', 'logging_configuration': 'loggingConfiguration', 'state_machine_name': 'stateMachineName', 'state_machine_type': 'stateMachineType', 'tags': 'tags', 'tracing_configuration': 'tracingConfiguration'})
class CfnStateMachineProps():
    def __init__(self, *, definition_string: str, role_arn: str, logging_configuration: typing.Optional[typing.Union[typing.Optional["CfnStateMachine.LoggingConfigurationProperty"], typing.Optional[aws_cdk.core.IResolvable]]]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional[str]=None, tags: typing.Optional[typing.List["CfnStateMachine.TagsEntryProperty"]]=None, tracing_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnStateMachine.TracingConfigurationProperty"]]]=None):
        ...
        if tags is not None: self._values["tags"] = tags
        if tracing_configuration is not None: self._values["tracing_configuration"] = tracing_configuration
    ...
    @builtins.property
    def tracing_configuration(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnStateMachine.TracingConfigurationProperty"]]]:
        """``AWS::StepFunctions::StateMachine.TracingConfiguration``.
...
class Errors(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions.Errors"):
    """Predefined error strings Error names in Amazon States Language - https://docs.aws.amazon.com/step-functions/latest/dg/concepts-error-handling.html.
...
class LogOptions():
    def __init__(self, *, destination: aws_cdk.aws_logs.ILogGroup, include_execution_data: typing.Optional[bool]=None, level: typing.Optional["LogLevel"]=None):
...
class StateMachineProps():
    def __init__(self, *, definition: "IChainable", logs: typing.Optional["LogOptions"]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, state_machine_name: typing.Optional[str]=None, state_machine_type: typing.Optional["StateMachineType"]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None):
