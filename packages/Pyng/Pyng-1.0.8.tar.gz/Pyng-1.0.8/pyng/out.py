...
@contextmanager
def log_handler(name, handler, level=None, propagate=True, optional=False):
    """
    ...
    Use 'logger = next(log_handler(...))' to simply set up logging as above
    without the implicit restore behavior.
    """
