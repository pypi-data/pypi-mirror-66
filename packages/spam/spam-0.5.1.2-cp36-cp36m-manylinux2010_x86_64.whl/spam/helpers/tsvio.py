...
def readCorrelationTSV(fileName, fieldBinRatio=1.0, readDisplacements=False, readFs=False, readConvergence=False, readPSCC=False, readEverything=True, returnFs=True):
    """
    ...
    ----------
        ...
        readEverything : bool, optional
            Activates "readFs", "readConvergence", "readPSCC"
            Default = True
...
def TSVtoTIFF(fileName, fieldBinRatio=1.0, lab=None, returnRS=False, outDir=".", prefix=None):
    ...
    fi = readCorrelationTSV(fileName, fieldBinRatio=fieldBinRatio, readDisplacements=True, readConvergence=returnRS)
