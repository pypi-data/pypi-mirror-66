...
class PlanResult(object):
    ...
    def __init__(self, tracedata=None, timetable=None, statistics=None, validations=None, unplanned_orders=None, progress=None, local_vars_configuration=None):  # noqa: E501
