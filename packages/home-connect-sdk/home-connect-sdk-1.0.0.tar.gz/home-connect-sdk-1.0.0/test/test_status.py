...
from home_connect_sdk.models.status import Status  # noqa: E501
...
class TestStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = home_connect_sdk.models.status.Status()  # noqa: E501
        if include_optional :
            return Status(
                data = home_connect_sdk.models.status_data.Status_data(
                    key = '0', 
                    name = '0', 
