...
from home_connect_sdk.models.array_of_images_data import ArrayOfImagesData  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfImagesData(unittest.TestCase):
    """ArrayOfImagesData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfImagesData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_images_data.ArrayOfImagesData()  # noqa: E501
        if include_optional :
            return ArrayOfImagesData(
                images = [
                    home_connect_sdk.models.array_of_images_data_images.ArrayOfImages_data_images(
                        key = '0', 
                        name = '0', 
                        imagekey = '0', 
                        previewimagekey = '0', 
    ...
    def testArrayOfImagesData(self):
        """Test ArrayOfImagesData"""
