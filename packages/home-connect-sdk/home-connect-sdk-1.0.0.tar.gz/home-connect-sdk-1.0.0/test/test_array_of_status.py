...
from home_connect_sdk.models.array_of_status import ArrayOfStatus  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfStatus(unittest.TestCase):
    """ArrayOfStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = home_connect_sdk.models.array_of_status.ArrayOfStatus()  # noqa: E501
        if include_optional :
            return ArrayOfStatus(
                data = home_connect_sdk.models.array_of_status_data.ArrayOfStatus_data(
                    status = [
                        home_connect_sdk.models.status_data.Status_data(
                            key = '0', 
                            name = '0', 
