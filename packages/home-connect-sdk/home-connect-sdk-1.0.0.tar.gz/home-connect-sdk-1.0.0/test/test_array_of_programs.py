...
from home_connect_sdk.models.array_of_programs import ArrayOfPrograms  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfPrograms(unittest.TestCase):
    """ArrayOfPrograms unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfPrograms
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_programs.ArrayOfPrograms()  # noqa: E501
        if include_optional :
            return ArrayOfPrograms(
                data = home_connect_sdk.models.array_of_programs_data.ArrayOfPrograms_data(
                    programs = [
                        home_connect_sdk.models.array_of_programs_data_programs.ArrayOfPrograms_data_programs(
                            key = '0', 
                            constraints = home_connect_sdk.models.array_of_programs_data_constraints.ArrayOfPrograms_data_constraints(
                                available = True, 
                                execution = 'none', ), )
                        ], )
            )
