...
from home_connect_sdk.models.array_of_events import ArrayOfEvents  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfEvents(unittest.TestCase):
    """ArrayOfEvents unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = home_connect_sdk.models.array_of_events.ArrayOfEvents()  # noqa: E501
        if include_optional :
            return ArrayOfEvents(
                items = [
                    home_connect_sdk.models.array_of_events_items.ArrayOfEvents_items(
                        key = '0', 
                        name = '0', 
                        uri = '0', 
                        timestamp = 56, 
