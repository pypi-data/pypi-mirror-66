...
from home_connect_sdk.models.program_definition_data_constraints import ProgramDefinitionDataConstraints  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestProgramDefinitionDataConstraints(unittest.TestCase):
    """ProgramDefinitionDataConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ProgramDefinitionDataConstraints
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.program_definition_data_constraints.ProgramDefinitionDataConstraints()  # noqa: E501
        if include_optional :
            return ProgramDefinitionDataConstraints(
                min = 56, 
                max = 56, 
                stepsize = 56, 
                allowedvalues = [
    ...
    def testProgramDefinitionDataConstraints(self):
        """Test ProgramDefinitionDataConstraints"""
