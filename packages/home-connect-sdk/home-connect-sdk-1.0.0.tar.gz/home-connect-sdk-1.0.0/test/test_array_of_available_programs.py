...
from home_connect_sdk.models.array_of_available_programs import ArrayOfAvailablePrograms  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfAvailablePrograms(unittest.TestCase):
    """ArrayOfAvailablePrograms unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfAvailablePrograms
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_available_programs.ArrayOfAvailablePrograms()  # noqa: E501
        if include_optional :
            return ArrayOfAvailablePrograms(
                data = home_connect_sdk.models.array_of_available_programs_data.ArrayOfAvailablePrograms_data(
                    programs = [
                        home_connect_sdk.models.array_of_available_programs_data_programs.ArrayOfAvailablePrograms_data_programs(
                            key = '0', 
                            constraints = home_connect_sdk.models.array_of_available_programs_data_constraints.ArrayOfAvailablePrograms_data_constraints(
                                execution = 'none', ), )
                        ], )
            )
        else :
    ...
    def testArrayOfAvailablePrograms(self):
        """Test ArrayOfAvailablePrograms"""
