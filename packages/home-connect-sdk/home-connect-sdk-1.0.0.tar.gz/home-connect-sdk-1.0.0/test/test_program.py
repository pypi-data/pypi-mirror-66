...
from home_connect_sdk.models.program import Program  # noqa: E501
...
class TestProgram(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = home_connect_sdk.models.program.Program()  # noqa: E501
        if include_optional :
            return Program(
                data = home_connect_sdk.models.program_data.Program_data(
                    key = '0', 
                    name = '0', 
                    options = [
