...
from home_connect_sdk.models.array_of_home_appliances_data_homeappliances import ArrayOfHomeAppliancesDataHomeappliances  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfHomeAppliancesDataHomeappliances(unittest.TestCase):
    """ArrayOfHomeAppliancesDataHomeappliances unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfHomeAppliancesDataHomeappliances
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_home_appliances_data_homeappliances.ArrayOfHomeAppliancesDataHomeappliances()  # noqa: E501
        if include_optional :
            return ArrayOfHomeAppliancesDataHomeappliances(
                ha_id = '0', 
                name = '0', 
                type = '0', 
                brand = '0', 
    ...
    def testArrayOfHomeAppliancesDataHomeappliances(self):
        """Test ArrayOfHomeAppliancesDataHomeappliances"""
