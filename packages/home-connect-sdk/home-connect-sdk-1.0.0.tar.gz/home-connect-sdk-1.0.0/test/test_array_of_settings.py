...
from home_connect_sdk.models.array_of_settings import ArrayOfSettings  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfSettings(unittest.TestCase):
    """ArrayOfSettings unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfSettings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_settings.ArrayOfSettings()  # noqa: E501
        if include_optional :
            return ArrayOfSettings(
                data = home_connect_sdk.models.array_of_settings_data.ArrayOfSettings_data(
                    settings = [
                        home_connect_sdk.models.array_of_settings_data_settings.ArrayOfSettings_data_settings(
                            key = '0', 
                            name = '0', 
