...
from home_connect_sdk.models.program_data import ProgramData  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestProgramData(unittest.TestCase):
    """ProgramData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = home_connect_sdk.models.program_data.ProgramData()  # noqa: E501
        if include_optional :
            return ProgramData(
                key = '0', 
                name = '0', 
                options = [
                    home_connect_sdk.models.program_data_options.Program_data_options(
                        key = '0', 
                        name = '0', 
