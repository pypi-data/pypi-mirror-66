...
from home_connect_sdk.models.array_of_programs_data_constraints import ArrayOfProgramsDataConstraints  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfProgramsDataConstraints(unittest.TestCase):
    """ArrayOfProgramsDataConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfProgramsDataConstraints
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_programs_data_constraints.ArrayOfProgramsDataConstraints()  # noqa: E501
        if include_optional :
            return ArrayOfProgramsDataConstraints(
                available = True, 
                execution = 'none'
            )
        else :
    ...
    def testArrayOfProgramsDataConstraints(self):
        """Test ArrayOfProgramsDataConstraints"""
