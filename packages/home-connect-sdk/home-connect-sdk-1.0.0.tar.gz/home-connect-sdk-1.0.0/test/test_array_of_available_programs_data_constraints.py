...
from home_connect_sdk.models.array_of_available_programs_data_constraints import ArrayOfAvailableProgramsDataConstraints  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestArrayOfAvailableProgramsDataConstraints(unittest.TestCase):
    """ArrayOfAvailableProgramsDataConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ArrayOfAvailableProgramsDataConstraints
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.array_of_available_programs_data_constraints.ArrayOfAvailableProgramsDataConstraints()  # noqa: E501
        if include_optional :
            return ArrayOfAvailableProgramsDataConstraints(
                execution = 'none'
            )
        else :
            return ArrayOfAvailableProgramsDataConstraints(
    ...
    def testArrayOfAvailableProgramsDataConstraints(self):
        """Test ArrayOfAvailableProgramsDataConstraints"""
