...
from home_connect_sdk.models.get_setting_data_constraints import GetSettingDataConstraints  # noqa: E501
from home_connect_sdk.rest import ApiException

class TestGetSettingDataConstraints(unittest.TestCase):
    """GetSettingDataConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GetSettingDataConstraints
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = home_connect_sdk.models.get_setting_data_constraints.GetSettingDataConstraints()  # noqa: E501
        if include_optional :
            return GetSettingDataConstraints(
                min = 56, 
                max = 56, 
                stepsize = 56, 
                allowedvalues = [
    ...
    def testGetSettingDataConstraints(self):
        """Test GetSettingDataConstraints"""
