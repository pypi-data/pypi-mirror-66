...
class ProgramData(object):
    ...
    openapi_types = {
        'key': 'str',
        'name': 'str',
        'options': 'list[ProgramDataOptions]'
    }
    ...
    def __init__(self, key=None, name=None, options=None, local_vars_configuration=None):  # noqa: E501
        """ProgramData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def key(self):
        """Gets the key of this ProgramData.  # noqa: E501

        A key identifying a specific program   # noqa: E501

        :return: The key of this ProgramData.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this ProgramData.

        A key identifying a specific program   # noqa: E501

        :param key: The key of this ProgramData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ProgramData.  # noqa: E501

        user-friendly, localized name of the program, e.g. \"4D Heißluft\" in German  # noqa: E501

        :return: The name of this ProgramData.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ProgramData.

        user-friendly, localized name of the program, e.g. \"4D Heißluft\" in German  # noqa: E501

        :param name: The name of this ProgramData.  # noqa: E501
        :type: str
        """
    ...
    @property
    def options(self):
        """Gets the options of this ProgramData.  # noqa: E501


        :return: The options of this ProgramData.  # noqa: E501
        :rtype: list[ProgramDataOptions]
        """
        return self._options

    @options.setter
    def options(self, options):
        """Sets the options of this ProgramData.


        :param options: The options of this ProgramData.  # noqa: E501
        :type: list[ProgramDataOptions]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProgramData):
            return False
