...
class WrongOperationStateError(object):
    ...
    def __init__(self, error=None, local_vars_configuration=None):  # noqa: E501
        """WrongOperationStateError - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this WrongOperationStateError.  # noqa: E501


        :return: The error of this WrongOperationStateError.  # noqa: E501
    ...
    def error(self, error):
        """Sets the error of this WrongOperationStateError.


        :param error: The error of this WrongOperationStateError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WrongOperationStateError):
            return False
