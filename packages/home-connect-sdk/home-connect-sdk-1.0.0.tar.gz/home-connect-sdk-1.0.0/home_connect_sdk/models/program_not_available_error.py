...
class ProgramNotAvailableError(object):
    ...
    @property
    def error(self):
        """Gets the error of this ProgramNotAvailableError.  # noqa: E501


        :return: The error of this ProgramNotAvailableError.  # noqa: E501
    ...
    def error(self, error):
        """Sets the error of this ProgramNotAvailableError.


        :param error: The error of this ProgramNotAvailableError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProgramNotAvailableError):
            return False
