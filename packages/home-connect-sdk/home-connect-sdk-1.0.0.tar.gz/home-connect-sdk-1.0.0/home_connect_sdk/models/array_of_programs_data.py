...
class ArrayOfProgramsData(object):
    ...
    """
    openapi_types = {
        'programs': 'list[ArrayOfProgramsDataPrograms]'
    }
    ...
    @property
    def programs(self):
        """Gets the programs of this ArrayOfProgramsData.  # noqa: E501


        :return: The programs of this ArrayOfProgramsData.  # noqa: E501
        :rtype: list[ArrayOfProgramsDataPrograms]
        """
        return self._programs

    @programs.setter
    def programs(self, programs):
        """Sets the programs of this ArrayOfProgramsData.


        :param programs: The programs of this ArrayOfProgramsData.  # noqa: E501
        :type: list[ArrayOfProgramsDataPrograms]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfProgramsData):
            return False
