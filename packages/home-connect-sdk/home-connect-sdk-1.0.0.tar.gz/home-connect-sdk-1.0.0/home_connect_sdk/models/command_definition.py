...
class CommandDefinition(object):
    ...
    """
    openapi_types = {
        'data': 'list[CommandDefinitionData]'
    }
    ...
    def __init__(self, data=None, local_vars_configuration=None):  # noqa: E501
        """CommandDefinition - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this CommandDefinition.  # noqa: E501


        :return: The data of this CommandDefinition.  # noqa: E501
        :rtype: list[CommandDefinitionData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this CommandDefinition.


        :param data: The data of this CommandDefinition.  # noqa: E501
        :type: list[CommandDefinitionData]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommandDefinition):
            return False
