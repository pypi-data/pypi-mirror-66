...
class ArrayOfSettingsData(object):
    ...
    """
    openapi_types = {
        'settings': 'list[ArrayOfSettingsDataSettings]'
    }
    ...
    def __init__(self, settings=None, local_vars_configuration=None):  # noqa: E501
        """ArrayOfSettingsData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def settings(self):
        """Gets the settings of this ArrayOfSettingsData.  # noqa: E501


        :return: The settings of this ArrayOfSettingsData.  # noqa: E501
        :rtype: list[ArrayOfSettingsDataSettings]
        """
        return self._settings

    @settings.setter
    def settings(self, settings):
        """Sets the settings of this ArrayOfSettingsData.


        :param settings: The settings of this ArrayOfSettingsData.  # noqa: E501
        :type: list[ArrayOfSettingsDataSettings]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfSettingsData):
            return False
