...
class ArrayOfStatusData(object):
    ...
    @property
    def status(self):
        """Gets the status of this ArrayOfStatusData.  # noqa: E501


        :return: The status of this ArrayOfStatusData.  # noqa: E501
    ...
    def status(self, status):
        """Sets the status of this ArrayOfStatusData.


        :param status: The status of this ArrayOfStatusData.  # noqa: E501
        :type: list[StatusData]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfStatusData):
            return False
