...
class ArrayOfAvailablePrograms(object):
    ...
    @property
    def data(self):
        """Gets the data of this ArrayOfAvailablePrograms.  # noqa: E501


        :return: The data of this ArrayOfAvailablePrograms.  # noqa: E501
        :rtype: ArrayOfAvailableProgramsData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ArrayOfAvailablePrograms.


        :param data: The data of this ArrayOfAvailablePrograms.  # noqa: E501
        :type: ArrayOfAvailableProgramsData
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfAvailablePrograms):
            return False
