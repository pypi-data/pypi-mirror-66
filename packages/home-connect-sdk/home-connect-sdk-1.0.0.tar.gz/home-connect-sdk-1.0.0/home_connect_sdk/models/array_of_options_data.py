...
class ArrayOfOptionsData(object):
    ...
    def __init__(self, options=None, local_vars_configuration=None):  # noqa: E501
        """ArrayOfOptionsData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def options(self):
        """Gets the options of this ArrayOfOptionsData.  # noqa: E501


        :return: The options of this ArrayOfOptionsData.  # noqa: E501
        :rtype: list[OptionData]
        """
        return self._options

    @options.setter
    def options(self, options):
        """Sets the options of this ArrayOfOptionsData.


        :param options: The options of this ArrayOfOptionsData.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfOptionsData):
            return False
