...
class SelectedProgramNotSetError(object):
    ...
    def __init__(self, error=None, local_vars_configuration=None):  # noqa: E501
        """SelectedProgramNotSetError - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this SelectedProgramNotSetError.  # noqa: E501


        :return: The error of this SelectedProgramNotSetError.  # noqa: E501
        :rtype: UnauthorizedErrorError
        """
        return self._error

    @error.setter
    def error(self, error):
        """Sets the error of this SelectedProgramNotSetError.


        :param error: The error of this SelectedProgramNotSetError.  # noqa: E501
        :type: UnauthorizedErrorError
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SelectedProgramNotSetError):
            return False
