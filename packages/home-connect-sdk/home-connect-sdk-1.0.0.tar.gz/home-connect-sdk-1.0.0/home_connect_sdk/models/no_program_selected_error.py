...
class NoProgramSelectedError(object):
    ...
    def __init__(self, error=None, local_vars_configuration=None):  # noqa: E501
        """NoProgramSelectedError - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this NoProgramSelectedError.  # noqa: E501


        :return: The error of this NoProgramSelectedError.  # noqa: E501
    ...
    def error(self, error):
        """Sets the error of this NoProgramSelectedError.


        :param error: The error of this NoProgramSelectedError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NoProgramSelectedError):
            return False
