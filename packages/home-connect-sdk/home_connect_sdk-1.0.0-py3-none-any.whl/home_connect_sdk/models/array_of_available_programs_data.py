...
class ArrayOfAvailableProgramsData(object):
    ...
    """
    openapi_types = {
        'programs': 'list[ArrayOfAvailableProgramsDataPrograms]'
    }
    ...
    def __init__(self, programs=None, local_vars_configuration=None):  # noqa: E501
        """ArrayOfAvailableProgramsData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def programs(self):
        """Gets the programs of this ArrayOfAvailableProgramsData.  # noqa: E501


        :return: The programs of this ArrayOfAvailableProgramsData.  # noqa: E501
        :rtype: list[ArrayOfAvailableProgramsDataPrograms]
        """
        return self._programs

    @programs.setter
    def programs(self, programs):
        """Sets the programs of this ArrayOfAvailableProgramsData.


        :param programs: The programs of this ArrayOfAvailableProgramsData.  # noqa: E501
        :type: list[ArrayOfAvailableProgramsDataPrograms]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfAvailableProgramsData):
            return False
