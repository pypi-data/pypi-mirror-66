...
class RequestTimeoutError(object):
    ...
    @property
    def error(self):
        """Gets the error of this RequestTimeoutError.  # noqa: E501


        :return: The error of this RequestTimeoutError.  # noqa: E501
    ...
    def error(self, error):
        """Sets the error of this RequestTimeoutError.


        :param error: The error of this RequestTimeoutError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestTimeoutError):
            return False
