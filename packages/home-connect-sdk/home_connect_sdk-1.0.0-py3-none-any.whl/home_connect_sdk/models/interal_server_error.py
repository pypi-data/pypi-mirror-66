...
class InteralServerError(object):
    ...
    def __init__(self, error=None, local_vars_configuration=None):  # noqa: E501
        """InteralServerError - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this InteralServerError.  # noqa: E501


        :return: The error of this InteralServerError.  # noqa: E501
    ...
    def error(self, error):
        """Sets the error of this InteralServerError.


        :param error: The error of this InteralServerError.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InteralServerError):
            return False
