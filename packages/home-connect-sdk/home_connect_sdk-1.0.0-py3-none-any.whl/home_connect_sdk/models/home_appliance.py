...
class HomeAppliance(object):
    ...
    @property
    def data(self):
        """Gets the data of this HomeAppliance.  # noqa: E501


        :return: The data of this HomeAppliance.  # noqa: E501
        :rtype: HomeApplianceData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this HomeAppliance.


        :param data: The data of this HomeAppliance.  # noqa: E501
        :type: HomeApplianceData
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HomeAppliance):
            return False
