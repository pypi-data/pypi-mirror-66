...
class ArrayOfEvents(object):
    ...
    @property
    def items(self):
        """Gets the items of this ArrayOfEvents.  # noqa: E501


        :return: The items of this ArrayOfEvents.  # noqa: E501
        :rtype: list[ArrayOfEventsItems]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this ArrayOfEvents.


        :param items: The items of this ArrayOfEvents.  # noqa: E501
        :type: list[ArrayOfEventsItems]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArrayOfEvents):
            return False
