...
class YachPlugin(NotificationPlugin):
    author = "yp"
    author_url = "https://github.com/qingchunyibeifangzongle/sentry-yach-plugin"
    version = VERSION
    description = "Post notifications to Yach."
    resource_links = [
        ("Source", "https://github.com/qingchunyibeifangzongle/sentry-yach-plugin"),
        ("Bug Tracker", "https://github.com/qingchunyibeifangzongle/sentry-yach-plugin/issues"),
        ("README", "https://github.com/qingchunyibeifangzongle/sentry-yach-plugin/blob/master/README.md"),
    ]
    ...
    def is_configured(self, project):
        return all((self.get_option(k, project) for k in ("url", "secret_key")))
    ...
    def notify_users(self, group, event, *args, **kwargs):
        ...
        secret_key = self.get_option("secret_key", group.project) or ""
        ...
        title = "New message from {}".format(event.project.slug)
