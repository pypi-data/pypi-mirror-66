...
def corr_save_nii(corrs, filename, affine, corr_mask=None, size=[60, 60, 60], ksize=[3, 3, 3], strides=[1, 1, 1], p=1, r=0, correct_method=None, plotrlt=True, img_background=None):

    """
    Save the searchlight RSA results as a NIfTI file for fMRI
    ...
    filename : string
        The file address+filename for the result .nii file.
    ...
    corr_mask : string
        ...
        It can just be one of your fMRI data file in your experiment for a mask file for ROI. If the corr_mask is a
    ...
    Notes
    -----
    A result .nii file of searchlight RSA results will be generated at the corresponding address of filename.
    """
