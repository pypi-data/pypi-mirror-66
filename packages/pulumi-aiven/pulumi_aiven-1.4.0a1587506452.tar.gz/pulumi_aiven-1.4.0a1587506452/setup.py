...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', 'v1.4.0-alpha.1587506452+ga036370'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven v1.4.0-alpha.1587506452+ga036370`
                """)
            else:
                raise
