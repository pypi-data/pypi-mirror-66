...
class IReadOnlyDictionary2(object):
    ...
    swagger_types = {
        ...
        'keyword_audio_transcript': 'list[str]'
    }
    ...
    attribute_map = {
        ...
        'keyword_audio_transcript': 'KeywordAudioTranscript'
    }

    def __init__(self, _none=None, language=None, acoustic=None, pronunciation=None, custom_voice=None, audio_files=None, keyword_audio_transcript=None):  # noqa: E501
        ...
        self._keyword_audio_transcript = None
        ...
        if keyword_audio_transcript is not None:
            self.keyword_audio_transcript = keyword_audio_transcript
    ...
    @property
    def keyword_audio_transcript(self):
        """Gets the keyword_audio_transcript of this IReadOnlyDictionary2.  # noqa: E501


        :return: The keyword_audio_transcript of this IReadOnlyDictionary2.  # noqa: E501
        :rtype: list[str]
        """
        return self._keyword_audio_transcript

    @keyword_audio_transcript.setter
    def keyword_audio_transcript(self, keyword_audio_transcript):
        """Sets the keyword_audio_transcript of this IReadOnlyDictionary2.


        :param keyword_audio_transcript: The keyword_audio_transcript of this IReadOnlyDictionary2.  # noqa: E501
        :type: list[str]
        """

        self._keyword_audio_transcript = keyword_audio_transcript
