...
class CloudCursor(object):
    ...
    def Filter(self, indexnum, indexname, constraintargs):
        ...
        '''
        # cloudquery> select * from aws_ec2_key_pair where region_name='us-west-1' and region_name='us-west-2' and region_name='us-east-1'
        # {"0": 3, "1": 3, "2": 3}
        ...
        self.data = self.table.table_obj.get_data(constraints=constraints)
