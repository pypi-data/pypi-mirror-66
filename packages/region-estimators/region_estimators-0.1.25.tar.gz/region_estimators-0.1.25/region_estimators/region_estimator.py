...
class RegionEstimator(object):
    ...
    def __init__(self, sensors, regions, actuals):
        ...
        """
        # Check sensors:
        assert 'sensor_id' in list(sensors.columns), "There is no sensor_id column in sensors dataframe"
        ...
        # Check regions
        assert 'region_id' in list(regions.columns), "There is no region_id column in regions dataframe"
