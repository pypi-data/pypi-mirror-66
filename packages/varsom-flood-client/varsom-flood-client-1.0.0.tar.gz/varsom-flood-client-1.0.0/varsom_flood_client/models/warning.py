...
class Warning(object):
    ...
    def __init__(self, event_id=None, id=None, master_id=None, version=None, lang_key=None, met_id=None, met_name=None, county_list=None, municipality_list=None, municipality_csv_string=None, activity_level=None, activity_level_name=None, danger_type=None, danger_type_name=None, valid_from=None, valid_to=None, next_warning_time=None, publish_time=None, created_time=None, danger_increase_date_time=None, danger_decrease_date_time=None, main_text=None, warning_text=None, advice_text=None, consequence_text=None, level_meaning_text=None, cause_text=None, area=None, exposed_height_type=None, exposed_height_value=None, exposed_height_value2=None, exposed_climate_type=None, cause_list=None, micro_blog_post_list=None, station_list=None):  # noqa: E501
