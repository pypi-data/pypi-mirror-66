...
class PuppetStub(betterproto.ServiceStub):
    ...
    async def event(self) -> AsyncGenerator[EventResponse, None]:
        ...
        async for response in self._unary_stream(
            "/wechaty.puppet.Puppet/Event", request, EventResponse,
        ):
            yield response
    ...
    async def frendship_accept(self, *, id: str = "") -> FriendshipAcceptResponse:
        request = FriendshipAcceptRequest()
        request.id = id

        return await self._unary_unary(
            "/wechaty.puppet.Puppet/FrendshipAccept", request, FriendshipAcceptResponse,
        )
    ...
    async def tag_contact_remove(
        ...
        return await self._unary_unary(
            "/wechaty.puppet.Puppet/TagContactRemove",
            request,
            TagContactRemoveResponse,
        )
    ...
    async def tag_contact_delete(self, *, id: str = "") -> TagContactDeleteResponse:
        ...
        return await self._unary_unary(
            "/wechaty.puppet.Puppet/TagContactDelete",
            request,
