...
cdef extern from "pattern.h":
    ...
    cdef cppclass Pattern:
        unsigned char * data
        Pattern() nogil
        Pattern(Pattern&, long unsigned int,long unsigned int) nogil
    ...
    cdef cppclass PatternPointer:
        ...
        PatternPointer(Pattern&, long unsigned int,long unsigned int) nogil
        PatternPointer(Pattern&) nogil
        PatternPointer(PatternPointer&, long unsigned int,long unsigned int) nogil
        PatternPointer(PatternPointer&) nogil
        Pattern pattern() nogil
        string tostring(ClassDecoder&) nogil
        long unsigned int n() nogil
        long unsigned int bytesize() nogil
        int skipcount() nogil
        int category() nogil
        int hash() nogil
        bint operator==(PatternPointer&) nogil
