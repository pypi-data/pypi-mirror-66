...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v1.5.0-alpha.1587155913+g30d2ddc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v1.5.0-alpha.1587155913+g30d2ddc`
                """)
            else:
                raise
