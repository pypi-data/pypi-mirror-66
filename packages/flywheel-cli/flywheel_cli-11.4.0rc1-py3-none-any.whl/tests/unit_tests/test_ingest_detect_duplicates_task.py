...
def test_run_dup_in_fw(detect_duplicates_task, create_item):
    ...
    assert detect_duplicates_task.insert_errors.mock_calls == [
        mock.call.push({"item_id": item_1.id, "error_code": expected_error_code}),
        mock.call.push({"item_id": item_3.id, "error_code": expected_error_code}),
        mock.call.flush(),
    ]
...
def test_run_dup_in_upload_set_first_items(detect_duplicates_task, create_item):
    ...
    assert detect_duplicates_task.insert_errors.mock_calls == [
        mock.call.push({"item_id": item_2.id, "error_code": expected_error_code}),
        mock.call.push({"item_id": item_1.id, "error_code": expected_error_code}),
        mock.call.flush(),
    ]
...
def test_run_dup_in_upload_set_middle_items(detect_duplicates_task, create_item):
    ...
    assert detect_duplicates_task.insert_errors.mock_calls == [
        mock.call.push({"item_id": item_3.id, "error_code": expected_error_code}),
        mock.call.push({"item_id": item_4.id, "error_code": expected_error_code}),
        mock.call.push({"item_id": item_2.id, "error_code": expected_error_code}),
        mock.call.flush(),
    ]
