"""
 * $Id: 1.0+5 utils.py 8e5d8580b2fa 2020-04-23 od $
 *
...
class Client(object):
    ...
    @webhook.setter
    def webhook(self, hook: str) -> None:
        self._webhook = hook
