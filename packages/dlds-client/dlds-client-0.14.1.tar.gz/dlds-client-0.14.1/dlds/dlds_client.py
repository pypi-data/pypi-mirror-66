...
class DLDSClient:
    ...
    def get_data_subset(self, subset_id):
        ...
        """
        try:
            response = self.http.get(self.base_url + '/data-subsets/{}/'.format(subset_id))
    ...
    def get_data_subset_items(self, subset_id):
        ...
        for i in range(n_requests):
            ...
            url = self.base_url + '/data-subsets/{}/items/?limit={}&offset={}'.format(subset_id, items_per_request,
                                                                                      offset)
    ...
    def upload_inference_results(self, results, timestamp, iteration, model_id, inverse_class_id_map,
        ...
        if override_latest:
            ...
            try:
                response = self.http.get(self.base_url + '/models/{}/latest_inference_results/'.format(model_id))
                if response.status_code == 200:
        ...
        for i in range(n_inference_results):
            ...
            if existing_result is None:
                ...
                requests.append((self.http.post, '{}/inference-results/'.format(self.base_url), inference_result))
                ...
                requests.append((self.http.patch,
                                 '{}/inference-results/{}/'.format(self.base_url, existing_result['id']),
                                 inference_result))
