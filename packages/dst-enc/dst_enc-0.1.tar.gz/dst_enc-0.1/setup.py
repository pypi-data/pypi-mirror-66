...
setup(
  name = 'dst_enc',         # How you named your package folder (MyLib)
  packages = ['dst_enc'],   # Chose the same as "name"
  ...
  url = 'https://github.com/DH4CK1/dst_enc',   # Provide either the link to your github or to your website
