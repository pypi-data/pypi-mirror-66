...
class DjangoSsoAppBaseViewMixin():
    def __init__(self, *args, **kwargs):
        super(DjangoSsoAppBaseViewMixin, self).__init__(*args, **kwargs)
...
class LoginView(allauth_account_views.LoginView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
...
class LogoutView(allauth_account_views.LogoutView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
    def get(self, request, *args, **kwargs):
...
class SignupView(allauth_account_views.SignupView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
    def get(self, request,  *args, **kwargs):
...
class PasswordResetView(allauth_account_views.PasswordResetView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
    def get(self, *args, **kwargs):
...
class PasswordResetFromKeyView(allauth_account_views.PasswordResetFromKeyView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
...
class EmailVerificationSentView(allauth_account_views.EmailVerificationSentView, DjangoSsoAppBaseViewMixin, WebpackBuiltTemplateViewMixin):
    def get(self, *args, **kwargs):
