...
class Storage(HasName):
    ...
    def getKeyInAppDataStore(self, *paths):
        return self.storagePathJoin("studio", g.userId, g.appId, *paths)

    def getKeyInAppLogsStore(self, *paths):
        return self.storagePathJoin("studio", g.userId, "logs", g.appId, *paths)

    def getKeyInNodeDataStore(self, *paths):
        return self.storagePathJoin("studio", g.userId, g.appId, g.nodeId, *paths)

    def getKeyInComponentDataStore(self, componentId, *paths):
        return self.storagePathJoin(
            "studio", g.userId, "component", componentId, *paths
        )
