...
class Storage(HasName):
    ...
    def getPathInAppDataStore(self, path):
        return self.getPathInTempStore(os.path.join("studio", g.userId, g.appId, path))

    def getPathInAppLogsStore(self, path):
        return self.getPathInTempStore(os.path.join("studio", g.userId, "logs", g.appId, path))

    def getPathInNodeDataStore(self, path):
        return self.getPathInTempStore(os.path.join("studio", g.userId, g.appId, g.nodeId, path))

    def getPathInComponentDataStore(self, componentId, path):
        return self.getPathInTempStore(os.path.join("studio", g.userId, "component", componentId, path))
