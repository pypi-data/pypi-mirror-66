...
class DataSource(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.DataSource/create',
    ...
    def delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.monitoring.v1.DataSource/delete',
            spaceone_dot_api_dot_monitoring_dot_v1_dot_data__source__pb2.DataSourceRequest.SerializeToString,
