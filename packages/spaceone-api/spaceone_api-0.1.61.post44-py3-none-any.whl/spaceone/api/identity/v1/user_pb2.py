...
_USER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\032\"\030/inventory/v1/users/stat',
  ),
  _descriptor.MethodDescriptor(
    name='find',
