...
class ResourceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.stat = channel.unary_unary(
                ...
                response_deserializer=spaceone_dot_api_dot_statistics_dot_v1_dot_resource__pb2.StatInfo.FromString,
                )
...
def add_ResourceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'stat': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=spaceone_dot_api_dot_statistics_dot_v1_dot_resource__pb2.StatInfo.SerializeToString,
            ),
    }
...
class Resource(object):
    ...
    def stat(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.statistics.v1.Resource/stat',
            ...
            spaceone_dot_api_dot_statistics_dot_v1_dot_resource__pb2.StatInfo.FromString,
