...
_SECRETGROUP = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\"\" /inventory/v1/secret-groups/stat',
  ),
])
