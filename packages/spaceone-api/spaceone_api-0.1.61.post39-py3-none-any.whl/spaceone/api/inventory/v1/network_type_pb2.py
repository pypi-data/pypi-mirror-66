...
_NETWORKTYPE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002B\022\033/inventory/v1/network-typesZ#\"!/inventory/v1/network-types/query',
  ),
])
