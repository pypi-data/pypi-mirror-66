...
_USER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0020\022\022/identity/v1/usersZ\032\"\030/identity/v1/users/query',
  ),
  _descriptor.MethodDescriptor(
    name='find',
