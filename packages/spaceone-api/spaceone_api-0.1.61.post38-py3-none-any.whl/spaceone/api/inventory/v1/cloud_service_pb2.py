...
_CLOUDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002D\022\034/inventory/v1/cloud-servicesZ$\"\"/inventory/v1/cloud-services/query',
  ),
])
