...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-chatbot", "1.33.1", __name__, "aws-chatbot@1.33.1.jsii.tgz")
...
class CfnSlackChannelConfigurationProps():
    def __init__(self, *, configuration_name: str, iam_role_arn: str, slack_channel_id: str, slack_workspace_id: str, arn: typing.Optional[str]=None, logging_level: typing.Optional[str]=None, sns_topic_arns: typing.Optional[typing.List[str]]=None):
...
__all__ = ["CfnSlackChannelConfiguration", "CfnSlackChannelConfigurationProps", "__jsii_assembly__"]
