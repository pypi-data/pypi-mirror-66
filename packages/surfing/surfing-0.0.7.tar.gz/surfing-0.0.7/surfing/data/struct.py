...
class AssetPosition(AssetDict):
    ...
    def update(self, trd: AssetTrade):
        ...
        assert trd.is_buy or (self.__dict__[trd.index_id] - v > -1e-8), f'asset trade failed, asset trade sell volume {v} more than position {self.__dict__[trd.index_id]}'
...
class FundTradeParam:
    ...
    MinCountAmtDiff: float=0.003 # 少于总资产千分之三的资产Amount差异，不做基金调仓处理
