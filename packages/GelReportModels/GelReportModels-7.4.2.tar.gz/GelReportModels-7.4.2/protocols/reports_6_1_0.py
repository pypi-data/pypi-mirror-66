...
class AdditionalFindingsExitQuestionnaire(ProtocolElement):
    """
    No documentation
    """
    _schemaSource = """
{"type": "record", "name": "AdditionalFindingsExitQuestionnaire", "namespace":
"org.gel.models.report.avro", "fields": [{"name": "eventDate", "type": "string", "doc": ""},
{"name": "reporter", "type": "string", "doc": ""}, {"name":
"additionalFindingsVariantGroupLevelQuestions", "type": {"type": "array", "items": {"type":
"record", "name": "AdditionalFindingsVariantGroupLevelQuestions", "doc": "", "fields": [{"name":
"variantGroup", "type": "int", "doc": ""}, {"name": "variantLevelQuestions", "type": ["null",
...
"doc": ""}]}}], "doc": ""}, {"name": "shortTandemRepeatLevelQuestions", "type": ["null", {"type":
"array", "items": {"type": "record", "name": "ShortTandemRepeatLevelQuestions", "doc": "", "fields":
[{"name": "coordinates", "type": {"type": "record", "name": "Coordinates", "fields": [{"name":
"assembly", "type": "Assembly"}, {"name": "chromosome", "type": "string"}, {"name": "start", "type":
...
""}, {"name": "familyHistoryCondition", "type": {"type": "enum", "name": "FamilyHistoryCondition",
"symbols": ["yes", "no", "unknown"]}, "doc": ""}, {"name": "familyHistoryPatient", "type": {"type":
"enum", "name": "FamilyHistoryPatient", "symbols": ["yes", "no", "unknown"]}, "doc": ""}, {"name":
"familyHistoryFamily", "type": {"type": "enum", "name": "FamilyHistoryFamily", "symbols": ["yes",
"no", "unknown"]}, "doc": ""}, {"name": "clinicalUtility", "type": {"type": "array", "items":
...
"informs_reproductive_choice", "unknown", "other"]}}, "doc": ""}]}}, "doc": ""}]}
"""
    schema = avro_parse(_schemaSource)
    requiredFields = {
    ...
    def isEmbeddedType(cls, fieldName):
        embeddedTypes = {
            'additionalFindingsVariantGroupLevelQuestions': AdditionalFindingsVariantGroupLevelQuestions,
        }
        return fieldName in embeddedTypes
    ...
    __slots__ = [
        'additionalFindingsVariantGroupLevelQuestions', 'eventDate',
        'reporter'
    ]

    def __init__(self, **kwargs):
        self.additionalFindingsVariantGroupLevelQuestions = kwargs.get(
            'additionalFindingsVariantGroupLevelQuestions', None)
...
class AdditionalFindingsVariantGroupLevelQuestions(ProtocolElement):
    """
    The additional findings variant group level questions
    """
    _schemaSource = """
{"type": "record", "name": "AdditionalFindingsVariantGroupLevelQuestions", "namespace":
"org.gel.models.report.avro", "doc": "", "fields": [{"name": "variantGroup", "type": "int", "doc":
""}, {"name": "variantLevelQuestions", "type": ["null", {"type": "array", "items": {"type":
"record", "name": "VariantLevelQuestions", "doc": "", "fields": [{"name": "variantCoordinates",
...
"GRCh37"]}, "doc": ""}]}, "doc": ""}, {"name": "confirmationDecision", "type": {"type": "enum",
...
{"type": "enum", "name": "ClinicalUtility", "symbols": ["none", "change_in_medication",
"surgical_option", "additional_surveillance_for_proband_or_relatives", "clinical_trial_eligibility",
"informs_reproductive_choice", "unknown", "other"]}}, "doc": ""}]}
"""
    schema = avro_parse(_schemaSource)
    requiredFields = {
        "clinicalUtility",
    ...
    __slots__ = [
        'clinicalUtility', 'familyHistoryCondition',
        'familyHistoryFamily', 'familyHistoryPatient',
        'shortTandemRepeatLevelQuestions',
    ...
    def __init__(self, **kwargs):
        ...
        self.familyHistoryCondition = kwargs.get(
            'familyHistoryCondition', None)
        self.familyHistoryFamily = kwargs.get(
            'familyHistoryFamily', None)
        self.familyHistoryPatient = kwargs.get(
            'familyHistoryPatient', None)
...
"domain_1_2_and_suplementary", "somatic_if_relevant"]}, "doc": ""}, {"name": "actionableVariants",
"type": {"type": "enum", "name": "CancerActionableVariants", "doc": "", "symbols": ["yes", "no"]},
"doc": ""}]}, "doc": ""}, {"name": "somaticVariantLevelQuestions", "type": ["null", {"type":
...
class FamilyHistoryCondition(object):
    """
    No documentation
    """
    yes = "yes"
...
class FamilyHistoryFamily(object):
    """
    No documentation
    """
    yes = "yes"
...
class FamilyHistoryPatient(object):
    """
    No documentation
    """
    yes = "yes"
