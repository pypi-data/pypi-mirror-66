...
function GetOciSubcommands_integration() {
    $ociSubcommands = @{
        ...
        'integration integration-instance' = 'change-compartment create delete get list update'
...
function GetOciCommandsToLongParams_integration() {
    $ociCommandsToLongParams = @{
        ...
        'integration integration-instance create' = 'compartment-id defined-tags display-name freeform-tags from-json help idcs-at is-byol max-wait-seconds message-packs type wait-for-state wait-interval-seconds'
        ...
        'integration integration-instance update' = 'defined-tags display-name force freeform-tags from-json help id if-match is-byol max-wait-seconds message-packs type wait-for-state wait-interval-seconds'
