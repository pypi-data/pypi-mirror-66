...
class S3ArtifactsProps(ArtifactsProps):
    def __init__(self, *, identifier: typing.Optional[str]=None, bucket: aws_cdk.aws_s3.IBucket, name: str, encryption: typing.Optional[bool]=None, include_build_id: typing.Optional[bool]=None, package_zip: typing.Optional[bool]=None, path: typing.Optional[str]=None) -> None:
