...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-codebuild", "1.33.1", __name__, "aws-codebuild@1.33.1.jsii.tgz")
...
class BitBucketSourceCredentialsProps():
    def __init__(self, *, password: aws_cdk.core.SecretValue, username: aws_cdk.core.SecretValue):
...
class CfnReportGroupProps():
    def __init__(self, *, export_config: typing.Union[aws_cdk.core.IResolvable, "CfnReportGroup.ReportExportConfigProperty"], type: str, name: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class EfsFileSystemLocationProps():
    def __init__(self, *, identifier: str, location: str, mount_point: str, mount_options: typing.Optional[str]=None):
...
class FileSystemConfig():
    def __init__(self, *, location: "CfnProject.ProjectFileSystemLocationProperty"):
...
class GitHubEnterpriseSourceCredentialsProps():
    def __init__(self, *, access_token: aws_cdk.core.SecretValue):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.PipelineProjectProps", jsii_struct_bases=[CommonProjectProps], name_mapping={'allow_all_outbound': 'allowAllOutbound', 'badge': 'badge', 'build_spec': 'buildSpec', 'cache': 'cache', 'description': 'description', 'encryption_key': 'encryptionKey', 'environment': 'environment', 'environment_variables': 'environmentVariables', 'file_system_locations': 'fileSystemLocations', 'project_name': 'projectName', 'role': 'role', 'security_groups': 'securityGroups', 'subnet_selection': 'subnetSelection', 'timeout': 'timeout', 'vpc': 'vpc'})
...
class Project(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.Project"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, artifacts: typing.Optional["IArtifacts"]=None, secondary_artifacts: typing.Optional[typing.List["IArtifacts"]]=None, secondary_sources: typing.Optional[typing.List["ISource"]]=None, source: typing.Optional["ISource"]=None, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str,"BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        ...
        :param vpc: VPC network to place codebuild network interfaces. Specify this if the codebuild project needs to access resources in a VPC. Default: - No VPC is specified.
        """
        props = ProjectProps(artifacts=artifacts, secondary_artifacts=secondary_artifacts, secondary_sources=secondary_sources, source=source, allow_all_outbound=allow_all_outbound, badge=badge, build_spec=build_spec, cache=cache, description=description, encryption_key=encryption_key, environment=environment, environment_variables=environment_variables, file_system_locations=file_system_locations, project_name=project_name, role=role, security_groups=security_groups, subnet_selection=subnet_selection, timeout=timeout, vpc=vpc)
...
class PipelineProject(Project, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-codebuild.PipelineProject"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, allow_all_outbound: typing.Optional[bool]=None, badge: typing.Optional[bool]=None, build_spec: typing.Optional["BuildSpec"]=None, cache: typing.Optional["Cache"]=None, description: typing.Optional[str]=None, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, environment: typing.Optional["BuildEnvironment"]=None, environment_variables: typing.Optional[typing.Mapping[str,"BuildEnvironmentVariable"]]=None, file_system_locations: typing.Optional[typing.List["IFileSystemLocation"]]=None, project_name: typing.Optional[str]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, vpc: typing.Optional[aws_cdk.aws_ec2.IVpc]=None) -> None:
        ...
        :param vpc: VPC network to place codebuild network interfaces. Specify this if the codebuild project needs to access resources in a VPC. Default: - No VPC is specified.
        """
        props = PipelineProjectProps(allow_all_outbound=allow_all_outbound, badge=badge, build_spec=build_spec, cache=cache, description=description, encryption_key=encryption_key, environment=environment, environment_variables=environment_variables, file_system_locations=file_system_locations, project_name=project_name, role=role, security_groups=security_groups, subnet_selection=subnet_selection, timeout=timeout, vpc=vpc)

        jsii.create(PipelineProject, self, [scope, id, props])


@jsii.data_type(jsii_type="@aws-cdk/aws-codebuild.ProjectProps", jsii_struct_bases=[CommonProjectProps], name_mapping={'allow_all_outbound': 'allowAllOutbound', 'badge': 'badge', 'build_spec': 'buildSpec', 'cache': 'cache', 'description': 'description', 'encryption_key': 'encryptionKey', 'environment': 'environment', 'environment_variables': 'environmentVariables', 'file_system_locations': 'fileSystemLocations', 'project_name': 'projectName', 'role': 'role', 'security_groups': 'securityGroups', 'subnet_selection': 'subnetSelection', 'timeout': 'timeout', 'vpc': 'vpc', 'artifacts': 'artifacts', 'secondary_artifacts': 'secondaryArtifacts', 'secondary_sources': 'secondarySources', 'source': 'source'})
...
__all__ = ["Artifacts", "ArtifactsConfig", "ArtifactsProps", "BindToCodePipelineOptions", "BitBucketSourceCredentials", "BitBucketSourceCredentialsProps", "BitBucketSourceProps", "BucketCacheOptions", "BuildEnvironment", "BuildEnvironmentVariable", "BuildEnvironmentVariableType", "BuildSpec", "Cache", "CfnProject", "CfnProjectProps", "CfnReportGroup", "CfnReportGroupProps", "CfnSourceCredential", "CfnSourceCredentialProps", "CodeCommitSourceProps", "CommonProjectProps", "ComputeType", "DockerImageOptions", "EfsFileSystemLocationProps", "EventAction", "FileSystemConfig", "FileSystemLocation", "FilterGroup", "GitHubEnterpriseSourceCredentials", "GitHubEnterpriseSourceCredentialsProps", "GitHubEnterpriseSourceProps", "GitHubSourceCredentials", "GitHubSourceCredentialsProps", "GitHubSourceProps", "IArtifacts", "IBuildImage", "IFileSystemLocation", "IProject", "ISource", "ImagePullPrincipalType", "LinuxBuildImage", "LocalCacheMode", "PhaseChangeEvent", "PipelineProject", "PipelineProjectProps", "Project", "ProjectProps", "S3ArtifactsProps", "S3SourceProps", "Source", "SourceConfig", "SourceProps", "StateChangeEvent", "WindowsBuildImage", "__jsii_assembly__"]
