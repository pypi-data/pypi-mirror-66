...
class VssManager(object):
    ...
    def get_user_message(self, m_id):
        ...
        """
        json = self.request('/user/message/{id}'.format(id=m_id))
        return json.get('data')
    ...
    def ack_user_message(self, m_id):
        ...
        """
        return self.request(
            '/user/message/{id}'.format(id=m_id), method=self.PATCH
        )
    ...
    def get_template(self, vm_id, **kwargs):
        ...
        """
        json = self.request('/vm/{vm_id}'.format(vm_id=vm_id), params=kwargs)
        return json.get('data')
    ...
    def get_vm_spec(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/spec'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_name(self, vm_id):
        ...
        :return: object
        """
        json = self.request('/vm/{vm_id}/name'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_state(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/state'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_state(self, vm_id, state, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/state'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_domain(self, vm_id):
        ...
        :return: object
        """
        json = self.request('/vm/{vm_id}/domain'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_domain(
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/domain'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_boot(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/boot'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_boot(self, vm_id, attribute, value, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/boot'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_os(self, vm_id):
        ...
        :return: object
        """
        json = self.request('/vm/{vm_id}/os'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_os(self, vm_id, os, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/os'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_folder(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/folder'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_folder(self, vm_id, folder_moId, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/folder'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_version(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/version'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_version(self, vm_id, vmx, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/version'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_guest(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/guest'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_guest_os(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/guest/os'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def run_cmd_guest_vm(self, vm_id, user, pwd, cmd, arg, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/guest/cmd'.format(vm_id=vm_id),
            method=self.POST,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_guest_process_id(self, vm_id, user, pwd, pid):
        ...
        json = self.request(
            '/vm/{vm_id}/guest/cmd/{pid}'.format(vm_id=vm_id, pid=pid),
            method=self.GET,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_guest_ip(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/guest/net/ip'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_tools(self, vm_id):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/guest/tools'.format(vm_id=vm_id), method=self.GET
        )
        return json.get('data')
    ...
    def update_vm_tools(self, vm_id, action, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/guest/tools'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def create_vm_snapshot(
        ...
        json = self.request(
            '/vm/{vm_id}/snapshot'.format(vm_id=vm_id),
            method=self.POST,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_snapshots(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/snapshot'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_snapshot(self, vm_id, snapshot):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/snapshot/{id}'.format(vm_id=vm_id, id=snapshot)
        )
        return json.get('data')
    ...
    def get_vm_consolidation(self, vm_id):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/snapshot/consolidate'.format(vm_id=vm_id)
        )
        return json.get('data')
    ...
    def get_vm_alarms(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/alarm'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_alarm(self, vm_id, moref):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/alarm/{moref}'.format(vm_id=vm_id, moref=moref)
        )
        return json.get('data')
    ...
    def update_vm_alarm(self, vm_id, moref, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{uuid]/alarm/{moref}'.format(vm_id=vm_id, moref=moref),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_events(self, vm_id, hours=1):
        ...
        json = self.request(
            '/vm/{vm_id}{events}'.format(vm_id=vm_id, events=event_uri)
        )
        return json.get('data')
    ...
    def get_vm_performance_cpu(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/performance/cpu'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_performance_memory(self, vm_id):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/performance/memory'.format(vm_id=vm_id)
        )
        return json.get('data')
    ...
    def get_vm_performance_io(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/performance/io'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_performance_net(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/performance/net'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def export_vm(self, vm_id):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/export'.format(vm_id=vm_id), method=self.POST
        )
        return json.get('data')
    ...
    def delete_vm(self, vm_id, force=False):
        ...
        json = self.request(
            '/vm/{vm_id}'.format(vm_id=vm_id), method=self.DELETE
        )
        return json.get('data')
    ...
    def create_vm_custom_spec(self, vm_id, custom_spec, **kwargs):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/custom_spec'.format(vm_id=vm_id),
            method=self.POST,
            payload=custom_spec,
            **kwargs
        )
    ...
    def get_vm_console(self, vm_id, auth=None, client='flash'):
        ...
        if auth:
            ...
            kwargs['auth'] = _auth
        json = self.request(
            '/vm/{vm_id}/console'.format(vm_id=vm_id), params=params, **kwargs
        )
        return json.get('data')

    def get_vm_vsphere_link(self, vm_id, **kwargs):
        """
        Produces an URL to the vSphere client on the given
        ...
        """
        json = self.request(
            '/vm/{vm_id}/vcenter'.format(vm_id=vm_id), **kwargs
        )
        return json.get('data')
    ...
    def is_vm_template(self, vm_id):
        ...
        :return: bool
        """
        json = self.request('/vm/{vm_id}/template'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def mark_vm_as_template(self, vm_id, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/template'.format(vm_id=vm_id),
            payload=json_payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def get_vm_memory(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/memory'.format(vm_id))
        return json.get('data')
    ...
    def get_vm_memory_config(self, vm_id):
        ...
        :return: change request object
        """
        json = self.request('/vm/{vm_id}/memory/config'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_memory_hot_add(self, vm_id, hot_add, **kwargs):
        ...
        payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/memory/config'.format(vm_id=vm_id),
            payload=payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def set_vm_memory(self, vm_id, sizeGB, **kwargs):
        ...
        payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/memory'.format(vm_id=vm_id),
            payload=payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def get_vm_cpu(self, vm_id):
        ...
        :return: change request object
        """
        json = self.request('/vm/{vm_id}/cpu'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_cpu_config(self, vm_id):
        ...
        :return: change request object
        """
        json = self.request('/vm/{vm_id}/cpu/config'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_cpu_hot_add(self, vm_id, hot_add, **kwargs):
        ...
        payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/cpu/config'.format(vm_id=vm_id),
            payload=payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def set_vm_cpu(self, vm_id, number, **kwargs):
        ...
        payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/cpu'.format(vm_id=vm_id),
            payload=payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def get_vm_nics(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/nic'.format(vm_id=vm_id))
        nic_numbers = [nic.get('unit') for nic in json.get('data')]
        nics = list()
        for nic in nic_numbers:
            json = self.request(
                '/vm/{vm_id}/nic/{nic}'.format(vm_id=vm_id, nic=nic)
            )
    ...
    def create_vm_nic(self, vm_id, networks, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/nic'.format(vm_id=vm_id),
            method=self.POST,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def delete_vm_nic(self, vm_id, unit, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/nic/{number}'.format(vm_id=vm_id, number=unit),
            method=self.DELETE,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def update_vm_nic_network(self, vm_id, nic, network, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/nic/{number}'.format(vm_id=vm_id, number=nic),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_floppies(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/floppy'.format(vm_id=vm_id))
    ...
    def get_vm_floppy(self, vm_id, floppy):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/floppy/{floppy}'.format(vm_id=vm_id, floppy=floppy)
        )
        return json.get('data')
    ...
    def get_vm_cds(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/cd'.format(vm_id=vm_id))
    ...
    def get_vm_cd(self, vm_id, cd):
        ...
        """
        json = self.request('/vm/{vm_id}/cd/{cd}'.format(vm_id=vm_id, cd=cd))
        return json.get('data')
    ...
    def update_vm_cd(self, vm_id, unit, iso=None, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/cd/{unit}'.format(vm_id=vm_id, unit=unit),
            method=self.PATCH,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_controllers(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/controller'.format(vm_id=vm_id))
        data = json.get('data')
        if not data:
            return None
    ...
    def get_vm_scsi_devices(self, vm_id):
        ...
        :return: list of objects
        """
        json = self.request('/vm/{vm_id}/controller/scsi'.format(vm_id=vm_id))
        data = json.get('data')
        if not data:
            return None
        scsi = []
    ...
    def get_vm_scsi_device(self, vm_id, bus, devices=None):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/controller/scsi/{bus}'.format(vm_id=vm_id, bus=bus)
        )
        data = json.get('data')
        if not data:
            return None
    ...
    def create_vm_scsi_device(self, vm_id, types, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/controller/scsi'.format(vm_id=vm_id),
            method=self.POST,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_disks(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/disk'.format(vm_id=vm_id))
        disk_units = [disk.get('unit') for disk in json.get('data')]
        disks = list()
        for disk in disk_units:
    ...
    def get_vm_disk(self, vm_id, disk):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/disk/{disk}'.format(vm_id=vm_id, disk=disk)
        )
        return json.get('data')
    ...
    def get_vm_disk_backing(self, vm_id, disk):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/disk/{disk}/backing'.format(vm_id=vm_id, disk=disk)
        )
        return json.get('data')
    ...
    def get_vm_disk_scsi(self, vm_id, disk):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/disk/{disk}/scsi'.format(vm_id=vm_id, disk=disk)
        )
        return json.get('data')
    ...
    def create_vm_disk(self, vm_id, values_in_gb, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/disk'.format(vm_id=vm_id),
            method=self.POST,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def delete_vm_disk(self, vm_id, unit, **kwargs):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/disk/{disk}'.format(vm_id=vm_id, disk=unit),
            method=self.DELETE,
            payload=kwargs,
        )
        return json.get('data')
    ...
    def is_powered_on_vm(self, vm_id):
        ...
        :return: bool
        """
        data = self.get_vms(filter='vm_id,eq,%s' % vm_id)
        if not data:
            return None
        else:
    ...
    def rename_vm(self, vm_id, name, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/name'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
    ...
    def get_vm_vmrc_copy_paste(self, vm_id, options=False, **kwargs):
        ...
        json = self.request(
            '/vm/{vm_id}/console/copy-paste'.format(vm_id=vm_id),
            params=params,
            **kwargs
        )
        return json.get('data')
    ...
    def get_vm_notes(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/note/client'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_notes(self, vm_id, notes, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/note/client'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_service(self, vm_id):
        ...
        :return: obj
        """
        json = self.request('/vm/{vm_id}/vss/service'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_service(self, vm_id, service_name_or_id, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/service'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_options(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/option'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_vss_description(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/description'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_description(self, vm_id, description, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/description'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_admin(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/admin'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_admin(self, vm_id, name, phone, email, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/admin'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_ha_group(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/ha_group'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def delete_vm_vss_ha_group(self, vm_id):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/vss/ha_group'.format(vm_id=vm_id), method=self.DELETE
        )
        return json.get('data')
    ...
    def update_vm_vss_ha_group(self, vm_id, vms, append=True, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/ha_group'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_usage(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/usage'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_vss_client(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/client'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_client(self, vm_id, client, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/client'.format(vm_id=vm_id),
            payload=json_payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def get_vm_vss_changelog(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/changelog'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_usage(self, vm_id, usage, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/usage'.format(vm_id=vm_id),
            payload=json_payload,
            method=self.PUT,
        )
        return json.get('data')
    ...
    def get_vm_vss_inform(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss/inform'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def update_vm_vss_inform(self, vm_id, emails, append=True, **kwargs):
        ...
        json_payload.update(kwargs)
        json = self.request(
            '/vm/{vm_id}/vss/inform'.format(vm_id=vm_id),
            method=self.PUT,
            payload=json_payload,
        )
        return json.get('data')
    ...
    def get_vm_vss_requested(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/vss'.format(vm_id=vm_id))
    ...
    def get_vm_extra_cfg_options(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/extra'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def get_vm_extra_cfg_option(self, vm_id, option):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/extra/{option}'.format(vm_id=vm_id, option=option)
        )
        return json.get('data')
    ...
    def update_vm_extra_cfg_options(self, vm_id, options):
        ...
        """
        json = self.request(
            '/vm/{vm_id}/extra'.format(vm_id=vm_id),
            method=self.PUT,
    ...
    def get_vm_permission(self, vm_id):
        ...
        :return: list of key value objects
        """
        json = self.request('/vm/{vm_id}/perm'.format(vm_id=vm_id))
        return json.get('data')
