...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-apigateway", "1.33.1", __name__, "aws-apigateway@1.33.1.jsii.tgz")
...
class AccessLogDestinationConfig():
    def __init__(self, *, destination_arn: str):
...
class BasePathMappingOptions():
    def __init__(self, *, base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None):
        """
        :param base_path: The base path name that callers of the API must provide in the URL after the domain name (e.g. ``example.com/base-path``). If you specify this property, it can't be an empty string. Default: - map requests from the domain root (e.g. ``example.com``). If this is undefined, no additional mappings will be allowed on this domain name.
        :param stage: The Deployment stage of API [disable-awslint:ref-via-interface]. Default: - map to deploymentStage of restApi otherwise stage needs to pass in URL
        """
...
class BasePathMappingProps(BasePathMappingOptions):
    def __init__(self, *, base_path: typing.Optional[str]=None, stage: typing.Optional["Stage"]=None, domain_name: "IDomainName", rest_api: "IRestApi"):
        """
        :param base_path: The base path name that callers of the API must provide in the URL after the domain name (e.g. ``example.com/base-path``). If you specify this property, it can't be an empty string. Default: - map requests from the domain root (e.g. ``example.com``). If this is undefined, no additional mappings will be allowed on this domain name.
        :param stage: The Deployment stage of API [disable-awslint:ref-via-interface]. Default: - map to deploymentStage of restApi otherwise stage needs to pass in URL
        :param domain_name: The DomainName to associate with this base path mapping.
...
class DomainNameOptions():
    def __init__(self, *, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None):
        """
...
class DomainNameProps(DomainNameOptions):
    def __init__(self, *, certificate: aws_cdk.aws_certificatemanager.ICertificate, domain_name: str, endpoint_type: typing.Optional["EndpointType"]=None, security_policy: typing.Optional["SecurityPolicy"]=None, mapping: typing.Optional["IRestApi"]=None):
        """
        :param certificate: The reference to an AWS-managed certificate for use by the edge-optimized endpoint for the domain name. For "EDGE" domain names, the certificate needs to be in the US East (N. Virginia) region.
        :param domain_name: The custom domain name for your API. Uppercase letters are not supported.
        :param endpoint_type: The type of endpoint for this DomainName. Default: REGIONAL
...
class JsonWithStandardFieldProps():
    def __init__(self, *, caller: bool, http_method: bool, ip: bool, protocol: bool, request_time: bool, resource_path: bool, response_length: bool, status: bool, user: bool):
...
class RequestAuthorizerProps(LambdaAuthorizerProps):
    def __init__(self, *, handler: aws_cdk.aws_lambda.IFunction, assume_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, authorizer_name: typing.Optional[str]=None, results_cache_ttl: typing.Optional[aws_cdk.core.Duration]=None, identity_sources: typing.List[str]):
...
__all__ = ["AccessLogDestinationConfig", "AccessLogField", "AccessLogFormat", "ApiKey", "ApiKeyProps", "ApiKeySourceType", "AuthorizationType", "Authorizer", "AwsIntegration", "AwsIntegrationProps", "BasePathMapping", "BasePathMappingOptions", "BasePathMappingProps", "CfnAccount", "CfnAccountProps", "CfnApiKey", "CfnApiKeyProps", "CfnApiMappingV2", "CfnApiMappingV2Props", "CfnApiV2", "CfnApiV2Props", "CfnAuthorizer", "CfnAuthorizerProps", "CfnAuthorizerV2", "CfnAuthorizerV2Props", "CfnBasePathMapping", "CfnBasePathMappingProps", "CfnClientCertificate", "CfnClientCertificateProps", "CfnDeployment", "CfnDeploymentProps", "CfnDeploymentV2", "CfnDeploymentV2Props", "CfnDocumentationPart", "CfnDocumentationPartProps", "CfnDocumentationVersion", "CfnDocumentationVersionProps", "CfnDomainName", "CfnDomainNameProps", "CfnDomainNameV2", "CfnDomainNameV2Props", "CfnGatewayResponse", "CfnGatewayResponseProps", "CfnIntegrationResponseV2", "CfnIntegrationResponseV2Props", "CfnIntegrationV2", "CfnIntegrationV2Props", "CfnMethod", "CfnMethodProps", "CfnModel", "CfnModelProps", "CfnModelV2", "CfnModelV2Props", "CfnRequestValidator", "CfnRequestValidatorProps", "CfnResource", "CfnResourceProps", "CfnRestApi", "CfnRestApiProps", "CfnRouteResponseV2", "CfnRouteResponseV2Props", "CfnRouteV2", "CfnRouteV2Props", "CfnStage", "CfnStageProps", "CfnStageV2", "CfnStageV2Props", "CfnUsagePlan", "CfnUsagePlanKey", "CfnUsagePlanKeyProps", "CfnUsagePlanProps", "CfnVpcLink", "CfnVpcLinkProps", "ConnectionType", "ContentHandling", "Cors", "CorsOptions", "Deployment", "DeploymentProps", "DomainName", "DomainNameAttributes", "DomainNameOptions", "DomainNameProps", "EmptyModel", "EndpointConfiguration", "EndpointType", "ErrorModel", "HttpIntegration", "HttpIntegrationProps", "IAccessLogDestination", "IApiKey", "IAuthorizer", "IDomainName", "IModel", "IRequestValidator", "IResource", "IRestApi", "IStage", "IdentitySource", "Integration", "IntegrationOptions", "IntegrationProps", "IntegrationResponse", "IntegrationType", "JsonSchema", "JsonSchemaType", "JsonSchemaVersion", "JsonWithStandardFieldProps", "LambdaAuthorizerProps", "LambdaIntegration", "LambdaIntegrationOptions", "LambdaRestApi", "LambdaRestApiProps", "LogGroupLogDestination", "Method", "MethodDeploymentOptions", "MethodLoggingLevel", "MethodOptions", "MethodProps", "MethodResponse", "MockIntegration", "Model", "ModelOptions", "ModelProps", "PassthroughBehavior", "Period", "ProxyResource", "ProxyResourceOptions", "ProxyResourceProps", "QuotaSettings", "RateLimitedApiKey", "RateLimitedApiKeyProps", "RequestAuthorizer", "RequestAuthorizerProps", "RequestValidator", "RequestValidatorOptions", "RequestValidatorProps", "Resource", "ResourceBase", "ResourceOptions", "ResourceProps", "RestApi", "RestApiProps", "SecurityPolicy", "Stage", "StageOptions", "StageProps", "ThrottleSettings", "ThrottlingPerMethod", "TokenAuthorizer", "TokenAuthorizerProps", "UsagePlan", "UsagePlanPerApiStage", "UsagePlanProps", "VpcLink", "VpcLinkProps", "__jsii_assembly__"]
