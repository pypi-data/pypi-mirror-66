...
class ModelMeta(object):
    ...
    factory_required_modules: [object] = []
        ...
        for django_field in self.django_fields:
            ...
            if field.related_model is not None:
                if field.related_model._meta.model_name == self.name:
                    ...
                    field.related_model_meta = ModelMeta(
            ...
            if factory.required_factory is not None:
                self.factory_required_modules.append(factory.required_factory)
    ...
    def to_json(self) -> dict:
        ...
        obj['django_fields'] = []
        obj['verbose_name_plural'] = str(obj['verbose_name_plural'])
        obj['model'] = None

        for field in self.fields:
            field_obj = field.to_json()
            obj['fields'].append(field_obj)
