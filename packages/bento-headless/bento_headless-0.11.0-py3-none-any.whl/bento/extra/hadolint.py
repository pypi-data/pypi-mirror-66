...
class HadolintTool(runner.Docker, output.Json):
    ...
    @property
    def binary_executable(self) -> Optional[str]:
        return "hadolint"

    @property
    def binary_version_pattern(self) -> Pattern:
        return self.VERSION_MATCH

    @property
    def binary_command(self) -> List[str]:
        # Docker command already includes executable
        return []

    @property
    def allowed_binary_versions(self) -> SimpleSpec:
        return self.BINARY_SPEC
