...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v1.6.0-alpha.1587211218+ga0758af'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v1.6.0-alpha.1587211218+ga0758af`
                """)
            else:
                raise
