...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v1.6.0-alpha.1587211963+g2ebb41f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v1.6.0-alpha.1587211963+g2ebb41f`
                """)
            else:
                raise
