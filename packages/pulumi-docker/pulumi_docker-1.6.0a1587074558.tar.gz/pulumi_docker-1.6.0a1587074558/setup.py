...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v1.6.0-alpha.1587074558+gc315a35'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v1.6.0-alpha.1587074558+gc315a35`
                """)
            else:
                raise
