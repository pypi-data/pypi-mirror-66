...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v1.6.0-alpha.1587210496+g5ed22e9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v1.6.0-alpha.1587210496+g5ed22e9`
                """)
            else:
                raise
