...
FRONTSIGNAL_RAW_FILENAME = "current_front.csv"
SIDESIGNAL_RAW_FILENAME = "current_side.csv"
...
class Experiment:
    def __init__(self, name="NewExperiment", connect=True, device_serial="auto"):
        ...
        self.frontsignal_rawfile = os.path.join(self.name,FRONTSIGNAL_RAW_FILENAME)
        self.sidesignal_rawfile = os.path.join(self.name,SIDESIGNAL_RAW_FILENAME)
