...
class ODmeasurement:
    def __init__(self, pe):
        self.pe = pe
        self.dev = pe.dev
        self.calibration_file_front = os.path.join(self.pe.directory, OD_FRONT_CALIBRATION_FILENAME)
        self.calibration_file_side = os.path.join(self.pe.directory, OD_SIDE_CALIBRATION_FILENAME)
