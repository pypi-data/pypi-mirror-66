...
def find_thetas(structure, output_type=OutputType.PDcode, chain=None, bridges_type=Bridges.SSBOND,
               model=None, arc_bridges=1, output='list', file_prefix='loop', folder_prefix='', bridges=None):
    """
    ...
    """
    g = Graph(structure, chain=chain, model=model, bridges_type=bridges_type, bridges=bridges)
