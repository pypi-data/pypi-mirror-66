...
def gln(input_data, chain2_data=None, chain1_boundary=(-1, -1),
    ...
    Args:
        ...
        mode (int, optional):
                ...
                calculating maximal absolute GLN value between fragments of two
    ...
    Returns:
        ...
        GLN mode (GlnMode.MAX), the dictionary with the maximal absolute 
        GLN between two chains, as well as maximal absolute GLN value 
        between one chain and the part of the second chain (indicated by
        the indices) is returned. In matrix mode (GlnMode.MATRIX), the 
        whole matrix of GLN between one chain (the loop) and each 
        subchain of second chain (tail) is calculated.
    """
