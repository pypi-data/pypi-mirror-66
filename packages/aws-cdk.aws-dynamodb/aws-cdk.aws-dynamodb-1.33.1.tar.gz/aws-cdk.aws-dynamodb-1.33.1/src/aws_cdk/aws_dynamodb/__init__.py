...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-dynamodb", "1.33.1", __name__, "aws-dynamodb@1.33.1.jsii.tgz")
...
class TableAttributes():
    def __init__(self, *, table_arn: typing.Optional[str]=None, table_name: typing.Optional[str]=None, table_stream_arn: typing.Optional[str]=None):
