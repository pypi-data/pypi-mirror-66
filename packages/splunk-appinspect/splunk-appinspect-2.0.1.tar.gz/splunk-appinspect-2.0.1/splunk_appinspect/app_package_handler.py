    ...
    def __init__(self, app_package_path):
        ...
        try:
            ...
            logger_output = ("An attempt was made to initialize"
                             ...
                             " Exception: {}").format(str(exception))
    ...
    def generate_package_hash_from_dir(self, algorithm='md5'):
        ...
        try:
            ...
            for app_package in self.app_packages:
                for root, dirs, files in sorted_walk(app_package.working_app_path):
                    for name in files:
...
class AppPackage(object):
    ...
    def _get_basename_from_path(self, path_to_extract_from):
        ...
        elif file_resource_full_name.endswith((".tgz",".spl",".zip")):
...
class CompressedAppPackage(AppPackage):
    ...
    def __init__(self, app_package_path):
        ...
        try:
            traversal_attack_found = self._perform_extraction(self.origin_path, self.extracted_path) # noqa pylint: disable=assignment-from-no-return
    ...
    def clean_up(self):
        ...
        if (self.extracted_path is not None and
            ...
            try:
                ...
                logger.warning("OSError raised when cleaning temp directory, {}".format(str(e)))
                # WA ACD-3024
