...
@splunk_appinspect.tags("splunk_appinspect", "splunk_6_1", "deprecated_feature", "ast")
...
def check_for_datamodel_acceleration_endpoint_usage(app, reporter):
    ...
    report_output = "From Splunk 6.1, datamodel/acceleration endpoint is deprecated. " \
    ...
    for matched_file, matched_lineno in check_routine.find_endpoint_usage(
        ...
        reporter.warn(report_output, matched_file, matched_lineno)
