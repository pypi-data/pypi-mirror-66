...
from splunk_appinspect.check_routine import xml_node, report_on_xml_findings, find_xml_nodes
...
def check_for_dashboard_xml_option_element_with_deprecated_attribute_value(app, reporter):
    ...
    """
    reporter_output = ("<option> elements with the attribute refresh.auto.interval was detected, "
