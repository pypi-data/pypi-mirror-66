...
@splunk_appinspect.tags("splunk_appinspect", "splunk_6_0", "deprecated_feature", "splunk_7_0", 'removed_feature')
...
def check_crawl_conf_black_list(app, reporter, target_splunk_version):
    ...
    if "splunk_6_0" <= target_splunk_version < 'splunk_7_0':
        check_routine.blacklist_conf(app, reporter.warn, "crawl.conf",
