...
class PythonModulesMetadata(object):
    ...
    def _build_metadata_tree(self, metadata_obj, namespace):
        ...
        if inspect.ismodule(metadata_obj):
            ...
            for attribute_name in dir(metadata_obj):
                if not attribute_name.startswith('__'):
                    ...
                    if attr:
                        module.add(attr)
            return module
        elif inspect.isfunction(metadata_obj) or inspect.ismethod(metadata_obj):
            ...
            if function_name in self._whitelist_functions:
                ...
                function = metadata_types.FunctionMetadata(function_name, namespace, metadata_obj.__doc__, tags=tags, python_object=metadata_obj)
                return function
        elif inspect.isclass(metadata_obj):
    ...
    def _check_module_name(self, metadata_module):
...
class MetadataQuery(object):
    ...
    def _is_namespace_prefix(self, prefix, namespace):
