...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloud9", "1.33.1", __name__, "aws-cloud9@1.33.1.jsii.tgz")
...
class Ec2EnvironmentProps():
    def __init__(self, *, vpc: aws_cdk.aws_ec2.IVpc, description: typing.Optional[str]=None, ec2_environment_name: typing.Optional[str]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, subnet_selection: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None):
...
__all__ = ["CfnEnvironmentEC2", "CfnEnvironmentEC2Props", "Ec2Environment", "Ec2EnvironmentProps", "IEc2Environment", "__jsii_assembly__"]
