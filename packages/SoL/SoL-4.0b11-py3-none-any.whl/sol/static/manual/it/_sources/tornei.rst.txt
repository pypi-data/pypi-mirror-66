...
Nel secondo caso SoL non impone attualmente nessun vincolo sul numero di concorrenti, ma per
funzionare correttamente questo deve essere una `potenza di due`__, cioè 4, 8, 16, 32, 64...


.. important:: Sebbene entrambi i sistemi possano usare una particolare `valutazione`, i tornei
               ad `eliminazione diretta` **non** vengono considerati quando la valutazione
               viene (ri)calcolata.
