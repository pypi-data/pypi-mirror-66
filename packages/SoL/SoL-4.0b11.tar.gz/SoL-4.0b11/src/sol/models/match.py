...
class Match(Base):
    ...
    misses1_1 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 1" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/1'),
            hint=_("Number of unsuccessful shots of the first competitor in board 1."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 1,
    for *training matches*."""

    misses1_2 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 2" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/2'),
            hint=_("Number of unsuccessful shots of the first competitor in board 2."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 2,
    for *training matches*."""

    misses1_3 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 3" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/3'),
            hint=_("Number of unsuccessful shots of the first competitor in board 3."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 3,
    for *training matches*."""

    misses1_4 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 4" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/4'),
            hint=_("Number of unsuccessful shots of the first competitor in board 4."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 4,
    for *training matches*."""

    misses1_5 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 5" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/5'),
            hint=_("Number of unsuccessful shots of the first competitor in board 5."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 5,
    for *training matches*."""

    misses1_6 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 6" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/6'),
            hint=_("Number of unsuccessful shots of the first competitor in board 6."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 6,
    for *training matches*."""

    misses1_7 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 7" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/7'),
            hint=_("Number of unsuccessful shots of the first competitor in board 7."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 7,
    for *training matches*."""

    misses1_8 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the first competitor in board 8" in
            # the Matches grid, keep it as compact as possible
            label=_('M1/8'),
            hint=_("Number of unsuccessful shots of the first competitor in board 8."),
            min=0, max=99))
    """Errors of the first :py:class:`competitor <.Competitor>` in board 8,
    for *training matches*."""

    misses2_1 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 1"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/1'),
            hint=_("Number of unsuccessful shots of the second competitor in board 1."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 1,
    for *training matches*."""

    misses2_2 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 2"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/2'),
            hint=_("Number of unsuccessful shots of the second competitor in board 2."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 2,
    for *training matches*."""

    misses2_3 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 3"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/3'),
            hint=_("Number of unsuccessful shots of the second competitor in board 3."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 3,
    for *training matches*."""

    misses2_4 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 4"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/4'),
            hint=_("Number of unsuccessful shots of the second competitor in board 4."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 4,
    for *training matches*."""

    misses2_5 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 5"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/5'),
            hint=_("Number of unsuccessful shots of the second competitor in board 5."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 5,
    for *training matches*."""

    misses2_6 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 6"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/6'),
            hint=_("Number of unsuccessful shots of the second competitor in board 6."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 6,
    for *training matches*."""

    misses2_7 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 7"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/7'),
            hint=_("Number of unsuccessful shots of the second competitor in board 7."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 7,
    for *training matches*."""

    misses2_8 = Column(
        smallint_t,
        info=dict(
            # TRANSLATORS: this is label for the "misses of the second competitor in board 8"
            # in the Matches grid, keep it as compact as possible
            label=_('M2/8'),
            hint=_("Number of unsuccessful shots of the second competitor in board 8."),
            min=0, max=99))
    """Errors of the second :py:class:`competitor <.Competitor>` in board 8,
    for *training matches*."""
    ...
    def serialize(self, serializer, competitors):
        ...
        tboards = self.tourney.championship.trainingboards
        if tboards:
