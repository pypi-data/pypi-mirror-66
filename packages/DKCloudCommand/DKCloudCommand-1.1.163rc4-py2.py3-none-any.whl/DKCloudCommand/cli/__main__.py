...
class Backend(object):
    ...
    def init_context(self):
        ...
        if self.current_command != 'config' and not os.path.isfile(self.cfg.get_config_file_location()):
            click.secho('You are running an unconfigured system!', fg='yellow')
...
def exit_if_python2():
    if six.PY2:
        sys.exit("Python2 reached end of life and is not supported by DKCloudCommand. Please use pip3 "
