...
setup(
    ...
    platforms=["all"],
    install_requires=["torch", "torchvision", "opencv-python", "numpy", "scipy"]  # 这个项目需要的第三方库
)


'''
    >>> python setup.py sdist
    >>> twine upload dist/labvision-0.0.x.tar.gz
    >>> pip install labvision -i https://pypi.org/simple -U
'''
