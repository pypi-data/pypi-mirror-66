...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v2.1.0-alpha.1586948920+ga8782f9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v2.1.0-alpha.1586948920+ga8782f9`
                """)
            else:
                raise
