...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v1.5.0-alpha.1586950138+g8c8c8f3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v1.5.0-alpha.1586950138+g8c8c8f3`
                """)
            else:
                raise
