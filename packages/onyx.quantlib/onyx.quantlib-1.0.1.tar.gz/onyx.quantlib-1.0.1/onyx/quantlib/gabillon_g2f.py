...
###############################################################################
"""
Core functions for multi asset two fctors Gabillon Model (G2F):
...
def rho_YY(
    rho_SL_k, rho_SL_k_comp,
    rho_SL_l, rho_SL_l_comp,
...
# -----------------------------------------------------------------------------
def TermCovG2F2Assets(
    sig_S_k, sig_L_k, rho_SL_k, rho_SL_k_comp, beta_k,
