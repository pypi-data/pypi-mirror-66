...
- disabledElements (list; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, state=Component.UNDEFINED, maxElementSelectable=Component.UNDEFINED, forceTableLayout=Component.UNDEFINED, enabledElements=Component.UNDEFINED, disabledElements=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'state', 'maxElementSelectable', 'forceTableLayout', 'enabledElements', 'disabledElements']
        self._type = 'PeriodicTableInput'
        self._namespace = 'dash_mp_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'state', 'maxElementSelectable', 'forceTableLayout', 'enabledElements', 'disabledElements']
