...
from drillcore_transformations_py.transformations import transform_without_gamma, vector_from_dip_and_dir
...
def main():
	from drillcore_transformations_py.usage import initialize_config, transform_excel_two_files, add_column_name, convention_testing_csv
	...
	convention_testing_csv(filename)
