...
class Pulp2to3MigrationPulp2Content(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, pulp2_id=None, pulp2_content_type_id=None, pulp2_last_updated=None, pulp2_storage_path=None, downloaded=False, pulp3_content=None, local_vars_configuration=None):  # noqa: E501
