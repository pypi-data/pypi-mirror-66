...
def listFilesInPath(bucket,prefix,removePrefix=True,subsetExt=None, 
                    removeExt=False,dropSubFolders=True):
    ...
    if dropSubFolders:
        listOfFiles = [fileName for fileName in listOfFiles if (fileName ==  os.path.basename(fileName))]
