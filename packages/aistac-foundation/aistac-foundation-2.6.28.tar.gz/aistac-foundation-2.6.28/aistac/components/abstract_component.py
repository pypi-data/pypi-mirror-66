...
class AbstractComponent(ABC):
    ...
    @abstractmethod
    def __init__(self, property_manager: AbstractPropertyManager, intent_model: AbstractIntentModel,
                 default_save: bool=None, reset_templates: bool=None, align_connectors: bool=None):
    ...
    def from_env(cls, task_name: str, default_save=None, reset_templates: bool=None, align_connectors: bool=None,
        ...
        return cls.from_uri(task_name=task_name, uri_pm_path=pm_uri, pm_file_type=pm_file_type, pm_module=pm_module,
