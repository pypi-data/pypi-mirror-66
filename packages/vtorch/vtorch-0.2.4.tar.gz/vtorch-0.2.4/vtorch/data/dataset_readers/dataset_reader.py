...
DATASET_READER_TYPE_FIELD = "type"
...
class DatasetReader:
    ...
    def __init__(
        ...
        self._init_parameters = {
            DATASET_READER_TYPE_FIELD: self._DATASET_READER_NAME,
    ...
    @classmethod
    def load_parameters(cls, path: str) -> Tuple[Dict[str, Any], Optional[str]]:
        ...
        dataset_reader_type = dataset_reader_parameters.pop(DATASET_READER_TYPE_FIELD, None)
        return dataset_reader_parameters, dataset_reader_type
