...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-sam", "1.33.1", __name__, "aws-sam@1.33.1.jsii.tgz")
...
class CfnFunction(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-sam.CfnFunction"):
    ...
    class CloudWatchLogsEventProperty():
        def __init__(self, *, filter_pattern: str, log_group_name: str):
            """
