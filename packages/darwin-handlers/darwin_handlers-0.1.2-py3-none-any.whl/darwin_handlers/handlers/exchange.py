...
from darwin_handlers.handlers.allocation import AllocationHandler
from darwin_handlers.utils.slippage import RandomUniformSlippageModel
from darwin_handlers.utils.trades.trade import DynamicTrade, Trade, TradeType
# 
...
class PortfolioHandler(DBHandler):
    ...
    def is_user_asset(self, asset: dict):
        """ Determines if the given asset is indeed the user's"""
