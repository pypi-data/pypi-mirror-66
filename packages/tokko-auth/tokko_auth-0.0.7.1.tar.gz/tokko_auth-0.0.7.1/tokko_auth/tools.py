...
from tokko_auth.settings import AUTH_STRATEGY
...
class PassportChecker:
    ...
    def approve_or_deny(self, token=None, strategy=JWT_ISSUER):
        ...
        return _strategy_callable(token, **self.strategy_kwargs)
