...
def get_version():
    ...
    :return: str
    """
    txt = (WORK_DIR / 'umr_discord_driver' / '__init__.py').read_text('utf-8')
    try:
...
setup(
    name='umr_discord_driver',
    packages=find_packages(include=['umr_discord_driver', 'umr_discord_driver.*']),
    version=get_version(),
    description='UMR Discord Driver',
