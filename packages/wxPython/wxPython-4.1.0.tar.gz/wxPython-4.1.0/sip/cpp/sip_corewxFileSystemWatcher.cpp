...
bool sipwxFileSystemWatcher::RemoveTree(const  ::wxFileName& path)
{
    ...
    extern bool sipVH__core_235(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&);

    return sipVH__core_235(sipGILState, 0, sipPySelf, sipMeth, path);
}
...
bool sipwxFileSystemWatcher::AddTree(const  ::wxFileName& path,int events,const  ::wxString& filter)
{
    ...
    extern bool sipVH__core_234(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int,const  ::wxString&);

    return sipVH__core_234(sipGILState, 0, sipPySelf, sipMeth, path, events, filter);
}
...
bool sipwxFileSystemWatcher::Add(const  ::wxFileName& path,int events)
{
    ...
    extern bool sipVH__core_233(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int);

    return sipVH__core_233(sipGILState, 0, sipPySelf, sipMeth, path, events);
}
