 ...
 ::wxAuiTabArt* sipwxAuiSimpleTabArt::Clone()
{
    ...
    extern  ::wxAuiTabArt* sipVH__aui_59(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__aui_59(sipGILState, 0, sipPySelf, sipMeth);
}
...
void sipwxAuiSimpleTabArt::DrawBackground( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& rect)
{
    ...
    extern void sipVH__aui_43(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&);

    sipVH__aui_43(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, rect);
}
...
void sipwxAuiSimpleTabArt::DrawButton( ::wxDC& dc, ::wxWindow*wnd,const  ::wxRect& in_rect,int bitmap_id,int button_state,int orientation, ::wxRect*out_rect)
{
    ...
    extern void sipVH__aui_60(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxRect&,int,int,int, ::wxRect*);

    sipVH__aui_60(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, in_rect, bitmap_id, button_state, orientation, out_rect);
}
...
void sipwxAuiSimpleTabArt::DrawTab( ::wxDC& dc, ::wxWindow*wnd,const  ::wxAuiNotebookPage& page,const  ::wxRect& rect,int close_button_state, ::wxRect*out_tab_rect, ::wxRect*out_button_rect,int*x_extent)
{
    ...
    extern void sipVH__aui_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxAuiNotebookPage&,const  ::wxRect&,int, ::wxRect*, ::wxRect*,int*);

    sipVH__aui_61(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, page, rect, close_button_state, out_tab_rect, out_button_rect, x_extent);
}
...
int sipwxAuiSimpleTabArt::GetBestTabCtrlSize( ::wxWindow*a0,const  ::wxAuiNotebookPageArray& a1,const  ::wxSize& a2)
{
    ...
    extern int sipVH__aui_62(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,const  ::wxAuiNotebookPageArray&,const  ::wxSize&);

    return sipVH__aui_62(sipGILState, 0, sipPySelf, sipMeth, a0, a1, a2);
}
 ...
 ::wxSize sipwxAuiSimpleTabArt::GetTabSize( ::wxDC& dc, ::wxWindow*wnd,const  ::wxString& caption,const  ::wxBitmap& bitmap,bool active,int close_button_state,int*x_extent)
{
    ...
    extern  ::wxSize sipVH__aui_63(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDC&, ::wxWindow*,const  ::wxString&,const  ::wxBitmap&,bool,int,int*);

    return sipVH__aui_63(sipGILState, 0, sipPySelf, sipMeth, dc, wnd, caption, bitmap, active, close_button_state, x_extent);
}
...
void sipwxAuiSimpleTabArt::SetFlags(uint flags)
{
    ...
    extern void sipVH__aui_37(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__aui_37(sipGILState, 0, sipPySelf, sipMeth, flags);
}
...
void sipwxAuiSimpleTabArt::SetMeasuringFont(const  ::wxFont& font)
{
    ...
    extern void sipVH__aui_39(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFont&);

    sipVH__aui_39(sipGILState, 0, sipPySelf, sipMeth, font);
}
...
void sipwxAuiSimpleTabArt::SetColour(const  ::wxColour& colour)
{
    ...
    extern void sipVH__aui_64(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxColour&);

    sipVH__aui_64(sipGILState, 0, sipPySelf, sipMeth, colour);
}
...
void sipwxAuiSimpleTabArt::SetSizingInfo(const  ::wxSize& tab_ctrl_size,size_t tab_count)
{
    ...
    extern void sipVH__aui_65(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&,size_t);

    sipVH__aui_65(sipGILState, 0, sipPySelf, sipMeth, tab_ctrl_size, tab_count);
}
