 ...
 ::wxString sipwxDataViewIndexListModel::GetColumnType(uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,sipName_DataViewIndexListModel,sipName_GetColumnType);
...
uint sipwxDataViewIndexListModel::GetColumnCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,sipName_DataViewIndexListModel,sipName_GetColumnCount);
...
void sipwxDataViewIndexListModel::GetValueByRow( ::wxVariant& variant,uint row,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[18]),sipPySelf,sipName_DataViewIndexListModel,sipName_GetValueByRow);
...
bool sipwxDataViewIndexListModel::SetValueByRow(const  ::wxDVCVariant& variant,uint row,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[19],sipPySelf,sipName_DataViewIndexListModel,sipName_SetValueByRow);
