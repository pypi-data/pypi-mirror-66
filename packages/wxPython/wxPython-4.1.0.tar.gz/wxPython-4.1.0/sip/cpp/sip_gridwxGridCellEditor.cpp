...
void sipwxGridCellEditor::Reset()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,sipName_GridCellEditor,sipName_Reset);
...
void sipwxGridCellEditor::ApplyEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,sipName_GridCellEditor,sipName_ApplyEdit);
...
bool sipwxGridCellEditor::EndEdit(int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,sipName_GridCellEditor,sipName_EndEdit);
...
void sipwxGridCellEditor::Create( ::wxWindow*parent, ::wxWindowID id, ::wxEvtHandler*evtHandler)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,sipName_GridCellEditor,sipName_Create);
 ...
 ::wxGridCellEditor* sipwxGridCellEditor::Clone() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[13]),sipPySelf,sipName_GridCellEditor,sipName_Clone);
...
void sipwxGridCellEditor::BeginEdit(int row,int col, ::wxGrid*grid)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[14],sipPySelf,sipName_GridCellEditor,sipName_BeginEdit);
...
static sipEncodedTypeDef supers_wxGridCellEditor[] = {{3, 0, 0}, {21, 0, 1}};
...
sipVariableDef variables_wxGridCellEditor[] = {
    {PropertyVariable, sipName_Window, &methods_wxGridCellEditor[8], &methods_wxGridCellEditor[16], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Value, &methods_wxGridCellEditor[7], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Control, &methods_wxGridCellEditor[6], &methods_wxGridCellEditor[14], SIP_NULLPTR, SIP_NULLPTR},
};
