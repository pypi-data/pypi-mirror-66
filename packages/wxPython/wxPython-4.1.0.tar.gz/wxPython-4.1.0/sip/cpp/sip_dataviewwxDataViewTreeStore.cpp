...
bool sipwxDataViewTreeStore::IsContainer(const  ::wxDataViewItem& item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[10]),sipPySelf,sipName_DataViewTreeStore,sipName_IsContainer);
...
void sipwxDataViewTreeStore::Resort()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[11],sipPySelf,SIP_NULLPTR,sipName_Resort);
...
bool sipwxDataViewTreeStore::SetValue(const  ::wxDVCVariant& variant,const  ::wxDataViewItem& item,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[12],sipPySelf,sipName_DataViewTreeStore,sipName_SetValue);
...
bool sipwxDataViewTreeStore::IsListModel() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[13]),sipPySelf,SIP_NULLPTR,sipName_IsListModel);
...
bool sipwxDataViewTreeStore::IsVirtualListModel() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[14]),sipPySelf,SIP_NULLPTR,sipName_IsVirtualListModel);
