 ...
 ::wxItemAttr* sipwxListView::OnGetItemAttr(long item) const
{
    ...
    extern  ::wxItemAttr* sipVH__core_167(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_167(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
int sipwxListView::OnGetItemColumnImage(long item,long column) const
{
    ...
    extern int sipVH__core_168(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long,long);

    return sipVH__core_168(sipGILState, 0, sipPySelf, sipMeth, item, column);
}
...
int sipwxListView::OnGetItemImage(long item) const
{
    ...
    extern int sipVH__core_169(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_169(sipGILState, 0, sipPySelf, sipMeth, item);
}
 ...
 ::wxString sipwxListView::OnGetItemText(long item,long column) const
{
    ...
    extern  ::wxString sipVH__core_170(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long,long);

    return sipVH__core_170(sipGILState, 0, sipPySelf, sipMeth, item, column);
}
...
bool sipwxListView::OnGetItemIsChecked(long item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[43]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemIsChecked);

    if (!sipMeth)
        return  ::wxListView::OnGetItemIsChecked(item);

    extern bool sipVH__core_110(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_110(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
static sipEncodedTypeDef supers_wxListView[] = {{299, 255, 1}};
