...
sipVariableDef variables_wxUpdateUIEvent[] = {
    {PropertyVariable, sipName_Text, &methods_wxUpdateUIEvent[12], &methods_wxUpdateUIEvent[16], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Shown, &methods_wxUpdateUIEvent[11], &methods_wxUpdateUIEvent[18], SIP_NULLPTR, SIP_NULLPTR},
