...
void sipwxValidator::SetWindow( ::wxWindow*window)
{
    ...
    sipVH__core_133(sipGILState, 0, sipPySelf, sipMeth, window);
}
 ...
 ::wxObject* sipwxValidator::Clone() const
{
    ...
    extern  ::wxObject* sipVH__core_132(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
