 ...
 ::wxEventCategory sipwxPropertyGridEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__propgrid_62(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_62(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxEvent* sipwxPropertyGridEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__propgrid_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_61(sipGILState, 0, sipPySelf, sipMeth);
}
