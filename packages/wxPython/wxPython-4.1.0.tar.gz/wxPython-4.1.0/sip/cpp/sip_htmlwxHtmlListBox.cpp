...
void sipwxHtmlListBox::OnDrawItem( ::wxDC& dc,const  ::wxRect& rect,size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[57]),sipPySelf,SIP_NULLPTR,sipName_OnDrawItem);
...
void sipwxHtmlListBox::OnDrawBackground( ::wxDC& dc,const  ::wxRect& rect,size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[58]),sipPySelf,SIP_NULLPTR,sipName_OnDrawBackground);
...
void sipwxHtmlListBox::OnDrawSeparator( ::wxDC& dc, ::wxRect& rect,size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[59]),sipPySelf,SIP_NULLPTR,sipName_OnDrawSeparator);
 ...
 ::wxCoord sipwxHtmlListBox::OnMeasureItem(size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[60]),sipPySelf,SIP_NULLPTR,sipName_OnMeasureItem);
