...
void sipwxAuiNotebook::SetImageList( ::wxImageList*imageList)
{
    ...
    extern void sipVH__aui_58(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxImageList*);

    sipVH__aui_58(sipGILState, 0, sipPySelf, sipMeth, imageList);
}
...
int sipwxAuiNotebook::GetPageImage(size_t nPage) const
{
    ...
    extern int sipVH__aui_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);

    return sipVH__aui_54(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxAuiNotebook::SetPageImage(size_t n,int imageId)
{
    ...
    extern bool sipVH__aui_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t,int);

    return sipVH__aui_57(sipGILState, 0, sipPySelf, sipMeth, n, imageId);
}
 ...
 ::wxString sipwxAuiNotebook::GetPageText(size_t page) const
{
    ...
    extern  ::wxString sipVH__aui_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);
...
bool sipwxAuiNotebook::SetPageText(size_t page,const  ::wxString& text)
{
    ...
    extern bool sipVH__aui_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t,const  ::wxString&);

    return sipVH__aui_55(sipGILState, 0, sipPySelf, sipMeth, page, text);
}
...
int sipwxAuiNotebook::GetSelection() const
{
    ...
    extern int sipVH__aui_42(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
int sipwxAuiNotebook::SetSelection(size_t new_page)
{
    ...
    return sipVH__aui_54(sipGILState, 0, sipPySelf, sipMeth, new_page);
}
...
int sipwxAuiNotebook::ChangeSelection(size_t n)
{
    ...
    return sipVH__aui_54(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
bool sipwxAuiNotebook::AddPage( ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__aui_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__aui_53(sipGILState, 0, sipPySelf, sipMeth, page, text, select, imageId);
}
...
bool sipwxAuiNotebook::DeletePage(size_t page)
{
    ...
    extern bool sipVH__aui_51(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);
...
bool sipwxAuiNotebook::InsertPage(size_t index, ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__aui_52(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t, ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__aui_52(sipGILState, 0, sipPySelf, sipMeth, index, page, text, select, imageId);
}
...
size_t sipwxAuiNotebook::GetPageCount() const
{
    ...
    extern size_t sipVH__aui_50(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__aui_50(sipGILState, 0, sipPySelf, sipMeth);
}
...
void sipwxAuiNotebook::SetPageSize(const  ::wxSize& size)
{
    ...
    extern void sipVH__aui_49(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&);

    sipVH__aui_49(sipGILState, 0, sipPySelf, sipMeth, size);
}
...
int sipwxAuiNotebook::HitTest(const  ::wxPoint& pt,long*flags) const
{
    ...
    extern int sipVH__aui_48(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&,long*);

    return sipVH__aui_48(sipGILState, 0, sipPySelf, sipMeth, pt, flags);
}
