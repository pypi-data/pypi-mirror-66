...
void sipwxDelegateRendererNative::DrawCheckBox( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int flags)
{
    ...
    extern void sipVH__core_26(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxRect&,int);

    sipVH__core_26(sipGILState, 0, sipPySelf, sipMeth, win, dc, rect, flags);
}
...
void sipwxDelegateRendererNative::DrawGauge( ::wxWindow*win, ::wxDC& dc,const  ::wxRect& rect,int value,int max,int flags)
{
    ...
    extern void sipVH__core_27(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxRect&,int,int,int);

    sipVH__core_27(sipGILState, 0, sipPySelf, sipMeth, win, dc, rect, value, max, flags);
}
...
void sipwxDelegateRendererNative::DrawItemText( ::wxWindow*win, ::wxDC& dc,const  ::wxString& text,const  ::wxRect& rect,int align,int flags, ::wxEllipsizeMode ellipsizeMode)
{
    ...
    extern void sipVH__core_29(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxString&,const  ::wxRect&,int,int, ::wxEllipsizeMode);

    sipVH__core_29(sipGILState, 0, sipPySelf, sipMeth, win, dc, text, rect, align, flags, ellipsizeMode);
}
 ...
 ::wxSize sipwxDelegateRendererNative::GetCollapseButtonSize( ::wxWindow*win, ::wxDC& dc)
{
    ...
    extern  ::wxSize sipVH__core_30(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&);

    return sipVH__core_30(sipGILState, 0, sipPySelf, sipMeth, win, dc);
}
...
void sipwxDelegateRendererNative::DrawSplitterSash( ::wxWindow*win, ::wxDC& dc,const  ::wxSize& size, ::wxCoord position, ::wxOrientation orient,int flags)
{
    ...
    extern void sipVH__core_31(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxDC&,const  ::wxSize&, ::wxCoord, ::wxOrientation,int);

    sipVH__core_31(sipGILState, 0, sipPySelf, sipMeth, win, dc, size, position, orient, flags);
}
 ...
 ::wxSize sipwxDelegateRendererNative::GetCheckBoxSize( ::wxWindow*win,int flags)
{
    ...
    extern  ::wxSize sipVH__core_33(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,int);

    return sipVH__core_33(sipGILState, 0, sipPySelf, sipMeth, win, flags);
}
 ...
 ::wxSize sipwxDelegateRendererNative::GetCheckMarkSize( ::wxWindow*win)
{
    ...
    extern  ::wxSize sipVH__core_34(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_34(sipGILState, 0, sipPySelf, sipMeth, win);
}
...
int sipwxDelegateRendererNative::GetHeaderButtonHeight( ::wxWindow*win)
{
    ...
    extern int sipVH__core_35(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_35(sipGILState, 0, sipPySelf, sipMeth, win);
}
 ...
 ::wxSplitterRenderParams sipwxDelegateRendererNative::GetSplitterParams(const  ::wxWindow*win)
{
    ...
    extern  ::wxSplitterRenderParams sipVH__core_36(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxWindow*);
 ...
 ::wxRendererVersion sipwxDelegateRendererNative::GetVersion() const
{
    ...
    extern  ::wxRendererVersion sipVH__core_37(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_37(sipGILState, 0, sipPySelf, sipMeth);
}
...
static sipEncodedTypeDef supers_wxDelegateRendererNative[] = {{458, 255, 1}};
