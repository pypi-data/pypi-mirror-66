...
static sipEncodedTypeDef supers_wxFontData[] = {{370, 255, 1}};
...
sipVariableDef variables_wxFontData[] = {
    {PropertyVariable, sipName_ShowHelp, &methods_wxFontData[6], &methods_wxFontData[12], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_InitialFont, &methods_wxFontData[5], &methods_wxFontData[10], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Colour, &methods_wxFontData[3], &methods_wxFontData[9], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ChosenFont, &methods_wxFontData[2], &methods_wxFontData[8], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AllowSymbols, &methods_wxFontData[1], &methods_wxFontData[7], SIP_NULLPTR, SIP_NULLPTR},
};
