...
bool sipwxPrintout::OnBeginDocument(int startPage,int endPage)
{
    ...
    return sipVH__core_84(sipGILState, 0, sipPySelf, sipMeth, startPage, endPage);
}
...
void sipwxPrintout::GetPageInfo(int*minPage,int*maxPage,int*pageFrom,int*pageTo)
{
    ...
    extern void sipVH__core_218(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int*,int*,int*,int*);

    sipVH__core_218(sipGILState, 0, sipPySelf, sipMeth, minPage, maxPage, pageFrom, pageTo);
}
...
static sipEncodedTypeDef supers_wxPrintout[] = {{370, 255, 1}};
