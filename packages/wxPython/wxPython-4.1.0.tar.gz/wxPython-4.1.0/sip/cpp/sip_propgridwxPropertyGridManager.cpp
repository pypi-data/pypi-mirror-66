 ...
 ::wxPropertyGrid* sipwxPropertyGridManager::CreatePropertyGrid() const
{
    ...
    extern  ::wxPropertyGrid* sipVH__propgrid_86(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_86(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxPropertyGridManager::RemovePage(int page)
{
    ...
    extern bool sipVH__propgrid_85(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__propgrid_85(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
bool sipwxPropertyGridManager::IsPropertySelected(const  ::wxPGPropArgCls& id) const
{
    ...
    extern bool sipVH__propgrid_84(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPGPropArgCls&);

    return sipVH__propgrid_84(sipGILState, 0, sipPySelf, sipMeth, id);
}
 ...
 ::wxPropertyGridPage* sipwxPropertyGridManager::InsertPage(int index,const  ::wxString& label,const  ::wxBitmap& bmp, ::wxPropertyGridPage*pageObj)
{
    ...
    extern  ::wxPropertyGridPage* sipVH__propgrid_83(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxString&,const  ::wxBitmap&, ::wxPropertyGridPage*);

    return sipVH__propgrid_83(sipGILState, 0, sipPySelf, sipMeth, index, label, bmp, pageObj);
}
