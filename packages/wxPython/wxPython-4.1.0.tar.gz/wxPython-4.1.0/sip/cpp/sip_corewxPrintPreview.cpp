...
void sipwxPrintPreview::SetPrintout( ::wxPrintout*printout)
{
    ...
    extern void sipVH__core_212(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPrintout*);

    sipVH__core_212(sipGILState, 0, sipPySelf, sipMeth, printout);
}
...
void sipwxPrintPreview::SetFrame( ::wxFrame*frame)
{
    ...
    extern void sipVH__core_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxFrame*);

    sipVH__core_56(sipGILState, 0, sipPySelf, sipMeth, frame);
}
...
bool sipwxPrintPreview::SetCurrentPage(int pageNum)
{
    ...
    return sipVH__core_142(sipGILState, 0, sipPySelf, sipMeth, pageNum);
}
...
void sipwxPrintPreview::SetCanvas( ::wxPreviewCanvas*window)
{
    ...
    extern void sipVH__core_211(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPreviewCanvas*);

    sipVH__core_211(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
bool sipwxPrintPreview::Print(bool prompt)
{
    ...
    extern bool sipVH__core_94(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, bool);

    return sipVH__core_94(sipGILState, 0, sipPySelf, sipMeth, prompt);
}
...
bool sipwxPrintPreview::PaintPage( ::wxPreviewCanvas*canvas, ::wxDC& dc)
{
    ...
    extern bool sipVH__core_210(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPreviewCanvas*, ::wxDC&);

    return sipVH__core_210(sipGILState, 0, sipPySelf, sipMeth, canvas, dc);
}
 ...
 ::wxPrintout* sipwxPrintPreview::GetPrintoutForPrinting() const
{
    ...
    extern  ::wxPrintout* sipVH__core_209(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxFrame* sipwxPrintPreview::GetFrame() const
{
    ...
    extern  ::wxFrame* sipVH__core_208(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxPreviewCanvas* sipwxPrintPreview::GetCanvas() const
{
    ...
    extern  ::wxPreviewCanvas* sipVH__core_207(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_207(sipGILState, 0, sipPySelf, sipMeth);
}
...
static sipEncodedTypeDef supers_wxPrintPreview[] = {{370, 255, 1}};
