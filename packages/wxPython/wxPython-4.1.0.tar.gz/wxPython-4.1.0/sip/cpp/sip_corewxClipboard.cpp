...
void sipwxClipboard::UsePrimarySelection(bool primary)
{
    ...
    sipVH__core_90(sipGILState, 0, sipPySelf, sipMeth, primary);
}
...
bool sipwxClipboard::SetData( ::wxDataObject*data)
{
    ...
    extern bool sipVH__core_87(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject*);

    return sipVH__core_87(sipGILState, 0, sipPySelf, sipMeth, data);
}
...
bool sipwxClipboard::IsSupported(const  ::wxDataFormat& format)
{
    ...
    extern bool sipVH__core_89(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&);

    return sipVH__core_89(sipGILState, 0, sipPySelf, sipMeth, format);
}
...
static sipEncodedTypeDef supers_wxClipboard[] = {{370, 255, 1}};
