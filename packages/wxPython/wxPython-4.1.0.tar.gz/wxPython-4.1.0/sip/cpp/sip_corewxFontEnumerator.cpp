...
bool sipwxFontEnumerator::EnumerateFacenames( ::wxFontEncoding encoding,bool fixedWidthOnly)
{
    ...
    extern bool sipVH__core_222(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxFontEncoding,bool);

    return sipVH__core_222(sipGILState, 0, sipPySelf, sipMeth, encoding, fixedWidthOnly);
}
