 ...
 ::wxSize sipwxGridCellRenderer::GetBestSize( ::wxGrid& grid, ::wxGridCellAttr& attr, ::wxDC& dc,int row,int col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,sipName_GridCellRenderer,sipName_GetBestSize);
...
void sipwxGridCellRenderer::Draw( ::wxGrid& grid, ::wxGridCellAttr& attr, ::wxDC& dc,const  ::wxRect& rect,int row,int col,bool isSelected)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,sipName_GridCellRenderer,sipName_Draw);
 ...
 ::wxGridCellRenderer* sipwxGridCellRenderer::Clone() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[4]),sipPySelf,sipName_GridCellRenderer,sipName_Clone);
...
static sipEncodedTypeDef supers_wxGridCellRenderer[] = {{3, 0, 0}, {21, 0, 1}};
