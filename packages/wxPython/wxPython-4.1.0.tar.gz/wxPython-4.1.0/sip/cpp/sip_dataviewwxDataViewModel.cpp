...
void sipwxDataViewModel::GetValue( ::wxVariant& variant,const  ::wxDataViewItem& item,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[7]),sipPySelf,sipName_DataViewModel,sipName_GetValue);
 ...
 ::wxDataViewItem sipwxDataViewModel::GetParent(const  ::wxDataViewItem& item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,sipName_DataViewModel,sipName_GetParent);
 ...
 ::wxString sipwxDataViewModel::GetColumnType(uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,sipName_DataViewModel,sipName_GetColumnType);
...
uint sipwxDataViewModel::GetColumnCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[10]),sipPySelf,sipName_DataViewModel,sipName_GetColumnCount);
...
uint sipwxDataViewModel::GetChildren(const  ::wxDataViewItem& item, ::wxDataViewItemArray& children) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,sipName_DataViewModel,sipName_GetChildren);
