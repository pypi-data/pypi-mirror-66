 ...
 ::wxObject* sipwxNumericPropertyValidator::Clone() const
{
    ...
    extern  ::wxObject* sipVH__propgrid_66(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
...
void sipwxNumericPropertyValidator::SetWindow( ::wxWindow*window)
{
    ...
    extern void sipVH__propgrid_65(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    sipVH__propgrid_65(sipGILState, 0, sipPySelf, sipMeth, window);
}
...
bool sipwxNumericPropertyValidator::Validate( ::wxWindow*parent)
{
    ...
    extern bool sipVH__propgrid_59(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__propgrid_59(sipGILState, 0, sipPySelf, sipMeth, parent);
}
