...
void sipwxPyApp::MacOpenURL(const  ::wxString& url)
{
    ...
    sipVH__core_54(sipGILState, 0, sipPySelf, sipMeth, url);
}
...
void sipwxPyApp::MacOpenFiles(const  ::wxArrayString& fileNames)
{
    ...
    extern void sipVH__core_117(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayString&);

    sipVH__core_117(sipGILState, 0, sipPySelf, sipMeth, fileNames);
}
...
int sipwxPyApp::FilterEvent( ::wxEvent& event)
{
    ...
    extern int sipVH__core_105(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEvent&);

    return sipVH__core_105(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
void sipwxPyApp::OnEventLoopEnter( ::wxEventLoopBase*loop)
{
    ...
    extern void sipVH__core_116(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEventLoopBase*);

    sipVH__core_116(sipGILState, 0, sipPySelf, sipMeth, loop);
}
