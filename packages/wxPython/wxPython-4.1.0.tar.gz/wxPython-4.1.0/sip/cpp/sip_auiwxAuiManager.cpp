...
sipVariableDef variables_wxAuiManager[] = {
    {PropertyVariable, sipName_ManagedWindow, &methods_wxAuiManager[11], &methods_wxAuiManager[27], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Flags, &methods_wxAuiManager[10], &methods_wxAuiManager[26], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ArtProvider, &methods_wxAuiManager[8], &methods_wxAuiManager[24], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AllPanes, &methods_wxAuiManager[7], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
