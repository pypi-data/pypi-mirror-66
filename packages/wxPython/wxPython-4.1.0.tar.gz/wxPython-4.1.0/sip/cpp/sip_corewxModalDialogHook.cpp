...
void sipwxModalDialogHook::Exit( ::wxDialog*dialog)
{
    ...
    extern void sipVH__core_238(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    sipVH__core_238(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
...
int sipwxModalDialogHook::Enter( ::wxDialog*dialog)
{
    ...
    extern int sipVH__core_237(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDialog*);

    return sipVH__core_237(sipGILState, 0, sipPySelf, sipMeth, dialog);
}
