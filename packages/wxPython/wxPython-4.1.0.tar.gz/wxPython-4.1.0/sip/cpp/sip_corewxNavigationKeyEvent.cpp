...
static sipEnumMemberDef enummembers_wxNavigationKeyEvent[] = {
    {sipName_FromTab, static_cast<int>( ::wxNavigationKeyEvent::FromTab), 365},
    {sipName_IsBackward, static_cast<int>( ::wxNavigationKeyEvent::IsBackward), 365},
    {sipName_IsForward, static_cast<int>( ::wxNavigationKeyEvent::IsForward), 365},
    {sipName_WinChange, static_cast<int>( ::wxNavigationKeyEvent::WinChange), 365},
};
