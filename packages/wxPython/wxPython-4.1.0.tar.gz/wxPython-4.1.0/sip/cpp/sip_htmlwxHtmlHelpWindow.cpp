...
sipwxHtmlHelpWindow::sipwxHtmlHelpWindow( ::wxWindow*parent,int wxWindowID,const  ::wxPoint& pos,const  ::wxSize& size,int style,int helpStyle, ::wxHtmlHelpData*data):  ::wxHtmlHelpWindow(parent,wxWindowID,pos,size,style,helpStyle,data), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
