 ...
 ::wxBitmap sipwxWizardPageSimple::GetBitmap() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[39]),sipPySelf,SIP_NULLPTR,sipName_GetBitmap);
 ...
 ::wxWizardPage* sipwxWizardPageSimple::GetNext() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,SIP_NULLPTR,sipName_GetNext);
 ...
 ::wxWizardPage* sipwxWizardPageSimple::GetPrev() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[41]),sipPySelf,SIP_NULLPTR,sipName_GetPrev);
