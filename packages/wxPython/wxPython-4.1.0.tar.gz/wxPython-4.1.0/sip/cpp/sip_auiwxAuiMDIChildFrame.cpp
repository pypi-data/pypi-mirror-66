...
bool sipwxAuiMDIChildFrame::Show(bool show)
{
    ...
    extern bool sipVH__aui_66(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, bool);

    return sipVH__aui_66(sipGILState, 0, sipPySelf, sipMeth, show);
}
