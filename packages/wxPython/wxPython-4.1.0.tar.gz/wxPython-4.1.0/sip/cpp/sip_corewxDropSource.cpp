...
bool sipwxDropSource::GiveFeedback( ::wxDragResult effect)
{
    ...
    extern bool sipVH__core_82(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDragResult);

    return sipVH__core_82(sipGILState, 0, sipPySelf, sipMeth, effect);
}
 ...
 ::wxDragResult sipwxDropSource::DoDragDrop(int flags)
{
    ...
    extern  ::wxDragResult sipVH__core_81(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);

    return sipVH__core_81(sipGILState, 0, sipPySelf, sipMeth, flags);
}
