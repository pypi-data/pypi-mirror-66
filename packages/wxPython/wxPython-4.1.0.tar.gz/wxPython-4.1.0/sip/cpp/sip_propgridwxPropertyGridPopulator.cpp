...
void sipwxPropertyGridPopulator::ProcessError(const  ::wxString& msg)
{
    ...
    extern void sipVH__propgrid_63(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&);

    sipVH__propgrid_63(sipGILState, 0, sipPySelf, sipMeth, msg);
}
