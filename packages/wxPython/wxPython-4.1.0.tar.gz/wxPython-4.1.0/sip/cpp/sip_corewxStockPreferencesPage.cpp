 ...
 ::wxWindow* sipwxStockPreferencesPage::CreateWindow( ::wxWindow*parent)
{
    ...
    extern  ::wxWindow* sipVH__core_236(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_236(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
static sipEncodedTypeDef supers_wxStockPreferencesPage[] = {{414, 255, 1}};
...
static sipEnumMemberDef enummembers_wxStockPreferencesPage[] = {
    {sipName_Kind_Advanced, static_cast<int>( ::wxStockPreferencesPage::Kind_Advanced), 523},
    {sipName_Kind_General, static_cast<int>( ::wxStockPreferencesPage::Kind_General), 523},
};
