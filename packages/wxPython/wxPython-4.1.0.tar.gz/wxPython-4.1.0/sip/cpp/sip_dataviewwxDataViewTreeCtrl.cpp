...
sipVariableDef variables_wxDataViewTreeCtrl[] = {
    {PropertyVariable, sipName_Store, &methods_wxDataViewTreeCtrl[37], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ImageList, &methods_wxDataViewTreeCtrl[30], &methods_wxDataViewTreeCtrl[53], SIP_NULLPTR, SIP_NULLPTR},
};
