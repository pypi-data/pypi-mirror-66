...
static sipEncodedTypeDef supers_wxSpinEvent[] = {{368, 255, 1}};
...
static PyMethodDef methods_wxSpinEvent[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetPosition), SIP_MLMETH_CAST(meth_wxSpinEvent_SetPosition), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSpinEvent_SetPosition)}
};
