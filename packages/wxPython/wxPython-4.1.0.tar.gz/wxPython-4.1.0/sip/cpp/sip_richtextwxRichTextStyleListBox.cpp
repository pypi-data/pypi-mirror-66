 ...
 ::wxColour sipwxRichTextStyleListBox::GetSelectedTextBgColour(const  ::wxColour& colBg) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[57]),sipPySelf,SIP_NULLPTR,sipName_GetSelectedTextBgColour);
 ...
 ::wxColour sipwxRichTextStyleListBox::GetSelectedTextColour(const  ::wxColour& colFg) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[58]),sipPySelf,SIP_NULLPTR,sipName_GetSelectedTextColour);
 ...
 ::wxString sipwxRichTextStyleListBox::OnGetItemMarkup(size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[59]),sipPySelf,SIP_NULLPTR,sipName_OnGetItemMarkup);
 ...
 ::wxString sipwxRichTextStyleListBox::OnGetItem(size_t n) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[60]),sipPySelf,SIP_NULLPTR,sipName_OnGetItem);
