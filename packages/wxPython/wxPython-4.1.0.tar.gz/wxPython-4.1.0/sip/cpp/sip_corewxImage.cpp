...
static PyObject *meth_wxImage_Paste(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ9ii", &sipSelf, sipType_wxImage, &sipCpp, sipType_wxImage, &image, &x, &y))
        {
            PyErr_Clear();
...
static sipEncodedTypeDef supers_wxImage[] = {{370, 255, 1}};
...
sipVariableDef variables_wxImage[] = {
    {PropertyVariable, sipName_Type, &methods_wxImage[41], &methods_wxImage[78], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskRed, &methods_wxImage[33], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskGreen, &methods_wxImage[32], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskBlue, &methods_wxImage[31], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Height, &methods_wxImage[27], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Width, &methods_wxImage[42], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
