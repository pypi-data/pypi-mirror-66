...
void sipwxComboCtrl::DoShowPopup(const  ::wxRect& rect,int flags)
{
    ...
    extern void sipVH__core_180(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxRect&,int);

    sipVH__core_180(sipGILState, 0, sipPySelf, sipMeth, rect, flags);
}
...
void sipwxComboCtrl::DoSetPopupControl( ::wxComboPopup*popup)
{
    ...
    extern void sipVH__core_179(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxComboPopup*);

    sipVH__core_179(sipGILState, 0, sipPySelf, sipMeth, popup);
}
...
bool sipwxComboCtrl::AnimateShow(const  ::wxRect& rect,int flags)
{
    ...
    extern bool sipVH__core_178(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxRect&,int);

    return sipVH__core_178(sipGILState, 0, sipPySelf, sipMeth, rect, flags);
}
...
void sipwxComboCtrl::HidePopup(bool generateEvent)
{
    ...
    sipVH__core_90(sipGILState, 0, sipPySelf, sipMeth, generateEvent);
}
...
bool sipwxComboCtrl::IsKeyPopupToggle(const  ::wxKeyEvent& event) const
{
    ...
    extern bool sipVH__core_177(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxKeyEvent&);

    return sipVH__core_177(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
static sipEncodedTypeDef supers_wxComboCtrl[] = {{93, 255, 0}, {555, 255, 1}};
...
sipVariableDef variables_wxComboCtrl[] = {
    {PropertyVariable, sipName_Value, &methods_wxComboCtrl[48], &methods_wxComboCtrl[84], SIP_NULLPTR, SIP_NULLPTR},
    ...
    {PropertyVariable, sipName_PopupControl, &methods_wxComboCtrl[43], &methods_wxComboCtrl[76], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Margins, &methods_wxComboCtrl[42], &methods_wxComboCtrl[74], SIP_NULLPTR, SIP_NULLPTR},
