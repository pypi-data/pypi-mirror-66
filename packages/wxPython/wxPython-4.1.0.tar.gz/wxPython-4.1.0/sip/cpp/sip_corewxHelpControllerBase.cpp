...
void sipwxHelpControllerBase::SetViewer(const  ::wxString& viewer,long flags)
{
    ...
    extern void sipVH__core_195(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,long);

    sipVH__core_195(sipGILState, 0, sipPySelf, sipMeth, viewer, flags);
}
...
void sipwxHelpControllerBase::SetParentWindow( ::wxWindow*parentWindow)
{
    ...
    sipVH__core_133(sipGILState, 0, sipPySelf, sipMeth, parentWindow);
}
...
void sipwxHelpControllerBase::SetFrameParameters(const  ::wxString& titleFormat,const  ::wxSize& size,const  ::wxPoint& pos,bool newFrameEachTime)
{
    ...
    extern void sipVH__core_194(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,const  ::wxSize&,const  ::wxPoint&,bool);

    sipVH__core_194(sipGILState, 0, sipPySelf, sipMeth, titleFormat, size, pos, newFrameEachTime);
}
...
bool sipwxHelpControllerBase::KeywordSearch(const  ::wxString& keyWord, ::wxHelpSearchMode mode)
{
    ...
    extern bool sipVH__core_193(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxHelpSearchMode);

    return sipVH__core_193(sipGILState, 0, sipPySelf, sipMeth, keyWord, mode);
}
 ...
 ::wxFrame* sipwxHelpControllerBase::GetFrameParameters( ::wxSize*size, ::wxPoint*pos,bool*newFrameEachTime)
{
    ...
    extern  ::wxFrame* sipVH__core_192(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxSize*, ::wxPoint*,bool*);

    return sipVH__core_192(sipGILState, 0, sipPySelf, sipMeth, size, pos, newFrameEachTime);
}
...
bool sipwxHelpControllerBase::DisplayTextPopup(const  ::wxString& text,const  ::wxPoint& pos)
{
    ...
    extern bool sipVH__core_191(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,const  ::wxPoint&);

    return sipVH__core_191(sipGILState, 0, sipPySelf, sipMeth, text, pos);
}
...
bool sipwxHelpControllerBase::DisplaySection(int sectionNo)
{
    ...
    return sipVH__core_142(sipGILState, 0, sipPySelf, sipMeth, sectionNo);
}
...
bool sipwxHelpControllerBase::DisplayContextPopup(int contextId)
{
    ...
    return sipVH__core_142(sipGILState, 0, sipPySelf, sipMeth, contextId);
}
...
bool sipwxHelpControllerBase::DisplayBlock(long blockNo)
{
    ...
    return sipVH__core_110(sipGILState, 0, sipPySelf, sipMeth, blockNo);
}
...
static sipEncodedTypeDef supers_wxHelpControllerBase[] = {{370, 255, 1}};
