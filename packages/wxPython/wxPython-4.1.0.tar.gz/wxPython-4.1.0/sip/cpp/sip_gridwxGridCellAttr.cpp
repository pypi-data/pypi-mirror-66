...
static sipEncodedTypeDef supers_wxGridCellAttr[] = {{3, 0, 0}, {21, 0, 1}};
...
static sipEnumMemberDef enummembers_wxGridCellAttr[] = {
    {sipName_Any, static_cast<int>( ::wxGridCellAttr::Any), 9},
    {sipName_Cell, static_cast<int>( ::wxGridCellAttr::Cell), 9},
    {sipName_Col, static_cast<int>( ::wxGridCellAttr::Col), 9},
    {sipName_Default, static_cast<int>( ::wxGridCellAttr::Default), 9},
    {sipName_Merged, static_cast<int>( ::wxGridCellAttr::Merged), 9},
    {sipName_Row, static_cast<int>( ::wxGridCellAttr::Row), 9},
};
