...
int sipwxHeaderCtrlSimple::GetBestFittingWidth(uint idx) const
{
    ...
    extern int sipVH__core_166(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_166(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrlSimple::GetColumn(uint idx) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,SIP_NULLPTR,sipName_GetColumn);

    if (!sipMeth)
        return  ::wxHeaderCtrlSimple::GetColumn(idx);

    extern const  ::wxHeaderColumn& sipVH__core_161(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);
...
void sipwxHeaderCtrlSimple::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    extern void sipVH__core_162(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,bool);

    sipVH__core_162(sipGILState, 0, sipPySelf, sipMeth, idx, show);
}
...
void sipwxHeaderCtrlSimple::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    extern void sipVH__core_163(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayInt&);

    sipVH__core_163(sipGILState, 0, sipPySelf, sipMeth, order);
}
...
bool sipwxHeaderCtrlSimple::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    extern bool sipVH__core_164(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,int);

    return sipVH__core_164(sipGILState, 0, sipPySelf, sipMeth, idx, widthTitle);
}
...
void sipwxHeaderCtrlSimple::OnColumnCountChanging(uint count)
{
    ...
    extern void sipVH__core_165(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__core_165(sipGILState, 0, sipPySelf, sipMeth, count);
}
