...
void sipwxGridCellDateTimeRenderer::SetParameters(const  ::wxString& params)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,SIP_NULLPTR,sipName_SetParameters);
...
static PyObject *meth_wxGridCellDateTimeRenderer_SetParameters(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1", &sipSelf, sipType_wxGridCellDateTimeRenderer, &sipCpp, sipType_wxString,&params, &paramsState))
        {
            PyErr_Clear();
    ...
    sipNoMethod(sipParseErr, sipName_GridCellDateTimeRenderer, sipName_SetParameters, SIP_NULLPTR);
...
static sipEncodedTypeDef supers_wxGridCellDateTimeRenderer[] = {{20, 255, 1}};
...
static PyMethodDef methods_wxGridCellDateTimeRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetParameters), SIP_MLMETH_CAST(meth_wxGridCellDateTimeRenderer_SetParameters), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxGridCellDateTimeRenderer_SetParameters)}
};
