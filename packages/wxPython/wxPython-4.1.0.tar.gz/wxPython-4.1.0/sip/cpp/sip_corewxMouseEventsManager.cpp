...
void sipwxMouseEventsManager::MouseClickCancelled(int item)
{
    ...
    sipVH__core_107(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
void sipwxMouseEventsManager::MouseDragEnd(int item,const  ::wxPoint& pos)
{
    ...
    extern void sipVH__core_227(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    sipVH__core_227(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseDragBegin(int item,const  ::wxPoint& pos)
{
    ...
    extern bool sipVH__core_226(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    return sipVH__core_226(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseClicked(int item)
{
    ...
    return sipVH__core_142(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
int sipwxMouseEventsManager::MouseHitTest(const  ::wxPoint& pos)
{
    ...
    extern int sipVH__core_225(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&);

    return sipVH__core_225(sipGILState, 0, sipPySelf, sipMeth, pos);
}
