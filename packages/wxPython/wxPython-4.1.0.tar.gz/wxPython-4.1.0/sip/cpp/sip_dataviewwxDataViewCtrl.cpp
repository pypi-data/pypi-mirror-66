...
sipVariableDef variables_wxDataViewCtrl[] = {
    {PropertyVariable, sipName_TopItem, &methods_wxDataViewCtrl[58], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SortingColumn, &methods_wxDataViewCtrl[57], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selections, &methods_wxDataViewCtrl[56], &methods_wxDataViewCtrl[90], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxDataViewCtrl[55], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedItemsCount, &methods_wxDataViewCtrl[54], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Model, &methods_wxDataViewCtrl[53], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MainWindow, &methods_wxDataViewCtrl[51], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Indent, &methods_wxDataViewCtrl[49], &methods_wxDataViewCtrl[88], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ExpanderColumn, &methods_wxDataViewCtrl[48], &methods_wxDataViewCtrl[86], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentItem, &methods_wxDataViewCtrl[45], &methods_wxDataViewCtrl[85], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentColumn, &methods_wxDataViewCtrl[44], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CountPerPage, &methods_wxDataViewCtrl[43], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColumnCount, &methods_wxDataViewCtrl[41], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
