...
const char sipStrings__grid[] = {
 ...
 ::wxEvent* sipVH__grid_65(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxEvent* sipRes = 0;
 ...
 ::wxEventCategory sipVH__grid_64(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxPen sipVH__grid_63(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPen sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
 ...
 ::wxPen sipVH__grid_62(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int col)
{
     ::wxPen sipRes;
 ...
 ::wxBorder sipVH__grid_61(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__grid_60(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowVariant variant)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "F", variant, sipType_wxWindowVariant);
}

void sipVH__grid_59(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiii", x, y, width, height);
}

 ::wxSize sipVH__grid_58(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxSize sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
void sipVH__grid_57(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int minW,int minH,int maxW,int maxH,int incW,int incH)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiiii", minW, minH, maxW, maxH, incW, incH);
}

void sipVH__grid_56(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int width,int height)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "ii", width, height);
}

void sipVH__grid_55(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int x,int y,int width,int height,int sizeFlags)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiiii", x, y, width, height, sizeFlags);
}

void sipVH__grid_54(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int*x,int*y)
{
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
 ...
 ::wxWindow* sipVH__grid_53(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxWindow* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
 ...
 ::wxValidator* sipVH__grid_52(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
 ...
 ::wxPoint sipVH__grid_51(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxPoint sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
bool sipVH__grid_50(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int direction,int size,int availableOtherDir)
{
    bool sipRes = 0;
...
void sipVH__grid_49(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool canFocus)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "b", canFocus);
}

bool sipVH__grid_48(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxEvent& event)
{
    bool sipRes = 0;
...
void sipVH__grid_47(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindowBase*child)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", child, sipType_wxWindowBase, SIP_NULLPTR);
}

void sipVH__grid_46(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", &dc, sipType_wxDC, SIP_NULLPTR);
}

bool sipVH__grid_45(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxScrollWinEvent& event)
{
    bool sipRes = 0;
...
bool sipVH__grid_44(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*child)
{
    bool sipRes = 0;
 ...
 ::wxSize sipVH__grid_43(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxSize& size)
{
     ::wxSize sipRes;
...
bool sipVH__grid_42(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
 ...
 ::wxGrid* sipVH__grid_41(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxGrid* sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
void sipVH__grid_40(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGrid*grid)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", grid, sipType_wxGrid, SIP_NULLPTR);
}

int sipVH__grid_39(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    int sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
void sipVH__grid_38(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,const  ::wxString& label)
{
 ...
 ::wxString sipVH__grid_37(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row)
{
     ::wxString sipRes;
...
bool sipVH__grid_36(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, size_t numRows)
{
    bool sipRes = 0;
...
bool sipVH__grid_35(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, size_t pos,size_t numRows)
{
    bool sipRes = 0;
...
void sipVH__grid_34(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,bool value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iib", row, col, value);
}

void sipVH__grid_33(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,double value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iid", row, col, value);
}

void sipVH__grid_32(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,long value)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iil", row, col, value);
}

double sipVH__grid_31(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    double sipRes = 0;
...
long sipVH__grid_30(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    long sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "ii", row, col);
...
bool sipVH__grid_29(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxString& typeName)
{
    bool sipRes = 0;
...
void sipVH__grid_27(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxString& value)
{
...
bool sipVH__grid_25(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col)
{
    bool sipRes = 0;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "ii", row, col);
 ...
 ::wxGridCellAttr* sipVH__grid_24(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col, ::wxGridCellAttr::wxAttrKind kind)
{
...
const  ::wxGridCornerHeaderRenderer& sipVH__grid_23(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
const  ::wxGridRowHeaderRenderer& sipVH__grid_22(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row)
{
...
const  ::wxGridColumnHeaderRenderer& sipVH__grid_21(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int col)
{
...
void sipVH__grid_20(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGridCellAttr*attr,int row)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "Di", attr, sipType_wxGridCellAttr, SIP_NULLPTR, row);
}

void sipVH__grid_19(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxGridCellAttr*attr,int row,int col)
{
...
void sipVH__grid_18(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxGrid& grid, ::wxDC& dc,const  ::wxString& value,const  ::wxRect& rect,int horizAlign,int vertAlign,int textOrientation)
{
...
void sipVH__grid_17(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxGrid& grid, ::wxDC& dc, ::wxRect& rect)
{
...
void sipVH__grid_16(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxValidator& validator)
{
 ...
 ::wxString sipVH__grid_15(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
     ::wxString sipRes;
    PyObject *sipResObj = sipCallMethod(SIP_NULLPTR, sipMethod, "");
...
bool sipVH__grid_14(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxKeyEvent& event)
{
    bool sipRes = 0;
...
void sipVH__grid_13(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, bool show, ::wxGridCellAttr*attr)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "bD", show, attr, sipType_wxGridCellAttr, SIP_NULLPTR);
}

void sipVH__grid_12(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxRect& rect)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "N", new  ::wxRect(rect), sipType_wxRect, SIP_NULLPTR);
}

void sipVH__grid_11(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxDC& dc,const  ::wxRect& rectCell,const  ::wxGridCellAttr& attr)
{
...
void sipVH__grid_10(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxKeyEvent& event)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "D", &event, sipType_wxKeyEvent, SIP_NULLPTR);
}

bool sipVH__grid_9(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col,const  ::wxGrid*grid,const  ::wxString& oldval, ::wxString*newval)
{
    bool sipRes = 0;
...
void sipVH__grid_8(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "");
}

void sipVH__grid_7(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod,  ::wxWindow*parent, ::wxWindowID id, ::wxEvtHandler*evtHandler)
{
 ...
 ::wxGridCellEditor* sipVH__grid_6(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod)
{
...
void sipVH__grid_5(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, int row,int col, ::wxGrid*grid)
{
    sipCallProcedureMethod(sipGILState, sipErrorHandler, sipPySelf, sipMethod, "iiD", row, col, grid, sipType_wxGrid, SIP_NULLPTR);
}

void sipVH__grid_4(sip_gilstate_t sipGILState, sipVirtErrorHandlerFunc sipErrorHandler, sipSimpleWrapper *sipPySelf, PyObject *sipMethod, const  ::wxString& params)
{
...
static sipEnumTypeDef enumTypes[] = {
    ...
    {{-1, 0, 0, SIP_TYPE_ENUM, sipNameNr_wxGridCellAttr__wxAttrKind, {0}, 0}, sipNameNr_AttrKind, 8, SIP_NULLPTR},
...
static sipEnumMemberDef enummembers[] = {
    {sipName_GRIDTABLE_NOTIFY_COLS_APPENDED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_APPENDED), 52},
    {sipName_GRIDTABLE_NOTIFY_COLS_DELETED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_DELETED), 52},
    {sipName_GRIDTABLE_NOTIFY_COLS_INSERTED, static_cast<int>(::wxGRIDTABLE_NOTIFY_COLS_INSERTED), 52},
    {sipName_GRIDTABLE_NOTIFY_ROWS_APPENDED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_APPENDED), 52},
    {sipName_GRIDTABLE_NOTIFY_ROWS_DELETED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_DELETED), 52},
    {sipName_GRIDTABLE_NOTIFY_ROWS_INSERTED, static_cast<int>(::wxGRIDTABLE_NOTIFY_ROWS_INSERTED), 52},
    {sipName_GRID_DRAW_BOX_RECT, static_cast<int>(::wxGRID_DRAW_BOX_RECT), 44},
    {sipName_GRID_DRAW_CELL_LINES, static_cast<int>(::wxGRID_DRAW_CELL_LINES), 44},
    {sipName_GRID_DRAW_COLS_HEADER, static_cast<int>(::wxGRID_DRAW_COLS_HEADER), 44},
    {sipName_GRID_DRAW_DEFAULT, static_cast<int>(::wxGRID_DRAW_DEFAULT), 44},
    {sipName_GRID_DRAW_ROWS_HEADER, static_cast<int>(::wxGRID_DRAW_ROWS_HEADER), 44},
    {sipName_GRID_DRAW_SELECTION, static_cast<int>(::wxGRID_DRAW_SELECTION), 44},
    {sipName_GRID_FLOAT_FORMAT_COMPACT, static_cast<int>(::wxGRID_FLOAT_FORMAT_COMPACT), 27},
    {sipName_GRID_FLOAT_FORMAT_DEFAULT, static_cast<int>(::wxGRID_FLOAT_FORMAT_DEFAULT), 27},
    {sipName_GRID_FLOAT_FORMAT_FIXED, static_cast<int>(::wxGRID_FLOAT_FORMAT_FIXED), 27},
    {sipName_GRID_FLOAT_FORMAT_SCIENTIFIC, static_cast<int>(::wxGRID_FLOAT_FORMAT_SCIENTIFIC), 27},
    {sipName_GRID_FLOAT_FORMAT_UPPER, static_cast<int>(::wxGRID_FLOAT_FORMAT_UPPER), 27},
};
