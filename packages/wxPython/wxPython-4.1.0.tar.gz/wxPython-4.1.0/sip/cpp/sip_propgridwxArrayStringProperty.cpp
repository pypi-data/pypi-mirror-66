 ...
 ::wxPGArrayEditorDialog* sipwxArrayStringProperty::CreateEditorDialog()
{
    ...
    extern  ::wxPGArrayEditorDialog* sipVH__propgrid_72(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_72(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxArrayStringProperty::OnCustomStringEdit( ::wxWindow*parent, ::wxString& value)
{
    ...
    extern bool sipVH__propgrid_71(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxString&);

    return sipVH__propgrid_71(sipGILState, 0, sipPySelf, sipMeth, parent, value);
}
...
void sipwxArrayStringProperty::ConvertArrayToString(const  ::wxArrayString& arr, ::wxString*pString,const  ::wxUniChar& delimiter) const
{
    ...
    extern void sipVH__propgrid_70(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayString&, ::wxString*,const  ::wxUniChar&);

    sipVH__propgrid_70(sipGILState, 0, sipPySelf, sipMeth, arr, pString, delimiter);
}
