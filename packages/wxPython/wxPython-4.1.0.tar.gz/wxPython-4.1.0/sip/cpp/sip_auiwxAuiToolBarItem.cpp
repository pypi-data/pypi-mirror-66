...
sipVariableDef variables_wxAuiToolBarItem[] = {
    {PropertyVariable, sipName_Window, &methods_wxAuiToolBarItem[16], &methods_wxAuiToolBarItem[38], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_UserData, &methods_wxAuiToolBarItem[15], &methods_wxAuiToolBarItem[37], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_State, &methods_wxAuiToolBarItem[14], &methods_wxAuiToolBarItem[35], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SpacerPixels, &methods_wxAuiToolBarItem[13], &methods_wxAuiToolBarItem[34], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SizerItem, &methods_wxAuiToolBarItem[12], &methods_wxAuiToolBarItem[33], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ShortHelp, &methods_wxAuiToolBarItem[11], &methods_wxAuiToolBarItem[32], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Proportion, &methods_wxAuiToolBarItem[10], &methods_wxAuiToolBarItem[31], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MinSize, &methods_wxAuiToolBarItem[9], &methods_wxAuiToolBarItem[30], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LongHelp, &methods_wxAuiToolBarItem[8], &methods_wxAuiToolBarItem[29], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Label, &methods_wxAuiToolBarItem[7], &methods_wxAuiToolBarItem[28], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Kind, &methods_wxAuiToolBarItem[6], &methods_wxAuiToolBarItem[27], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Id, &methods_wxAuiToolBarItem[5], &methods_wxAuiToolBarItem[26], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_HoverBitmap, &methods_wxAuiToolBarItem[4], &methods_wxAuiToolBarItem[25], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DisabledBitmap, &methods_wxAuiToolBarItem[3], &methods_wxAuiToolBarItem[23], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Bitmap, &methods_wxAuiToolBarItem[2], &methods_wxAuiToolBarItem[22], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Alignment, &methods_wxAuiToolBarItem[1], &methods_wxAuiToolBarItem[21], SIP_NULLPTR, SIP_NULLPTR},
};
