...
bool sipwxEditorDialogProperty::DisplayEditorDialog( ::wxPropertyGrid*pg, ::wxPGVariant& value)
{
    ...
    extern bool sipVH__propgrid_68(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxPropertyGrid*, ::wxPGVariant&);

    return sipVH__propgrid_68(sipGILState, 0, sipPySelf, sipMeth, pg, value);
}
