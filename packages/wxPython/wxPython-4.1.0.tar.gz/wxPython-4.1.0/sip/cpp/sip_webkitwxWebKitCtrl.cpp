...
sipVariableDef variables_wxWebKitCtrl[] = {
    {PropertyVariable, sipName_Title, &methods_wxWebKitCtrl[36], &methods_wxWebKitCtrl[59], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxWebKitCtrl[35], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ScrollPos, &methods_wxWebKitCtrl[34], &methods_wxWebKitCtrl[58], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageURL, &methods_wxWebKitCtrl[33], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageTitle, &methods_wxWebKitCtrl[32], &methods_wxWebKitCtrl[57], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageSource, &methods_wxWebKitCtrl[31], &methods_wxWebKitCtrl[56], SIP_NULLPTR, SIP_NULLPTR},
};
