...
void sipwxFileHistory::UseMenu( ::wxMenu*menu)
{
    ...
    extern void sipVH__core_228(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxMenu*);

    sipVH__core_228(sipGILState, 0, sipPySelf, sipMeth, menu);
}
...
void sipwxFileHistory::Save( ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_230(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxConfigBase&);
...
void sipwxFileHistory::RemoveFileFromHistory(size_t i)
{
    ...
    sipVH__core_141(sipGILState, 0, sipPySelf, sipMeth, i);
}
...
void sipwxFileHistory::Load(const  ::wxConfigBase& config)
{
    ...
    extern void sipVH__core_229(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxConfigBase&);

    sipVH__core_229(sipGILState, 0, sipPySelf, sipMeth, config);
}
 ...
 ::wxString sipwxFileHistory::GetHistoryFile(size_t index) const
{
    ...
    return sipVH__core_152(sipGILState, 0, sipPySelf, sipMeth, index);
}
...
void sipwxFileHistory::AddFileToHistory(const  ::wxString& filename)
{
    ...
    sipVH__core_54(sipGILState, 0, sipPySelf, sipMeth, filename);
}
...
static sipEncodedTypeDef supers_wxFileHistory[] = {{370, 255, 1}};
