...
void sipwxPrinter::ReportError( ::wxWindow*parent, ::wxPrintout*printout,const  ::wxString& message)
{
    ...
    extern void sipVH__core_217(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,const  ::wxString&);

    sipVH__core_217(sipGILState, 0, sipPySelf, sipMeth, parent, printout, message);
}
 ...
 ::wxDC* sipwxPrinter::PrintDialog( ::wxWindow*parent)
{
    ...
    extern  ::wxDC* sipVH__core_216(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_216(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
bool sipwxPrinter::Print( ::wxWindow*parent, ::wxPrintout*printout,bool prompt)
{
    ...
    extern bool sipVH__core_215(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,bool);

    return sipVH__core_215(sipGILState, 0, sipPySelf, sipMeth, parent, printout, prompt);
}
 ...
 ::wxPrintDialogData& sipwxPrinter::GetPrintDialogData() const
{
    ...
    extern  ::wxPrintDialogData& sipVH__core_214(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_214(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxPrintAbortDialog* sipwxPrinter::CreateAbortWindow( ::wxWindow*parent, ::wxPrintout*printout)
{
    ...
    extern  ::wxPrintAbortDialog* sipVH__core_213(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*);

    return sipVH__core_213(sipGILState, 0, sipPySelf, sipMeth, parent, printout);
}
...
static sipEncodedTypeDef supers_wxPrinter[] = {{370, 255, 1}};
