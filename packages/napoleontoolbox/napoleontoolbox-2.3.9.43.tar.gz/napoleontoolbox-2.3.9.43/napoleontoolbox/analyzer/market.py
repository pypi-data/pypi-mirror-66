...
class MarketAnalyzer:
    ...
    def plot_perf(self, title='Performances', ax=None, show=True,saving_png_path = None,saving_png_perf_path = None, **kwargs):
        ...
        **kwargs
        ...
        if not df.empty:
            ...
            if saving_png_perf_path is not None:
                fig = ax.get_figure()
                fig.savefig(saving_png_perf_path)
