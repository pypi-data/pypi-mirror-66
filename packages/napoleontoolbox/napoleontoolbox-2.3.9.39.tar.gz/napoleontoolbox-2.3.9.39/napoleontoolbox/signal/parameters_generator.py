...
def generate_fourier_wvt_decomposition(lookback_windows,contravariants,n_harms,dec_levels):
    parameters = []
    for lookback_window in lookback_windows:
        for contravariant in contravariants:
...
def generate_fourier_decomposition(lookback_windows,contravariants,n_harms):
    parameters = []
    for lookback_window in lookback_windows:
        for contravariant in contravariants:
            for n_harm in n_harms:
