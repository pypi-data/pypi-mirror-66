...
def score(self, toscore):
    ...
    print( 'inside score' )
    for frame in self.frame_selector( toscore ):
        print( frame )
...
# {% endif %}
sub_directory = 'scores_' + sub_directory + '_MSE_lr-{}_epochs-{}_ws-{}_extraws-{}_slidingstep-{}'.format( 
        learning_rate, epochs, window_size, extra_pre_post, sliding_step )
