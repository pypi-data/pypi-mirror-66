...
from azureml.automl.core.shared.logging_utilities import BLACKLISTED_LOGGING_KEYS
...
class AzureAutoMLClient:
    ...
    def _raise_feature_unavailable_exception(self, e: AzureMLServiceException) -> None:
        if is_error_code(e, ErrorHierarchy.FEATUREUNAVAILABLE_ERROR) is True:
            ...
            try:
                ...
                pass
            raise FeatureUnavailableException(error_message).with_generic_msg('Feature is not available') from None
    ...
    def _set_environment_variables_for_reconstructing_run(run):
        ...
        os.environ["AZUREML_DISCOVERY_SERVICE_ENDPOINT"] = run.experiment.workspace.discovery_url
