    ...
    def get_output(self,
        ...
        if return_onnx_model:
            ...
            if not automl_settings.enable_onnx_compatible_models:
                raise OnnxConvertException.create_without_pii("Invalid parameter 'return_onnx_model' passed in.")
            if return_split_onnx_model and not automl_settings.enable_split_onnx_featurizer_estimator_models:
                raise OnnxConvertException.create_without_pii("Invalid parameter 'return_split_onnx_model' passed in.")
