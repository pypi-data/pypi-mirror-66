...
class ExperimentOperations(object):
    ...
    def delete_tags(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, delete_tags_command, custom_headers=None, raw=False, **operation_config):
        """Updates the experiment.
        ...
        :param experiment_id:
        :type experiment_id: str
        :param delete_tags_command:
        :type delete_tags_command: ~_restclient.models.DeleteTagsCommandDto
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        # Construct body
        body_content = self._serialize.body(delete_tags_command, 'DeleteTagsCommandDto')
