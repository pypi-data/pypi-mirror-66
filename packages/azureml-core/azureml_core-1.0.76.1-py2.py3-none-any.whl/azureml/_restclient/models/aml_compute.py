...
class AmlCompute(Compute):
    ...
    :ivar is_attached_compute: Indicating whether the compute was provisioned
     by user and brought from outside if true, or Azure Machine learning
    ...
    :type properties: ~_restclient.models.AmlComputeProperties
    """
    ...
    def __init__(self, compute_location=None, description=None, resource_id=None, properties=None):
        super(AmlCompute, self).__init__(compute_location=compute_location, description=description, resource_id=resource_id)
