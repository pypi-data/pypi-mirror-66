...
class CondaDependencies(object):
    ...
    .. note::
        ...
        If no parameters are specified, `azureml-defaults` will be added to the CondaDependency object as the only
        pip dependency. The `azureml-default` dependency will not be pinned to a specific version and will target the
    ...
    def create(pip_indexurl=None, pip_packages=None, conda_packages=None,
        ...
        Returns an instance of CondaDependencies object with user specified dependencies
        ...
        .. note::
            ...
            If `pin_sdk_version` is set to true, pip dependencies of the packages distributed as a part of AzureML
            Python SDK will be pinned to the SDK version installed in the current environment.
        ...
        :param pin_sdk_version: pin sdk packages to the client version.
    ...
    def add_pip_package(self, pip_package):
        ...
        .. note::
            ...
            reference to the end of the dependecnies list. This may change the order of the dependencies.
    ...
    def remove_pip_option(self, pip_option):
        ...
        :param pip_option: the pip option to be removed.
        :type pip_option: str
        """
        if not self._is_option(pip_option):
            raise UserErrorException(
