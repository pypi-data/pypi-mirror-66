...
class ServicePrincipalAuthentication(AbstractAuthentication):
    ...
    def __init__(self, tenant_id, service_principal_id, service_principal_password, cloud='AzureCloud', _enable_caching=False):
...
class AzureMLTokenAuthentication(AbstractAuthentication):
    ...
    code that submitted the run. The AzureMLTokenAuthentication class can only be used in the context of
    ...
    def __init__(self, azureml_access_token, expiry_time=None, host=None, subscription_id=None,
        ...
        The class can only be used in the context of submitted run. The token cannot be used against any ARM
