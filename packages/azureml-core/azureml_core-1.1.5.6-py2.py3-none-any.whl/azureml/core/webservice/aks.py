...
class AksWebservice(Webservice):
    ...
    cluster](https://docs.microsoft.com/azure/machine-learning/how-to-deploy-azure-kubernetes-service).
    ...
    :vartype autoscaler: azureml.core.aks.Autoscaler
    ...
    :vartype liveness_probe_requirements: azureml.core.aks.LivenessProbeRequirements
    :var data_collection: The DataCollection object for the Webservice.
    :vartype data_collection: azureml.core.aks.DataCollection
    ...
    :var azureml.core.webserivce.AksWebservice.scoring_uri: The scoring endpoint for the Webservice
    ...
    :vartype version_type: azureml.core.aks.AksEndpoint.VersionType
    ...
    :var azureml.core.webserivce.AksWebservice.models: A list of Models deployed to the Webservice.
    ...
    :var azureml.core.webserivce.AksWebservice.swagger_uri: The swagger endpoint for the Webservice.
...
class AksServiceDeploymentConfiguration(WebserviceDeploymentConfiguration):
    ...
    :vartype scoring_timeout_ms: int
    :var replica_max_concurrent_requests: The number of maximum concurrent requests per node to allow for this
        Webservice. Defaults to 1
...
class AksEndpointDeploymentConfiguration(AksServiceDeploymentConfiguration):
    ...
    :var azureml.core.webservice.aks.AksEndpointDeploymentConfiguration.replica_max_concurrent_requests: The number
        of maximum concurrent requests per node to allow for this Webservice. Defaults to 1.
    :vartype replica_max_concurrent_requests: int
