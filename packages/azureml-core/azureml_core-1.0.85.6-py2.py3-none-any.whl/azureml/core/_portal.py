...
# TODO: Remove when portal endpoints availabe in cloud.py under azureml._vendor.azure_cli_core.cloud
_PUBLIC_PORTAL_DOMAIN_NAME = 'https://ml.azure.com'
_CHINA_PORTAL_DOMAIN_NAME = 'https://studio.ml.azure.cn'
_US_GOV_PORTAL_DOMAIN_NAME = 'https://studio.ml.azure.us'
_MOONCAKE_REGIONS = ["chinaeast2"]
_FAIRFAX_REGIONS = ["usgovvirginia"]
...
class HasWorkspacePortal(HasPortal):
    ...
    def _get_portal_domain(workspace):
        ...
        if workspace.location in _MOONCAKE_REGIONS:
            portal_domain = _CHINA_PORTAL_DOMAIN_NAME
        elif workspace.location in _FAIRFAX_REGIONS:
            portal_domain = _US_GOV_PORTAL_DOMAIN_NAME
