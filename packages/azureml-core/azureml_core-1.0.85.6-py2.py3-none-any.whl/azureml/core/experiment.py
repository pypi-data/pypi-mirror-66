...
class ViewType(object):
    """ViewType is used to filter out or include archived experiments in get requests."""
...
class Experiment(ChainedIdentity, HasExperimentPortal):
    """The main entry point into experimenting with Azure Machine Learning.
    ...
    def list(workspace, experiment_name=None, view_type=ViewType.ActiveOnly, tags=None):
        ...
        :param view_type: Optional view_type enum to filter or include archived experiments.
