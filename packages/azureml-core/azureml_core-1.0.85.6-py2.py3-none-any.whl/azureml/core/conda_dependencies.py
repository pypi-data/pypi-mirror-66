...
class CondaDependencies(object):
    ...
    def create(pip_indexurl=None, pip_packages=None, conda_packages=None,
        ...
        .. note::
            ...
            If `pip_packages` is not specified, `azureml-defaults` will be added as the
            default dependencies. User specified `pip_packages` dependencies will
            override the default values.

            If `pin_sdk_version` is set to true, pip dependencies of the packages
            distributed as a part of Azure Machine Learning Python SDK will be
            pinned to the SDK version installed in the current environment.
    ...
    def add_pip_package(self, pip_package):
        ...
        .. note::
            ...
            Adding a dependency of an already referenced package will remove
            the previous reference and add a new reference to the end of the
            dependencies list. This may change the order of the dependencies.
