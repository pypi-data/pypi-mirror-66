...
def create_error_event(run_id, error_dict):
    ...
    root_error = RootError(code=error_dict.get("code"), message=error_dict.get("message"),
                           inner_error=inner_error, debug_info=debug_info, details_uri=error_dict.get("details_uri"))
