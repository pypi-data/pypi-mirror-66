                ...
                if isinstance(dataset, FileDataset):
                    ...
                    if datastores is not None:
                        for dstore_index, dstore in enumerate(datastores):
                            ...
                            _log_and_print('Looking for variable: {}'.format(var))
                            var_val = os.environ.get(var)
                            _log_and_print('Variable value: {}'.format(var_val))
                    ...
                    if len(dataset_as_dataref) > 0:
                        ...
                        _log_and_print("Dataset '{}' converted to DataReference.".format(
                            data_configuration.environment_variable_name))
                        _log_and_print("Set {}={}, skipping mount.".format(
