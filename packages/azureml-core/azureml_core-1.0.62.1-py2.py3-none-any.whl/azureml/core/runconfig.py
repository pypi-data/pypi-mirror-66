...
class DataPath(_AbstractRunConfigElement):
    """A class for managing DataPath.

    :param datastore_name: Name of the datastore.
    :type datastore_name: str
    :param path: Relative path on datastore.
...
class Dataset(_AbstractRunConfigElement):
    """A reference to a saved dataset which will be used in the run.
...
class DataLocation(_AbstractRunConfigElement):
    """A class for managing DataLocation where data comes from.

    :param dataset: To represent a dataset.
    :param datapath: To represent a datapath.
    """
...
class Data(_AbstractRunConfigElement):
    ...
    :param data_location: Represents the location of the data.
    :type data_location: DataLocation
    :param create_output_directories: Whether to create new folder.
    ...
    :type path_on_compute: str
    :param overwrite: Whether to overwrite the data if it exists.
    :type overwrite: bool
    """
