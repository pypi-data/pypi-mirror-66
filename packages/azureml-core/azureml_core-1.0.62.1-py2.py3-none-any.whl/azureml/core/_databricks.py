...
class DatabricksSection(_AbstractRunConfigElement):
    ...
    :type maven_libraries: :class:`list[azureml.core._databricks.MavenLibrary]`

    :param pypi_libraries: List of PyPi libraries.
    :type pypi_libraries: :class:`list[azureml.core._databricks.PyPiLibrary]`

    :param rcran_libraries: List of RCran libraries.
    :type rcran_libraries: :class:`list[azureml.core._databricks.RCranLibrary]`

    :param jar_libraries: List of JAR libraries.
    :type jar_libraries: :class:`list[azureml.core._databricks.JarLibrary]`

    :param egg_libraries: List of Egg libraries.
    :type egg_libraries: :class:`list[azureml.core._databricks.EggLibrary]`

    :param cluster: Databricks cluster information
    :type cluster: azureml.core._databricks.DatabricksCluster
    """
