...
class Run(_RunBase):
    ...
    def get_secret(self, name):
        """Get secret from the context of a run.

        Get the secret value for the name provided.

        :param name:
        :type name: Secret name to retrieve the values for
    ...
    def submit_child(self, config, tags=None, **kwargs):
        ...
        .. remarks::
            ...
            An example of how to submit a child experiment from your local machine is as follows:
    ...
    def get_children(self, recursive=False, tags=None, properties=None, type=None, status=None, _rehydrate_runs=True):
        ...
        :type _rehydrate_runs: bool
        :return: A generator of azureml.core.run.Run
    ...
    def _get_outputs_datapath(self):
        ...
        blob_azureml_datastore = Datastore.register_azure_blob_container(
    ...
    @_check_for_data_container_id
    def upload_files(self, names, paths, return_artifacts=False):
    ...
    def register_model(self, model_name, model_path=None, tags=None, properties=None, model_framework=None,
                       model_framework_version=None, description=None, datasets=None, **kwargs):
        ...
        :type description: str
        :param datasets:
        :type datasets: builtin.list[tuple[str, Dataset | DatasetSnapshot]]
        :param kwargs:
        ...
        return self._client.register_model(
            ...
            description=description, datasets=datasets, unpack=False, **kwargs)
...
class InputDatasets(dict):
    """Container for holding materialized dataset in the run.
            ...
            for pair in dataset_environment_var_list:
                ...
                if len(pair_list) == 2:
                    ...
                    if var_value and dataset_consumption_type.lower() == 'direct':
                        super().__setitem__(var_name.lower(), _Dataset.get_by_id(self.workspace, var_value))
                    else:
