...
class DatasetSubGroup(abstract_subgroup.AbstractSubGroup):
    """This class defines the dataset sub group."""
    ...
    def get_subgroup_title(self):
        ...
        return "Commands for managing datasets with the Azure ML Workspace"

    def get_nested_subgroups(self):
        """Returns sub-groups of this sub-group."""
        return super(DatasetSubGroup, self).compute_nested_subgroups(__package__)
