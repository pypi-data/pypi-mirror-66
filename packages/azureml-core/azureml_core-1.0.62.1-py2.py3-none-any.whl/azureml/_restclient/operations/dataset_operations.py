...
class DatasetOperations(object):
    ...
    def associate_datasets1(
        ...
        """
        # Construct URL
        url = self.associate_datasets1.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    associate_datasets1.metadata = {'url': '/dataset/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/datasets/{datasetId}/associations'}
    ...
    def ensure_saved(
            self, subscription_id, resource_group_name, workspace_name, dataset=None, custom_headers=None, raw=False, **operation_config):
        """
