...
class MetricsClient(RunClient):
    ...
    def _get_metrics_for_runs(self, run_ids, use_batch=False, metric_types=None, after_timestamp=None, name=None,
                              merge_strategy_type=None):
    ...
    def _get_all_metrics(self, run_ids=None, use_batch=False, metric_types=None, after_timestamp=None,
