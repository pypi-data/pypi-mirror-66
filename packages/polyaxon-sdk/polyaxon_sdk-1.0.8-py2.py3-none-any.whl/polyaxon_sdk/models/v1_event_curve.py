...
class V1EventCurve(object):
    ...
    """
    openapi_types = {"x": "list[float]", "y": "list[float]", "annotation": "str"}

    attribute_map = {"x": "x", "y": "y", "annotation": "annotation"}

    def __init__(
        self, x=None, y=None, annotation=None, local_vars_configuration=None
    ):  # noqa: E501
