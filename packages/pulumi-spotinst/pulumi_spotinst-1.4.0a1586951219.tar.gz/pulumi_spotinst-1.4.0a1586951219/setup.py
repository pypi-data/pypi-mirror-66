...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v1.4.0-alpha.1586951219+ge8176ed'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v1.4.0-alpha.1586951219+ge8176ed`
                """)
            else:
                raise
