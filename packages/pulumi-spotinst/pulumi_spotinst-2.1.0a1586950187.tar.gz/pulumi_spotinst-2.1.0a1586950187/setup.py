...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.1.0-alpha.1586950187+g078ab40'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.1.0-alpha.1586950187+g078ab40`
                """)
            else:
                raise
