...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v1.4.0-alpha.1587166267+ged3f12c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v1.4.0-alpha.1587166267+ged3f12c`
                """)
            else:
                raise
