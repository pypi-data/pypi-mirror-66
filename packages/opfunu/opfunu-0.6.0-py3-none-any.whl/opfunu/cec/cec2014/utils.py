#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu Nguyen" at 12:51, 21/04/2020                                                        %
#                                                                                                       %
...
CURRENT_PATH = pkg_resources.resource_filename("opfunu", "cec/cec2014/")
SUPPORT_PATH_DATA = pkg_resources.resource_filename("opfunu", "cec/cec2014/support_data/")
