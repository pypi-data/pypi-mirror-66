...
class NumberInfoInText:
    ...
    def __init__(self, text, start_i, end_i, thousands_sep_indices=None, comma_sep_index=-1):
        ...
        self.end_i = end_i
        self.thousands_sep_indices = thousands_sep_indices
...
class NumberIdentificationHelpers:
    ...
    def get_standard_separators_for_language(cls, language_code):
        if language_code in cls.STANDARD_SEPARATORS_PER_LANGUAGE.keys():
            ...
            return cls.BACKUP_SEPARATORS

    @classmethod
    def _find_potential_thousand_sep_combos(cls, text):
    ...
    @classmethod
    def _find_potential_commas(cls, text):
    ...
    def find_numbers(cls, text, language_code=None):
        potential_commas = cls._find_potential_commas(text)
        potential_separators = cls._find_potential_thousand_sep_combos(text)
