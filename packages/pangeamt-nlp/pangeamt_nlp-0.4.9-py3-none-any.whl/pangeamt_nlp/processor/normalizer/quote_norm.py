...
class QuotesInfo:
    ...
    STANDARD_QUOTES = STANDARD_QUOTES_PER_LANGUAGE["en"]

    STANDARD_QUOTE_PAIRS = ALL_QUOTE_PAIRS_PER_LANGUAGE["en"]
    ...
    def get_all_quote_pairs_for_language(cls, language_code):
        ...
        if cls.has_quote_pairs_for_language(language_code):
            ...
            quote_pairs = cls.STANDARD_QUOTE_PAIRS
