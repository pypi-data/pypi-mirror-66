...
class DatasourceApi(object):
    ...
    def save(self, data_source_id, **kwargs):  # noqa: E501
        """Add data source  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save(data_source_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str data_source_id: The data source ID (required)
        :param object body: Login details for user
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.save_with_http_info(data_source_id, **kwargs)  # noqa: E501

    def save_with_http_info(self, data_source_id, **kwargs):  # noqa: E501
        """Add data source  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_with_http_info(data_source_id, async_req=True)
        >>> result = thread.get()
