...
db = cb.subsample('clubear.csv') # initialize and specify the dataset path
...
sample = db.run(subsize=1000, method='seq') # sequential 
sample = db.run(subsize=1000, method='rand') # random  
        '''
        print(demo_str)
