...
class DatasourceBQ(object):
    ...
    def __init__(self, name=None, client_project=None, client_dataset=None, client_table=None, id=None, organization_id=None, internal_project=None, internal_dataset=None, internal_table=None, n_rows=None, n_columns=None, n_bytes=None):  # noqa: E501
