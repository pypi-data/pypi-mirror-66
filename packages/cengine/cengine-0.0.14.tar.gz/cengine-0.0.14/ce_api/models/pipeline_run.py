...
class PipelineRun(object):
    ...
    def __init__(self, ml_metadata_context_id=None, kubeflow_run_id=None, kubeflow_run_name=None, pipeline_id=None, run_time=None, cloud_job_prefix=None, status=None, kubeflow_start_time=None, kubeflow_end_time=None, components_status=None, id=None):  # noqa: E501
