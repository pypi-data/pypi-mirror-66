...
ALLOWED_KEYS = {
    *range(arcade.key.A, arcade.key.Z + 1),  # A-Z
    *range(arcade.key.NUM_0, arcade.key.NUM_9 + 1),  # Numpad 0-9
    *range(arcade.key.KEY_0, arcade.key.KEY_9 + 1),  # 0-9
    arcade.key.LEFT,
    arcade.key.RIGHT,
    arcade.key.BACKSPACE,
    arcade.key.SPACE,
    arcade.key.EXCLAMATION,
    arcade.key.DOUBLEQUOTE,
    arcade.key.HASH,
    arcade.key.POUND,
    arcade.key.DOLLAR,
    arcade.key.PERCENT,
    arcade.key.AMPERSAND,
    arcade.key.APOSTROPHE,
    arcade.key.PARENLEFT,
    arcade.key.PARENRIGHT,
    arcade.key.ASTERISK,
    arcade.key.PLUS,
    arcade.key.COMMA,
    arcade.key.MINUS,
    ...
    arcade.key.ASCIICIRCUM,
    arcade.key.UNDERSCORE,
}
