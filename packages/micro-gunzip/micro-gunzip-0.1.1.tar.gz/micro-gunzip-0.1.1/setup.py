...
def main():
    ...
    install_requires = ["microapp>=0.1.3"]
    ...
    setup(
        ...
        entry_points={"microapp.apps": "gunzip = micro_gunzip"},
        project_urls={
            "Bug Reports": "https://github.com/grnydawn/microapp-gunzip/issues",
            "Source": "https://github.com/grnydawn/microapp-gunzip",
        }
    )
