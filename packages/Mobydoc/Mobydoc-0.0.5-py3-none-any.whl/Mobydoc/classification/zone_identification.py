...
class ClassificationZoneIdentification(Base):
    ...
    # RangTaxonomique.Reference_Id
    id_rang_taxonomique = Column("ClassificationZoneIdentification_RangTaxonomique_Id", UUID, nullable=True)
    ...
    def json(self):
        ...
        data['id_rang_taxonomique'] = self.id_rang_taxonomique
