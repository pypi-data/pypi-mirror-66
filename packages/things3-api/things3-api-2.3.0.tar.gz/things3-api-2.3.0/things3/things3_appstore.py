...
class Things3Appstore():
    ...
    DOMAIN = "dbpath"
    db_file = things3.things3.Things3.FILE_SQLITE
    ...
    def restore_access_token(self):
        ...
        self.debug(f"Bookmark: {bookmark_file_url}")
    ...
    def main(self):
        ...
        try:
            ...
            self.debug(f"Database not found: {self.db_file}. Details: {error}")
        ...
        things3.things3_app.Things3App(database=self.db_file).main()
