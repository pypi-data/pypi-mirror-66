...
def download_blob(bucket_name, source_file):
    storage_client = storage.Client()
    bucket = storage_client.get_bucket(bucket_name)
...
class _CreateCategoricalEncodedVariables(DoFn):
    ...
    def process(self, data):
        ...
        equipment_mlb = pickle.load(download_blob("user_transforms", "user_equipment_mlb.pkl"))
        state_lbe = pickle.load(download_blob("user_transforms", "user_state_lbe.pkl"))
        state_ohe = pickle.load(download_blob("user_transforms", "user_state_ohe.pkl"))
        city_lbe = pickle.load(download_blob("user_transforms", "user_city_lbe.pkl"))
        city_ohe = pickle.load(download_blob("user_transforms", "user_city_ohe.pkl"))
        email_lbe = pickle.load(download_blob("user_transforms", "user_email_lbe.pkl"))
        email_ohe = pickle.load(download_blob("user_transforms", "user_email_ohe.pkl"))
        zip_code_lbe = pickle.load(download_blob("user_transforms", "user_zip_code_lbe.pkl"))
        zip_code_ohe = pickle.load(download_blob("user_transforms", "user_zip_code_ohe.pkl"))
        channel_lbe = pickle.load(download_blob("user_transforms", "user_channel_lbe.pkl"))
        channel_ohe = pickle.load(download_blob("user_transforms", "user_channel_ohe.pkl"))
        dot_lbe = pickle.load(download_blob("user_transforms", "user_dot_lbe.pkl"))
        dot_ohe = pickle.load(download_blob("user_transforms", "user_dot_ohe.pkl"))
        hos_home_timezone_lbe = pickle.load(
            download_blob("user_transforms", "user_hos_home_timezone_lbe.pkl"))
        hos_home_timezone_ohe = pickle.load(
            download_blob("user_transforms", "user_hos_home_timezone_ohe.pkl"))
        hos_cycle_lbe = pickle.load(
            download_blob("user_transforms", "user_hos_cycle_lbe.pkl"))
        hos_cycle_ohe = pickle.load(
            download_blob("user_transforms", "user_hos_cycle_ohe.pkl"))
        mc_number_lbe = pickle.load(
            download_blob("user_transforms", "user_mc_number_lbe.pkl"))
        mc_number_ohe = pickle.load(
            download_blob("user_transforms", "user_mc_number_ohe.pkl"))
        user_type_lbe = pickle.load(
            download_blob("user_transforms", "user_user_type_lbe.pkl"))
        user_type_ohe = pickle.load(
            download_blob("user_transforms", "user_user_type_ohe.pkl"))
        safety_rating_lbe = pickle.load(
            download_blob("user_transforms", "user_safety_rating_lbe.pkl"))
        safety_rating_ohe = pickle.load(
            download_blob("user_transforms", "user_safety_rating_ohe.pkl"))
