...
def chart(dfstock, overlaps=dict(), figures=dict(), marks=dict(), start_date=None, end_date=None):
    ...
    for mark in marks:
        ...
        assert mark[1] in dfstock.index
    ...
    if len(dfstock) <= 500:
        ...
        range_start =  100 - int(10000/len(dfstock))
