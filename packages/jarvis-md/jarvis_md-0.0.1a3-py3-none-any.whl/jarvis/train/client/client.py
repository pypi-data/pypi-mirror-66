...
class Client():
    ...
    def augment(self, arrays, test, **kwargs):
        ...
        """
        if self.daug_func is not None and kwargs['indices'] is None and not test:
    ...
    def perform_norm(self, arr, clip=None, shift=None, scale=None, rands=None, mapping=None, test=False, **kwargs):
        ...
        if mapping is not None:
            self.map_array(x, mapping, **kwargs)
    ...
    def generator_test(self, split, cohorts=None, **kwargs):
        ...
        if drop_duplicates:
            ...
            shape = list(self.specs['xs'].values())[0]['shape']['input']
