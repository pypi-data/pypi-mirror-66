...
/** @brief List of atoms without references to events, as can be used in, i.e.,
 * rule specification.
 */
...
/** @brief AtomsIndex keeps references to set expressions accessible by atoms,
 * which is useful for matching.
 */
class AtomsIndex {
 public:
  /** @brief Creates an empty index.
   * @param getAtomsVector datasource function that returns the list of atoms
   * for a requested expression.
   */
