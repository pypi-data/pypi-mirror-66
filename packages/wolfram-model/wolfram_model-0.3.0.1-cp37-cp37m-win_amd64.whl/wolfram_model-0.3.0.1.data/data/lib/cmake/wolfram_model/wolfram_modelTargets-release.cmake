...
set_target_properties(wolfram_model::SetReplace PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/SetReplace.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS wolfram_model::SetReplace )
list(APPEND _IMPORT_CHECK_FILES_FOR_wolfram_model::SetReplace "${_IMPORT_PREFIX}/lib/SetReplace.lib" )
