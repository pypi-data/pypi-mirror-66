...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloudwatch", "1.33.1", __name__, "aws-cloudwatch@1.33.1.jsii.tgz")
...
class CfnInsightRuleProps():
    def __init__(self, *, rule_body: str, rule_name: str, rule_state: str, tags: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, aws_cdk.core.CfnTag]]]]]=None):
