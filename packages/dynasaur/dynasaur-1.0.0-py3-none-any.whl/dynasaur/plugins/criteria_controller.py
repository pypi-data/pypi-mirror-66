...
class CriteriaController(Plugin, PluginInterface):
    ...
    def __init__(self, path_to_def_file, path_def_file_id, data_source, user_function=None, volume_path=None):
        '''
        ...
        Plugin.__init__(self, path_to_def_file=path_to_def_file, path_def_file_id=path_def_file_id,
                        data_source=data_source, volume_path=volume_path, user_function=user_function,
                        name=DefinitionConstants.CRITERIA)
