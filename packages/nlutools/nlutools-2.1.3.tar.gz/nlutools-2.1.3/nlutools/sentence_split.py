...
if __name__ == "__main__":
    ...
    with CodeTimer("long_text"):
        print(split_text(t))
    t = "【本套课程目前已更新130余节】【总课时约200节，课均时长30分钟；诚意之作，完全以实战为需求设计的系列课程，欢迎购买】【剩余项目课程将每月更新15-20节、预计结课日期为1月】【30元优惠券】购买前请先咨询微信:echo_zhijin(或直接扫描底部二维码)【欢迎添加微，买课的咨询课程/就业事宜、不买课的交个朋友！】【Xmind+AdobeXD+illustrator+Photoshop+Sketch+实战项目+就业保障】➡️就业划个重点"
    print(split_text(t))