...
def kagra_offline(scope, name, rse, rse_attrs, proto_attrs):
    ...
    pfn = "%s/%s/%s/%s" % (calib, "O3", detector, name)
...
#   def igwn_frames(scope, name, rse, rse_attrs, proto_attrs):
#       """
#       Map the GWF files according to the modern schema.
#
#       O3:K-K1_C10-1268039680-4096.gwf ->
