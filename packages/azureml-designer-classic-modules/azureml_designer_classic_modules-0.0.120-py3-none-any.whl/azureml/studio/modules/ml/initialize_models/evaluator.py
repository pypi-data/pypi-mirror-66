...
class RegressionEvaluator(BaseEvaluator):
    ...
    def _drop_missing_scored_label_instance(self, df):
        """Fix bug 575553, to clean instances with NAN scored labels.

        Note: The BinaryClassificationEvaluator, MultiClassificationEvaluator and AnomalyDetectionEvaluator
        have the same issue. But considering they won't hit this issue with correct use, we don't fix them this time.
        """
