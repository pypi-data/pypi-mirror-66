...
from .deliverer import SignalDeliverer, get_deliverer
...
class Runner(BaseRunner):
    ...
    def __init__(
        ...
        self.use_signals = isinstance(deliverer, SignalDeliverer)
    ...
    def publish_metrics(self, force_finalize=True):
        ...
        self.deliverer.post_metrics(
            self.metrics_store.get_data_to_publish(
                datetime.utcnow(), force_finalize=force_finalize))
    ...
    def set_deliverer(self, batch_size, max_staleness, use_signals=False):
