...
# -*- coding: utf-8 -*-
#
# jupyter_vtk documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jupyter_vtk', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyter_vtkdoc'
...
latex_documents = [
    (master_doc, 'jupyter_vtk.tex', 'jupyter_vtk Documentation',
     'Trung Le', 'manual'),
]
