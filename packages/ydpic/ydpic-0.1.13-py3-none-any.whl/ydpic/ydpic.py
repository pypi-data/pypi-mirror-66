...
def main():
    ...
    parser_upload.add_argument("-c --config", dest="config_file_path", help="config file path.",
                               default=os.path.join(".", "config.ini"))

    parser_upload.add_argument("-f --format", dest="output_format", help="img output format.",
