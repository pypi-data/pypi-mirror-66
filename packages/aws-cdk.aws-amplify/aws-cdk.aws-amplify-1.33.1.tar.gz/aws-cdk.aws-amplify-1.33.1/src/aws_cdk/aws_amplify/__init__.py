...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-amplify", "1.33.1", __name__, "aws-amplify@1.33.1.jsii.tgz")
...
class AutoBranchCreation():
    def __init__(self, *, auto_build: typing.Optional[bool]=None, basic_auth: typing.Optional["BasicAuth"]=None, build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec]=None, environment_variables: typing.Optional[typing.Mapping[str,str]]=None, patterns: typing.Optional[typing.List[str]]=None, pull_request_environment_name: typing.Optional[str]=None, pull_request_preview: typing.Optional[bool]=None, stage: typing.Optional[str]=None):
...
class BasicAuthConfig():
    def __init__(self, *, enable_basic_auth: bool, password: str, username: str):
...
class BasicAuthProps():
    def __init__(self, *, username: str, encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, password: typing.Optional[aws_cdk.core.SecretValue]=None):
...
class BranchProps(BranchOptions):
    def __init__(self, *, auto_build: typing.Optional[bool]=None, basic_auth: typing.Optional["BasicAuth"]=None, branch_name: typing.Optional[str]=None, build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec]=None, description: typing.Optional[str]=None, environment_variables: typing.Optional[typing.Mapping[str,str]]=None, pull_request_environment_name: typing.Optional[str]=None, pull_request_preview: typing.Optional[bool]=None, stage: typing.Optional[str]=None, app: "IApp"):
...
class CodeCommitSourceCodeProviderProps():
    def __init__(self, *, repository: aws_cdk.aws_codecommit.IRepository):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-amplify.CustomRule", jsii_struct_bases=[], name_mapping={'source': 'source', 'target': 'target', 'condition': 'condition', 'status': 'status'})
class CustomRule():
    def __init__(self, *, source: str, target: str, condition: typing.Optional[str]=None, status: typing.Optional["RedirectStatus"]=None):
    ...
    def __repr__(self) -> str:
        return 'CustomRule(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class DomainOptions():
    def __init__(self, *, domain_name: typing.Optional[str]=None, sub_domains: typing.Optional[typing.List["SubDomain"]]=None):
...
class DomainProps(DomainOptions):
    def __init__(self, *, domain_name: typing.Optional[str]=None, sub_domains: typing.Optional[typing.List["SubDomain"]]=None, app: "IApp"):
...
class GitHubSourceCodeProviderProps():
    def __init__(self, *, oauth_token: aws_cdk.core.SecretValue, owner: str, repository: str):
...
class App(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-amplify.App"):
    ...
    def add_custom_rule(self, *, source: str, target: str, condition: typing.Optional[str]=None, status: typing.Optional["RedirectStatus"]=None) -> "App":
        ...
        :stability: experimental
        """
        rule = CustomRule(source=source, target=target, condition=condition, status=status)
...
class SourceCodeProviderConfig():
    def __init__(self, *, repository: str, access_token: typing.Optional[aws_cdk.core.SecretValue]=None, oauth_token: typing.Optional[aws_cdk.core.SecretValue]=None):
...
class SubDomain():
    def __init__(self, *, branch: "IBranch", prefix: typing.Optional[str]=None):
        """Sub domain settings.

        :param branch: The branch.
        :param prefix: The prefix. Default: - the branch name
...
__all__ = ["App", "AppProps", "AutoBranchCreation", "BasicAuth", "BasicAuthConfig", "BasicAuthProps", "Branch", "BranchOptions", "BranchProps", "CfnApp", "CfnAppProps", "CfnBranch", "CfnBranchProps", "CfnDomain", "CfnDomainProps", "CodeCommitSourceCodeProvider", "CodeCommitSourceCodeProviderProps", "CustomRule", "Domain", "DomainOptions", "DomainProps", "GitHubSourceCodeProvider", "GitHubSourceCodeProviderProps", "IApp", "IBranch", "ISourceCodeProvider", "RedirectStatus", "SourceCodeProviderConfig", "SubDomain", "__jsii_assembly__"]
