...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v1.12.0-alpha.1587141526+gfb5badf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v1.12.0-alpha.1587141526+gfb5badf`
                """)
            else:
                raise
