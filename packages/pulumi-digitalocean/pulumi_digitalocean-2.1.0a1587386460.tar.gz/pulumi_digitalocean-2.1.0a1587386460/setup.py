...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v2.1.0-alpha.1587386460+g5eb14a4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v2.1.0-alpha.1587386460+g5eb14a4`
                """)
            else:
                raise
