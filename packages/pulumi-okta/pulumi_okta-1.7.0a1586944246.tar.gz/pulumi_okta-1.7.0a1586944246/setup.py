...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.7.0-alpha.1586944246+g67aa31c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.7.0-alpha.1586944246+g67aa31c`
                """)
            else:
                raise
