...
class Domain(BaseAPI, domain_pb2_grpc.DomainServicer):
    ...
    def create(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data = domain_svc.create_domain(params)
    ...
    def update(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data = domain_svc.update_domain(params)
            return self.locator.get_info('DomainInfo', data)
    ...
    def delete(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            ...
            data = domain_svc.delete_domain(params)
    ...
    def enable(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data = domain_svc.enable_domain(params)
            return self.locator.get_info('DomainInfo', data)
    ...
    def disable(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data = domain_svc.disable_domain(params)
            return self.locator.get_info('DomainInfo', data)
    ...
    def get(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data = domain_svc.get_domain(params)
            return self.locator.get_info('DomainInfo', data)
    ...
    def list(self, request, context):
        ...
        with self.locator.get_service('DomainService', metadata) as domain_svc:
            data, total_count = domain_svc.list_domains(params)
