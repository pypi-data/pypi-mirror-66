...
class Estimator:
    ...
    def CRLBAndChiSquare(self, params, samples=None,roipos=None, constants=None):
        ...
        if samples is not None:
            ...
            assert np.array_equal(samples.shape, [len(params), *self.sampleshape])
    ...
    def Estimate(self, imgs, roipos=None, constants=None, initial=None):
        ...
        assert np.array_equal(imgs.shape, [numspots, *self.sampleshape])
