...
#%%   
class PSFConvSpotDetector:
    def __init__(self, psfstack, bgimg, minPhotons, maxFilterSizeXY, debugMode=False):
    ...
    def CreateNativeFactory(self,ctx):
        ...
        return SpotDetectorNativeFactory(
                m._ConvolutionSpotDetector_Configure(
                    self.bgimg, w, h, self.psfstack, roisize, depth,
                    self.maxFilterSizeXY, self.minPhotons, self.debugMode),
                m._SpotDetector_DestroyFactory)
...
#		const float* psfstack, int roisize, int depth, int maxFilterSizeXY, float minPhotons);

        self._ConvolutionSpotDetector_Configure = lib.ConvolutionSpotDetector_Configure
        self._ConvolutionSpotDetector_Configure.argtypes=[
        ...
        self._ConvolutionSpotDetector_Configure.restype = ctypes.c_void_p
