...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-apigatewayv2", "1.33.1", __name__, "aws-apigatewayv2@1.33.1.jsii.tgz")
...
class CfnIntegration(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-apigatewayv2.CfnIntegration"):
    ...
    class TlsConfigProperty():
        def __init__(self, *, server_name_to_verify: typing.Optional[str]=None):
            """
