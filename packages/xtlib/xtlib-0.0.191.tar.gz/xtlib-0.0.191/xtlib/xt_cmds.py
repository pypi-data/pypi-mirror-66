...
def main(cmd=None, new_start_time=None, capture_output=False, mini=False, raise_syntax_exception=True):
    ...
    if mini:
        ...
        show_commands = {
            ...
            "run": ["script", "script-args", "experiment", "hp-config", "max-runs", "nodes", "runs", "search-type"], 
            ...
            #"list_experiments": ["name"],
            "plot": ["runs", "col-list", "aggregate", "break-on", "cap-size", "error-bars", "group-by", "layout", 
                "legend-titles", "marker-shape", "marker-size", "max-runs", "max-traces", "plot-titles", "save-to", "show-legend",
                "smoothing-factor", "title", "x"],  
            "help": ["command", "about", "browse", "version"],
            "generate_help": ["dest-dir"],
            #"root": ["help", "console", "stack-trace"]
            }
