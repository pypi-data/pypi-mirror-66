...
class StoreBlobObjs():
    ...
    def _create_info_container_if_needed(self):
        ...
        if not self.provider.does_blob_exist(info_container, constants.STORAGE_INFO_FILE):
...
class BlobsObject():
    ...
    def _get_container_path_target(self, path):
        '''
        This help function is the first step in converting all of our _xxx (internal)
