...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cassandra", "1.33.1", __name__, "aws-cassandra@1.33.1.jsii.tgz")
...
class CfnKeyspaceProps():
    def __init__(self, *, keyspace_name: typing.Optional[str]=None):
...
class CfnTable(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cassandra.CfnTable"):
    ...
    class BillingModeProperty():
        def __init__(self, *, mode: str, provisioned_throughput: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnTable.ProvisionedThroughputProperty"]]]=None):
            """
    ...
    class ClusteringKeyColumnProperty():
        def __init__(self, *, column: typing.Union["CfnTable.ColumnProperty", aws_cdk.core.IResolvable], order_by: typing.Optional[str]=None):
            """
...
__all__ = ["CfnKeyspace", "CfnKeyspaceProps", "CfnTable", "CfnTableProps", "__jsii_assembly__"]
