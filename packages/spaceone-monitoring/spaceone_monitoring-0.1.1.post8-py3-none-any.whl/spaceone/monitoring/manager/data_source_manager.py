...
class DataSourceManager(BaseManager):
    ...
    def register_data_source(self, params):
        def _rollback(data_source_vo):
            _LOGGER.info(f'[register_data_source._rollback] '
                         f'Register data_source : {data_source_vo.name} '
    ...
    def get_data_source(self, data_source_id, domain_id):
        return self.data_source_model.get(data_source_id=data_source_id, domain_id=domain_id)
