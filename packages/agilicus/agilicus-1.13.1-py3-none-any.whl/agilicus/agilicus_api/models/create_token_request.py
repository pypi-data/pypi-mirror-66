...
class CreateTokenRequest(object):
    ...
    def __init__(self, sub=None, org=None, roles=None, audiences=None, time_validity=None, hosts=None, token_validity=None, session=None, local_vars_configuration=None):  # noqa: E501
