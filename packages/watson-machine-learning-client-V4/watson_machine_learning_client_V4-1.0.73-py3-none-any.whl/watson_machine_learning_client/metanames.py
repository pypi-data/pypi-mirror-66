...
from watson_machine_learning_client.utils.wml_client_error import WMLClientError
...
class DeploymentMetaNames(MetaNamesBase):
    ...
    ASSET = "asset"
    R_SHINY = "r_shiny"
    HYBRID_PIPELINE_HARDWARE_SPEC = "hybrid_pipeline_hardware_spec"
    ...
    _meta_props_definitions = [
        ...
        MetaProp('HYBRID_PIPELINE_HARDWARE_SPEC', HYBRID_PIPELINE_HARDWARE_SPEC, dict, example_value={}, required=False),
