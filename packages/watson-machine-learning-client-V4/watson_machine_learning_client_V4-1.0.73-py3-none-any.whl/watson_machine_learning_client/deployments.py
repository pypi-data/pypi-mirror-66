...
from watson_machine_learning_client.utils.wml_client_error import WMLClientError, MissingValue, NoVirtualDeploymentSupportedForICP
...
class Deployments(WMLResource):
    ...
    def create(self, artifact_uid=None, meta_props=None, rev_id=None, **kwargs):
            ...
            if not self._client.ICP_30:
                ...
                if self.ConfigurationMetaNames.HYBRID_PIPELINE_HARDWARE_SPEC in metaProps:
                    metaProps.pop(self.ConfigurationMetaNames.HYBRID_PIPELINE_HARDWARE_SPEC)
        ...
        for m in resources:
            ...
            if self._client.ICP_30:
                values.append((m[u'metadata'][u'guid'], state ,
                               m[u'metadata'][u'created_at'],m['entity']['deployment']['id']))
            else:
                values.append((m[u'metadata'][u'guid'], state,
    ...
    def create_job(self,deployment_id,meta_props):
        ...
        if self._client.ICP_30:
            ...
            if 'hybrid_pipeline_hardware_spec' in meta_props:
                payload.update({"hybrid_pipeline_hardware_spec": meta_props[self.ConfigurationMetaNames.HYBRID_PIPELINE_HARDWARE_SPEC]})
        else:
