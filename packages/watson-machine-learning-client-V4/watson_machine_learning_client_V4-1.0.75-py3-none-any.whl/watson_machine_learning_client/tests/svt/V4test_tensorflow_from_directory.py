...
class TestWMLClientWithTensorflow(unittest.TestCase):
    ...
    def test_05_create_deployment(self):
        ...
        deployment_details = self.client.deployments.create(artifact_uid=TestWMLClientWithTensorflow.model_uid,meta_props={self.client.deployments.ConfigurationMetaNames.NAME: "Test deployment"})
