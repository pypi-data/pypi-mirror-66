...
import requests
from watson_machine_learning_client.utils import SPACES_DETAILS_TYPE, INSTANCE_DETAILS_TYPE, MEMBER_DETAILS_TYPE,PKG_EXTN_DETAILS_TYPE, STR_TYPE, STR_TYPE_NAME, docstring_parameter, meta_props_str_conv, str_type_conv, get_file_from_cos
from watson_machine_learning_client.metanames import PkgExtnMetaNames
from watson_machine_learning_client.wml_resource import WMLResource
from watson_machine_learning_client.utils.wml_client_error import WMLClientError, ApiRequestFailure
import os,json
...
class PkgExtn(WMLResource):
    ...
    def store(self, meta_props, file_path):
        """
                ...
                **Example**
                 ...
                 >>>    client.package_extensions.ConfigurationMetaNames.TYPE: "conda_yml/pip_zip",
                 >>> }
    ...
    def list(self):
        ...
        pkg_extn_values = [
            (m[u'metadata'][u'name'],m[u'metadata'][u'asset_id'],m[u'entity'][u'package_extension'][u'type'],m[u'metadata'][u'created_at']) for
            m in asset_details]
