...
class Connections(WMLResource):
        ...
        try:
            if self._client.default_space_id is not None:
                new_el = {'metadata': {'id': response_data['metadata']['asset_id'],
                                       ...
                                       'last_access_time': response_data['metadata']['usage']['last_access_time']
                                       },
                          'entity': {
    ...
    def get_details(self, connection_id):
        ...
        if not self._client.ICP_30 and not self._client.ICP:
    ...
    ##For CP4D, check if either spce or project ID is set
        ...
        if not self._ICP and not self._client.ICP_30:
