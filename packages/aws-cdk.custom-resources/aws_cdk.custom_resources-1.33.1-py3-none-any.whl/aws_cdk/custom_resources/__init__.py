...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/custom-resources", "1.33.1", __name__, "custom-resources@1.33.1.jsii.tgz")
...
class AwsSdkCall():
    def __init__(self, *, action: str, service: str, api_version: typing.Optional[str]=None, ignore_error_codes_matching: typing.Optional[str]=None, output_path: typing.Optional[str]=None, parameters: typing.Any=None, physical_resource_id: typing.Optional["PhysicalResourceId"]=None, region: typing.Optional[str]=None):
        """An AWS SDK call.
...
class SdkCallsPolicyOptions():
    def __init__(self, *, resources: typing.List[str]):
...
__all__ = ["AwsCustomResource", "AwsCustomResourcePolicy", "AwsCustomResourceProps", "AwsSdkCall", "PhysicalResourceId", "Provider", "ProviderProps", "SdkCallsPolicyOptions", "__jsii_assembly__"]
