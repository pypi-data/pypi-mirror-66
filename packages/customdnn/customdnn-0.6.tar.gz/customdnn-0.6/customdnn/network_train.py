...
# User defined Dropout percentage
...
class TrainingDeepNetwork: 
    ...
    def run_nn_epochs(self,Z_all, A_all,param,cost_array,dZ_all,dW_all,Vdw,Vdb,nw_size,layer_nn,learning_rate,mini_batches,beta1,beta2,epoch_num,gradient,data_size,batch_size,drop_perc):
        ...
        for epoch in range(1,epoch_num+1):
            ...
            for num in range(0,num_batches):
                ...
                Z_all, A_all = self.forward_prop(param,x_min,nw_size,drop_perc)
                A_all['A'+str(0)]=x_min
    ...
    def train_network(self,x,y, learning_rate=.001, beta1=.9, beta2=.999,batch_size=32,network_size=3,gradient="Adam",epoch_num=1000 ):
        ...
        if (inp == "Y" or inp == "y"):
            ...
            cost_epoch_array,cost_array,auc_array,Z_all,A_all,dZ_all,dW_all,Vdw,Vdb, param = self.run_nn_epochs(Z_all, A_all,param,cost_array,dZ_all,dW_all,Vdw,Vdb,nw_size,layer_nn,learning_rate,mini_batches,beta1,beta2,epoch_num,gradient,data_size,batch_size,drop_perc)
