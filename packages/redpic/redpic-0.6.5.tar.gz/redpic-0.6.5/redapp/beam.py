...
def beam_tab(beam):
    ...
    select_current = Slider(start=0, end=5_000,
                            ...
                            title='Curent [A]')
    # Phase ellipse
    x_input = TextInput(value="0", title="X [m]:", width=60)
    y_input = TextInput(value="0", title="Y [m]:", width=60)
    z_input = TextInput(value="0", title="Z [m]:", width=60)

    px_input = TextInput(value="0", title="Px [MeV/c]:", width=60)
    py_input = TextInput(value="0", title="Py [MeV/c]:", width=60)
    pz_input = TextInput(value="0", title="Pz [MeV/c]:", width=60)

    x_off_input = TextInput(value="0", title="X_off:", width=60)
    y_off_input = TextInput(value="0", title="Y_off:", width=60)
