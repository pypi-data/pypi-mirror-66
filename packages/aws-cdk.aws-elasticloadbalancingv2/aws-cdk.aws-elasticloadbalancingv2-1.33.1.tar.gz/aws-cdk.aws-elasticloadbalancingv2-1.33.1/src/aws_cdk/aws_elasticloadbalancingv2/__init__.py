...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2", "1.33.1", __name__, "aws-elasticloadbalancingv2@1.33.1.jsii.tgz")
...
class AddRuleProps():
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None):
...
class AddApplicationTargetGroupsProps(AddRuleProps):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, target_groups: typing.List["IApplicationTargetGroup"]):
...
class BaseApplicationListenerRuleProps():
    def __init__(self, *, priority: jsii.Number, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None):
...
class AddFixedResponseProps(AddRuleProps, FixedResponse):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, status_code: str, content_type: typing.Optional["ContentType"]=None, message_body: typing.Optional[str]=None):
