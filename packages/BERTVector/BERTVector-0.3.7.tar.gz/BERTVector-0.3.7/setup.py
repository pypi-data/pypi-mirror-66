...
# 导入静态文件
file_data = [
    ("BERTVector/test/", ["BERTVector/test/test.txt", "BERTVector/test/test.pkl"]),
]
...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'BERTVector = BERTVector.BERTVector:main_cli',
            'bertvector_test = BERTVector.test.bertvector_test:bertvector_test',
            ]
        }
)
