...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.1.0-alpha.1586941913+g3fbe850'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.1.0-alpha.1586941913+g3fbe850`
                """)
            else:
                raise
