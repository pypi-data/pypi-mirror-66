...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.12.0-alpha.1586942928+gb6c9249'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.12.0-alpha.1586942928+gb6c9249`
                """)
            else:
                raise
