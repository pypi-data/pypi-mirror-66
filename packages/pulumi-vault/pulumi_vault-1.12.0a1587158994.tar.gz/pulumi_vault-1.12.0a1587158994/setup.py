...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.12.0-alpha.1587158994+ga5eb33e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.12.0-alpha.1587158994+ga5eb33e`
                """)
            else:
                raise
