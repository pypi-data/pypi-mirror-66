...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.1.0-alpha.1586941988+g0f312c1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.1.0-alpha.1586941988+g0f312c1`
                """)
            else:
                raise
