...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-rds", "1.33.1", __name__, "aws-rds@1.33.1.jsii.tgz")
...
class ParameterGroupFamily():
    def __init__(self, *, engine_major_version: str, parameter_group_family: str):
...
class ParameterGroupProps():
    def __init__(self, *, family: str, description: typing.Optional[str]=None, parameters: typing.Optional[typing.Mapping[str,str]]=None):
