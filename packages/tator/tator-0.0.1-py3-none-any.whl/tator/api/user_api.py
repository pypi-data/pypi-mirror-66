...
class UserApi(object):
    ...
    def list_current_user_ap_is(self, **kwargs):  # noqa: E501
        """list_current_user_ap_is  # noqa: E501

        Returns the current user.  This is the equivalent of a whoami() operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_current_user_ap_is(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_current_user_ap_is_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_current_user_ap_is_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_current_user_ap_is_with_http_info(self, **kwargs):  # noqa: E501
        """list_current_user_ap_is  # noqa: E501

        Returns the current user.  This is the equivalent of a whoami() operation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_current_user_ap_is_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_current_user_ap_is" % key
                )
            params[key] = val
        del params['kwargs']
