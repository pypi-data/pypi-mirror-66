...
class ProgressApi(object):
    ...
    def create_progress_api(self, project, **kwargs):  # noqa: E501
        """create_progress_api  # noqa: E501
        ...
        >>> thread = api.create_progress_api(project, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int project: A unique integer identifying a project. (required)
        :param list[Body39] body:
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.create_progress_api_with_http_info(project, **kwargs)  # noqa: E501
        else:
            (data) = self.create_progress_api_with_http_info(project, **kwargs)  # noqa: E501
            return data

    def create_progress_api_with_http_info(self, project, **kwargs):  # noqa: E501
        """create_progress_api  # noqa: E501

        Broadcast progress update.  Progress messages are sent in the web UI via WebSocket, and are displayed as progress bars associated with individual media files and as a summary in the webpage header. All members of a project can see progress bars from uploads and background jobs initiated by other users within the project. This endpoint accepts an array of messages, allowing for progress messages to be batched into a single request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_progress_api_with_http_info(project, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_progress_api" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('project' not in params or
            ...
            raise ValueError("Missing the required parameter `project` when calling `create_progress_api`")  # noqa: E501
