...
class AnalysisApi(object):
    ...
    def create_analysis(self, project, **kwargs):  # noqa: E501
        ...
        Define and list analyses for a project.  Analysis objects are used to display information about filtered media lists and/or annotations on the project detail page of the web UI. Currently only counting analysis is supported.  # noqa: E501
    ...
    def retrieve_analysis(self, project, **kwargs):  # noqa: E501
        """retrieve_analysis  # noqa: E501

        Define and list analyses for a project.  Analysis objects are used to display information about filtered media lists and/or annotations on the project detail page of the web UI. Currently only counting analysis is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_analysis(project, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.retrieve_analysis_with_http_info(project, **kwargs)  # noqa: E501
        else:
            (data) = self.retrieve_analysis_with_http_info(project, **kwargs)  # noqa: E501
            return data

    def retrieve_analysis_with_http_info(self, project, **kwargs):  # noqa: E501
        """retrieve_analysis  # noqa: E501

        Define and list analyses for a project.  Analysis objects are used to display information about filtered media lists and/or annotations on the project detail page of the web UI. Currently only counting analysis is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_analysis_with_http_info(project, async_req=True)
        >>> result = thread.get()
        ...
        if ('project' not in params or
                params['project'] is None):
            raise ValueError("Missing the required parameter `project` when calling `retrieve_analysis`")  # noqa: E501
