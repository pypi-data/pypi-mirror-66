...
class Body39(object):
    ...
    @property
    def job_type(self):
        """Gets the job_type of this Body39.  # noqa: E501

        Type of background job.  # noqa: E501

        :return: The job_type of this Body39.  # noqa: E501
        :rtype: str
        """
    ...
    def job_type(self, job_type):
        """Sets the job_type of this Body39.

        Type of background job.  # noqa: E501

        :param job_type: The job_type of this Body39.  # noqa: E501
        :type: str
        """
        if job_type is None:
    ...
    @swid.setter
    def swid(self, swid):
        """Sets the swid of this Body39.

        UUID generated for the service worker that is doing an upload. This field is required if the `job_type` is `upload`.  # noqa: E501

        :param swid: The swid of this Body39.  # noqa: E501
        :type: str
        """
    ...
    @property
    def state(self):
        """Gets the state of this Body39.  # noqa: E501

        State of the job.  # noqa: E501

        :return: The state of this Body39.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this Body39.

        State of the job.  # noqa: E501

        :param state: The state of this Body39.  # noqa: E501
        :type: str
        """
        if state is None:
    ...
    @property
    def message(self):
        """Gets the message of this Body39.  # noqa: E501

        Progress message. This should be short to fit in the UI.  # noqa: E501

        :return: The message of this Body39.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this Body39.

        Progress message. This should be short to fit in the UI.  # noqa: E501

        :param message: The message of this Body39.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def progress(self, progress):
        """Sets the progress of this Body39.

        Progress percent completion. This is used to display the progress bar associated with the job.  # noqa: E501

        :param progress: The progress of this Body39.  # noqa: E501
        :type: float
        """
        if progress is None:
    ...
    @property
    def sections(self):
        """Gets the sections of this Body39.  # noqa: E501
        ...
        :return: The sections of this Body39.  # noqa: E501
        :rtype: str
        """
    ...
    def sections(self, sections):
        """Sets the sections of this Body39.

        Comma separated string of media sections, one for each media ID that this job applies to. Required only for `job_type` of `algorithm`.  # noqa: E501

        :param sections: The sections of this Body39.  # noqa: E501
        :type: str
        """
    ...
    @property
    def media_ids(self):
        """Gets the media_ids of this Body39.  # noqa: E501
        ...
        :return: The media_ids of this Body39.  # noqa: E501
        :rtype: str
        """
    ...
    def media_ids(self, media_ids):
        """Sets the media_ids of this Body39.

        Comma separated string of media ids, one for each media that this job applies to. Required only for `job_type` of `algorithm`.  # noqa: E501

        :param media_ids: The media_ids of this Body39.  # noqa: E501
        :type: str
        """
