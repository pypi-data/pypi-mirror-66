...
class Body42(object):
    ...
    @property
    def gid(self):
        """Gets the gid of this Body42.  # noqa: E501
        ...
        :return: The gid of this Body42.  # noqa: E501
        :rtype: str
        """
        return self._gid
    ...
    @gid.setter
    def gid(self, gid):
        """Sets the gid of this Body42.

        UUID generated for the job group. This value is returned in the response of the `AlgorithmLaunch` and `Transcode` endpoints.  # noqa: E501

        :param gid: The gid of this Body42.  # noqa: E501
        :type: str
        """
        if gid is None:
    ...
    @property
    def uid(self):
        """Gets the uid of this Body42.  # noqa: E501
        ...
        :return: The uid of this Body42.  # noqa: E501
        :rtype: str
        """
        return self._uid
    ...
    @uid.setter
    def uid(self, uid):
        """Sets the uid of this Body42.

        UUID generated for the individual job. This value is returned in the response of the `AlgorithmLaunch` and `Transcode` endpoints.  # noqa: E501

        :param uid: The uid of this Body42.  # noqa: E501
        :type: str
        """
        if uid is None:
    ...
    @property
    def id(self):
        """Gets the id of this Body42.  # noqa: E501

        Unique integer identifying a media.  # noqa: E501

        :return: The id of this Body42.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this Body42.

        Unique integer identifying a media.  # noqa: E501

        :param id: The id of this Body42.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    def media_files(self, media_files):
        """Sets the media_files of this Body42.

        Object containing upload urls for the transcoded file and corresponding `VideoDefinition`.  # noqa: E501

        :param media_files: The media_files of this Body42.  # noqa: E501
        :type: list[str]
        """
