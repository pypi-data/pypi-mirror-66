...
def games_scrape(season):  
  """
  Returns a DataFrame of game information for a season.
  Game information includes the conferences of the participants, whether the game was played on a neutral field,
  and the final score, all of which are relevant for downstream data manipulation and training.
