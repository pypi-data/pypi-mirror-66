...
tot = pd.read_pickle(
  r'C:\Users\Visitor\AppData\Local\Programs\Python\Python38-32\cfbdata\cfb819_advseasondata.pkl')
train(2013,2018,tot,learn_rate = 0.00005,verbose=True)
model_testing.model_test(2019, tot)
