...
class CticErwinQasmSimulator(BaseQCticSimulator):
...
class CticErwinStatevectorSimulator(BaseQCticSimulator):
    """Backend that represents the CTIC Erwin simulation platform.
...
class CticErwinUnitarySimulator(BaseQCticSimulator):
    """Backend that represents the CTIC Erwin simulation platform.
