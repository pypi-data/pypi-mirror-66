...
class QCticProvider(BaseProvider):
    ...
    ENV_HOST = "ERWIN_HOST"
    ENV_USERNAME = "ERWIN_USERNAME"
    ENV_PASSWORD = "ERWIN_PASSWORD"
    ENV_TOKEN = "ERWIN_TOKEN"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._backends = [
            CticErwinQasmSimulator(provider=self),
            CticErwinStatevectorSimulator(provider=self),
            CticErwinUnitarySimulator(provider=self)
        ]
