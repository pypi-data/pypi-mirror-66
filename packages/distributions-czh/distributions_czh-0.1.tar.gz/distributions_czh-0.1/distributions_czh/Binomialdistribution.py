...
class Binomial(Distribution):
    ...
    def __init__(self, probability=0.5, number_trials=25):     
    ...
    def __add__(self, other):  
        ...
        added_prob = self.p
        added_n = self.n + other.n
        added = Binomial(probability=added_prob, number_trials=added_n)
        return added
