/*! For license information please see chunk.56ffdcd44c42dc89b90b.js.LICENSE */
...
</dom-module>`;document.head.appendChild(n.content);var r=i(319),o=i(316);class s extends(Object(o.a)(r.a)){static get is(){return"vaadin-date-picker-overlay"}}customElements.define(s.is,s);i(215),i(259),i(241),i(290);const l=a.a`<dom-module id="material-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        padding: 8px;
...
</dom-module>`;document.head.appendChild(l.content);i(336);const d=a.a`<dom-module id="material-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        font-family: var(--material-font-family);
...
//# sourceMappingURL=chunk.56ffdcd44c42dc89b90b.js.map