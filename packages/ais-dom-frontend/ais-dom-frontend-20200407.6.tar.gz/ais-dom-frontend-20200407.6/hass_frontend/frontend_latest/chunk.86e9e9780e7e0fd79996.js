/*! For license information please see chunk.86e9e9780e7e0fd79996.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[206],{196:function(e,t,i){"use strict";i.d(t,"a",function(){return n});var r=i(8),o=i(11);const n=Object(r.a)(e=>(class extends e{fire(e,t,i){return i=i||{},Object(o.a)(i.node||this,e,t,i)}}))},328:function(e,t,i){"use strict";i.d(t,"b",function(){return r}),i.d(t,"a",function(){return o});const r=async(e,t=!1,r=!1)=>{if(!e.parentNode)throw new Error("Cannot setup Leaflet map on disconnected element");const n=await i.e(173).then(i.t.bind(null,419,7));n.Icon.Default.imagePath="/static/images/leaflet/images/",r&&await i.e(174).then(i.t.bind(null,420,7));const s=n.map(e),a=document.createElement("link");return a.setAttribute("href","/static/images/leaflet/leaflet.css"),a.setAttribute("rel","stylesheet"),e.parentNode.appendChild(a),s.setView([52.3731339,4.8903147],13),o(n,t).addTo(s),[s,n]},o=(e,t)=>e.tileLayer(`https://{s}.basemaps.cartocdn.com/${t?"dark_all":"light_all"}/{z}/{x}/{y}${e.Browser.retina?"@2x.png":".png"}`,{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, &copy; <a href="https://carto.com/attributions">CARTO</a>',subdomains:"abcd",minZoom:0,maxZoom:20})},353:function(e,t,i){"use strict";i.d(t,"a",function(){return o});const r=e=>{const t=parseFloat(e);if(isNaN(t))throw new Error(`${e} is not a number`);return t};function o(e){if(!e)return null;try{if(e.endsWith("%"))return{w:100,h:r(e.substr(0,e.length-1))};const i=e.replace(":","x").split("x");return 0===i.length?null:1===i.length?{w:r(i[0]),h:1}:{w:r(i[0]),h:r(i[1])}}catch(t){}return null}},364:function(e,t,i){"use strict";i(3);var r=i(5),o=i(4),n=i(18);Object(r.a)({_template:o.a`
    <style>
      :host {
...
`,is:"iron-image",properties:{src:{type:String,value:""},alt:{type:String,value:null},crossorigin:{type:String,value:null},preventLoad:{type:Boolean,value:!1},sizing:{type:String,value:null,reflectToAttribute:!0},position:{type:String,value:"center"},preload:{type:Boolean,value:!1},placeholder:{type:String,value:null,observer:"_placeholderChanged"},fade:{type:Boolean,value:!1},loaded:{notify:!0,readOnly:!0,type:Boolean,value:!1},loading:{notify:!0,readOnly:!0,type:Boolean,value:!1},error:{notify:!0,readOnly:!0,type:Boolean,value:!1},width:{observer:"_widthChanged",type:Number,value:null},height:{observer:"_heightChanged",type:Number,value:null}},observers:["_transformChanged(sizing, position)","_loadStateObserver(src, preventLoad)"],created:function(){this._resolvedSrc=""},_imgOnLoad:function(){this.$.img.src===this._resolveSrc(this.src)&&(this._setLoading(!1),this._setLoaded(!0),this._setError(!1))},_imgOnError:function(){this.$.img.src===this._resolveSrc(this.src)&&(this.$.img.removeAttribute("src"),this.$.sizedImgDiv.style.backgroundImage="",this._setLoading(!1),this._setLoaded(!1),this._setError(!0))},_computePlaceholderHidden:function(){return!this.preload||!this.fade&&!this.loading&&this.loaded},_computePlaceholderClassName:function(){return this.preload&&this.fade&&!this.loading&&this.loaded?"faded-out":""},_computeImgDivHidden:function(){return!this.sizing},_computeImgDivARIAHidden:function(){return""===this.alt?"true":void 0},_computeImgDivARIALabel:function(){return null!==this.alt?this.alt:""===this.src?"":this._resolveSrc(this.src).replace(/[?|#].*/g,"").split("/").pop()},_computeImgHidden:function(){return!!this.sizing},_widthChanged:function(){this.style.width=isNaN(this.width)?this.width:this.width+"px"},_heightChanged:function(){this.style.height=isNaN(this.height)?this.height:this.height+"px"},_loadStateObserver:function(e,t){var i=this._resolveSrc(e);i!==this._resolvedSrc&&(this._resolvedSrc="",this.$.img.removeAttribute("src"),this.$.sizedImgDiv.style.backgroundImage="",""===e||t?(this._setLoading(!1),this._setLoaded(!1),this._setError(!1)):(this._resolvedSrc=i,this.$.img.src=this._resolvedSrc,this.$.sizedImgDiv.style.backgroundImage='url("'+this._resolvedSrc+'")',this._setLoading(!0),this._setLoaded(!1),this._setError(!1)))},_placeholderChanged:function(){this.$.placeholder.style.backgroundImage=this.placeholder?'url("'+this.placeholder+'")':""},_transformChanged:function(){var e=this.$.sizedImgDiv.style,t=this.$.placeholder.style;e.backgroundSize=t.backgroundSize=this.sizing,e.backgroundPosition=t.backgroundPosition=this.sizing?this.position:"",e.backgroundRepeat=t.backgroundRepeat=this.sizing?"no-repeat":""},_resolveSrc:function(e){var t=Object(n.c)(e,this.$.baseURIAnchor.href);return t.length>=2&&"/"===t[0]&&"/"!==t[1]&&(t=(location.origin||location.protocol+"//"+location.host)+t),t}})},435:function(e,t,i){"use strict";i(364);var r=i(4),o=i(32),n=i(196);customElements.define("ha-entity-marker",class extends(Object(n.a)(o.a)){static get template(){return r.a`
    ...
    `:r.f``}},{kind:"method",key:"shouldUpdate",value:function(e){if(!e.has("hass")||e.size>1)return!0;const t=e.get("hass");if(!t||!this._configEntities)return!0;for(const i of this._configEntities)if(t.states[i.entity]!==this.hass.states[i.entity])return!0;return!1}},{kind:"method",key:"firstUpdated",value:function(e){b(k(f.prototype),"firstUpdated",this).call(this,e),this.loadMap();const t=this.shadowRoot.getElementById("root");if(!this._config||this.isPanel||!t)return;if(this._connected&&this._attachObserver(),!this._config.aspect_ratio)return void(t.style.paddingBottom="100%");const i=Object(l.a)(this._config.aspect_ratio);t.style.paddingBottom=i&&i.w>0&&i.h>0?`${(100*i.h/i.w).toFixed(2)}%`:t.style.paddingBottom="100%"}},{kind:"method",key:"updated",value:function(e){var t;if((e.has("hass")||e.has("_history"))&&(this._drawEntities(),this._fitMap()),e.has("_config")&&void 0!==e.get("_config")&&this.updateMap(e.get("_config")),this._config.hours_to_show&&(null===(t=this._configEntities)||void 0===t?void 0:t.length)){const t=6e4;e.has("_config")?this._getHistory():Date.now()-this._date.getTime()>=t&&this._getHistory()}}},{kind:"get",key:"_mapEl",value:function(){return this.shadowRoot.getElementById("map")}},{kind:"method",key:"loadMap",value:async function(){[this._leafletMap,this.Leaflet]=await Object(o.b)(this._mapEl,void 0!==this._config&&!0===this._config.dark_mode),this._drawEntities(),this._leafletMap.invalidateSize(),this._fitMap()}},{kind:"method",key:"updateMap",value:function(e){const t=this._leafletMap,i=this._config,r=this.Leaflet;t&&i&&r&&(i.dark_mode!==e.dark_mode&&Object(o.a)(r,!0===i.dark_mode).addTo(t),i.entities===e.entities&&i.geo_location_sources===e.geo_location_sources||this._drawEntities(),t.invalidateSize(),this._fitMap())}},{kind:"method",key:"_fitMap",value:function(){if(!(this._leafletMap&&this.Leaflet&&this._config&&this.hass))return;const e=this._config.default_zoom;if(0===this._mapItems.length)return void this._leafletMap.setView(new this.Leaflet.LatLng(this.hass.config.latitude,this.hass.config.longitude),e||14);const t=this.Leaflet.featureGroup(this._mapItems).getBounds();this._leafletMap.fitBounds(t.pad(.5)),e&&this._leafletMap.getZoom()>e&&this._leafletMap.setZoom(e)}},{kind:"method",key:"_getColor",value:function(e){let t;return this._colorDict[e]?t=this._colorDict[e]:(t=this._colors[this._colorIndex],this._colorIndex=(this._colorIndex+1)%this._colors.length,this._colorDict[e]=t),t}},{kind:"method",key:"_drawEntities",value:function(){const e=this.hass,t=this._leafletMap,i=this._config,r=this.Leaflet;if(!(e&&t&&i&&r))return;this._mapItems&&this._mapItems.forEach(e=>e.remove());const o=this._mapItems=[];this._mapZones&&this._mapZones.forEach(e=>e.remove());const a=this._mapZones=[];this._mapPaths&&this._mapPaths.forEach(e=>e.remove());const l=this._mapPaths=[],d=this._configEntities.concat();if(i.geo_location_sources){const t=i.geo_location_sources.includes("all");for(const r of Object.keys(e.states)){const o=e.states[r];"geo_location"===Object(c.a)(r)&&(t||i.geo_location_sources.includes(o.attributes.source))&&d.push({entity:r})}}if(this._config.hours_to_show&&this._history)for(const n of this._history){if((null==n?void 0:n.length)<=1)continue;const e=n[0].entity_id,t=n.reduce((e,t)=>{const i=t.attributes.latitude,r=t.attributes.longitude;return i&&r&&e.push([i,r]),e},[]);for(let i=0;i<t.length-1;i++){const o=.2+i*(.8/(t.length-2));l.push(r.circleMarker(t[i],{radius:3,color:this._getColor(e),opacity:o,interactive:!1}));const n=[t[i],t[i+1]];l.push(r.polyline(n,{color:this._getColor(e),opacity:o,interactive:!1}))}}for(const c of d){const t=c.entity,i=e.states[t];if(!i)continue;const l=Object(s.a)(i),{latitude:d,longitude:h,passive:u,icon:p,radius:f,entity_picture:m,gps_accuracy:g}=i.attributes;if(!d||!h)continue;if("zone"===Object(n.a)(i)){if(u)continue;let e="";if(p){const t=document.createElement("ha-icon");t.setAttribute("icon",p),e=t.outerHTML}else{const t=document.createElement("span");t.innerHTML=l,e=t.outerHTML}a.push(r.marker([d,h],{icon:r.divIcon({html:e,iconSize:[24,24],className:!0===this._config.dark_mode?"dark":"light"}),interactive:!1,title:l})),a.push(r.circle([d,h],{interactive:!1,color:"#FF9800",radius:f}));continue}const y=l.split(" ").map(e=>e[0]).join("").substr(0,3);o.push(r.marker([d,h],{icon:r.divIcon({html:`\n              <ha-entity-marker\n                entity-id="${t}"\n                entity-name="${y}"\n                entity-picture="${m||""}"\n                entity-color="${this._getColor(t)}"\n              ></ha-entity-marker>\n            `,iconSize:[48,48],className:""}),title:Object(s.a)(i)})),g&&o.push(r.circle([d,h],{interactive:!1,color:this._getColor(t),radius:g}))}this._mapItems.forEach(e=>t.addLayer(e)),this._mapZones.forEach(e=>t.addLayer(e)),this._mapPaths.forEach(e=>t.addLayer(e))}},{kind:"method",key:"_attachObserver",value:function(){"function"==typeof ResizeObserver?(this._resizeObserver=new ResizeObserver(()=>this._debouncedResizeListener()),this._resizeObserver.observe(this._mapEl)):window.addEventListener("resize",this._debouncedResizeListener)}},{kind:"method",key:"_getHistory",value:async function(){if(this._date=new Date,!this._configEntities)return;const e=this._configEntities.map(e=>e.entity).join(","),t=new Date,i=new Date;i.setHours(t.getHours()-this._config.hours_to_show);const r=await Object(p.c)(this.hass,e,i,t,!1,!1);r.length<1||(this._history=r)}},{kind:"method",key:"_cleanupHistory",value:function(){if(this._history)if(this._config.hours_to_show<=0)this._history=void 0;else{var e;const t=null===(e=this._configEntities)||void 0===e?void 0:e.map(e=>e.entity);this._history=this._history.reduce((e,i)=>{const r=i[0].entity_id;return(null==t?void 0:t.includes(r))&&e.push(i),e},[])}}},{kind:"get",static:!0,key:"styles",value:function(){return r.c`
    ...
    `}}]}},r.a)}}]);
//# sourceMappingURL=chunk.86e9e9780e7e0fd79996.js.map