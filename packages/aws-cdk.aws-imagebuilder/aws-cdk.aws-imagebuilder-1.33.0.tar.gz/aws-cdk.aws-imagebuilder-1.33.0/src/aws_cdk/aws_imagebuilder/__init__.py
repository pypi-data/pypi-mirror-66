...
class CfnComponentProps():
    def __init__(self, *, name: str, platform: str, version: str, change_description: typing.Optional[str]=None, data: typing.Optional[str]=None, description: typing.Optional[str]=None, kms_key_id: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, uri: typing.Optional[str]=None) -> None:
...
class CfnDistributionConfiguration(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnDistributionConfiguration"):
    ...
    class DistributionProperty():
        def __init__(self, *, ami_distribution_configuration: typing.Any=None, license_configuration_arns: typing.Optional[typing.List[str]]=None, region: typing.Optional[str]=None) -> None:
            """
...
class CfnDistributionConfigurationProps():
    def __init__(self, *, distributions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnDistributionConfiguration.DistributionProperty", aws_cdk.core.IResolvable]]], name: str, description: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str, str]]=None) -> None:
...
class CfnImagePipeline(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnImagePipeline"):
    ...
    class ImageTestsConfigurationProperty():
        def __init__(self, *, image_tests_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, timeout_minutes: typing.Optional[jsii.Number]=None) -> None:
            """
    ...
    class ScheduleProperty():
        def __init__(self, *, pipeline_execution_start_condition: typing.Optional[str]=None, schedule_expression: typing.Optional[str]=None) -> None:
            """
...
class CfnImageRecipe(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipe"):
    ...
    class EbsInstanceBlockDeviceSpecificationProperty():
        def __init__(self, *, delete_on_termination: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, encrypted: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, iops: typing.Optional[jsii.Number]=None, kms_key_id: typing.Optional[str]=None, snapshot_id: typing.Optional[str]=None, volume_size: typing.Optional[jsii.Number]=None, volume_type: typing.Optional[str]=None) -> None:
            """
    ...
    class InstanceBlockDeviceMappingProperty():
        def __init__(self, *, device_name: typing.Optional[str]=None, ebs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty"]]]=None, no_device: typing.Optional[str]=None, virtual_name: typing.Optional[str]=None) -> None:
            """
...
class CfnInfrastructureConfiguration(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnInfrastructureConfiguration"):
    ...
    class LoggingProperty():
        def __init__(self, *, s3_logs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnInfrastructureConfiguration.S3LogsProperty"]]]=None) -> None:
            """
    ...
    class S3LogsProperty():
        def __init__(self, *, s3_bucket_name: typing.Optional[str]=None, s3_key_prefix: typing.Optional[str]=None) -> None:
            """
