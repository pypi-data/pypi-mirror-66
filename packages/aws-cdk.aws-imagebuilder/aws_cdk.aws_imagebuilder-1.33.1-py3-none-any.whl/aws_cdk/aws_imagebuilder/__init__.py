...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-imagebuilder", "1.33.1", __name__, "aws-imagebuilder@1.33.1.jsii.tgz")


@jsii.implements(aws_cdk.core.IInspectable)
class CfnComponent(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnComponent"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, name: str, platform: str, version: str, change_description: typing.Optional[str]=None, data: typing.Optional[str]=None, description: typing.Optional[str]=None, kms_key_id: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None, uri: typing.Optional[str]=None) -> None:
        ...
        """
        props = CfnComponentProps(name=name, platform=platform, version=version, change_description=change_description, data=data, description=description, kms_key_id=kms_key_id, tags=tags, uri=uri)
    ...
    def change_description(self, value: typing.Optional[str]):
    ...
    @data.setter
    def data(self, value: typing.Optional[str]):
    ...
    @uri.setter
    def uri(self, value: typing.Optional[str]):
        jsii.set(self, "uri", value)


@jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnComponentProps", jsii_struct_bases=[], name_mapping={'name': 'name', 'platform': 'platform', 'version': 'version', 'change_description': 'changeDescription', 'data': 'data', 'description': 'description', 'kms_key_id': 'kmsKeyId', 'tags': 'tags', 'uri': 'uri'})
class CfnComponentProps():
    def __init__(self, *, name: str, platform: str, version: str, change_description: typing.Optional[str]=None, data: typing.Optional[str]=None, description: typing.Optional[str]=None, kms_key_id: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None, uri: typing.Optional[str]=None):
        ...
        if change_description is not None: self._values["change_description"] = change_description
    ...
    def __repr__(self) -> str:
        return 'CfnComponentProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnDistributionConfiguration(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnDistributionConfiguration"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, distributions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["DistributionProperty", aws_cdk.core.IResolvable]]], name: str, description: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None) -> None:
        ...
        """
        props = CfnDistributionConfigurationProps(distributions=distributions, name=name, description=description, tags=tags)
    ...
    def distributions(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["DistributionProperty", aws_cdk.core.IResolvable]]]:
    ...
    def distributions(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["DistributionProperty", aws_cdk.core.IResolvable]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnDistributionConfiguration.DistributionProperty", jsii_struct_bases=[], name_mapping={'ami_distribution_configuration': 'amiDistributionConfiguration', 'license_configuration_arns': 'licenseConfigurationArns', 'region': 'region'})
    class DistributionProperty():
        def __init__(self, *, ami_distribution_configuration: typing.Any=None, license_configuration_arns: typing.Optional[typing.List[str]]=None, region: typing.Optional[str]=None):
            """
            ...
            if ami_distribution_configuration is not None: self._values["ami_distribution_configuration"] = ami_distribution_configuration
            if license_configuration_arns is not None: self._values["license_configuration_arns"] = license_configuration_arns
        ...
        def __repr__(self) -> str:
            return 'DistributionProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnDistributionConfigurationProps", jsii_struct_bases=[], name_mapping={'distributions': 'distributions', 'name': 'name', 'description': 'description', 'tags': 'tags'})
class CfnDistributionConfigurationProps():
    def __init__(self, *, distributions: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnDistributionConfiguration.DistributionProperty", aws_cdk.core.IResolvable]]], name: str, description: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None):
    ...
    @builtins.property
    def distributions(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnDistributionConfiguration.DistributionProperty", aws_cdk.core.IResolvable]]]:
        """``AWS::ImageBuilder::DistributionConfiguration.Distributions``.
    ...
    def __repr__(self) -> str:
        return 'CfnDistributionConfigurationProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnImagePipeline(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnImagePipeline"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, image_recipe_arn: str, infrastructure_configuration_arn: str, name: str, description: typing.Optional[str]=None, distribution_configuration_arn: typing.Optional[str]=None, image_tests_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ImageTestsConfigurationProperty"]]]=None, schedule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ScheduleProperty"]]]=None, status: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None) -> None:
        ...
        """
        props = CfnImagePipelineProps(image_recipe_arn=image_recipe_arn, infrastructure_configuration_arn=infrastructure_configuration_arn, name=name, description=description, distribution_configuration_arn=distribution_configuration_arn, image_tests_configuration=image_tests_configuration, schedule=schedule, status=status, tags=tags)
    ...
    def image_recipe_arn(self, value: str):
    ...
    def infrastructure_configuration_arn(self, value: str):
    ...
    def distribution_configuration_arn(self, value: typing.Optional[str]):
        jsii.set(self, "distributionConfigurationArn", value)

    @builtins.property
    @jsii.member(jsii_name="imageTestsConfiguration")
    def image_tests_configuration(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ImageTestsConfigurationProperty"]]]:
    ...
    def image_tests_configuration(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["ImageTestsConfigurationProperty"]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImagePipeline.ImageTestsConfigurationProperty", jsii_struct_bases=[], name_mapping={'image_tests_enabled': 'imageTestsEnabled', 'timeout_minutes': 'timeoutMinutes'})
    class ImageTestsConfigurationProperty():
        def __init__(self, *, image_tests_enabled: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None, timeout_minutes: typing.Optional[jsii.Number]=None):
            """
            ...
            if image_tests_enabled is not None: self._values["image_tests_enabled"] = image_tests_enabled
            if timeout_minutes is not None: self._values["timeout_minutes"] = timeout_minutes

        @builtins.property
        def image_tests_enabled(self) -> typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]:
        ...
        def __repr__(self) -> str:
            return 'ImageTestsConfigurationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImagePipeline.ScheduleProperty", jsii_struct_bases=[], name_mapping={'pipeline_execution_start_condition': 'pipelineExecutionStartCondition', 'schedule_expression': 'scheduleExpression'})
    class ScheduleProperty():
        def __init__(self, *, pipeline_execution_start_condition: typing.Optional[str]=None, schedule_expression: typing.Optional[str]=None):
            """
            ...
            if pipeline_execution_start_condition is not None: self._values["pipeline_execution_start_condition"] = pipeline_execution_start_condition
...
@jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImagePipelineProps", jsii_struct_bases=[], name_mapping={'image_recipe_arn': 'imageRecipeArn', 'infrastructure_configuration_arn': 'infrastructureConfigurationArn', 'name': 'name', 'description': 'description', 'distribution_configuration_arn': 'distributionConfigurationArn', 'image_tests_configuration': 'imageTestsConfiguration', 'schedule': 'schedule', 'status': 'status', 'tags': 'tags'})
class CfnImagePipelineProps():
    def __init__(self, *, image_recipe_arn: str, infrastructure_configuration_arn: str, name: str, description: typing.Optional[str]=None, distribution_configuration_arn: typing.Optional[str]=None, image_tests_configuration: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImagePipeline.ImageTestsConfigurationProperty"]]]=None, schedule: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImagePipeline.ScheduleProperty"]]]=None, status: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None):
        ...
        if description is not None: self._values["description"] = description
        if distribution_configuration_arn is not None: self._values["distribution_configuration_arn"] = distribution_configuration_arn
        if image_tests_configuration is not None: self._values["image_tests_configuration"] = image_tests_configuration
    ...
    @builtins.property
    def image_tests_configuration(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImagePipeline.ImageTestsConfigurationProperty"]]]:
        """``AWS::ImageBuilder::ImagePipeline.ImageTestsConfiguration``.
    ...
    @builtins.property
    def schedule(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImagePipeline.ScheduleProperty"]]]:
        """``AWS::ImageBuilder::ImagePipeline.Schedule``.
    ...
    def __repr__(self) -> str:
        return 'CfnImagePipelineProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnImageRecipe(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipe"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, components: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ComponentConfigurationProperty"]]], name: str, parent_image: str, version: str, block_device_mappings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "InstanceBlockDeviceMappingProperty"]]]]]=None, description: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None) -> None:
        ...
        """
        props = CfnImageRecipeProps(components=components, name=name, parent_image=parent_image, version=version, block_device_mappings=block_device_mappings, description=description, tags=tags)
    ...
    def components(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ComponentConfigurationProperty"]]]:
    ...
    @components.setter
    def components(self, value: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "ComponentConfigurationProperty"]]]):
    ...
    @parent_image.setter
    def parent_image(self, value: str):
    ...
    def block_device_mappings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "InstanceBlockDeviceMappingProperty"]]]]]:
    ...
    def block_device_mappings(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "InstanceBlockDeviceMappingProperty"]]]]]):
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipe.ComponentConfigurationProperty", jsii_struct_bases=[], name_mapping={'component_arn': 'componentArn'})
    class ComponentConfigurationProperty():
        def __init__(self, *, component_arn: typing.Optional[str]=None):
            """
            ...
            if component_arn is not None: self._values["component_arn"] = component_arn
        ...
        def __repr__(self) -> str:
            return 'ComponentConfigurationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty", jsii_struct_bases=[], name_mapping={'delete_on_termination': 'deleteOnTermination', 'encrypted': 'encrypted', 'iops': 'iops', 'kms_key_id': 'kmsKeyId', 'snapshot_id': 'snapshotId', 'volume_size': 'volumeSize', 'volume_type': 'volumeType'})
    class EbsInstanceBlockDeviceSpecificationProperty():
        ...
        def __repr__(self) -> str:
            return 'EbsInstanceBlockDeviceSpecificationProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipe.InstanceBlockDeviceMappingProperty", jsii_struct_bases=[], name_mapping={'device_name': 'deviceName', 'ebs': 'ebs', 'no_device': 'noDevice', 'virtual_name': 'virtualName'})
    class InstanceBlockDeviceMappingProperty():
        def __init__(self, *, device_name: typing.Optional[str]=None, ebs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty"]]]=None, no_device: typing.Optional[str]=None, virtual_name: typing.Optional[str]=None):
            """
        ...
        @builtins.property
        def ebs(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImageRecipe.EbsInstanceBlockDeviceSpecificationProperty"]]]:
        ...
        def __repr__(self) -> str:
            return 'InstanceBlockDeviceMappingProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnImageRecipeProps", jsii_struct_bases=[], name_mapping={'components': 'components', 'name': 'name', 'parent_image': 'parentImage', 'version': 'version', 'block_device_mappings': 'blockDeviceMappings', 'description': 'description', 'tags': 'tags'})
class CfnImageRecipeProps():
    def __init__(self, *, components: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnImageRecipe.ComponentConfigurationProperty"]]], name: str, parent_image: str, version: str, block_device_mappings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnImageRecipe.InstanceBlockDeviceMappingProperty"]]]]]=None, description: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None):
    ...
    @builtins.property
    def components(self) -> typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnImageRecipe.ComponentConfigurationProperty"]]]:
        """``AWS::ImageBuilder::ImageRecipe.Components``.
    ...
    @builtins.property
    def block_device_mappings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional[typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnImageRecipe.InstanceBlockDeviceMappingProperty"]]]]]:
        """``AWS::ImageBuilder::ImageRecipe.BlockDeviceMappings``.
    ...
    def __repr__(self) -> str:
        return 'CfnImageRecipeProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnInfrastructureConfiguration(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnInfrastructureConfiguration"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, instance_profile_name: str, name: str, description: typing.Optional[str]=None, instance_types: typing.Optional[typing.List[str]]=None, key_pair: typing.Optional[str]=None, logging: typing.Any=None, security_group_ids: typing.Optional[typing.List[str]]=None, sns_topic_arn: typing.Optional[str]=None, subnet_id: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None, terminate_instance_on_failure: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
        ...
        """
        props = CfnInfrastructureConfigurationProps(instance_profile_name=instance_profile_name, name=name, description=description, instance_types=instance_types, key_pair=key_pair, logging=logging, security_group_ids=security_group_ids, sns_topic_arn=sns_topic_arn, subnet_id=subnet_id, tags=tags, terminate_instance_on_failure=terminate_instance_on_failure)
    ...
    @logging.setter
    def logging(self, value: typing.Any):
    ...
    def terminate_instance_on_failure(self) -> typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]:
    ...
    def terminate_instance_on_failure(self, value: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]):
        jsii.set(self, "terminateInstanceOnFailure", value)

    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnInfrastructureConfiguration.LoggingProperty", jsii_struct_bases=[], name_mapping={'s3_logs': 's3Logs'})
    class LoggingProperty():
        def __init__(self, *, s3_logs: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnInfrastructureConfiguration.S3LogsProperty"]]]=None):
            """
        ...
        @builtins.property
        def s3_logs(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnInfrastructureConfiguration.S3LogsProperty"]]]:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnInfrastructureConfiguration.S3LogsProperty", jsii_struct_bases=[], name_mapping={'s3_bucket_name': 's3BucketName', 's3_key_prefix': 's3KeyPrefix'})
    class S3LogsProperty():
        def __init__(self, *, s3_bucket_name: typing.Optional[str]=None, s3_key_prefix: typing.Optional[str]=None):
            """
        ...
        def __repr__(self) -> str:
            return 'S3LogsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-imagebuilder.CfnInfrastructureConfigurationProps", jsii_struct_bases=[], name_mapping={'instance_profile_name': 'instanceProfileName', 'name': 'name', 'description': 'description', 'instance_types': 'instanceTypes', 'key_pair': 'keyPair', 'logging': 'logging', 'security_group_ids': 'securityGroupIds', 'sns_topic_arn': 'snsTopicArn', 'subnet_id': 'subnetId', 'tags': 'tags', 'terminate_instance_on_failure': 'terminateInstanceOnFailure'})
class CfnInfrastructureConfigurationProps():
    def __init__(self, *, instance_profile_name: str, name: str, description: typing.Optional[str]=None, instance_types: typing.Optional[typing.List[str]]=None, key_pair: typing.Optional[str]=None, logging: typing.Any=None, security_group_ids: typing.Optional[typing.List[str]]=None, sns_topic_arn: typing.Optional[str]=None, subnet_id: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None, terminate_instance_on_failure: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None):
        ...
        if tags is not None: self._values["tags"] = tags
        if terminate_instance_on_failure is not None: self._values["terminate_instance_on_failure"] = terminate_instance_on_failure
    ...
    def __repr__(self) -> str:
        return 'CfnInfrastructureConfigurationProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


__all__ = ["CfnComponent", "CfnComponentProps", "CfnDistributionConfiguration", "CfnDistributionConfigurationProps", "CfnImagePipeline", "CfnImagePipelineProps", "CfnImageRecipe", "CfnImageRecipeProps", "CfnInfrastructureConfiguration", "CfnInfrastructureConfigurationProps", "__jsii_assembly__"]
