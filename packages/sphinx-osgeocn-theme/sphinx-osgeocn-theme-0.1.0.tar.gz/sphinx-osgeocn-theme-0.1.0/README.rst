=============================================================
Bootstrap v4 HTML Theme of Sphinx for OSGeo China Chapter
=============================================================

Based on `sphinxbootstrap4theme https://github.com/myyasuda/sphinxbootstrap4theme`_ .
Many thanks.
...
.. code-block:: bat
   ...
   pip install sphinx-osgeocn-theme
...
.. code-block:: python
   ...
   import sphinx-osgeocn-theme

   html_theme = 'sphinx-osgeocn-theme'
   html_theme_path = [sphinx-osgeocn-theme.get_path()]
