...
_NETWORKPROTOPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='payloadType',
            full_name='optilab.optnet.NetworkProtoPacket.payloadType',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='payload',
            full_name='optilab.optnet.NetworkProtoPacket.payload',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_POINTTOPOINTPROTOPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='packetType',
            full_name='optilab.optnet.PointToPointProtoPacket.packetType',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='packetId',
            full_name='optilab.optnet.PointToPointProtoPacket.packetId',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='payload',
            full_name='optilab.optnet.PointToPointProtoPacket.payload',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='sourceRoot',
            full_name='optilab.optnet.PointToPointProtoPacket.sourceRoot',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='packetTag',
            full_name='optilab.optnet.PointToPointProtoPacket.packetTag',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_BROADCASTPROTOPACKET_PROTONETWORKADDRESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='sendAddr',
            full_name='optilab.optnet.BroadcastProtoPacket.ProtoNetworkAddress.sendAddr',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='recvAddr',
            full_name='optilab.optnet.BroadcastProtoPacket.ProtoNetworkAddress.recvAddr',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_BROADCASTPROTOPACKET_NETWORKMAPENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='optilab.optnet.BroadcastProtoPacket.NetworkMapEntry.key',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='optilab.optnet.BroadcastProtoPacket.NetworkMapEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_BROADCASTPROTOPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='packetType',
            full_name='optilab.optnet.BroadcastProtoPacket.packetType',
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='payload',
            full_name='optilab.optnet.BroadcastProtoPacket.payload',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='networkMap',
            full_name='optilab.optnet.BroadcastProtoPacket.networkMap',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='sourceAddr',
            full_name='optilab.optnet.BroadcastProtoPacket.sourceAddr',
            index=3,
            number=4,
            type=12,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _BROADCASTPROTOPACKET_PROTONETWORKADDRESS,
        _BROADCASTPROTOPACKET_NETWORKMAPENTRY,
    ],
    enum_types=[
...
_BROADCASTPROTOPACKET_NETWORKMAPENTRY.fields_by_name[
    'value'].message_type = _BROADCASTPROTOPACKET_PROTONETWORKADDRESS
