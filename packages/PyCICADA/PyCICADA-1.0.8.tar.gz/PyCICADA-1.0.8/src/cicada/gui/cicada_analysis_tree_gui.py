...
class AnalysisTreeApp(QWidget):
    ...
    def create_tree_model(self):
        ...
        analysis_class_names = ["CicadaHubsAnalysis", "CicadaConnectivityGraph", "CicadaConnectivityGraphsDescription",
                                "CicadaPsthAnalysis", "CicadaCellsMapAnalysis",
                                "CicadaSplittingCellsAnalysis",
                                ...
                                "CicadaTransientDurationAnalysis", "CicadaTransientAmplitudeAnalysis",
                                "CicadaSceDescritpionAnalysis",
                                "CicadaCellAssVsIntervalsAnalysis", "CicadaTransientsVsIntervalsAnalysis",
                                "CicadaActivityIntervalsRatioAnalysis", "CicadaTripleSeqPlotAnalysis",
                                "CicadaBehaviorQuantificationAnalysis"]
        analysis_instances = []
