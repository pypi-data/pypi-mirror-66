...
##############################################################################
"""
$Id: widget.py 5009 2020-04-21 03:07:49Z roger.ineichen $
"""
...
class Select2WidgetMixin(object):
    ...
    def formatErrorLoading(self):
        msg = zope.i18n.translate(_("The results could not be loaded."),
            context=self.request)
        return 'function() {return "%s";}' % msg

    @property
    def formatInputTooLong(self):
        msg = zope.i18n.translate(_(
    ...
    def formatNoResults(self):
        msg = zope.i18n.translate(_("No results found"),
            context=self.request)
        return 'function() {return "%s";}' % msg
    ...
    def formatRemoveAllItems(self):
        msg = zope.i18n.translate(_('Remove all items'),
            context=self.request)
        return 'function() {return "%s";}' % msg
    ...
    def getPlaceholder(self):
        ...
        if placeholder is not None:
            return zope.i18n.translate(placeholder,
                context=self.request)
        ...
        for _, term in enumerate(self.terms):
            if self.isGroupTerm(term):
                if gName is not None and subTerms:
                    ...
                    subTerms = []
                # set as next gName
                gName = zope.i18n.translate(term.title,
