...
from xjlibrary.mLog.mylogger import MLogger
...
class Sqlite3Utiles(object):
    ...
    def Sqlite3DBConnectFromFilePath(self, dbfilepath, encoding="gbk"):
        """
        ...
        sqlite3_moudle = Sqlite3Builder().build_file_path(dbfilepath).get_moudle()
