 ...
 */
    ...
    if (PyModule_AddObject(__pyx_m, __pyx_k_logging, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
    #else
 ...
 */
    ...
    #if CYTHON_COMPILING_IN_LIMITED_API
    __Pyx_INCREF(__pyx_t_1);
    if (PyModule_AddObject(__pyx_m, __pyx_k_logger, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
    #else
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5pyboy_6logger_1log_level, 0, __pyx_n_s_log_level, NULL, __pyx_n_s_pyboy_logger, __pyx_t_1, ((PyObject *)__pyx_codeobj__2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    #else
    ...
    #if CYTHON_COMPILING_IN_LIMITED_API
    __Pyx_INCREF(__pyx_t_2);
    if (PyModule_AddObject(__pyx_m, __pyx_k_log_level, __pyx_t_2) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
    #else
