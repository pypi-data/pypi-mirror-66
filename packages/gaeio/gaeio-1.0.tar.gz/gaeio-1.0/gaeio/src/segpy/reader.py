...
from gaeio.src.segpy.datatypes import DATA_SAMPLE_FORMAT_TO_SEG_Y_TYPE, \
    SEG_Y_TYPE_DESCRIPTION, SEG_Y_TYPE_TO_CTYPE, size_in_bytes
from gaeio.src.segpy.toolkit import (extract_revision,
                                            bytes_per_sample,
