...
class TwitterBot:
    def __init__(self,  bot_crediential_file,
        ...
        strategy_class, strategy_params,bucket_name = None, events_folder = None, storing_medium = None ):
    ...
    def go(self):
        ...
        try:
            ...
            if self.storing_medium == 's3':
                ...
                print ({'time': str(datetime.now()), 'error_message': str(e)})
