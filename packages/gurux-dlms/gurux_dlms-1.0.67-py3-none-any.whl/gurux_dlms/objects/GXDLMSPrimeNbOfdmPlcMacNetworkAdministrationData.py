    ...
    def __getAvailableSwitches(self, settings):
        ...
        if not self.availableSwitches:
            ...
            for it in self.availableSwitches:
                ...
                _GXCommon.setData(bb, DataType.INT32, it.lsId)
                _GXCommon.setData(bb, DataType.INT16, it.level)
                _GXCommon.setData(bb, DataType.INT16, it.rxLevel)
                _GXCommon.setData(bb, DataType.INT16, it.rxSnr)
        return bb.array()
    ...
    def __getCommunications(self, settings):
        ...
        if not self.communications:
            ...
            for it in self.communications:
                ...
                _GXCommon.setData(bb, DataType.INT16, it.txPower)
                _GXCommon.setData(bb, DataType.INT16, it.txCoding)
                _GXCommon.setData(bb, DataType.INT16, it.rxCoding)
                _GXCommon.setData(bb, DataType.INT16, it.rxLvl)
                _GXCommon.setData(bb, DataType.INT16, it.snr)
                _GXCommon.setData(bb, DataType.INT16, it.txPowerModified)
                _GXCommon.setData(bb, DataType.INT16, it.txCodingModified)
                _GXCommon.setData(bb, DataType.INT16, it.rxCodingModified)
        return bb.array()
