    ...
    def wrapper(view_method):
        ...
        def inner(self, request=None, *args, **kwargs):
            if isinstance(self, HttpRequest):
                from simple_permissions.decorators.functionbase import permission_required as decorator
                ...
                from simple_permissions.decorators.classbase import get_object_from_classbased_instance
                # get object
