...
class CustomAttributeConfig():
    def __init__(self, *, data_type: str, number_constraints: typing.Optional["NumberAttributeConstraints"]=None, string_constraints: typing.Optional["StringAttributeConstraints"]=None) -> None:
