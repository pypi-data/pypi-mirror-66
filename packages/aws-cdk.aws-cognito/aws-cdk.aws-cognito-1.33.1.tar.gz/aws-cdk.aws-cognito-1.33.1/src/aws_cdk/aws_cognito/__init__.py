...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cognito", "1.33.1", __name__, "aws-cognito@1.33.1.jsii.tgz")
...
class AuthFlow():
    def __init__(self, *, admin_user_password: typing.Optional[bool]=None, custom: typing.Optional[bool]=None, refresh_token: typing.Optional[bool]=None, user_password: typing.Optional[bool]=None, user_srp: typing.Optional[bool]=None):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.CustomAttributeConfig", jsii_struct_bases=[], name_mapping={'data_type': 'dataType', 'number_constraints': 'numberConstraints', 'string_constraints': 'stringConstraints'})
class CustomAttributeConfig():
    def __init__(self, *, data_type: str, number_constraints: typing.Optional["NumberAttributeConstraints"]=None, string_constraints: typing.Optional["StringAttributeConstraints"]=None):
...
class EmailSettings():
    def __init__(self, *, from_: typing.Optional[str]=None, reply_to: typing.Optional[str]=None):
...
class BooleanAttribute(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.BooleanAttribute"):
    ...
    def __init__(self) -> None:
        jsii.create(BooleanAttribute, self, [])
...
class DateTimeAttribute(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.DateTimeAttribute"):
    ...
    """
    def __init__(self) -> None:
        jsii.create(DateTimeAttribute, self, [])
...
class MfaSecondFactor():
    def __init__(self, *, otp: bool, sms: bool):
...
class NumberAttribute(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.NumberAttribute"):
    ...
    def __init__(self, *, max: typing.Optional[jsii.Number]=None, min: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = NumberAttributeProps(max=max, min=min)
...
class NumberAttributeConstraints():
    def __init__(self, *, max: typing.Optional[jsii.Number]=None, min: typing.Optional[jsii.Number]=None):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.NumberAttributeProps", jsii_struct_bases=[NumberAttributeConstraints], name_mapping={'max': 'max', 'min': 'min'})
class NumberAttributeProps(NumberAttributeConstraints):
    def __init__(self, *, max: typing.Optional[jsii.Number]=None, min: typing.Optional[jsii.Number]=None):
...
class OAuthFlows():
    def __init__(self, *, authorization_code_grant: typing.Optional[bool]=None, client_credentials: typing.Optional[bool]=None, implicit_code_grant: typing.Optional[bool]=None):
...
class OAuthSettings():
    def __init__(self, *, flows: "OAuthFlows", scopes: typing.List["OAuthScope"], callback_urls: typing.Optional[typing.List[str]]=None):
...
class PasswordPolicy():
    def __init__(self, *, min_length: typing.Optional[jsii.Number]=None, require_digits: typing.Optional[bool]=None, require_lowercase: typing.Optional[bool]=None, require_symbols: typing.Optional[bool]=None, require_uppercase: typing.Optional[bool]=None, temp_password_validity: typing.Optional[aws_cdk.core.Duration]=None):
...
class RequiredAttributes():
    def __init__(self, *, address: typing.Optional[bool]=None, birthdate: typing.Optional[bool]=None, email: typing.Optional[bool]=None, family_name: typing.Optional[bool]=None, fullname: typing.Optional[bool]=None, gender: typing.Optional[bool]=None, given_name: typing.Optional[bool]=None, last_update_time: typing.Optional[bool]=None, locale: typing.Optional[bool]=None, middle_name: typing.Optional[bool]=None, nickname: typing.Optional[bool]=None, phone_number: typing.Optional[bool]=None, preferred_username: typing.Optional[bool]=None, profile_page: typing.Optional[bool]=None, profile_picture: typing.Optional[bool]=None, timezone: typing.Optional[bool]=None, website: typing.Optional[bool]=None):
...
class StringAttribute(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cognito.StringAttribute"):
    ...
    def __init__(self, *, max_len: typing.Optional[jsii.Number]=None, min_len: typing.Optional[jsii.Number]=None) -> None:
        ...
        :stability: experimental
        """
        props = StringAttributeProps(max_len=max_len, min_len=min_len)
...
class StringAttributeConstraints():
    def __init__(self, *, max_len: typing.Optional[jsii.Number]=None, min_len: typing.Optional[jsii.Number]=None):
...
@jsii.data_type(jsii_type="@aws-cdk/aws-cognito.StringAttributeProps", jsii_struct_bases=[StringAttributeConstraints], name_mapping={'max_len': 'maxLen', 'min_len': 'minLen'})
class StringAttributeProps(StringAttributeConstraints):
    def __init__(self, *, max_len: typing.Optional[jsii.Number]=None, min_len: typing.Optional[jsii.Number]=None):
...
class UserPoolClientOptions():
    def __init__(self, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None):
...
class UserPoolClientProps(UserPoolClientOptions):
    def __init__(self, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, user_pool_client_name: typing.Optional[str]=None, user_pool: "IUserPool"):
        """Properties for the UserPoolClient construct.
...
__all__ = ["AuthFlow", "AutoVerifiedAttrs", "BooleanAttribute", "CfnIdentityPool", "CfnIdentityPoolProps", "CfnIdentityPoolRoleAttachment", "CfnIdentityPoolRoleAttachmentProps", "CfnUserPool", "CfnUserPoolClient", "CfnUserPoolClientProps", "CfnUserPoolDomain", "CfnUserPoolDomainProps", "CfnUserPoolGroup", "CfnUserPoolGroupProps", "CfnUserPoolIdentityProvider", "CfnUserPoolIdentityProviderProps", "CfnUserPoolProps", "CfnUserPoolResourceServer", "CfnUserPoolResourceServerProps", "CfnUserPoolRiskConfigurationAttachment", "CfnUserPoolRiskConfigurationAttachmentProps", "CfnUserPoolUICustomizationAttachment", "CfnUserPoolUICustomizationAttachmentProps", "CfnUserPoolUser", "CfnUserPoolUserProps", "CfnUserPoolUserToGroupAttachment", "CfnUserPoolUserToGroupAttachmentProps", "CustomAttributeConfig", "DateTimeAttribute", "EmailSettings", "ICustomAttribute", "IUserPool", "IUserPoolClient", "Mfa", "MfaSecondFactor", "NumberAttribute", "NumberAttributeConstraints", "NumberAttributeProps", "OAuthFlows", "OAuthScope", "OAuthSettings", "PasswordPolicy", "RequiredAttributes", "SignInAliases", "StringAttribute", "StringAttributeConstraints", "StringAttributeProps", "UserInvitationConfig", "UserPool", "UserPoolClient", "UserPoolClientOptions", "UserPoolClientProps", "UserPoolOperation", "UserPoolProps", "UserPoolTriggers", "UserVerificationConfig", "VerificationEmailStyle", "__jsii_assembly__"]
