...
def build(profile, directory, librarian, jsonpath):
...
"""
    run_build(APP_NAME, profile, directory, librarian, jsonpath)
...
def release(profile, directory, librarian, delete_residue, off):
    ...
    run_build(APP_NAME, profile, directory, librarian, jsonpath=None)
    run_upload(APP_NAME, profile, directory, delete_residue)
    run_submit(APP_NAME, profile, librarian, off)
