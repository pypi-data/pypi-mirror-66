...
if __name__ == '__main__':
    ...
    args = ap.parse_args()
    inputSuffixList = pegaflow.getListOutOfStr(list_in_str=args.inputSuffixList, data_type=str, 
    ...
    mergeWC = pegaflow.registerExecutable(wflow, pipe2File_path, args.site_handler, 
                executableName='mergeWC', cluster_size=args.cluster_size)
    sleep = pegaflow.registerExecutable(wflow, "/bin/sleep", args.site_handler, 
