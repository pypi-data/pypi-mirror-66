...
class MysqlHelper:
    ...
    def export(self, **kwargs):
        ...
        if debug():
            file_folder = kwargs.get('file_folder', os.path.join(os.path.expanduser('~'), 'DataExported', self.table))
        else:
            file_folder = kwargs.get('file_folder',  os.path.join(os.path.dirname(inspect.stack()[1][1]), 'Data/'))
