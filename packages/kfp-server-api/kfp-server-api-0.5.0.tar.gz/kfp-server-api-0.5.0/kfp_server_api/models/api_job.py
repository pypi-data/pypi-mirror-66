...
class ApiJob(object):
    ...
    def __init__(self, id=None, name=None, description=None, pipeline_spec=None, resource_references=None, max_concurrency=None, trigger=None, mode=None, created_at=None, updated_at=None, status=None, error=None, enabled=None, no_catchup=None):  # noqa: E501
