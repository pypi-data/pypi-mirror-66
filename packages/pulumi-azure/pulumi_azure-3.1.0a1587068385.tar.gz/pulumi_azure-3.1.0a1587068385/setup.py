...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.1.0-alpha.1587068385+g9e82ce03'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.1.0-alpha.1587068385+g9e82ce03`
                """)
            else:
                raise
