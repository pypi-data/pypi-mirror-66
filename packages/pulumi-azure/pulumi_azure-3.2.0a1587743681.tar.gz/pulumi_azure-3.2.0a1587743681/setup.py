...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.2.0-alpha.1587743681+gf611a50d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.2.0-alpha.1587743681+gf611a50d`
                """)
            else:
                raise
