...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.1.0-alpha.1586951300+gcc5114b3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.1.0-alpha.1586951300+gcc5114b3`
                """)
            else:
                raise
