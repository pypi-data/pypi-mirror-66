...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.1.0-alpha.1587071680+gdd55ece9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.1.0-alpha.1587071680+gdd55ece9`
                """)
            else:
                raise
