...
$Id: client.py 4723 2018-02-04 08:42:19Z roger.ineichen $
"""
...
def getMongoClient(settings=None, connect=True, retry=True):
    ...
    if uri == 'testing' or settings.P01_CDN_RECIPE_PROCESS:
        # testing or resource extraction, just a dumy client using testing port
