...
class Coordinator:
    ...
    @property
    def schema_constraint_path(self):
    ...
    @property
    def constraint_dump_statement(self):
        return self.base_dump_statement + ' --section=post-data --file=%(file)s'  % {
            'file': self.schema_constraint_path,
        }
