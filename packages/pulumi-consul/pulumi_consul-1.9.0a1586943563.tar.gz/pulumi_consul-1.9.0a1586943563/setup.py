...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.9.0-alpha.1586943563+gfc9f4cf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.9.0-alpha.1586943563+gfc9f4cf`
                """)
            else:
                raise
