        ...
        if os.path.isfile(output_path):
            ...
            if self.on_change:
                ...
                if input_mtime == output_mtime:
                    return True, False, True, f"File not changed ({input_mtime}), skipping"
                elif output_mtime > input_mtime:
                    return True, False, True, f"Destination file newer than input ({output_mtime}>{input_mtime}), skipping"
        else:
