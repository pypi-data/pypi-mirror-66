...
class ThermoModelHandle:
    ...
    def move_up_model_priority(self, key, priority=0):
        ...
        """
        index = as_model_index(self.models, key)
        self.models.rotate(priority - index)
    ...
    def remove(self, key):
        ...
        """
        model = as_model(self.models, key)
...
class TPDependentModelHandle(ThermoModelHandle):
    ...
    def __call__(self, T, P):
        ...
        raise DomainError(f"{no_valid_model(self.chemical, self.var)} "
