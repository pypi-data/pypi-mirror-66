...
def DIPPR9G(T, P, Tc, Pc, k_l):
    ...
    Notes
    -----
    Adjustes for pressure the thermal conductivity of a liquid using an
...
def thermal_conductivity_liquid_handle(handle, CAS, MW, Tm, Tb, Tc, Pc, omega, Hfus):
...
def thermal_conductivity_gas_handle(handle, CAS, MW, Tb, Tc, Pc, Vc, Zc, omega, dipole, Vg, Cn, mug):
    ...
    if all((MW, Tc, Vc, Zc, omega, Cn, Vg)):
...
thermal_conductivity_handle = PhaseTPPropertyBuilder('kappa', None,
