...
@author: yoelr
"""
from flexsolve import wegstein, IQ_interpolation, fixed_point, SolverError
...
class VLE:
    ...
    def _y_iter(self, y, Psats_over_P, T, P):
        ...
        try:
            x = self.itersolver(self._x_iter,
                                self._x, 1e-12,
                                args=(Psat_over_P_phi,))
        except SolverError as solver_error:
            x = fixed_point(self._x_iter,
                            solver_error.x, 1e-6,
                            args=(Psat_over_P_phi,))
        self._x = x
    ...
    def _solve_v(self, T, P):
        ...
        if isinstance(self._phi, IdealFugacityCoefficients):
            ...
            self._y = self.itersolver(self._y_iter, v/v.sum(), 1e-6,
