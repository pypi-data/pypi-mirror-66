...
class MultiStream(Stream):
    ...
    * H [Enthalpy; in kJ/hr]:
    ...
    def _init_cache(self):
        super()._init_cache()
        self._streams = {}
        self._vle_cache = Cache(VLE, self._imol, self._thermal_condition, thermo=self._thermo,
                                bubble_point_cache=self._bubble_point_cache,
                                dew_point_cache=self._dew_point_cache)
        self._lle_cache = Cache(LLE, self._imol, self._thermal_condition, self._thermo)
