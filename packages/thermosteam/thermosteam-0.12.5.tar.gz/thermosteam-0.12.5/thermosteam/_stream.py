...
class Stream:
    ...
    **chemical_flows : float
    ...
    def _init_cache(self):
        self._bubble_point_cache = utils.Cache(eq.BubblePoint)
        self._dew_point_cache = utils.Cache(eq.DewPoint)
    ...
    def phases(self, phases):
        ...
        self._streams = {}
        self._vle_cache = utils.Cache(
                              eq.VLE, self._imol, self._thermal_condition,
                              thermo=self._thermo,
                              bubble_point_cache=self._bubble_point_cache,
                              dew_point_cache=self._dew_point_cache)
        self._lle_cache = utils.Cache(eq.LLE, self._imol,
                                      self._thermal_condition, self._thermo)
