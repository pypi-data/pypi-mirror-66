...
class QRemoteObjectAbstractPersistedStore(PySide2.QtCore.QObject):
    ...
    def saveProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, values: typing.Sequence[typing.Any]): ...
...
class QRemoteObjectReplica(PySide2.QtCore.QObject):
    ...
    def persistProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, props: typing.Sequence[typing.Any]): ...
    ...
    def send(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.Sequence[typing.Any]): ...
    ...
    def setProperties(self, arg__1: typing.Sequence[typing.Any]): ...
