...
class QScxmlDynamicScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, names: typing.List[int], parameters: typing.List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: typing.Optional[PySide2.QtCore.QObject]=...): ...
...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    def setInitialValues(self, initialValues: typing.Dict[str, typing.Any]): ...
...
class QScxmlStaticScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, nameList: typing.List[int], parameters: typing.List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: typing.Optional[PySide2.QtCore.QObject]=...): ...
