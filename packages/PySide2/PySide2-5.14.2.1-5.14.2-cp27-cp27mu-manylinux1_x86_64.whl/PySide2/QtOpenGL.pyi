...
class QGLShaderProgram(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setUniformValueArrayInt(self, location: int, values: shibokensupport.typing27.Sequence, count: int): ...
    @typing.overload
    def setUniformValueArrayInt(self, name: str, values: shibokensupport.typing27.Sequence, count: int): ...
    @typing.overload
    def setUniformValueArrayUint(self, location: int, values: shibokensupport.typing27.Sequence, count: int): ...
    @typing.overload
    def setUniformValueArrayUint(self, name: str, values: shibokensupport.typing27.Sequence, count: int): ...
