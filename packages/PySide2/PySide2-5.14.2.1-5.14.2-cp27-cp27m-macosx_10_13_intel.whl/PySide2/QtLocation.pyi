...
class QGeoCodeReply(PySide2.QtCore.QObject):
    ...
    def setLocations(self, locations: typing.Sequence[PySide2.QtPositioning.QGeoLocation]): ...
...
class QGeoCodingManagerEngine(PySide2.QtCore.QObject):
    ...
    def __init__(self, parameters: typing.Dict[str, typing.Any], parent: typing.Optional[PySide2.QtCore.QObject]=...): ...
...
class QGeoManeuver(Shiboken.Object):
    ...
    def setExtendedAttributes(self, extendedAttributes: typing.Dict[str, typing.Any]): ...
...
class QGeoRoute(Shiboken.Object):
    ...
    def setPath(self, path: typing.Sequence[PySide2.QtPositioning.QGeoCoordinate]): ...
...
class QGeoRouteReply(PySide2.QtCore.QObject):
    ...
    def abort(self): ...
    def addRoutes(self, routes: typing.Sequence[PySide2.QtLocation.QGeoRoute]): ...
    ...
    def setFinished(self, finished: bool): ...
    def setRoutes(self, routes: typing.Sequence[PySide2.QtLocation.QGeoRoute]): ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, waypoints: typing.Sequence[PySide2.QtPositioning.QGeoCoordinate]=...): ...
    ...
    def setExcludeAreas(self, areas: typing.Sequence[PySide2.QtPositioning.QGeoRectangle]): ...
    def setExtraParameters(self, extraParameters: typing.Dict[str, typing.Any]): ...
    ...
    def setWaypoints(self, waypoints: typing.Sequence[PySide2.QtPositioning.QGeoCoordinate]): ...
    def setWaypointsMetadata(self, waypointMetadata: typing.Sequence[typing.Dict]): ...
...
class QGeoServiceProvider(PySide2.QtCore.QObject):
    ...
    def __init__(self, providerName: str, parameters: typing.Dict[str, typing.Any]=..., allowExperimental: bool=...): ...
    ...
    def setLocale(self, locale: PySide2.QtCore.QLocale): ...
    def setParameters(self, parameters: typing.Dict[str, typing.Any]): ...
...
class QPlace(Shiboken.Object):
    ...
    def insertContent(self, type: PySide2.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]): ...
    ...
    def setCategories(self, categories: typing.Sequence[PySide2.QtLocation.QPlaceCategory]): ...
    def setCategory(self, category: PySide2.QtLocation.QPlaceCategory): ...
    def setContactDetails(self, contactType: str, details: typing.Sequence[PySide2.QtLocation.QPlaceContactDetail]): ...
    def setContent(self, type: PySide2.QtLocation.QPlaceContent.Type, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]): ...
...
class QPlaceContentReply(PySide2.QtLocation.QPlaceReply):
    ...
    def setContent(self, content: typing.Dict[int, PySide2.QtLocation.QPlaceContent]): ...
...
class QPlaceManager(PySide2.QtCore.QObject):
    ...
    def setLocale(self, locale: PySide2.QtCore.QLocale): ...
    def setLocales(self, locale: typing.Sequence[PySide2.QtCore.QLocale]): ...
...
class QPlaceManagerEngine(PySide2.QtCore.QObject):
    ...
    def searchSuggestions(self, request: PySide2.QtLocation.QPlaceSearchRequest) -> PySide2.QtLocation.QPlaceSearchSuggestionReply: ...
    def setLocales(self, locales: typing.Sequence[PySide2.QtCore.QLocale]): ...
...
class QPlaceMatchReply(PySide2.QtLocation.QPlaceReply):
    ...
    def setPlaces(self, results: typing.Sequence[PySide2.QtLocation.QPlace]): ...
...
class QPlaceMatchRequest(Shiboken.Object):
    ...
    def places(self) -> typing.List[PySide2.QtLocation.QPlace]: ...
    def setParameters(self, parameters: typing.Dict[str, typing.Any]): ...
    def setPlaces(self, places: typing.Sequence[PySide2.QtLocation.QPlace]): ...
    def setResults(self, results: typing.Sequence[PySide2.QtLocation.QPlaceSearchResult]): ...
...
class QPlaceSearchSuggestionReply(PySide2.QtLocation.QPlaceReply):
    ...
    def setSuggestions(self, suggestions: typing.Sequence[str]): ...
