...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    def setAllowedItems(self, allowedItems: typing.Sequence[PySide2.QtMacExtras.QMacToolBarItem]): ...
    def setItems(self, items: typing.Sequence[PySide2.QtMacExtras.QMacToolBarItem]): ...
...
class QMacToolBarItem(PySide2.QtCore.QObject):
    ...
    def text(self) -> str: ...
def qRegisterDraggedTypes(types: typing.Sequence[str]): ...
