...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/cloud-assembly-schema", "1.33.1", __name__, "cloud-assembly-schema@1.33.1.jsii.tgz")
...
class MetadataEntry():
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[typing.Optional[str], typing.Optional["FileAssetMetadataEntry"], typing.Optional["ContainerImageAssetMetadataEntry"], typing.Optional[typing.List["Tag"]]]]=None, trace: typing.Optional[typing.List[str]]=None):
...
__all__ = ["ArtifactManifest", "ArtifactMetadataEntryType", "ArtifactType", "AssemblyManifest", "ContainerImageAssetMetadataEntry", "FileAssetMetadataEntry", "Manifest", "MetadataEntry", "MissingContext", "RuntimeInfo", "Tag", "__jsii_assembly__"]
