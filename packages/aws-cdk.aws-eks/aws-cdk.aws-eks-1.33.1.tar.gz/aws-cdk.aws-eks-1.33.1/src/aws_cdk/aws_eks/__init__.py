...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-eks", "1.33.1", __name__, "aws-eks@1.33.1.jsii.tgz")
...
class AutoScalingGroupOptions():
    def __init__(self, *, bootstrap_enabled: typing.Optional[bool]=None, bootstrap_options: typing.Optional["BootstrapOptions"]=None, machine_image_type: typing.Optional["MachineImageType"]=None, map_role: typing.Optional[bool]=None):
...
class CfnCluster(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-eks.CfnCluster"):
    ...
    class EncryptionConfigProperty():
        def __init__(self, *, provider: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnCluster.ProviderProperty"]]]=None, resources: typing.Optional[typing.List[str]]=None):
            """
    ...
    class ProviderProperty():
        def __init__(self, *, key_arn: typing.Optional[str]=None):
            """
...
class KubernetesPatchProps():
    def __init__(self, *, apply_patch: typing.Mapping[str,typing.Any], cluster: "Cluster", resource_name: str, restore_patch: typing.Mapping[str,typing.Any], patch_type: typing.Optional["PatchType"]=None, resource_namespace: typing.Optional[str]=None):
...
class NodegroupProps(NodegroupOptions):
    def __init__(self, *, ami_type: typing.Optional["NodegroupAmiType"]=None, desired_size: typing.Optional[jsii.Number]=None, disk_size: typing.Optional[jsii.Number]=None, force_update: typing.Optional[bool]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, labels: typing.Optional[typing.Mapping[str,str]]=None, max_size: typing.Optional[jsii.Number]=None, min_size: typing.Optional[jsii.Number]=None, nodegroup_name: typing.Optional[str]=None, node_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, release_version: typing.Optional[str]=None, remote_access: typing.Optional["NodegroupRemoteAccess"]=None, subnets: typing.Optional[aws_cdk.aws_ec2.SubnetSelection]=None, tags: typing.Optional[typing.Mapping[str,str]]=None, cluster: "Cluster"):
...
class NodegroupRemoteAccess():
    def __init__(self, *, ssh_key_name: str, source_security_groups: typing.Optional[typing.List[aws_cdk.aws_ec2.ISecurityGroup]]=None):
        """The remote access (SSH) configuration to use with your node group.
...
__all__ = ["AutoScalingGroupOptions", "AwsAuth", "AwsAuthMapping", "AwsAuthProps", "BootstrapOptions", "CapacityOptions", "CfnCluster", "CfnClusterProps", "CfnNodegroup", "CfnNodegroupProps", "Cluster", "ClusterAttributes", "ClusterOptions", "ClusterProps", "CoreDnsComputeType", "DefaultCapacityType", "EksOptimizedImage", "EksOptimizedImageProps", "FargateCluster", "FargateClusterProps", "FargateProfile", "FargateProfileOptions", "FargateProfileProps", "HelmChart", "HelmChartOptions", "HelmChartProps", "ICluster", "INodegroup", "KubernetesPatch", "KubernetesPatchProps", "KubernetesResource", "KubernetesResourceProps", "MachineImageType", "NodeType", "Nodegroup", "NodegroupAmiType", "NodegroupOptions", "NodegroupProps", "NodegroupRemoteAccess", "PatchType", "Selector", "__jsii_assembly__"]
