...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.1.0-alpha.1587386352+g665aaf9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.1.0-alpha.1587386352+g665aaf9`
                """)
            else:
                raise
