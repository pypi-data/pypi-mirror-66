...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.1.0-alpha.1586950646+g6bd5ce1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.1.0-alpha.1586950646+g6bd5ce1`
                """)
            else:
                raise
