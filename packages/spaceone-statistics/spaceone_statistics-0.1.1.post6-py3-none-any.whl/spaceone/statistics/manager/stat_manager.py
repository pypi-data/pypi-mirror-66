...
class StatManager(BaseManager):
    ...
    def join_and_execute_formula(self, base_results, join, formulas, sort, limit, domain_id):
        base_df = pd.DataFrame(base_results)
        base_df = self._left_join(base_df, join, domain_id)
    ...
    def _left_join(self, base_df, join, domain_id):
        for join_query in join:
            ...
            try:
                ...
                raise ERROR_STATISTICS_JOIN(join_key=join_query['key'])
