...
def DiffInfo(diff_info):
    info = {
        'topic': diff_info['topic'],
        'values': change_list_value_type(diff_info.get('values', [])),
        'domain_id': diff_info['domain_id']
    }

    return history_pb2.DiffInfo(**info)
