...
def test_compute_kernel_bias(shape, fit_intercept, alpha):
    ...
    if shape[0] > shape[1] or not fit_intercept:
        ...
        onp.testing.assert_array_almost_equal(expected.coef_, kernel, decimal=3)
        onp.testing.assert_array_almost_equal(expected.intercept_, bias, decimal=3)
