...
setup(
    name='RileyUtils',  # How you named your package folder (MyLib)
    packages=['RileyUtils'],  # Chose the same as "name"
    version='0.1',  # Start with a small number and increase it with every change you make
    license='MIT',  # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description='A library with useful things in it.',  # Give a short description about your library
    ...
    keywords=['Riley', 'Useful', 'Utility'],  # Keywords that define your package best
