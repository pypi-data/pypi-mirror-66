...
class NamespaceMetadataTransactionBodyBuilder:
    ...
    def loadFromBinary(cls, payload: bytes) -> NamespaceMetadataTransactionBodyBuilder:
        ...
        bytes_ = bytes_[8:]
        # gen: _load_from_binary_custom
        targetNamespaceId = NamespaceIdDto.loadFromBinary(bytes_)
    ...
    def serialize(self) -> bytes:
        ...
        targetNamespaceIdBytes = self.targetNamespaceId.serialize()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, targetNamespaceIdBytes)
