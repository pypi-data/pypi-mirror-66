...
class MosaicNonceDto:
    ...
    def __init__(self, mosaicNonce: int):
        """Constructor.
        Args:
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        mosaicNonceBytes = GeneratorUtils.uintToBuffer(self.getMosaicNonce(), 4)
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, mosaicNonceBytes)
        return bytes_
