...
class AccountAddressRestrictionTransactionBodyBuilder:
    ...
    def __init__(self, restrictionFlags: int, restrictionAdditions: List[UnresolvedAddressDto], restrictionDeletions: List[UnresolvedAddressDto]):
        """Constructor.
        Args:
    ...
    def loadFromBinary(cls, payload: bytes) -> AccountAddressRestrictionTransactionBodyBuilder:
        ...
        restrictionAdditions: List[UnresolvedAddressDto] = []
        ...
        # gen: _load_from_binary_array
        restrictionDeletions: List[UnresolvedAddressDto] = []
        for _ in range(restrictionDeletionsCount):
            item = UnresolvedAddressDto.loadFromBinary(bytes_)
            restrictionDeletions.append(item)
            bytes_ = bytes_[item.getSize():]
        return AccountAddressRestrictionTransactionBodyBuilder(restrictionFlags, restrictionAdditions, restrictionDeletions)
