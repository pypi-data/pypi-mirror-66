...
class MosaicExpiryReceiptBuilder(ReceiptBuilder):
    ...
    def __init__(self, version: int, type_: ReceiptTypeDto, artifactId: MosaicIdDto):
        """Constructor.
        Args:
    ...
    def loadFromBinary(cls, payload: bytes) -> MosaicExpiryReceiptBuilder:
        ...
        artifactId = MosaicIdDto.loadFromBinary(bytes_)
        bytes_ = bytes_[artifactId.getSize():]
        return MosaicExpiryReceiptBuilder(superObject.version, superObject.type_, artifactId)
