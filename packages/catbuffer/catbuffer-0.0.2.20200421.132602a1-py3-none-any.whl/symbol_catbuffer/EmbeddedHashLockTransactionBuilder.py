...
class EmbeddedHashLockTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def __init__(self, signerPublicKey: KeyDto, version: int, network: NetworkTypeDto, type_: EntityTypeDto, mosaic: UnresolvedMosaicBuilder, duration: BlockDurationDto, hash_: Hash256Dto):
        """Constructor.
        Args:
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedHashLockTransactionBuilder:
        ...
        return EmbeddedHashLockTransactionBuilder(superObject.signerPublicKey, superObject.version, superObject.network, superObject.type_, hashLockTransactionBody.mosaic, hashLockTransactionBody.duration, hashLockTransactionBody.hash_)
