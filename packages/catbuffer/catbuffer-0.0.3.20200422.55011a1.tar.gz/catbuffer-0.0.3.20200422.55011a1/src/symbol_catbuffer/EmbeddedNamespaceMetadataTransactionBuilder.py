...
class EmbeddedNamespaceMetadataTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def __init__(self, signerPublicKey: KeyDto, version: int, network: NetworkTypeDto, type_: EntityTypeDto, targetPublicKey: KeyDto, scopedMetadataKey: int, targetNamespaceId: NamespaceIdDto, valueSizeDelta: int, value: bytes):
        """Constructor.
        Args:
