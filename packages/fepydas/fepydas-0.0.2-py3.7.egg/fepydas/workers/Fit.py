...
from fepydas.libs.deconvolution import convolve
...
class Fit:
  ...
  def convolutedResidual(self, params, x, data=None, irf=None):
    parvals = params.valuesdict()
    return data - convolve(self.function(x,**parvals),irf)
  ...
  def evaluateConvolution(self, x, irf):
    return convolve(self.evaluate(x),irf)
