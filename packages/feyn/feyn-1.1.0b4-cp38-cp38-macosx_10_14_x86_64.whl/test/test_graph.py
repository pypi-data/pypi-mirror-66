...
class TestGraph(unittest.TestCase):
    ...
    def test_query_accepts_np(self):
        input = _feyn.Interaction("fixed", name="input")
    ...
    def test_invalid_graph(self):
        ...
        with self.assertRaises(RuntimeError):
            graph = feyn.Graph(1)
            node = _feyn.Interaction('tanh', name="in")
        ...
        with self.assertRaises(RuntimeError):
            ...
            register = _feyn.Interaction('fixed', name='in')
            register._set_source(0, -1)

            node = _feyn.Interaction('tanh', name="tanh")
