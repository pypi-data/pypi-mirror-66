...
class BMP280:
	def __init__(self, Interface, SDO):
		"""Object constructor. Initializes the I2C interface, check the sensor device ID, reset the sensor
		...
		ID = self.__Interface.read_byte_data(self.__Address, BMP280_REGISTER_ID)
		if(ID != BMP280_ID):
