...
def project_arguments(topic_ontology,model,vocab_size,is_cluster_corpora,is_testing):
    corpora = load_corpora_list()
    cluster_corpora = ['args-me','aifdb','kialo','ibm-debater-claim-sentence-search']
...
project_arguments('debatepedia','esa',10,True,False)
