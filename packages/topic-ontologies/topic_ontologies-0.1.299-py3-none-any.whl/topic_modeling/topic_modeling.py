...
def convert_topic_vectors_args_me():
    read_cluster_topic_vectors('args-me','wikipedia','esa')
    read_cluster_topic_vectors('args-me','strategic-intelligence','esa')
    read_cluster_topic_vectors('args-me','debatepedia','esa')

def convert_topic_vectors_ibm_debater_claim_sentence_search():
    read_cluster_topic_vectors('ibm-debater-claim-sentence-search','wikipedia','esa')
    read_cluster_topic_vectors('ibm-debater-claim-sentence-search','strategic-intelligence','esa')
    read_cluster_topic_vectors('ibm-debater-claim-sentence-search','debatepedia','esa')
