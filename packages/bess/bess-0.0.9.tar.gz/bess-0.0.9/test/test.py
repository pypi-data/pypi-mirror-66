...
# np.random.seed(123)
# data = gen_data(100, 200, family="poisson", k=5, rho=0, sigma=1)
...
# np.random.seed(123)
# data = gen_data(100, 200, family="possion", k=5, rho=0, sigma=1, c=10)
#
# model = PdasPossion(path_type="seq", sequence=[5])
# model.fit(data.x, data.y, is_normal=True)
# print(np.nonzero(data.beta))
# print(np.nonzero(model.beta))
# print(data.beta[np.nonzero(data.beta)])
