...
def _automl_auto_mode_get_explainer_data(
    ...
    if streaming:
        ...
        explainer_data_y = y.to_pandas_dataframe(extended_types=False).values
        explainer_data_y_valid = y_valid.to_pandas_dataframe(extended_types=False).values
    else:
...
def _automl_pick_evaluation_samples_explanations(featurized_X_data: DataInputType,
    ...
    :type y: DataSingleColumnInputTypee
    ...
    :type y_valid: DataSingleColumnInputTypee
