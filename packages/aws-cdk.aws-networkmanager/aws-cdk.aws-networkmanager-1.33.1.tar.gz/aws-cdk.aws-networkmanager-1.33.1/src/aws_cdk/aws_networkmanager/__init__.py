...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-networkmanager", "1.33.1", __name__, "aws-networkmanager@1.33.1.jsii.tgz")
...
class CfnCustomerGatewayAssociationProps():
    def __init__(self, *, customer_gateway_arn: str, device_id: str, global_network_id: str, link_id: typing.Optional[str]=None):
...
class CfnDevice(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-networkmanager.CfnDevice"):
    ...
    class LocationProperty():
        def __init__(self, *, address: typing.Optional[str]=None, latitude: typing.Optional[str]=None, longitude: typing.Optional[str]=None):
            """
...
class CfnDeviceProps():
    def __init__(self, *, global_network_id: str, description: typing.Optional[str]=None, location: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnDevice.LocationProperty"]]]=None, model: typing.Optional[str]=None, serial_number: typing.Optional[str]=None, site_id: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, type: typing.Optional[str]=None, vendor: typing.Optional[str]=None):
...
class CfnLink(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-networkmanager.CfnLink"):
    ...
    class BandwidthProperty():
        def __init__(self, *, download_speed: typing.Optional[jsii.Number]=None, upload_speed: typing.Optional[jsii.Number]=None):
            """
...
class CfnLinkAssociationProps():
    def __init__(self, *, device_id: str, global_network_id: str, link_id: str):
...
class CfnLinkProps():
    def __init__(self, *, bandwidth: typing.Union["CfnLink.BandwidthProperty", aws_cdk.core.IResolvable], global_network_id: str, site_id: str, description: typing.Optional[str]=None, provider: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None, type: typing.Optional[str]=None):
...
class CfnSiteProps():
    def __init__(self, *, global_network_id: str, description: typing.Optional[str]=None, location: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnSite.LocationProperty"]]]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class CfnTransitGatewayRegistrationProps():
    def __init__(self, *, global_network_id: str, transit_gateway_arn: str):
...
__all__ = ["CfnCustomerGatewayAssociation", "CfnCustomerGatewayAssociationProps", "CfnDevice", "CfnDeviceProps", "CfnGlobalNetwork", "CfnGlobalNetworkProps", "CfnLink", "CfnLinkAssociation", "CfnLinkAssociationProps", "CfnLinkProps", "CfnSite", "CfnSiteProps", "CfnTransitGatewayRegistration", "CfnTransitGatewayRegistrationProps", "__jsii_assembly__"]
