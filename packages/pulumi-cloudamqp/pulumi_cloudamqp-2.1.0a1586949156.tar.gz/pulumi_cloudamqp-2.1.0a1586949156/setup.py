...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v2.1.0-alpha.1586949156+gcbc842f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v2.1.0-alpha.1586949156+gcbc842f`
                """)
            else:
                raise
