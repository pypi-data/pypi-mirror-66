...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v1.7.0-alpha.1587165244+g3b51d48'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v1.7.0-alpha.1587165244+g3b51d48`
                """)
            else:
                raise
