...
def _rspAccountStr(self):
    return '<account tg={} avail={} withd={} marketV={} curMarr={} eid={} err={}>'.format(
        self.account_id, self.avail_amt, self.balance, self.mkt_value,
        self.frz_margin, self.err_id, self.err_msg
    )
...
def _rtnTradeStr(self):
    return '<t tid={} oid={} ref={} tg={} exch={} ass={} tkr={} dir={} of={} tp={} px={} vol={} comm={} t={}>'.format(
        ...
        message_pb.OffsetFlag.Name(self.offset_flag), message_pb.OrderType.Name(self.order_type), self.traded_price,
        self.traded_vol, self.commission, self.trade_time.ToDatetime()
    )
