...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.path = None
        grid_size = 16
        playing_field_width = 2000
        playing_field_height = 700
        self.barrier_list = arcade.BarrierList(enemy,
                                               self.wall_list,
                                               grid_size,
                                               -15, int(playing_field_width / grid_size),
                                               -25, int(playing_field_height / grid_size))
    ...
    def on_update(self, delta_time):
        ...
        try:
            ...
            for enemy in self.enemy_list:
                self.path = arcade.astar(enemy.position,
