...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-detective", "1.33.1", __name__, "aws-detective@1.33.1.jsii.tgz")
...
class CfnMemberInvitationProps():
    def __init__(self, *, graph_arn: str, member_email_address: str, member_id: str, message: typing.Optional[str]=None):
...
__all__ = ["CfnGraph", "CfnMemberInvitation", "CfnMemberInvitationProps", "__jsii_assembly__"]
