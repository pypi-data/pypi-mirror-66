...
class MainFrame(wx.Frame):
  ...
  def on_chord_changed(self, event, chord_db, config):
    ...
    palette_obj = Palette(self.palette_radio.GetSelection())
    ...
    try:
      ...
      if self.chord_type_radio.GetStringSelection() == 'Movable':
        draw_root_finder(instrument_obj, palette_obj, chord_obj, (290, 100), movable_image.name)
      ...
      draw_chord(instrument_obj, palette_obj, chord_obj.chord_type, chord_obj.finger_str, chord_obj.fret_str, (290, 490), chord_output_file)
