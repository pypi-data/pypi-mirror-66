...
class LocalizationsApi(object):
    ...
    def get_localization_by_id(self, localization_id, target_language, accept, **kwargs):  # noqa: E501
    ...
    def get_localization_by_id_with_http_info(self, localization_id, target_language, accept, **kwargs):  # noqa: E501
        """Get Localization Object by ID  # noqa: E501
        ...
        all_params = ['localization_id', 'target_language', 'accept']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_localization_by_id" % key
                )
        ...
        if self.api_client.client_side_validation and ('localization_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `localization_id` when calling `get_localization_by_id`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('target_language' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `target_language` when calling `get_localization_by_id`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('accept' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `accept` when calling `get_localization_by_id`")  # noqa: E501
