...
The Ezsmdeploy Python SDK is built to PyPI and has the following dependencies - "sagemaker>=1.55.3","yaspin==0.16.0","shortuuid==1.0.1" and "locustio==0.14.5". Ezsmdeploy can be installed with pip as follows:
