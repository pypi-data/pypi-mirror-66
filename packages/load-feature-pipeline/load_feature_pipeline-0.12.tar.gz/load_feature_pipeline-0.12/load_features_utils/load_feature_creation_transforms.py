...
class _CreateCategoricalEncodedVariables(DoFn):
    ...
    def process(self, df):
        ...
        download_blob("load_transforms", "load_quantile_mlb.pkl", "load_quantile_mlb.pkll")
        with open('load_equipment_mlb.pkl', 'rb') as f:
        ...
        download_blob("load_transforms", "load_city_lbe.pkl", "load_state_lbe.pkl")
        ...
        download_blob("load_transforms", "load_email_ohe.pkl", "load_equipment_mlb.pkl")
