...
setup(
    ...
    download_url='https://github.com/jakubarendac/MinutiaeClassificator/archive/0.1.6.tar.gz',
    keywords=['minutiae', 'extraction', 'classification', 'biometrics'],
    # TODO : add needed packages
    install_requires=['opencv-python', 'keras==2.2.4','tensorflow==1.13.1','tensorflow-gpu==1.13.1'],
    classifiers=[
