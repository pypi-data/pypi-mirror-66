...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v1.7.0-alpha.1587141551+g71627d8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v1.7.0-alpha.1587141551+g71627d8`
                """)
            else:
                raise
