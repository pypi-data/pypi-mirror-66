...
class Model(DataObject):
    ...
    def write_to_storage(self, entity_name, dataframe, writer, number_of_partition=None, fn=None, lit=None, model_json_name="model.json", columnHeaders=False, delimiter=","):
        entity = None
        entity_index = -1
        ...
        for name, url in names_and_urls:
            ...
            partition.fileFormatSetting = CsvFormatSettings(columnHeaders=columnHeaders, delimiter=delimiter)
