...
class CfnDetectorModel(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iotevents.CfnDetectorModel"):
    ...
    class FirehoseProperty():
        def __init__(self, *, delivery_stream_name: typing.Optional[str]=None, separator: typing.Optional[str]=None) -> None:
            """
    ...
    class IotEventsProperty():
        def __init__(self, *, input_name: typing.Optional[str]=None) -> None:
            """
    ...
    class IotTopicPublishProperty():
        def __init__(self, *, mqtt_topic: typing.Optional[str]=None) -> None:
            """
    ...
    class SqsProperty():
        def __init__(self, *, queue_url: typing.Optional[str]=None, use_base64: typing.Optional[typing.Union[typing.Optional[bool], typing.Optional[aws_cdk.core.IResolvable]]]=None) -> None:
            """
