...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iotevents", "1.33.1", __name__, "aws-iotevents@1.33.1.jsii.tgz")
...
class CfnDetectorModel(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iotevents.CfnDetectorModel"):
    ...
    class SetTimerProperty():
        def __init__(self, *, duration_expression: typing.Optional[str]=None, seconds: typing.Optional[jsii.Number]=None, timer_name: typing.Optional[str]=None):
            """
