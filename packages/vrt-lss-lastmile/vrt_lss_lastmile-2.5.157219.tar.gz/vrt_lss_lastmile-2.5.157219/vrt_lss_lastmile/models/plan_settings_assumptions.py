...
class PlanSettingsAssumptions(object):
    ...
    def __init__(self, traffic_jams=True, flight_distance=False, disable_compatibility=False, disable_capacity=False, same_order_time_window=False, expand_shift_time_window=False, local_vars_configuration=None):  # noqa: E501
        """PlanSettingsAssumptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def traffic_jams(self):
        """Gets the traffic_jams of this PlanSettingsAssumptions.  # noqa: E501

        Учет пробок при планировании маршрутов.  # noqa: E501

        :return: The traffic_jams of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def traffic_jams(self, traffic_jams):
        """Sets the traffic_jams of this PlanSettingsAssumptions.

        Учет пробок при планировании маршрутов.  # noqa: E501

        :param traffic_jams: The traffic_jams of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def flight_distance(self):
        """Gets the flight_distance of this PlanSettingsAssumptions.  # noqa: E501
        ...
        :return: The flight_distance of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def flight_distance(self, flight_distance):
        """Sets the flight_distance of this PlanSettingsAssumptions.

        Использовать для расчетов расстояния по прямой. Если указано false - расстояния рассчитываются по дорогам. При включении данного параметра учет пробок (traffic_jams) автоматически выключается.   # noqa: E501

        :param flight_distance: The flight_distance of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def disable_compatibility(self):
        """Gets the disable_compatibility of this PlanSettingsAssumptions.  # noqa: E501

        Отключить учет совместимостей. Если указано true - все становится совместимо со всем.   # noqa: E501

        :return: The disable_compatibility of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def disable_compatibility(self, disable_compatibility):
        """Sets the disable_compatibility of this PlanSettingsAssumptions.

        Отключить учет совместимостей. Если указано true - все становится совместимо со всем.   # noqa: E501

        :param disable_compatibility: The disable_compatibility of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def disable_capacity(self):
        """Gets the disable_capacity of this PlanSettingsAssumptions.  # noqa: E501

        Отключить учет вместимостей. Если указано true - весь транспорт вмещает неограниченное количество грузов.   # noqa: E501

        :return: The disable_capacity of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def disable_capacity(self, disable_capacity):
        """Sets the disable_capacity of this PlanSettingsAssumptions.

        Отключить учет вместимостей. Если указано true - весь транспорт вмещает неограниченное количество грузов.   # noqa: E501

        :param disable_capacity: The disable_capacity of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def same_order_time_window(self):
        """Gets the same_order_time_window of this PlanSettingsAssumptions.  # noqa: E501
        ...
        :return: The same_order_time_window of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def same_order_time_window(self, same_order_time_window):
        """Sets the same_order_time_window of this PlanSettingsAssumptions.

        Использовать для расчетов одинаковое (указанное) временное окно для заказов и заявок. Временное окно берется от начала самого раннего до конца самого позднего окна из всех заказов и заявок.   # noqa: E501

        :param same_order_time_window: The same_order_time_window of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def expand_shift_time_window(self):
        """Gets the expand_shift_time_window of this PlanSettingsAssumptions.  # noqa: E501
        ...
        :return: The expand_shift_time_window of this PlanSettingsAssumptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def expand_shift_time_window(self, expand_shift_time_window):
        """Sets the expand_shift_time_window of this PlanSettingsAssumptions.

        Расширить временное окно для смен исполнителей и транспорта.  Левая граница первой смены одной сущности расширяется до левой границы указанного окна, правая до правой границы или начала следующего окна на эту же сущность. Каждая следующая смена сдвигает правую границу до следующей смены или до правой границы указанного окна.   # noqa: E501

        :param expand_shift_time_window: The expand_shift_time_window of this PlanSettingsAssumptions.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlanSettingsAssumptions):
            return False
