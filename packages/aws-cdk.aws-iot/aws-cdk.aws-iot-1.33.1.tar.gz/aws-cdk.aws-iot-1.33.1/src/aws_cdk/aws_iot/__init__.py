...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-iot", "1.33.1", __name__, "aws-iot@1.33.1.jsii.tgz")
...
class CfnTopicRule(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-iot.CfnTopicRule"):
    ...
    class AssetPropertyTimestampProperty():
        def __init__(self, *, time_in_seconds: str, offset_in_nanos: typing.Optional[str]=None):
            """
    ...
    class AssetPropertyValueProperty():
        def __init__(self, *, timestamp: typing.Union[aws_cdk.core.IResolvable, "CfnTopicRule.AssetPropertyTimestampProperty"], value: typing.Union[aws_cdk.core.IResolvable, "CfnTopicRule.AssetPropertyVariantProperty"], quality: typing.Optional[str]=None):
            """
    ...
    class AssetPropertyVariantProperty():
        def __init__(self, *, boolean_value: typing.Optional[str]=None, double_value: typing.Optional[str]=None, integer_value: typing.Optional[str]=None, string_value: typing.Optional[str]=None):
            """
    ...
    class HttpAuthorizationProperty():
        def __init__(self, *, sigv4: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnTopicRule.SigV4AuthorizationProperty"]]]=None):
            """
    ...
    class IotEventsActionProperty():
        def __init__(self, *, input_name: str, role_arn: str, message_id: typing.Optional[str]=None):
            """
    ...
    class IotSiteWiseActionProperty():
        def __init__(self, *, put_asset_property_value_entries: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnTopicRule.PutAssetPropertyValueEntryProperty"]]], role_arn: str):
            """
    ...
    class PutAssetPropertyValueEntryProperty():
        def __init__(self, *, property_values: typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnTopicRule.AssetPropertyValueProperty"]]], asset_id: typing.Optional[str]=None, entry_id: typing.Optional[str]=None, property_alias: typing.Optional[str]=None, property_id: typing.Optional[str]=None):
            """
    ...
    class RepublishActionProperty():
        def __init__(self, *, role_arn: str, topic: str, qos: typing.Optional[jsii.Number]=None):
            """
    ...
    class SigV4AuthorizationProperty():
        def __init__(self, *, role_arn: str, service_name: str, signing_region: str):
            """
