...
class PapersClient(NamespacedClient):
    ...
    def add_csv(self, params=None):
        ...
        for index in range(len(df)):
            ...
            research_problem = self.__setValue('contribution:research_problem', paper, '')
            ...
            metadata_headers = ['paper:title', 'paper:authors', 'paper:publication_month', 'paper:publication_year', 'paper:doi', 'paper:research_field', 'contribution:research_problem']
