...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', 'v0.0.1-dev.1587702691+g6217447'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway v0.0.1-dev.1587702691+g6217447`
                """)
            else:
                raise
