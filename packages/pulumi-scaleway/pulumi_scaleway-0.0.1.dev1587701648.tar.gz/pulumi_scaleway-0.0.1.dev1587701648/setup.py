...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', 'v0.0.1-dev.1587701648+g53c65a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway v0.0.1-dev.1587701648+g53c65a5`
                """)
            else:
                raise
