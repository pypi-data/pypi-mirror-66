...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', 'v0.0.1-dev.1587699404+ga5a66ff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway v0.0.1-dev.1587699404+ga5a66ff`
                """)
            else:
                raise
