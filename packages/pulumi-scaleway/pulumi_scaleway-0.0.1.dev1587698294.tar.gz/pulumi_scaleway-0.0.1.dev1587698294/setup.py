...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', 'v0.0.1-dev.1587698294+g2deb59e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway v0.0.1-dev.1587698294+g2deb59e`
                """)
            else:
                raise
