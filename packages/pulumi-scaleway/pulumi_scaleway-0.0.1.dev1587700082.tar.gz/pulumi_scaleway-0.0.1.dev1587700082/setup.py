...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', 'v0.0.1-dev.1587700082+g9c7018b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource scaleway v0.0.1-dev.1587700082+g9c7018b`
                """)
            else:
                raise
