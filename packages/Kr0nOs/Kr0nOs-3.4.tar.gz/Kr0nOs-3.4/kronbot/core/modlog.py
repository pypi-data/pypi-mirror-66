...
log = logging.getLogger("kron.core.modlog")
...
class Case:
    ...
    @classmethod
    async def from_json(
        cls, mod_channel: discord.TextChannel, bot: Kron, case_number: int, data: dict, **kwargs
    ):
...
async def get_case(case_number: int, guild: discord.Guild, bot: Kron) -> Case:
    """
...
async def get_latest_case(guild: discord.Guild, bot: Kron) -> Optional[Case]:
...
async def get_all_cases(guild: discord.Guild, bot: Kron) -> List[Case]:
    """
...
async def get_cases_for_member(
    guild: discord.Guild, bot: Kron, *, member: discord.Member = None, member_id: int = None
) -> List[Case]:
    """
...
async def register_casetypes(new_types: List[dict]) -> List[CaseType]:
    ...
    See Also
    --------
    kronbot.core.modlog.register_casetype
