...
from kronbot.core.utils.common_filters import (
    escape_spoilers_and_mass_mentions,
    filter_invites,
    filter_various_mentions,
)
from kronbot.core.utils.mod import get_audit_reason
    ...
    async def userinfo(self, ctx, *, user: discord.Member = None):
        ...
        if roles:
            ...
            if len(role_str) > 1024:
                ...
                # infintesimally small compared to when we don't across all uses of Kron.
