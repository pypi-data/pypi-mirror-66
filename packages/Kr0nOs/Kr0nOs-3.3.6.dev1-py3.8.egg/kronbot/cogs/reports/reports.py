...
from kronbot.core.utils.antispam import AntiSpam
from kronbot.core.utils.chat_formatting import box, pagify
from kronbot.core.utils.predicates import MessagePredicate
from kronbot.core.utils.tunnel import Tunnel

_ = Translator("Reports", __file__)

log = logging.getLogger("kron.reports")
...
class Reports(commands.Cog):
    ...
    # see kronbot/core/utils/antispam.py for more details
    ...
    async def internal_filter(self, m: discord.Member, mod=False, perms=None):
        ...
        # in Kron, though I'm not sure it makes sense to use here.
