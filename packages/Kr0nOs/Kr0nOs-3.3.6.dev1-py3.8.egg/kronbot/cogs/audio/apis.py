...
from typing import TYPE_CHECKING, Callable, List, MutableMapping, NoReturn, Optional, Tuple, Union

import aiohttp
import discord

import lavalink
from kronbot.core import Config, commands
...
log = logging.getLogger("kronbot.audio.cache")
...
def _pass_config_to_apis(config: Config, bot: Kron):
...
class SpotifyAPI:
    ...
    def __init__(self, bot: Kron, session: aiohttp.ClientSession):
        self.bot = bot
