...
from typing import AsyncIterator, Iterator, List, MutableMapping, Optional, Union
...
def _pass_config_to_dataclasses(config: Config, bot: Kron, folder: str):
