...
log = logging.getLogger("kron.config")
...
class Config(metaclass=ConfigMeta):
    """Configuration manager for cogs and Kron.
    ...
    unique_identifier : `int`
        ...
        conflicts occur.
    driver
        An instance of a driver that implements `kronbot.core.drivers.BaseDriver`.
    force_registration : `bool`
    ...
    def guild_from_id(self, guild_id: int) -> Group:
        ...
        Returns
        -------
        `Group <kronbot.core.config.Group>`
