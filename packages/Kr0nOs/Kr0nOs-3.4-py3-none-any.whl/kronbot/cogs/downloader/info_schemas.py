...
from kronbot import VersionInfo
from kronbot import version_info as kron_version_info
...
def ensure_kron_version_info(
    info_file: Path, key_name: str, value: Union[Any, UseDefault]
) -> VersionInfo:
    default = kron_version_info
    if value is USE_DEFAULT:
        return default
    if not isinstance(value, str):
        log.warning(
...
INSTALLABLE_SCHEMA: SchemaType = {
    "min_bot_version": ensure_kron_version_info,
    "max_bot_version": ensure_kron_version_info,
