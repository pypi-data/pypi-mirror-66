...
from mastapy.system_model.optimization import _1801, _1799
...
TStep = TypeVar('TStep', bound='_1799.OptimizationStep')


class OptimizationStrategy(_1801.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
