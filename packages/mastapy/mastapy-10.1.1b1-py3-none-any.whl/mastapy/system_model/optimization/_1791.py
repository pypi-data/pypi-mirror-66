...
from mastapy.system_model.optimization import _1800, _1792
...
class ConicalGearOptimisationStrategy(_1800.OptimizationStrategy['_1792.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
