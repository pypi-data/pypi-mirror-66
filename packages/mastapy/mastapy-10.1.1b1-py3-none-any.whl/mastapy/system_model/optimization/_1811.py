...
from mastapy.system_model.optimization import _1820, _1812
...
class ConicalGearOptimisationStrategy(_1820.OptimizationStrategy['_1812.ConicalGearOptimizationStep']):
    '''ConicalGearOptimisationStrategy
