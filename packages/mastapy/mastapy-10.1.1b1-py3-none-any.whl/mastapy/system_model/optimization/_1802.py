...
from mastapy.system_model.optimization import _1794
...
class OptimizationStrategyDatabase(_0.APIBase):
    '''OptimizationStrategyDatabase
    ...
    @property
    def item(self) -> '_1794.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1794.CylindricalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1794.CylindricalGearOptimisationStrategy':
        ...
        return constructor.new(_1794.CylindricalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_optimisation_strategy: '_1794.CylindricalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, cylindrical_gear_optimisation_strategy: '_1794.CylindricalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_optimisation_strategy: '_1794.CylindricalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1794.CylindricalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1794.CylindricalGearOptimisationStrategy))

    def save_changes(self, cylindrical_gear_optimisation_strategy: '_1794.CylindricalGearOptimisationStrategy'):
