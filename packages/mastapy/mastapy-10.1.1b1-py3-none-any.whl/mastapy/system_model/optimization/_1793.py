...
from mastapy.system_model.optimization import _1791
...
class ConicalGearOptimizationStrategyDatabase(_0.APIBase):
    '''ConicalGearOptimizationStrategyDatabase
    ...
    @property
    def item(self) -> '_1791.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1791.ConicalGearOptimisationStrategy)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1791.ConicalGearOptimisationStrategy':
        ...
        return constructor.new(_1791.ConicalGearOptimisationStrategy)(method_result) if method_result else None

    def can_be_removed(self, conical_gear_optimisation_strategy: '_1791.ConicalGearOptimisationStrategy') -> 'bool':
    ...
    def rename(self, conical_gear_optimisation_strategy: '_1791.ConicalGearOptimisationStrategy', new_name: 'str') -> 'bool':
    ...
    def remove(self, conical_gear_optimisation_strategy: '_1791.ConicalGearOptimisationStrategy'):
    ...
    def get_all_items(self) -> 'Iterable[_1791.ConicalGearOptimisationStrategy]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1791.ConicalGearOptimisationStrategy))

    def save_changes(self, conical_gear_optimisation_strategy: '_1791.ConicalGearOptimisationStrategy'):
