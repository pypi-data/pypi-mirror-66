...
from mastapy.gears.gear_designs.face import _746
...
class FaceGearMesh(_1852.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_746.FaceGearMeshDesign':
        ...
        return constructor.new(_746.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
