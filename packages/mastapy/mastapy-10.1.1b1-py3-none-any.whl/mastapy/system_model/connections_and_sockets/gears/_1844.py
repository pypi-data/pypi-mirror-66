...
class ConceptGearMesh(_1852.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_901.ConceptGearMeshDesign':
        ...
        return constructor.new(_901.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
