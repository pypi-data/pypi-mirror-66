...
from mastapy.utility_gui import _1496
from mastapy import _3, _6498, _0
...
from mastapy.system_model.part_model import (
    _2013, _2010, _2012, _2006,
    _1977, _1978, _1979, _1982,
    _1984, _1985, _1986, _1989,
    _1990, _1993, _1994, _1995,
    _1998, _2001, _2002, _2003,
    _2005, _2007, _2009, _2014,
    _2015, _2016
)
from mastapy.gears import _125, _131
from mastapy.gears.materials import _381
from mastapy.utility import _1130, _1129, _1128
from mastapy.system_model import _1809, _1808
...
from mastapy.system_model.part_model.configurations import _2144, _2142, _2145
...
from mastapy.system_model.database_access import _1829
from mastapy.bearings.bearing_designs.rolling import _1756
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2474
from mastapy.system_model.part_model.shaft_model import _2019
from mastapy.system_model.part_model.couplings import (
    _2108, _2110, _2111, _2113,
    _2114, _2115, _2116, _2117,
    _2118, _2119, _2120, _2121,
...
from mastapy.gears.gear_designs.creation_options import _878, _881, _880
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1496.MASTAGUI':
        ...
        return constructor.new(_1496.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def file_save_details_most_recent(self) -> '_1130.FileHistoryItem':
        ...
        return constructor.new(_1130.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1809.TransmissionTemperatureSet':
        ...
        return constructor.new(_1809.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_972.DetailedSplineJointSettings':
        ...
        return constructor.new(_972.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1129.FileHistory':
        ...
        return constructor.new(_1129.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2048.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2048.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1808.SystemReporting':
        ...
        return constructor.new(_1808.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1912.BatchOperations':
        ...
        return constructor.new(_1912.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1592.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1592.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2048.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2048.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2144.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2144.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2142.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2142.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2145.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2145.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5234.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5234.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_6181.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_6181.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_5235.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5235.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2012.RootAssembly':
        ...
        return constructor.new(_2012.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2069.GearSetConfiguration':
        ...
        return constructor.new(_2069.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @property
    def status(self) -> '_1309.Status':
        ...
        return constructor.new(_1309.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def databases(self) -> '_1829.Databases':
        ...
        return constructor.new(_1829.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1756.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5234.DesignState':
        ...
        return constructor.new(_5234.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5235.DutyCycle':
        ...
        return constructor.new(_5235.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1309.Status':
        ...
        return constructor.new(_1309.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6498.TaskProgress') -> '_1309.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2474.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2474.SynchroniserShift':
        ...
        return constructor.new(_2474.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2474.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5234.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5235.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1977.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1977.Assembly.TYPE](), constructor.new(_1977.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1128.ExternalFullFEFileOption'] = _1128.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2104.BeltCreationOptions':
        ...
        return constructor.new(_2104.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2106.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2106.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2107.ShaftCreationOptions':
        ...
        return constructor.new(_2107.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_878.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_878.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2105.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2105.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_881.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_881.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None

    def new_hypoid_gear_set_creation_options(self) -> '_880.HypoidGearSetCreationOptions':
        ...
        return constructor.new(_880.HypoidGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1383.NodalMatrix':
        ...
        return constructor.new(_1383.NodalMatrix)(method_result) if method_result else None
