...
from mastapy.system_model.imported_fes import (
    _1953, _1958, _1952, _1944
)
from mastapy.nodal_analysis.dev_tools_analyses import _1472
...
from mastapy.system_model.connections_and_sockets import (
    _1855, _1836, _1838, _1840,
    _1841, _1842, _1844, _1845,
...
class ImportedFELink(_0.APIBase):
    ...
    def socket(self) -> '_1855.Socket':
        ...
        return constructor.new(_1855.Socket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1836.CVTPulleySocket':
        ...
        if _1836.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1836.CVTPulleySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1838.CylindricalSocket':
        ...
        if _1838.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1838.CylindricalSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1840.ElectricMachineStatorSocket':
        ...
        if _1840.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1840.ElectricMachineStatorSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_connecting_socket(self) -> '_1841.InnerShaftConnectingSocket':
        ...
        if _1841.InnerShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1841.InnerShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1842.InnerShaftSocket':
        ...
        if _1842.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1842.InnerShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_connecting_socket(self) -> '_1844.OuterShaftConnectingSocket':
        ...
        if _1844.OuterShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1844.OuterShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1845.OuterShaftSocket':
        ...
        if _1845.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1845.OuterShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket(self) -> '_1847.PlanetarySocket':
        ...
        if _1847.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1847.PlanetarySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_pulley_socket(self) -> '_1848.PulleySocket':
        ...
        if _1848.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1848.PulleySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_1851.RollingRingSocket':
        ...
        if _1851.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1851.RollingRingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_shaft_connecting_socket(self) -> '_1852.ShaftConnectingSocket':
        ...
        if _1852.ShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1852.ShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_shaft_socket(self) -> '_1853.ShaftSocket':
        ...
        if _1853.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1853.ShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1859.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1859.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1859.AGMAGleasonConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_1861.BevelDifferentialGearTeethSocket':
        ...
        if _1861.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1861.BevelDifferentialGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_1863.BevelGearTeethSocket':
        ...
        if _1863.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1863.BevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_1865.ConceptGearTeethSocket':
        ...
        if _1865.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1865.ConceptGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_1867.ConicalGearTeethSocket':
        ...
        if _1867.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1867.ConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1869.CylindricalGearTeethSocket':
        ...
        if _1869.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1869.CylindricalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_1871.FaceGearTeethSocket':
        ...
        if _1871.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1871.FaceGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_gear_teeth_socket(self) -> '_1873.GearTeethSocket':
        ...
        if _1873.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1873.GearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_1875.HypoidGearTeethSocket':
        ...
        if _1875.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1875.HypoidGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1876.KlingelnbergConicalGearTeethSocket':
        ...
        if _1876.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1876.KlingelnbergConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_1880.KlingelnbergHypoidGearTeethSocket':
        ...
        if _1880.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1880.KlingelnbergHypoidGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_1881.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _1881.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1881.KlingelnbergSpiralBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_1883.SpiralBevelGearTeethSocket':
        ...
        if _1883.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1883.SpiralBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_1885.StraightBevelDiffGearTeethSocket':
        ...
        if _1885.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1885.StraightBevelDiffGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_1887.StraightBevelGearTeethSocket':
        ...
        if _1887.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1887.StraightBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_1889.WormGearTeethSocket':
        ...
        if _1889.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1889.WormGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_1891.ZerolBevelGearTeethSocket':
        ...
        if _1891.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1891.ZerolBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_clutch_socket(self) -> '_1893.ClutchSocket':
        ...
        if _1893.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1893.ClutchSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_1895.ConceptCouplingSocket':
        ...
        if _1895.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1895.ConceptCouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_coupling_socket(self) -> '_1897.CouplingSocket':
        ...
        if _1897.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1897.CouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_1899.PartToPartShearCouplingSocket':
        ...
        if _1899.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1899.PartToPartShearCouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_spring_damper_socket(self) -> '_1901.SpringDamperSocket':
        ...
        if _1901.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1901.SpringDamperSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_1903.TorqueConverterPumpSocket':
        ...
        if _1903.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1903.TorqueConverterPumpSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_1904.TorqueConverterTurbineSocket':
        ...
        if _1904.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1904.TorqueConverterTurbineSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def alignment_in_world_coordinate_system(self) -> '_1952.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1952.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_1952.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1952.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_1952.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1952.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None

    @property
    def nodes(self) -> 'List[_1944.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1944.ImportedFEStiffnessNode))
        return value
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_1944.ImportedFEStiffnessNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_1944.ImportedFEStiffnessNode))
    ...
    def add_or_replace_node(self, node: '_1944.ImportedFEStiffnessNode'):
