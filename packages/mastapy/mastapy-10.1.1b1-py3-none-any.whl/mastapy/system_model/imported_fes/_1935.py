...
from mastapy.system_model.imported_fes import (
    _1915, _1948, _1972, _1909,
    _1911, _1973, _1968, _1947,
    _1907, _1931, _1934, _1954,
    _1953, _1950, _1951, _1952
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _1993, _1989, _2001
from mastapy.nodal_analysis import _1376, _1369, _1372
from mastapy.nodal_analysis.component_mode_synthesis import _1492
...
class ImportedFE(_1372.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1915.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1915.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1915.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1909.AlignmentMethod':
        ...
        return constructor.new(_1909.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1909.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1376.GravityForceSource':
        ...
        return constructor.new(_1376.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1369.FEMeshingOptions':
        ...
        return constructor.new(_1369.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1492.FullFEModel':
        ...
        return constructor.new(_1492.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1808.RelativeComponentAlignment[_1989.Component]':
        ...
        return constructor.new(_1808.RelativeComponentAlignment)[_1989.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1911.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1911.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1063.CoordinateSystem3D':
        ...
        return constructor.new(_1063.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1973.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1973.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1968.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1968.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2022.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2022.Shaft))
        return value

    @property
    def links(self) -> 'List[_1907.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1907.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1118.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1118.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1118.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1118.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1931.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1931.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1934.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1934.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1954.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1954.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2001.ImportedFEComponent':
        ...
        return constructor.new(_2001.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6501.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1953.ImportedFEWithSelectionStaticAnalysis':
        ...
        return constructor.new(_1953.ImportedFEWithSelectionStaticAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_components(self) -> '_1950.ImportedFEWithSelectionComponents':
        ...
        return constructor.new(_1950.ImportedFEWithSelectionComponents)(method_result) if method_result else None

    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1951.ImportedFEWithSelectionForHarmonicAnalysis':
        ...
        return constructor.new(_1951.ImportedFEWithSelectionForHarmonicAnalysis)(method_result) if method_result else None

    def create_imported_fe_with_selection_modal_analysis(self) -> '_1952.ImportedFEWithSelectionModalAnalysis':
        ...
        return constructor.new(_1952.ImportedFEWithSelectionModalAnalysis)(method_result) if method_result else None

    def links_for(self, node: '_1947.ImportedFEStiffnessNode') -> 'List[_1907.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1907.ImportedFELink))
