...
class ImportedFELink(_0.APIBase):
    ...
    def socket(self) -> '_1835.Socket':
        ...
        return constructor.new(_1835.Socket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1816.CVTPulleySocket':
        ...
        if _1816.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1816.CVTPulleySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1818.CylindricalSocket':
        ...
        if _1818.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1818.CylindricalSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1820.ElectricMachineStatorSocket':
        ...
        if _1820.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1820.ElectricMachineStatorSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_connecting_socket(self) -> '_1821.InnerShaftConnectingSocket':
        ...
        if _1821.InnerShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1821.InnerShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1822.InnerShaftSocket':
        ...
        if _1822.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1822.InnerShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_connecting_socket(self) -> '_1824.OuterShaftConnectingSocket':
        ...
        if _1824.OuterShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1824.OuterShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1825.OuterShaftSocket':
        ...
        if _1825.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1825.OuterShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket(self) -> '_1827.PlanetarySocket':
        ...
        if _1827.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1827.PlanetarySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_pulley_socket(self) -> '_1828.PulleySocket':
        ...
        if _1828.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1828.PulleySocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_1831.RollingRingSocket':
        ...
        if _1831.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1831.RollingRingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_shaft_connecting_socket(self) -> '_1832.ShaftConnectingSocket':
        ...
        if _1832.ShaftConnectingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1832.ShaftConnectingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_shaft_socket(self) -> '_1833.ShaftSocket':
        ...
        if _1833.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1833.ShaftSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1839.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1839.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1839.AGMAGleasonConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_1841.BevelDifferentialGearTeethSocket':
        ...
        if _1841.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1841.BevelDifferentialGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_1843.BevelGearTeethSocket':
        ...
        if _1843.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1843.BevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_1845.ConceptGearTeethSocket':
        ...
        if _1845.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1845.ConceptGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_1847.ConicalGearTeethSocket':
        ...
        if _1847.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1847.ConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1849.CylindricalGearTeethSocket':
        ...
        if _1849.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1849.CylindricalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_1851.FaceGearTeethSocket':
        ...
        if _1851.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1851.FaceGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_gear_teeth_socket(self) -> '_1853.GearTeethSocket':
        ...
        if _1853.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1853.GearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_1855.HypoidGearTeethSocket':
        ...
        if _1855.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1855.HypoidGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1856.KlingelnbergConicalGearTeethSocket':
        ...
        if _1856.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1856.KlingelnbergConicalGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_1860.KlingelnbergHypoidGearTeethSocket':
        ...
        if _1860.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1860.KlingelnbergHypoidGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_1861.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _1861.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1861.KlingelnbergSpiralBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_1863.SpiralBevelGearTeethSocket':
        ...
        if _1863.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1863.SpiralBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_1865.StraightBevelDiffGearTeethSocket':
        ...
        if _1865.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1865.StraightBevelDiffGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_1867.StraightBevelGearTeethSocket':
        ...
        if _1867.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1867.StraightBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_1869.WormGearTeethSocket':
        ...
        if _1869.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1869.WormGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_1871.ZerolBevelGearTeethSocket':
        ...
        if _1871.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1871.ZerolBevelGearTeethSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_clutch_socket(self) -> '_1873.ClutchSocket':
        ...
        if _1873.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1873.ClutchSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_1875.ConceptCouplingSocket':
        ...
        if _1875.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1875.ConceptCouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_coupling_socket(self) -> '_1877.CouplingSocket':
        ...
        if _1877.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new(_1877.CouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_1879.PartToPartShearCouplingSocket':
        ...
        if _1879.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1879.PartToPartShearCouplingSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_spring_damper_socket(self) -> '_1881.SpringDamperSocket':
        ...
        if _1881.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1881.SpringDamperSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_1883.TorqueConverterPumpSocket':
        ...
        if _1883.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1883.TorqueConverterPumpSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_1884.TorqueConverterTurbineSocket':
        ...
        if _1884.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
        ...
        return constructor.new(_1884.TorqueConverterTurbineSocket)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def alignment_in_world_coordinate_system(self) -> '_1932.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1932.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_1932.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1932.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_1932.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_1932.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None

    @property
    def nodes(self) -> 'List[_1924.ImportedFEStiffnessNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1924.ImportedFEStiffnessNode))
        return value
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_1924.ImportedFEStiffnessNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_1924.ImportedFEStiffnessNode))
    ...
    def add_or_replace_node(self, node: '_1924.ImportedFEStiffnessNode'):
