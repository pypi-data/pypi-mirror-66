...
class ImportedFEResults(_0.APIBase):
    ...
    @property
    def node_results(self) -> 'List[_1976.NodeComparisonResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1976.NodeComparisonResult))
        return value
