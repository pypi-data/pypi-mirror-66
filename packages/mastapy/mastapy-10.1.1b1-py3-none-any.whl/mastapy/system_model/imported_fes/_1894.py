...
from mastapy.system_model.imported_fes import _1895
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_1895.BearingRacePosition':
        ...
        return constructor.new(_1895.BearingRacePosition)(value) if value else None
