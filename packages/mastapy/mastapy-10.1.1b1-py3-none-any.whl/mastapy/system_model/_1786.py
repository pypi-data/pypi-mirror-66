...
from mastapy.math_utility import _1049
...
T = TypeVar('T', bound='_1966.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1049.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1049.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1787.RelativeOffsetOption':
        ...
        return constructor.new(_1787.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1787.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
