...
from mastapy.utility_gui import _1477
from mastapy import _3, _6478, _0
...
from mastapy.system_model.imported_fes import _1892
from mastapy.bearings.bearing_results.rolling import _1572
from mastapy.system_model.part_model.configurations import _2124, _2122, _2125
...
from mastapy.system_model.database_access import _1809
from mastapy.bearings.bearing_designs.rolling import _1736
from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2454
...
from mastapy.gears.gear_designs.creation_options import _870, _873, _872
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self) -> '_1477.MASTAGUI':
        ...
        return constructor.new(_1477.MASTAGUI)(self.wrapped.MastaGUI) if self.wrapped.MastaGUI else None
    ...
    @property
    def efficiency_rating_method_for_bearings(self) -> '_96.BearingEfficiencyRatingMethod':
        ...
        return constructor.new(_96.BearingEfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method_for_bearings.setter
    def efficiency_rating_method_for_bearings(self, value: '_96.BearingEfficiencyRatingMethod'):
    ...
    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_external_external_meshes(self) -> '_377.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_377.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForExternalExternalMeshes else None

    @property
    def iso14179_coefficient_of_friction_constants_and_exponents_for_internal_external_meshes(self) -> '_377.ISOTR1417912001CoefficientOfFrictionConstants':
        ...
        return constructor.new(_377.ISOTR1417912001CoefficientOfFrictionConstants)(self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes) if self.wrapped.ISO14179CoefficientOfFrictionConstantsAndExponentsForInternalExternalMeshes else None

    @property
    def file_save_details_most_recent(self) -> '_1118.FileHistoryItem':
        ...
        return constructor.new(_1118.FileHistoryItem)(self.wrapped.FileSaveDetailsMostRecent) if self.wrapped.FileSaveDetailsMostRecent else None

    @property
    def default_system_temperatures(self) -> '_1789.TransmissionTemperatureSet':
        ...
        return constructor.new(_1789.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def detailed_spline_settings(self) -> '_964.DetailedSplineJointSettings':
        ...
        return constructor.new(_964.DetailedSplineJointSettings)(self.wrapped.DetailedSplineSettings) if self.wrapped.DetailedSplineSettings else None
    ...
    @property
    def file_save_details_all(self) -> '_1117.FileHistory':
        ...
        return constructor.new(_1117.FileHistory)(self.wrapped.FileSaveDetailsAll) if self.wrapped.FileSaveDetailsAll else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2028.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2028.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1788.SystemReporting':
        ...
        return constructor.new(_1788.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_1892.BatchOperations':
        ...
        return constructor.new(_1892.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1572.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1572.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2028.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2028.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2124.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2124.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def imported_fe_configurations(self) -> 'List[_2122.ActiveImportedFESelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ImportedFEConfigurations, constructor.new(_2122.ActiveImportedFESelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2125.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2125.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5214.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5214.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_6161.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_6161.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_5215.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5215.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_1992.RootAssembly':
        ...
        return constructor.new(_1992.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None
    ...
    @property
    def databases(self) -> '_1809.Databases':
        ...
        return constructor.new(_1809.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    def remove_bearing_from_database(self, rolling_bearing: '_1736.RollingBearing'):
    ...
    def design_state_named(self, name: 'str') -> '_5214.DesignState':
        ...
        return constructor.new(_5214.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5215.DutyCycle':
        ...
        return constructor.new(_5215.DutyCycle)(method_result) if method_result else None
    ...
    def save(self, file_name: 'str', save_results: 'bool') -> '_1294.Status':
        ...
        return constructor.new(_1294.Status)(method_result) if method_result else None

    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6478.TaskProgress') -> '_1294.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2454.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2454.SynchroniserShift':
        ...
        return constructor.new(_2454.SynchroniserShift)(method_result) if method_result else None

    def add_synchroniser_shift_empty(self) -> '_2454.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5214.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5215.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_1957.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_1957.Assembly.TYPE](), constructor.new(_1957.Assembly))
    ...
    @staticmethod
    def load(file_path: 'str', load_full_fe_option: Optional['_1116.ExternalFullFEFileOption'] = _1116.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS) -> 'Design':
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2084.BeltCreationOptions':
        ...
        return constructor.new(_2084.BeltCreationOptions)(method_result) if method_result else None

    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2086.PlanetCarrierCreationOptions':
        ...
        return constructor.new(_2086.PlanetCarrierCreationOptions)(method_result) if method_result else None

    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2087.ShaftCreationOptions':
        ...
        return constructor.new(_2087.ShaftCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_pair_creation_options(self) -> '_870.CylindricalGearPairCreationOptions':
        ...
        return constructor.new(_870.CylindricalGearPairCreationOptions)(method_result) if method_result else None

    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2085.CylindricalGearLinearTrainCreationOptions':
        ...
        return constructor.new(_2085.CylindricalGearLinearTrainCreationOptions)(method_result) if method_result else None

    def new_spiral_bevel_gear_set_creation_options(self) -> '_873.SpiralBevelGearSetCreationOptions':
        ...
        return constructor.new(_873.SpiralBevelGearSetCreationOptions)(method_result) if method_result else None

    def new_hypoid_gear_set_creation_options(self) -> '_872.HypoidGearSetCreationOptions':
        ...
        return constructor.new(_872.HypoidGearSetCreationOptions)(method_result) if method_result else None

    def new_nodal_matrix(self, dense_matrix: 'List[List[float]]') -> '_1364.NodalMatrix':
        ...
        return constructor.new(_1364.NodalMatrix)(method_result) if method_result else None
