...
from mastapy.system_model.analyses_and_results.static_loads import _6132, _6128, _6109
...
class HarmonicLoadDataImportFromMotorPackages(_6128.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
