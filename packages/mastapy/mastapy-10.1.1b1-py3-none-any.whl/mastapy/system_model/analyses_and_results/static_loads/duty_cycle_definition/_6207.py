...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6208, _6202
...
class TorqueInputOptions(_6202.PowerLoadInputOptions):
    '''TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self) -> '_6208.TorqueValuesObtainedFrom':
        ...
        return constructor.new(_6208.TorqueValuesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6208.TorqueValuesObtainedFrom'):
