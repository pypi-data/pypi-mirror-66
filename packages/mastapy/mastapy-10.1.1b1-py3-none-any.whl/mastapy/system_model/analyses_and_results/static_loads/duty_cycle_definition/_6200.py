...
class MultiTimeSeriesDataInputFileOptions(_1479.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1317.TextFileDelimiterOptions':
        ...
        return constructor.new(_1317.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
