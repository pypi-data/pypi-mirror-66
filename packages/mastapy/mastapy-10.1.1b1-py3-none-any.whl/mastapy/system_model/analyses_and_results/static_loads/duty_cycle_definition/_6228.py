...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6218, _6229, _6220, _6217,
    _6221, _6223, _6230, _6227,
    _6219, _6222, _6216
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6137.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6137.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6137.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6229.TimeStepInputOptions':
        ...
        return constructor.new(_6229.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6220.GearRatioInputOptions':
        ...
        return constructor.new(_6220.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6217.DesignStateOptions':
        ...
        return constructor.new(_6217.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6221.LoadCaseNameOptions':
        ...
        return constructor.new(_6221.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6223.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6223.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6230.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6230.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6227.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6227.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6219.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6219.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6222.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6222.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6216.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6216.BoostPressureLoadCaseInputOptions))
        return value
