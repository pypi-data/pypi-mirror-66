...
class BevelDifferentialGearAdvancedSystemDeflection(_6226.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    def component_detailed_analysis(self) -> '_338.BevelGearRating':
        ...
        return constructor.new(_338.BevelGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2195.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2195.BevelDifferentialGearSystemDeflection))
        return value
