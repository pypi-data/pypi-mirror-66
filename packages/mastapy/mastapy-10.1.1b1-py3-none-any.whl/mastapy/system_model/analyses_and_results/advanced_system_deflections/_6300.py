...
class KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection(_6297.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_design(self) -> '_1880.KlingelnbergCycloPalloidHypoidGearMesh':
    ...
    @property
    def connection_load_case(self) -> '_6143.KlingelnbergCycloPalloidHypoidGearMeshLoadCase':
        ...
        return constructor.new(_6143.KlingelnbergCycloPalloidHypoidGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2279.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2279.KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection))
        return value
