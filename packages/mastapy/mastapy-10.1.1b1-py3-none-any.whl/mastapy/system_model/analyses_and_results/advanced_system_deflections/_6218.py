...
class BearingAdvancedSystemDeflection(_6246.ConnectorAdvancedSystemDeflection):
    '''BearingAdvancedSystemDeflection
    ...
    @property
    def duty_cycle(self) -> '_1548.LoadedBearingDutyCycle':
        ...
        return constructor.new(_1548.LoadedBearingDutyCycle)(self.wrapped.DutyCycle) if self.wrapped.DutyCycle else None
