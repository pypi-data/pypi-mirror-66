...
class FlexiblePinAnalysisManufactureLevel(_5764.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_3481.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_3481.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
