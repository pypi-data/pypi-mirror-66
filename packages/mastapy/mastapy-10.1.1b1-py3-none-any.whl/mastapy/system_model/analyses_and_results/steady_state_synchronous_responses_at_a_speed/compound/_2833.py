...
class BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed(_2829.BevelDifferentialGearCompoundSteadyStateSynchronousResponseAtASpeed):
    '''BevelDifferentialSunGearCompoundSteadyStateSynchronousResponseAtASpeed
