...
from mastapy.system_model.analyses_and_results.load_case_groups import _5212, _5213, _5209
...
class DesignState(_5209.AbstractDesignStateLoadCaseGroup):
    '''DesignState
    ...
    @property
    def clutches(self) -> 'List[_5212.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Clutches, constructor.new(_5212.ClutchEngagementStatus))
        return value

    @property
    def concept_synchro_mounted_gears(self) -> 'List[_5213.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptSynchroMountedGears, constructor.new(_5213.ConceptSynchroGearEngagementStatus))
        return value

    def clutch_engagement_status_for(self, clutch_connection: '_1872.ClutchConnection') -> '_5212.ClutchEngagementStatus':
        ...
        return constructor.new(_5212.ClutchEngagementStatus)(method_result) if method_result else None

    def concept_synchro_gear_engagement_status_for(self, gear: '_2041.CylindricalGear') -> '_5213.ConceptSynchroGearEngagementStatus':
        ...
        return constructor.new(_5213.ConceptSynchroGearEngagementStatus)(method_result) if method_result else None
    ...
    def create_load_case(self, name: Optional['str'] = 'New Static Load') -> '_6161.StaticLoadCase':
        ...
        return constructor.new(_6161.StaticLoadCase)(method_result) if method_result else None
