...
TReal = TypeVar('TReal', bound='_1966.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6048.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5226.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
