...
TReal = TypeVar('TReal', bound='_1986.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6068.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5246.DesignEntityStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
