...
TAssembly = TypeVar('TAssembly', bound='_1958.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6023.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5226.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
