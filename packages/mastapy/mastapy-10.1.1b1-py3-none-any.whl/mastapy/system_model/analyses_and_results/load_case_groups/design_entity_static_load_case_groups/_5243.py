...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5246
...
TAssembly = TypeVar('TAssembly', bound='_1978.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6043.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5246.DesignEntityStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
