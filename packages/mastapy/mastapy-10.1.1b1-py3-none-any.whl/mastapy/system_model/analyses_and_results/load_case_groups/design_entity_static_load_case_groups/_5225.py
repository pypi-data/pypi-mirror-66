...
TConnection = TypeVar('TConnection', bound='_1814.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6060.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5226.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
