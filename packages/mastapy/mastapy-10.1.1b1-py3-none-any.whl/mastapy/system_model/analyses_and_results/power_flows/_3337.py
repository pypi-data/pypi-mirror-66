...
from mastapy.system_model.analyses_and_results.power_flows import _3336, _3335, _3270
...
class WormGearSetPowerFlow(_3270.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3336.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3336.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3336.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3336.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3335.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3335.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3335.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3335.WormGearMeshPowerFlow))
        return value
