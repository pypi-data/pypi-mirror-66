...
from mastapy.system_model.analyses_and_results.power_flows import _3268, _3269, _3309
...
class GearSetPowerFlow(_3309.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3268.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3268.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3269.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3269.GearPowerFlow))
        return value
