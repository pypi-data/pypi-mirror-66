...
from mastapy.utility.units_and_measurements.measurements import _1205
...
class ShaftModalComplexShape(_3188.ShaftComplexShape['_1205.Number', 'SMT.MastaAPI.Utility.UnitsAndMeasurements.Measurements.Number']):
    '''ShaftModalComplexShape
