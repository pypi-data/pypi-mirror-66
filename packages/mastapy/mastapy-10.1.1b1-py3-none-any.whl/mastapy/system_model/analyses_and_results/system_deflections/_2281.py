...
class KlingelnbergCycloPalloidHypoidGearSystemDeflection(_2278.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3281.KlingelnbergCycloPalloidHypoidGearPowerFlow':
