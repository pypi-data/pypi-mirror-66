...
class BevelDifferentialPlanetGearSystemDeflection(_2195.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3205.BevelDifferentialPlanetGearPowerFlow':
