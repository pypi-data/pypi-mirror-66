...
class BevelDifferentialGearMeshSystemDeflection(_2198.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3202.BevelDifferentialGearMeshPowerFlow':
