...
from mastapy.system_model.analyses_and_results.system_deflections import _2207, _2269
from mastapy.system_model.analyses_and_results.power_flows import (
    _3193, _3197, _3198, _3201,
    _3204, _3209, _3210, _3214,
    _3219, _3222, _3225, _3230,
    _3232, _3237, _3243, _3244,
    _3247, _3251, _3256, _3259,
    _3262, _3270, _3272, _3279,
    _3282, _3286, _3289, _3292,
    _3295, _3298, _3303, _3307,
    _3314, _3317
)
...
class AbstractAssemblySystemDeflection(_2269.PartSystemDeflection):
    '''AbstractAssemblySystemDeflection
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_2329.RigidlyConnectedComponentGroupSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_2329.RigidlyConnectedComponentGroupSystemDeflection))
        return value

    @property
    def components_with_unknown_mass_properties(self) -> 'List[_2207.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithUnknownMassProperties, constructor.new(_2207.ComponentSystemDeflection))
        return value

    @property
    def components_with_zero_mass_properties(self) -> 'List[_2207.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentsWithZeroMassProperties, constructor.new(_2207.ComponentSystemDeflection))
        return value

    @property
    def power_flow_results(self) -> '_3193.AbstractAssemblyPowerFlow':
