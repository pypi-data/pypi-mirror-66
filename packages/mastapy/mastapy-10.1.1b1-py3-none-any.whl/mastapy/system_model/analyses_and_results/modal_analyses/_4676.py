...
from mastapy.system_model.analyses_and_results.modal_analyses import _4699, _4729, _4756
...
class AbstractAssemblyModalAnalysis(_4756.PartModalAnalysis):
    '''AbstractAssemblyModalAnalysis
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4699.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4699.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4729.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4729.GearMeshModalAnalysis))
        return value
