...
from mastapy.utility.modal_analysis import _1297
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2159.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1297.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1297.DesignEntityExcitationDescription))
        return value
