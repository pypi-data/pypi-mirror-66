...
from mastapy.nodal_analysis.component_mode_synthesis import _1474
...
class ModalCMSResultsForModeAndFE(_0.APIBase):
    ...
    @property
    def modal_full_fe_results(self) -> '_1474.ModalCMSResults':
        ...
        return constructor.new(_1474.ModalCMSResults)(self.wrapped.ModalFullFEResults) if self.wrapped.ModalFullFEResults else None
