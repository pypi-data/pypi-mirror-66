...
class PerModeResultsReport(_1263.CustomReportChart):
    '''PerModeResultsReport
    ...
    @property
    def display_option(self) -> '_1319.TableAndChartOptions':
    ...
    def display_option(self, value: '_1319.TableAndChartOptions'):
