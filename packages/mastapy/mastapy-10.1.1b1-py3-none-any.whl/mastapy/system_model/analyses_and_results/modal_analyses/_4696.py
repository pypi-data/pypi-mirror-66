...
from mastapy.system_model.analyses_and_results.modal_analyses import _4719, _4749, _4776
...
class AbstractAssemblyModalAnalysis(_4776.PartModalAnalysis):
    ...
    @property
    def rigidly_connected_groups(self) -> 'List[_4719.ComponentModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidlyConnectedGroups, constructor.new(_4719.ComponentModalAnalysis))
        return value

    @property
    def gear_meshes(self) -> 'List[_4749.GearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshes, constructor.new(_4749.GearMeshModalAnalysis))
        return value
