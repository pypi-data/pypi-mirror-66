...
from mastapy.nodal_analysis import _1362, _1361
...
class ModalAnalysisBarModelFEExportOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_1361.BarModelAnalysisType':
        ...
        return constructor.new(_1361.BarModelAnalysisType)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_1361.BarModelAnalysisType'):
    ...
    @property
    def mode_options(self) -> '_1452.EigenvalueOptions':
        ...
        return constructor.new(_1452.EigenvalueOptions)(self.wrapped.ModeOptions) if self.wrapped.ModeOptions else None
