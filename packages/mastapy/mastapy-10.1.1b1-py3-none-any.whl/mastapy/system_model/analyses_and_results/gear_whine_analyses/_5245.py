...
class BevelGearMeshGearWhineAnalysis(_5233.AGMAGleasonConicalGearMeshGearWhineAnalysis):
    '''BevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2198.BevelGearMeshSystemDeflection':
