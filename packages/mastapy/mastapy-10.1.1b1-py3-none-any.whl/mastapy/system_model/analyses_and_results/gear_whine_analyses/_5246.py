...
class BevelGearSetGearWhineAnalysis(_5234.AGMAGleasonConicalGearSetGearWhineAnalysis):
    '''BevelGearSetGearWhineAnalysis
    ...
    @property
    def assembly_design(self) -> '_2036.BevelGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2199.BevelGearSetSystemDeflection':
