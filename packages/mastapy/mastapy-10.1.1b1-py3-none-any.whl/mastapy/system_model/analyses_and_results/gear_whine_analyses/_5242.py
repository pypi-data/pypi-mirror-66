...
class BevelDifferentialPlanetGearGearWhineAnalysis(_5239.BevelDifferentialGearGearWhineAnalysis):
    '''BevelDifferentialPlanetGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2033.BevelDifferentialPlanetGear':
    ...
    @property
    def system_deflection_results(self) -> '_2196.BevelDifferentialPlanetGearSystemDeflection':
