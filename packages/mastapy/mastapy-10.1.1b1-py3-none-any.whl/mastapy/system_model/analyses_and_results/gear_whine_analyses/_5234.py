...
class AGMAGleasonConicalGearSetGearWhineAnalysis(_5263.ConicalGearSetGearWhineAnalysis):
    '''AGMAGleasonConicalGearSetGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2187.AGMAGleasonConicalGearSetSystemDeflection':
