...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5366, _5317
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def modal_analysis_options(self) -> '_4775.ModalAnalysisOptions':
        ...
        return constructor.new(_4775.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
