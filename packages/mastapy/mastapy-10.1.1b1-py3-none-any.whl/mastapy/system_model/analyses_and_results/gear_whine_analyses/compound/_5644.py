...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.compound import _5672
...
class AGMAGleasonConicalGearCompoundGearWhineAnalysis(_5672.ConicalGearCompoundGearWhineAnalysis):
    '''AGMAGleasonConicalGearCompoundGearWhineAnalysis
