...
class BevelDifferentialGearMeshGearWhineAnalysis(_5245.BevelGearMeshGearWhineAnalysis):
    '''BevelDifferentialGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2193.BevelDifferentialGearMeshSystemDeflection':
