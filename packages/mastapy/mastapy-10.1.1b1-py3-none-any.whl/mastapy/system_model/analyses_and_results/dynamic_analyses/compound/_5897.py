...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _5925
...
class AGMAGleasonConicalGearCompoundDynamicAnalysis(_5925.ConicalGearCompoundDynamicAnalysis):
    '''AGMAGleasonConicalGearCompoundDynamicAnalysis
