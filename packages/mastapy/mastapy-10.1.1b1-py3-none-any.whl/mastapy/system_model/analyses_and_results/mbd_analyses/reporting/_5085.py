...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5082
...
class DynamicTorqueResultAtTime(_5082.AbstractMeasuredDynamicResponseAtTime):
    '''DynamicTorqueResultAtTime
