...
class BearingMultiBodyDynamicsAnalysis(_4980.ConnectorMultiBodyDynamicsAnalysis):
    '''BearingMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5084.DynamicForceVector3DResult':
        ...
        return constructor.new(_5084.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None
