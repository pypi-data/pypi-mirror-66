...
from mastapy.system_model.part_model.couplings import _2134, _2136
...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2134.SynchroniserHalf':
        ...
        return constructor.new(_2134.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2136.SynchroniserSleeve':
        ...
        return constructor.new(_2136.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
