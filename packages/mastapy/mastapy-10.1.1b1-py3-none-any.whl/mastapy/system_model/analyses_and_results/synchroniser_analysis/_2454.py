...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2114.SynchroniserHalf':
        ...
        return constructor.new(_2114.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2116.SynchroniserSleeve':
        ...
        return constructor.new(_2116.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
