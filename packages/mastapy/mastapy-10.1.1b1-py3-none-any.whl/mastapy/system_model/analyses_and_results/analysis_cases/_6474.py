...
class TimeSeriesLoadAnalysisCase(_6458.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6175.TimeSeriesLoadCase':
        ...
        return constructor.new(_6175.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
