...
from mastapy.system_model.analyses_and_results import _2160, _2158
...
class DesignEntityCompoundAnalysis(_2158.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2160.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2160.DesignEntitySingleContextAnalysis))
        return value
