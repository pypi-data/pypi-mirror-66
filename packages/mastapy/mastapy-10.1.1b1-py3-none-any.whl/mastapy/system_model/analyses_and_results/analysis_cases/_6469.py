...
class PartCompoundAnalysis(_6466.DesignEntityCompoundAnalysis):
    '''PartCompoundAnalysis
    ...
    @property
    def twod_drawing(self) -> '_6481.SMTBitmap':
        ...
        return constructor.new(_6481.SMTBitmap)(self.wrapped.TwoDDrawing) if self.wrapped.TwoDDrawing else None
