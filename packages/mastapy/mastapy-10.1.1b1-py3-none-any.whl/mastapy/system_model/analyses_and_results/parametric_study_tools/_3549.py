...
from mastapy.system_model.analyses_and_results.static_loads import _6052, _6154
from mastapy.system_model import _1799
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3550, _3551
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6154.ParametricStudyType':
        ...
        return constructor.new(_6154.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6154.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1799.ExternalFullFELoader':
        ...
        return constructor.new(_1799.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3550.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3550.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3551.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3551.ParametricStudyVariable))
        return value
