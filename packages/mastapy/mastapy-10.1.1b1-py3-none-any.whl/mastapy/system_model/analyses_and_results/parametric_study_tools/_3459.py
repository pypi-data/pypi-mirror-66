...
class ClutchConnectionParametricStudyTool(_3475.CouplingConnectionParametricStudyTool):
    '''ClutchConnectionParametricStudyTool
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2203.ClutchConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2203.ClutchConnectionSystemDeflection))
        return value
