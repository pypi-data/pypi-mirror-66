...
class FlexiblePinAssembly(_1994.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2041.CylindricalGear':
        ...
        return constructor.new(_2041.CylindricalGear)(self.wrapped.PlanetGear) if self.wrapped.PlanetGear else None
