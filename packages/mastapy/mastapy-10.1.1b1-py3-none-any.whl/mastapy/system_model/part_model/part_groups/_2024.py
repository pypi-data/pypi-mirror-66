...
from mastapy.math_utility import _1056
from mastapy.system_model.part_model.part_groups import _2025, _2023
...
class ConcentricPartGroup(_2023.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def radial_position(self) -> '_1056.Vector2D':
        ...
        return constructor.new(_1056.Vector2D)(self.wrapped.RadialPosition) if self.wrapped.RadialPosition else None

    @property
    def parallel_groups(self) -> 'List[_2025.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2025.ConcentricPartGroupParallelToThis))
        return value
