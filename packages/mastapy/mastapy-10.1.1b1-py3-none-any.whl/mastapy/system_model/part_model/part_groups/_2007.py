...
from mastapy.system_model.part_model.part_groups import _2004, _2006, _2003
...
class ParallelPartGroup(_2003.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2004.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2004.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2006.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2006.DesignMeasurements))
        return value
