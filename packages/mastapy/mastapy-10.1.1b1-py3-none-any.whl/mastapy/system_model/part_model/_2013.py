...
from mastapy.system_model.part_model import _2021, _2019
...
class PowerLoad(_2019.VirtualComponent):
    '''PowerLoad
    ...
    @property
    def electric_machine_detail(self) -> '_6101.ElectricMachineDetail':
        ...
        return constructor.new(_6101.ElectricMachineDetail)(self.wrapped.ElectricMachineDetail) if self.wrapped.ElectricMachineDetail else None
