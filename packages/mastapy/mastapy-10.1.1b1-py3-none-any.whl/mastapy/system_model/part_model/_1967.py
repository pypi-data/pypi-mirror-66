...
from mastapy.system_model.part_model import _1968
...
class ComponentsConnectedResult(_0.APIBase):
    ...
    @property
    def created_socket_connection(self) -> '_1968.ConnectedSockets':
        ...
        return constructor.new(_1968.ConnectedSockets)(self.wrapped.CreatedSocketConnection) if self.wrapped.CreatedSocketConnection else None
