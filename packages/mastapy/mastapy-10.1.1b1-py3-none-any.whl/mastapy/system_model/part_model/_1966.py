...
from mastapy.math_utility import _1052, _1053
from mastapy.system_model.connections_and_sockets import _1812, _1829
...
class Component(_1986.Part):
    ...
    @property
    def twod_drawing_full_model(self) -> '_6481.SMTBitmap':
        ...
        return constructor.new(_6481.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1812.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1812.ComponentConnection))
        return value
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1052.CoordinateSystem3D') -> '_1829.RealignmentResult':
        ...
        return constructor.new(_1829.RealignmentResult)(method_result) if method_result else None

    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1829.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1053.CoordinateSystemEditor':
        ...
        return constructor.new(_1053.CoordinateSystemEditor)(method_result) if method_result else None
