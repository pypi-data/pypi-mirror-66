...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2079
from mastapy.system_model.part_model.gears import _2041, _2048
...
class CylindricalGearSet(_2048.GearSet):
    '''CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(self) -> 'overridable.Overridable_ContactRatioRequirements':
        ...
        value = overridable.Overridable_ContactRatioRequirements.implicit_type()
    ...
    @property
    def active_gear_set_design(self) -> '_777.CylindricalGearSetDesign':
    ...
    @property
    def supercharger_rotor_set(self) -> '_2079.SuperchargerRotorSet':
        ...
        return constructor.new(_2079.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2041.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2041.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1848.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1848.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_777.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_777.CylindricalGearSetDesign))
        return value
