...
class FaceGear(_2046.Gear):
    ...
    @property
    def active_gear_design(self) -> '_744.FaceGearDesign':
        ...
        return constructor.new(_744.FaceGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def face_gear_design(self) -> '_744.FaceGearDesign':
        ...
        return constructor.new(_744.FaceGearDesign)(self.wrapped.FaceGearDesign) if self.wrapped.FaceGearDesign else None
