...
class SuperchargerRotorSetDatabase(_0.APIBase):
    '''SuperchargerRotorSetDatabase
    ...
    @property
    def item(self) -> '_2079.SuperchargerRotorSet':
        ...
        return constructor.new(_2079.SuperchargerRotorSet)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_2079.SuperchargerRotorSet':
        ...
        return constructor.new(_2079.SuperchargerRotorSet)(method_result) if method_result else None

    def can_be_removed(self, supercharger_rotor_set: '_2079.SuperchargerRotorSet') -> 'bool':
    ...
    def rename(self, supercharger_rotor_set: '_2079.SuperchargerRotorSet', new_name: 'str') -> 'bool':
    ...
    def remove(self, supercharger_rotor_set: '_2079.SuperchargerRotorSet'):
    ...
    def get_all_items(self) -> 'Iterable[_2079.SuperchargerRotorSet]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_2079.SuperchargerRotorSet))

    def save_changes(self, supercharger_rotor_set: '_2079.SuperchargerRotorSet'):
