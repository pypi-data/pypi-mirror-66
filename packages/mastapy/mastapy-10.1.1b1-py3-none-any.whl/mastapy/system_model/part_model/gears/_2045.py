...
from mastapy.system_model.part_model.gears import _2044, _2048
...
class FaceGearSet(_2048.GearSet):
    '''FaceGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_750.FaceGearSetDesign':
    ...
    @property
    def face_gears(self) -> 'List[_2044.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2044.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1850.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1850.FaceGearMesh))
        return value
