...
from mastapy.system_model.part_model.couplings import _2109, _2121
...
class BeltDrive(_2014.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2109.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2109.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2109.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2121.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2121.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1830.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1830.BeltConnection))
        return value
