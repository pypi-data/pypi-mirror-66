...
class Shaft(_1959.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1976.GuideImage':
        ...
        return constructor.new(_1976.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_1983.MountableComponent', offset: 'float'):
