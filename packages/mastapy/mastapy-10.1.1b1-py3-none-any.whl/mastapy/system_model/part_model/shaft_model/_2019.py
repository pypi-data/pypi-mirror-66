...
class Shaft(_1979.AbstractShaftOrHousing):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_1996.GuideImage':
        ...
        return constructor.new(_1996.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2003.MountableComponent', offset: 'float'):
