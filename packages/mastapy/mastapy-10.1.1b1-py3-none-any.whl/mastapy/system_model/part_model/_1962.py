...
from mastapy.bearings.tolerances import (
    _1512, _1513, _1514, _1523,
    _1519, _1526, _1515, _1527,
    _1520
)
from mastapy.bearings.bearing_results import _1560, _1561
from mastapy.bearings import (
    _1491, _1498, _1487, _1483
)
...
class Bearing(_1969.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1513.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1513.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1513.BearingToleranceDefinitionOptions'):
    ...
    @property
    def journal_bearing_type(self) -> '_1498.JournalBearingType':
        ...
        return constructor.new(_1498.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1498.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1487.BearingDampingMatrixOption':
        ...
        return constructor.new(_1487.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1487.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def efficiency_rating_method(self) -> 'overridable.Overridable_BearingEfficiencyRatingMethod':
        ...
        value = overridable.Overridable_BearingEfficiencyRatingMethod.implicit_type()
    ...
    @property
    def ring_tolerance_inner(self) -> '_1514.InnerRingTolerance':
        ...
        return constructor.new(_1514.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1523.RingTolerance':
        ...
        return constructor.new(_1523.RingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1514.InnerRingTolerance':
        ...
        if _1514.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1514.InnerRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1519.OuterRingTolerance':
        ...
        if _1519.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1519.OuterRingTolerance)(self.wrapped.RingToleranceLeft) if self.wrapped.RingToleranceLeft else None

    @property
    def ring_tolerance_outer(self) -> '_1519.OuterRingTolerance':
        ...
        return constructor.new(_1519.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1523.RingTolerance':
        ...
        return constructor.new(_1523.RingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1514.InnerRingTolerance':
        ...
        if _1514.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1514.InnerRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1519.OuterRingTolerance':
        ...
        if _1519.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1519.OuterRingTolerance)(self.wrapped.RingToleranceRight) if self.wrapped.RingToleranceRight else None

    @property
    def inner_support_detail(self) -> '_1526.SupportDetail':
        ...
        return constructor.new(_1526.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1526.SupportDetail':
        ...
        return constructor.new(_1526.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1526.SupportDetail':
        ...
        return constructor.new(_1526.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1526.SupportDetail':
        ...
        return constructor.new(_1526.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1515.InnerSupportTolerance':
        ...
        return constructor.new(_1515.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1527.SupportTolerance':
        ...
        return constructor.new(_1527.SupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1515.InnerSupportTolerance':
        ...
        if _1515.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1515.InnerSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1520.OuterSupportTolerance':
        ...
        if _1520.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
        ...
        return constructor.new(_1520.OuterSupportTolerance)(self.wrapped.SupportToleranceLeft) if self.wrapped.SupportToleranceLeft else None

    @property
    def support_tolerance_outer(self) -> '_1520.OuterSupportTolerance':
        ...
        return constructor.new(_1520.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1527.SupportTolerance':
        ...
        return constructor.new(_1527.SupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1515.InnerSupportTolerance':
        ...
        if _1515.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1515.InnerSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1520.OuterSupportTolerance':
        ...
        if _1520.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
        ...
        return constructor.new(_1520.OuterSupportTolerance)(self.wrapped.SupportToleranceRight) if self.wrapped.SupportToleranceRight else None

    @property
    def simple_bearing_detail_property(self) -> '_1708.BearingDesign':
        ...
        return constructor.new(_1708.BearingDesign)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1709.DetailedBearing':
        ...
        if _1709.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1709.DetailedBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1710.DummyRollingBearing':
        ...
        if _1710.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1710.DummyRollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1711.LinearBearing':
        ...
        if _1711.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1711.LinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1712.NonLinearBearing':
        ...
        if _1712.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1712.NonLinearBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1713.AngularContactBallBearing':
        ...
        if _1713.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1713.AngularContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1714.AngularContactThrustBallBearing':
        ...
        if _1714.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1714.AngularContactThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1715.AsymmetricSphericalRollerBearing':
        ...
        if _1715.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1715.AsymmetricSphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1716.AxialThrustCylindricalRollerBearing':
        ...
        if _1716.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1716.AxialThrustCylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1717.AxialThrustNeedleRollerBearing':
        ...
        if _1717.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1717.AxialThrustNeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1718.BallBearing':
        ...
        if _1718.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1718.BallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1720.BarrelRollerBearing':
        ...
        if _1720.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1720.BarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1725.CylindricalRollerBearing':
        ...
        if _1725.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1725.CylindricalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1726.DeepGrooveBallBearing':
        ...
        if _1726.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1726.DeepGrooveBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1728.FourPointContactBallBearing':
        ...
        if _1728.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1728.FourPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1730.MultiPointContactBallBearing':
        ...
        if _1730.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1730.MultiPointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1731.NeedleRollerBearing':
        ...
        if _1731.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1731.NeedleRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1732.NonBarrelRollerBearing':
        ...
        if _1732.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1732.NonBarrelRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1733.RollerBearing':
        ...
        if _1733.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1733.RollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1736.RollingBearing':
        ...
        if _1736.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1736.RollingBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1737.SelfAligningBallBearing':
        ...
        if _1737.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1737.SelfAligningBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1739.SphericalRollerBearing':
        ...
        if _1739.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1739.SphericalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1740.SphericalRollerThrustBearing':
        ...
        if _1740.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1740.SphericalRollerThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1741.TaperRollerBearing':
        ...
        if _1741.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1741.TaperRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1742.ThreePointContactBallBearing':
        ...
        if _1742.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1742.ThreePointContactBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1743.ThrustBallBearing':
        ...
        if _1743.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1743.ThrustBallBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1744.ToroidalRollerBearing':
        ...
        if _1744.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1744.ToroidalRollerBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1757.PadFluidFilmBearing':
        ...
        if _1757.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1757.PadFluidFilmBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1759.PlainGreaseFilledJournalBearing':
        ...
        if _1759.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1759.PlainGreaseFilledJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1761.PlainJournalBearing':
        ...
        if _1761.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1761.PlainJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1763.PlainOilFedJournalBearing':
        ...
        if _1763.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1763.PlainOilFedJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1764.TiltingPadJournalBearing':
        ...
        if _1764.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1764.TiltingPadJournalBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1765.TiltingPadThrustBearing':
        ...
        if _1765.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1765.TiltingPadThrustBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1767.ConceptAxialClearanceBearing':
        ...
        if _1767.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1767.ConceptAxialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1768.ConceptClearanceBearing':
        ...
        if _1768.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1768.ConceptClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1769.ConceptRadialClearanceBearing':
        ...
        if _1769.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
        ...
        return constructor.new(_1769.ConceptRadialClearanceBearing)(self.wrapped.SimpleBearingDetailProperty) if self.wrapped.SimpleBearingDetailProperty else None

    @property
    def detail(self) -> '_1708.BearingDesign':
        ...
        return constructor.new(_1708.BearingDesign)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_detailed_bearing(self) -> '_1709.DetailedBearing':
        ...
        if _1709.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1709.DetailedBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1710.DummyRollingBearing':
        ...
        if _1710.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1710.DummyRollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_linear_bearing(self) -> '_1711.LinearBearing':
        ...
        if _1711.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1711.LinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1712.NonLinearBearing':
        ...
        if _1712.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1712.NonLinearBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1713.AngularContactBallBearing':
        ...
        if _1713.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1713.AngularContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1714.AngularContactThrustBallBearing':
        ...
        if _1714.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1714.AngularContactThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1715.AsymmetricSphericalRollerBearing':
        ...
        if _1715.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1715.AsymmetricSphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1716.AxialThrustCylindricalRollerBearing':
        ...
        if _1716.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1716.AxialThrustCylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1717.AxialThrustNeedleRollerBearing':
        ...
        if _1717.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1717.AxialThrustNeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_ball_bearing(self) -> '_1718.BallBearing':
        ...
        if _1718.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1718.BallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1720.BarrelRollerBearing':
        ...
        if _1720.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1720.BarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1725.CylindricalRollerBearing':
        ...
        if _1725.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1725.CylindricalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1726.DeepGrooveBallBearing':
        ...
        if _1726.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1726.DeepGrooveBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1728.FourPointContactBallBearing':
        ...
        if _1728.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1728.FourPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1730.MultiPointContactBallBearing':
        ...
        if _1730.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1730.MultiPointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1731.NeedleRollerBearing':
        ...
        if _1731.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1731.NeedleRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1732.NonBarrelRollerBearing':
        ...
        if _1732.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1732.NonBarrelRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_roller_bearing(self) -> '_1733.RollerBearing':
        ...
        if _1733.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1733.RollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1736.RollingBearing':
        ...
        if _1736.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new(_1736.RollingBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1737.SelfAligningBallBearing':
        ...
        if _1737.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1737.SelfAligningBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1739.SphericalRollerBearing':
        ...
        if _1739.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1739.SphericalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1740.SphericalRollerThrustBearing':
        ...
        if _1740.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1740.SphericalRollerThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1741.TaperRollerBearing':
        ...
        if _1741.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1741.TaperRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1742.ThreePointContactBallBearing':
        ...
        if _1742.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1742.ThreePointContactBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1743.ThrustBallBearing':
        ...
        if _1743.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1743.ThrustBallBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1744.ToroidalRollerBearing':
        ...
        if _1744.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1744.ToroidalRollerBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1757.PadFluidFilmBearing':
        ...
        if _1757.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1757.PadFluidFilmBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1759.PlainGreaseFilledJournalBearing':
        ...
        if _1759.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1759.PlainGreaseFilledJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1761.PlainJournalBearing':
        ...
        if _1761.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1761.PlainJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1763.PlainOilFedJournalBearing':
        ...
        if _1763.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1763.PlainOilFedJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1764.TiltingPadJournalBearing':
        ...
        if _1764.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1764.TiltingPadJournalBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1765.TiltingPadThrustBearing':
        ...
        if _1765.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1765.TiltingPadThrustBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1767.ConceptAxialClearanceBearing':
        ...
        if _1767.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1767.ConceptAxialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1768.ConceptClearanceBearing':
        ...
        if _1768.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1768.ConceptClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1769.ConceptRadialClearanceBearing':
        ...
        if _1769.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
        ...
        return constructor.new(_1769.ConceptRadialClearanceBearing)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def axial_internal_clearance_tolerance(self) -> '_1961.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_1961.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_1991.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_1991.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    @property
    def friction_coefficients(self) -> '_1660.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1660.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def mounting(self) -> 'List[_1963.BearingRaceMountingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Mounting, constructor.new(_1963.BearingRaceMountingOptions))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1483.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_1999.Shaft', offset: Optional['float'] = float('nan')) -> '_1967.ComponentsConnectedResult':
        ...
        return constructor.new(_1967.ComponentsConnectedResult)(method_result) if method_result else None

    def try_attach_right_side_to(self, shaft: '_1999.Shaft', offset: Optional['float'] = float('nan')) -> '_1967.ComponentsConnectedResult':
