...
from mastapy.bearings.bearing_results import _1554
...
class LoadedPlainJournalBearingResults(_1554.LoadedDetailedBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1701.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1701.LoadedPlainJournalBearingRow))
        return value
