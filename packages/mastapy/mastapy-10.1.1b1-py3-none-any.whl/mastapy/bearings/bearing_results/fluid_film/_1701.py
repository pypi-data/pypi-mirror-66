...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1492.BearingRow':
        ...
        return constructor.new(_1492.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_6481.SMTBitmap':
        ...
        return constructor.new(_6481.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
