...
from mastapy.bearings.bearing_results.rolling import _1575, _1595
...
class LoadedAngularContactBallBearingRow(_1595.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1575.LoadedAngularContactBallBearingResults':
