...
from mastapy.bearings.bearing_results.rolling import _1581, _1619
...
class LoadedAsymmetricSphericalRollerBearingRow(_1619.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1581.LoadedAsymmetricSphericalRollerBearingResults':
