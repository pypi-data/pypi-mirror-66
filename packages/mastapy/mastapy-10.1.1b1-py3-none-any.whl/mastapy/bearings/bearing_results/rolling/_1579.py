...
from mastapy.bearings.bearing_results.rolling import _1578, _1576
...
class LoadedAngularContactThrustBallBearingRow(_1576.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1578.LoadedAngularContactThrustBallBearingResults':
