...
from mastapy.bearings.bearing_results.rolling.skf_module import _1687, _1703
...
class AdjustedSpeed(_1703.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1687.AdjustmentFactors':
        ...
        return constructor.new(_1687.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
