...
class GreaseLifeAndRelubricationInterval(_1683.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1675.Grease':
        ...
        return constructor.new(_1675.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1678.InitialFill':
        ...
        return constructor.new(_1678.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1677.GreaseQuantity':
        ...
        return constructor.new(_1677.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
