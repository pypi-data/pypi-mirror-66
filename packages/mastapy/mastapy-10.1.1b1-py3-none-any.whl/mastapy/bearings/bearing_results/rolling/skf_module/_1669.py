...
from mastapy.bearings.bearing_results.rolling.skf_module import _1679, _1683
...
class BearingRatingLife(_1683.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1679.LifeModel':
        ...
        return constructor.new(_1679.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
