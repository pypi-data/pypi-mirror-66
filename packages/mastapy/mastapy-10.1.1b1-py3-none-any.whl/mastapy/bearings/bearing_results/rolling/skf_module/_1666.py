...
from mastapy.bearings.bearing_results.rolling.skf_module import _1667, _1683
...
class AdjustedSpeed(_1683.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1667.AdjustmentFactors':
        ...
        return constructor.new(_1667.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
