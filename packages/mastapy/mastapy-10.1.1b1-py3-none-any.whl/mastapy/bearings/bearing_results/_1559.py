...
from mastapy.bearings.bearing_results.rolling import _1622, _1651
from mastapy.bearings import _1489
from mastapy.bearings.bearing_results import _1556
...
class LoadedRollingBearingDutyCycle(_1556.LoadedNonLinearBearingDutyCycleResults):
    '''LoadedRollingBearingDutyCycle
    ...
    @property
    def maximum_element_normal_stress_inner_summary(self) -> '_1331.DutyCyclePropertySummaryStress[_1622.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1331.DutyCyclePropertySummaryStress)[_1622.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressInnerSummary) if self.wrapped.MaximumElementNormalStressInnerSummary else None

    @property
    def maximum_element_normal_stress_outer_summary(self) -> '_1331.DutyCyclePropertySummaryStress[_1622.LoadedRollingBearingResults]':
        ...
        return constructor.new(_1331.DutyCyclePropertySummaryStress)[_1622.LoadedRollingBearingResults](self.wrapped.MaximumElementNormalStressOuterSummary) if self.wrapped.MaximumElementNormalStressOuterSummary else None

    @property
    def maximum_element_normal_stress_summary(self) -> '_1331.DutyCyclePropertySummaryStress[_1489.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1331.DutyCyclePropertySummaryStress)[_1489.BearingLoadCaseResultsLightweight](self.wrapped.MaximumElementNormalStressSummary) if self.wrapped.MaximumElementNormalStressSummary else None

    @property
    def misalignment_summary(self) -> '_1330.DutyCyclePropertySummarySmallAngle[_1489.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1330.DutyCyclePropertySummarySmallAngle)[_1489.BearingLoadCaseResultsLightweight](self.wrapped.MisalignmentSummary) if self.wrapped.MisalignmentSummary else None

    @property
    def iso2812007_dynamic_equivalent_load_summary(self) -> '_1328.DutyCyclePropertySummaryForce[_1489.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1328.DutyCyclePropertySummaryForce)[_1489.BearingLoadCaseResultsLightweight](self.wrapped.ISO2812007DynamicEquivalentLoadSummary) if self.wrapped.ISO2812007DynamicEquivalentLoadSummary else None

    @property
    def isots162812008_dynamic_equivalent_load_summary(self) -> '_1328.DutyCyclePropertySummaryForce[_1489.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1328.DutyCyclePropertySummaryForce)[_1489.BearingLoadCaseResultsLightweight](self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary) if self.wrapped.ISOTS162812008DynamicEquivalentLoadSummary else None

    @property
    def maximum_truncation_summary(self) -> '_1329.DutyCyclePropertySummaryPercentage[_1489.BearingLoadCaseResultsLightweight]':
        ...
        return constructor.new(_1329.DutyCyclePropertySummaryPercentage)[_1489.BearingLoadCaseResultsLightweight](self.wrapped.MaximumTruncationSummary) if self.wrapped.MaximumTruncationSummary else None

    @property
    def maximum_static_contact_stress_duty_cycle(self) -> '_1651.MaximumStaticContactStressDutyCycle':
        ...
        return constructor.new(_1651.MaximumStaticContactStressDutyCycle)(self.wrapped.MaximumStaticContactStressDutyCycle) if self.wrapped.MaximumStaticContactStressDutyCycle else None
