...
class LinearBearing(_1708.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1494.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1494.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1494.BearingStiffnessMatrixOption'):
