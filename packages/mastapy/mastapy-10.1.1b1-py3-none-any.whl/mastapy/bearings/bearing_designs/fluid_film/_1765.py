...
from mastapy.bearings.bearing_designs.fluid_film import _1757
...
class TiltingPadThrustBearing(_1757.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1509.TiltingPadTypes':
        ...
        return constructor.new(_1509.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1509.TiltingPadTypes'):
