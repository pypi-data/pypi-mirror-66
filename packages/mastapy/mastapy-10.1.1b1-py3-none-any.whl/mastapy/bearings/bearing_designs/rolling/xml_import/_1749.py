...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1747, _1746
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1747.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1747.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1746.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1746.AbstractXmlVariableAssignment))
        return value
