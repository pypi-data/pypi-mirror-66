...
from mastapy.bearings import (
    _1524, _1527, _1503, _1504,
    _1505, _1506
)
from mastapy.bearings.bearing_designs.rolling import (
    _1767, _1751, _1749, _1746,
    _1760, _1743
)
...
class RollingBearing(_1731.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1503.BearingCatalog':
        ...
        return constructor.new(_1503.BearingCatalog)(value) if value else None
    ...
    def width_series(self) -> 'overridable.Overridable_WidthSeries':
        ...
        value = overridable.Overridable_WidthSeries.implicit_type()
    ...
    def height_series(self) -> 'overridable.Overridable_HeightSeries':
        ...
        value = overridable.Overridable_HeightSeries.implicit_type()
    ...
    def diameter_series(self) -> 'overridable.Overridable_DiameterSeries':
        ...
        value = overridable.Overridable_DiameterSeries.implicit_type()
    ...
    @property
    def type_information(self) -> '_1746.BearingTypeExtraInformation':
        ...
        return constructor.new(_1746.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1506.BearingCageMaterial':
        ...
        return constructor.new(_1506.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1506.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1760.SleeveType':
        ...
        return constructor.new(_1760.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1743.BearingProtection':
        ...
        return constructor.new(_1743.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
