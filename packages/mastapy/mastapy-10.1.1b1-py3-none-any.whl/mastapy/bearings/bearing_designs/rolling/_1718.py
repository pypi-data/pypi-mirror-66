...
from mastapy.bearings.bearing_designs.rolling import _1719, _1736
...
class BallBearing(_1736.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1719.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1719.BallBearingShoulderDefinition))
        return value
