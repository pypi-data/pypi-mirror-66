...
from mastapy.bearings.bearing_designs.rolling import _1734, _1735, _1733
...
class NonBarrelRollerBearing(_1733.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1734.RollerEndShape':
        ...
        return constructor.new(_1734.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1734.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1735.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1735.RollerRibDetail))
        return value
