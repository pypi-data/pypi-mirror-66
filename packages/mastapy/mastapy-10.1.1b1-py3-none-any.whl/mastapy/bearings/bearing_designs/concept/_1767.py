...
from mastapy.bearings.bearing_designs.concept import _1766, _1768
...
class ConceptAxialClearanceBearing(_1768.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1766.BearingNodePosition':
        ...
        return constructor.new(_1766.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1766.BearingNodePosition'):
