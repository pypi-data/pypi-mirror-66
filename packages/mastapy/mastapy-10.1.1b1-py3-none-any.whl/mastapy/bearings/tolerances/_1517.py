...
from mastapy.bearings.tolerances import _1513, _1510
...
class InterferenceTolerance(_1510.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1513.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1513.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1500.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1500.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1500.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
