...
from mastapy.utility.modal_analysis.gears import _1300, _1303, _1305
...
class GearOrderForTE(_1305.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1300.GearPositions':
        ...
        return constructor.new(_1300.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1303.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1303.OrderForTE))
        return value
