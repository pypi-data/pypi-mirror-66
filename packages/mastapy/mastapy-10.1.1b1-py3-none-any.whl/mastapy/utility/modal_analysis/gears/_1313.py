...
from mastapy.utility.modal_analysis.gears import _1314, _1318
...
class GearMeshForTE(_1318.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1314.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1314.GearOrderForTE))
        return value
