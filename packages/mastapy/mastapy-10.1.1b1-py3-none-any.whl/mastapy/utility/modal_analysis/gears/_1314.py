...
from mastapy.utility.modal_analysis.gears import _1315, _1318, _1320
...
class GearOrderForTE(_1320.OrderWithRadius):
    '''GearOrderForTE
    ...
    @property
    def position(self) -> '_1315.GearPositions':
        ...
        return constructor.new(_1315.GearPositions)(value) if value else None

    @property
    def additional_orders_and_harmonics(self) -> 'List[_1318.OrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AdditionalOrdersAndHarmonics, constructor.new(_1318.OrderForTE))
        return value
