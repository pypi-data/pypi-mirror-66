...
from mastapy.utility.modal_analysis.gears import _1299, _1303
...
class GearMeshForTE(_1303.OrderForTE):
    '''GearMeshForTE
    ...
    @property
    def attached_gears(self) -> 'List[_1299.GearOrderForTE]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AttachedGears, constructor.new(_1299.GearOrderForTE))
        return value
