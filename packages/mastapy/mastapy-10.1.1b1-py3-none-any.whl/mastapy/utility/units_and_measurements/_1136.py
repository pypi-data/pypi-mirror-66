...
from mastapy.utility.units_and_measurements import _1141
...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1129.RoundingMethods':
        ...
        return constructor.new(_1129.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1129.RoundingMethods'):
    ...
    @property
    def current_unit(self) -> '_1141.Unit':
        ...
        return constructor.new(_1141.Unit)(self.wrapped.CurrentUnit) if self.wrapped.CurrentUnit else None
