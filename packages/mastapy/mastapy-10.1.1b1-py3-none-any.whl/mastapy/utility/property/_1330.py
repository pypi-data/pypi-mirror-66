...
from mastapy.utility.units_and_measurements.measurements import _1146
...
class DutyCyclePropertySummarySmallAngle(_1327.DutyCyclePropertySummary['_1146.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
