...
from mastapy.utility.units_and_measurements.measurements import _1228
...
class DutyCyclePropertySummaryStress(_1327.DutyCyclePropertySummary['_1228.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
