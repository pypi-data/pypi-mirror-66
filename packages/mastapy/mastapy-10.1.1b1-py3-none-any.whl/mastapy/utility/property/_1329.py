...
from mastapy.utility.units_and_measurements.measurements import _1206
...
class DutyCyclePropertySummaryPercentage(_1327.DutyCyclePropertySummary['_1206.Percentage', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryPercentage
