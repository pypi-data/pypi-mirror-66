...
from mastapy.bearings.tolerances import _1527, _1515, _1520
...
class InterferenceFitHalfDesign(_961.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1020.StressRegions':
        ...
        return constructor.new(_1020.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1527.SupportTolerance':
        ...
        return constructor.new(_1527.SupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1515.InnerSupportTolerance':
        ...
        if _1515.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1515.InnerSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None

    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1520.OuterSupportTolerance':
        ...
        if _1520.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
        ...
        return constructor.new(_1520.OuterSupportTolerance)(self.wrapped.Tolerance) if self.wrapped.Tolerance else None
