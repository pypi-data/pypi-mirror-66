...
from mastapy.detailed_rigid_connectors.interference_fits import _1017, _1016, _1021
...
class InterferenceFitDesign(_960.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1017.CalculationMethods':
        ...
        return constructor.new(_1017.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1017.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1016.AssemblyMethods':
        ...
        return constructor.new(_1016.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1016.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
