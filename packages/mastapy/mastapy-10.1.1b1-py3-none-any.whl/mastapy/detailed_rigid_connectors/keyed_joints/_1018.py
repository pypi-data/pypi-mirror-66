...
from mastapy.detailed_rigid_connectors.keyed_joints import _1021, _1019
...
class KeyedJointDesign(_1026.InterferenceFitDesign):
    '''KeyedJointDesign
