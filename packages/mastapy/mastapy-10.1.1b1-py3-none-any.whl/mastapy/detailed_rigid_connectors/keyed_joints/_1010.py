...
from mastapy.detailed_rigid_connectors.keyed_joints import _1013, _1011
...
class KeyedJointDesign(_1018.InterferenceFitDesign):
    '''KeyedJointDesign
