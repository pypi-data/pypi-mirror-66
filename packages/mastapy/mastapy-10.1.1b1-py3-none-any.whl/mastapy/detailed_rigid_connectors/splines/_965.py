...
from mastapy.detailed_rigid_connectors.splines import _975, _984, _992
...
class DIN5480SplineHalfDesign(_992.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_975.ManufacturingTypes':
        ...
        return constructor.new(_975.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_975.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_984.FinishingMethods':
        ...
        return constructor.new(_984.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_984.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
