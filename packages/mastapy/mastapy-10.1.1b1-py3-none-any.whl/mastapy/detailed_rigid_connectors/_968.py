...
from mastapy.detailed_rigid_connectors import _969
...
class DetailedRigidConnectorDesign(_0.APIBase):
    ...
    @property
    def twod_spline_drawing(self) -> '_6501.SMTBitmap':
        ...
        return constructor.new(_6501.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None

    @property
    def halves(self) -> 'List[_969.DetailedRigidConnectorHalfDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_969.DetailedRigidConnectorHalfDesign))
        return value
