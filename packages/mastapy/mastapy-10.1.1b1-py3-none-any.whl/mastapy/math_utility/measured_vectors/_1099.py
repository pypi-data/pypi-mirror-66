...
from mastapy.math_utility.measured_vectors import _1104, _1098
...
class ForceAndDisplacementResults(_1098.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1104.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1104.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
