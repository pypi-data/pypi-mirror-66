...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self) -> '_1104.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1104.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
