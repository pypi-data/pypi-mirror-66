...
from mastapy.math_utility.measured_vectors import _1116
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    def force(self) -> '_1116.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1116.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
