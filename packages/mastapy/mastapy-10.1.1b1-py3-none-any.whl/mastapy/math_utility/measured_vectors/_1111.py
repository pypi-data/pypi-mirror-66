...
from mastapy.math_utility.measured_vectors import _1116, _1110
...
class ForceAndDisplacementResults(_1110.AbstractForceAndDisplacementResults):
    '''ForceAndDisplacementResults
    ...
    @property
    def displacement(self) -> '_1116.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1116.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None
