...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def update_method(self) -> '_1079.PIDControlUpdateMethod':
        ...
        return constructor.new(_1079.PIDControlUpdateMethod)(value) if value else None

    @update_method.setter
    def update_method(self, value: '_1079.PIDControlUpdateMethod'):
