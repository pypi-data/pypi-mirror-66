...
from mastapy.math_utility.optimisation import _1087
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1087.ParetoOptimisationInput':
        ...
        return constructor.new(_1087.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
