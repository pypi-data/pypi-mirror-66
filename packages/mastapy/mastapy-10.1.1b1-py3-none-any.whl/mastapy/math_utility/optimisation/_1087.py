...
from mastapy.math_utility.optimisation import _1096, _1093
...
class ParetoOptimisationInput(_1093.ParetoOptimistaionVariable):
    '''ParetoOptimisationInput
    ...
    @property
    def specify_input_range_as(self) -> '_1096.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1096.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1096.SpecifyOptimisationInputAs'):
