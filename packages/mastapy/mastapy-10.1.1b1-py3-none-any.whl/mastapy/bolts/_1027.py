...
class BoltGeometryDatabase(_0.APIBase):
    '''BoltGeometryDatabase
    ...
    @property
    def item(self) -> '_1026.BoltGeometry':
        ...
        return constructor.new(_1026.BoltGeometry)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1026.BoltGeometry':
        ...
        return constructor.new(_1026.BoltGeometry)(method_result) if method_result else None

    def can_be_removed(self, bolt_geometry: '_1026.BoltGeometry') -> 'bool':
    ...
    def rename(self, bolt_geometry: '_1026.BoltGeometry', new_name: 'str') -> 'bool':
    ...
    def remove(self, bolt_geometry: '_1026.BoltGeometry'):
    ...
    def get_all_items(self) -> 'Iterable[_1026.BoltGeometry]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1026.BoltGeometry))

    def save_changes(self, bolt_geometry: '_1026.BoltGeometry'):
