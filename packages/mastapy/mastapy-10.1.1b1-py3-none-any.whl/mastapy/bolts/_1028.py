...
from mastapy.bolts import _1043, _1025
...
class BoltMaterial(_1025.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1043.StrengthGrades':
        ...
        return constructor.new(_1043.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1043.StrengthGrades'):
