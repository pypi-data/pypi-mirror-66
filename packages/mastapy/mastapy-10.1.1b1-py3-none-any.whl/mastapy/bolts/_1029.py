...
from mastapy.bolts import _1028
...
class BoltMaterialDatabase(_0.APIBase):
    '''BoltMaterialDatabase
    ...
    @property
    def item(self) -> '_1028.BoltMaterial':
        ...
        return constructor.new(_1028.BoltMaterial)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_1028.BoltMaterial':
        ...
        return constructor.new(_1028.BoltMaterial)(method_result) if method_result else None

    def can_be_removed(self, bolt_material: '_1028.BoltMaterial') -> 'bool':
    ...
    def rename(self, bolt_material: '_1028.BoltMaterial', new_name: 'str') -> 'bool':
    ...
    def remove(self, bolt_material: '_1028.BoltMaterial'):
    ...
    def get_all_items(self) -> 'Iterable[_1028.BoltMaterial]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_1028.BoltMaterial))

    def save_changes(self, bolt_material: '_1028.BoltMaterial'):
