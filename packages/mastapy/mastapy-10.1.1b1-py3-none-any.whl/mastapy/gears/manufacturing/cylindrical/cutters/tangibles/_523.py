...
class CutterShapeDefinition(_0.APIBase):
    ...
    def design(self) -> '_513.CylindricalGearRealCutterDesign':
        ...
        return constructor.new(_513.CylindricalGearRealCutterDesign)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_grinding_worm(self) -> '_508.CylindricalGearGrindingWorm':
        ...
        return constructor.new(_508.CylindricalGearGrindingWorm)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_plunge_shaver(self) -> '_510.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_510.CylindricalGearPlungeShaver)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_rack_design(self) -> '_512.CylindricalGearRackDesign':
        ...
        return constructor.new(_512.CylindricalGearRackDesign)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_cylindrical_gear_shaver(self) -> '_515.CylindricalGearShaver':
        ...
        return constructor.new(_515.CylindricalGearShaver)(self.wrapped.Design) if self.wrapped.Design else None
    ...
    def design_of_type_involute_cutter_design(self) -> '_518.InvoluteCutterDesign':
        ...
        return constructor.new(_518.InvoluteCutterDesign)(self.wrapped.Design) if self.wrapped.Design else None
