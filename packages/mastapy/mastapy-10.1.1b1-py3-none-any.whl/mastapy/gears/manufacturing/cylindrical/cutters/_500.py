...
from mastapy.gears.manufacturing.cylindrical.cutters import _502
...
class CylindricalFormedWheelGrinderDatabase(_0.APIBase):
    '''CylindricalFormedWheelGrinderDatabase
    ...
    @property
    def item(self) -> '_502.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_502.CylindricalGearFormGrindingWheel)(self.wrapped.Item) if self.wrapped.Item else None

    def create(self, name: 'str') -> '_502.CylindricalGearFormGrindingWheel':
        ...
        return constructor.new(_502.CylindricalGearFormGrindingWheel)(method_result) if method_result else None

    def can_be_removed(self, cylindrical_gear_form_grinding_wheel: '_502.CylindricalGearFormGrindingWheel') -> 'bool':
    ...
    def rename(self, cylindrical_gear_form_grinding_wheel: '_502.CylindricalGearFormGrindingWheel', new_name: 'str') -> 'bool':
    ...
    def remove(self, cylindrical_gear_form_grinding_wheel: '_502.CylindricalGearFormGrindingWheel'):
    ...
    def get_all_items(self) -> 'Iterable[_502.CylindricalGearFormGrindingWheel]':
        ...
        return conversion.pn_to_mp_objects_in_iterable(self.wrapped.GetAllItems(), constructor.new(_502.CylindricalGearFormGrindingWheel))

    def save_changes(self, cylindrical_gear_form_grinding_wheel: '_502.CylindricalGearFormGrindingWheel'):
