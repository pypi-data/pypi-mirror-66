...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _598
...
class BasicConicalGearMachineSettingsGenerated(_598.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
