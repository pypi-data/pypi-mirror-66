...
class MicroGeometryDesignSpaceSearch(_675.DesignSpaceSearchBase['_634.CylindricalGearSetLoadDistributionAnalysis', '_686.MicroGeometryDesignSpaceSearchCandidate']):
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_851.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_851.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_851.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_851.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_851.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_851.CylindricalGearSetMicroGeometry))
        return value
