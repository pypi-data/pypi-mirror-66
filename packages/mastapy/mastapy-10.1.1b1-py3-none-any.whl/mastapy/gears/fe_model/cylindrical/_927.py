...
from mastapy.gears.gear_designs.cylindrical import _779
...
class CylindricalGearSetFEModel(_924.GearSetFEModel):
    '''CylindricalGearSetFEModel
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_779.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_779.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None
