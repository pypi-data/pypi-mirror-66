...
class GearFEModel(_950.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_931.GearMeshingElementOptions':
        ...
        return constructor.new(_931.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_129.GearFlanks', progress: '_6498.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_6498.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
