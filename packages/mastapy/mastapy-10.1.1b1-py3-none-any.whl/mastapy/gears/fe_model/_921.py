...
class GearFEModel(_942.GearImplementationDetail):
    '''GearFEModel
    ...
    @property
    def element_settings(self) -> '_923.GearMeshingElementOptions':
        ...
        return constructor.new(_923.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
    ...
    def get_stress_influence_coefficients_from_fe_with_progress(self, flank: '_128.GearFlanks', progress: '_6478.TaskProgress'):
        ''' 'GetStressInfluenceCoefficientsFromFE' is the original name of this method.
