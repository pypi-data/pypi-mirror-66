...
class FaceGearSetDesign(_705.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_749.FaceGearPinionDesign':
        ...
        return constructor.new(_749.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_752.FaceGearWheelDesign':
        ...
        return constructor.new(_752.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_751.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_751.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_744.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_744.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_744.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_744.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_746.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_746.FaceGearMeshDesign))
        return value
