...
from mastapy.gears.gear_designs.face import _746, _751, _748
...
class FaceGearMeshMicroGeometry(_946.GearMeshImplementationDetail):
    '''FaceGearMeshMicroGeometry
    ...
    @property
    def face_mesh(self) -> '_746.FaceGearMeshDesign':
        ...
        return constructor.new(_746.FaceGearMeshDesign)(self.wrapped.FaceMesh) if self.wrapped.FaceMesh else None

    @property
    def face_gear_set_micro_geometry(self) -> '_751.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_751.FaceGearSetMicroGeometry)(self.wrapped.FaceGearSetMicroGeometry) if self.wrapped.FaceGearSetMicroGeometry else None
