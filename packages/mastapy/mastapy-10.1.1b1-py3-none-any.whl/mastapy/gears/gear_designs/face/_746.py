...
from mastapy.gears.gear_designs.face import _750, _744
...
class FaceGearMeshDesign(_704.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_750.FaceGearSetDesign':
        ...
        return constructor.new(_750.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
