...
class SelectedDesignConstraintsCollection(_1125.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_701.DesignConstraintsCollection':
        ...
        return constructor.new(_701.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
