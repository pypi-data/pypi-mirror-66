...
from mastapy.gears.gear_designs.bevel import _909, _904
...
class StraightBevelDiffGearDesign(_904.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_909.EdgeRadiusType':
        ...
        return constructor.new(_909.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_909.EdgeRadiusType'):
