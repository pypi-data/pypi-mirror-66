...
from mastapy.gears.gear_designs.bevel import _917, _912
...
class StraightBevelDiffGearDesign(_912.BevelGearDesign):
    '''StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self) -> '_917.EdgeRadiusType':
        ...
        return constructor.new(_917.EdgeRadiusType)(value) if value else None

    @edge_radius_from.setter
    def edge_radius_from(self, value: '_917.EdgeRadiusType'):
