...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _863
...
class CylindricalAccuracyGraderWithProfileFormAndSlope(_863.CylindricalAccuracyGrader):
    '''CylindricalAccuracyGraderWithProfileFormAndSlope
