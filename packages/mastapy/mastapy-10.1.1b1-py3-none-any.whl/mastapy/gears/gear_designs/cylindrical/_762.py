...
from mastapy.gears.gear_designs.cylindrical import _793, _791, _817
...
class BacklashSpecification(_817.RelativeValuesSpecification['BacklashSpecification']):
    '''BacklashSpecification
    ...
    def normal_backlash(self) -> '_793.CylindricalMeshLinearBacklashSpecification':
        ...
        return constructor.new(_793.CylindricalMeshLinearBacklashSpecification)(self.wrapped.NormalBacklash) if self.wrapped.NormalBacklash else None
    ...
    def circumferential_backlash_pitch_circle(self) -> '_793.CylindricalMeshLinearBacklashSpecification':
        ...
        return constructor.new(_793.CylindricalMeshLinearBacklashSpecification)(self.wrapped.CircumferentialBacklashPitchCircle) if self.wrapped.CircumferentialBacklashPitchCircle else None
    ...
    def circumferential_backlash_reference_circle(self) -> '_793.CylindricalMeshLinearBacklashSpecification':
        ...
        return constructor.new(_793.CylindricalMeshLinearBacklashSpecification)(self.wrapped.CircumferentialBacklashReferenceCircle) if self.wrapped.CircumferentialBacklashReferenceCircle else None
    ...
    def radial_backlash(self) -> '_793.CylindricalMeshLinearBacklashSpecification':
        ...
        return constructor.new(_793.CylindricalMeshLinearBacklashSpecification)(self.wrapped.RadialBacklash) if self.wrapped.RadialBacklash else None
