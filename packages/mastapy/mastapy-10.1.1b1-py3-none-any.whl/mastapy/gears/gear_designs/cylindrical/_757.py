...
from mastapy.gears.gear_designs.cylindrical import _797
from mastapy.utility import _1112
...
class CaseHardeningPropertiesForFEAnalysis(_1112.CachedIndependentReportablePropertiesBase['CaseHardeningPropertiesForFEAnalysis']):
    '''CaseHardeningPropertiesForFEAnalysis
    ...
    @property
    def surface_material_properties(self) -> '_797.HardenedMaterialProperties':
        ...
        return constructor.new(_797.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_797.HardenedMaterialProperties':
        ...
        return constructor.new(_797.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
