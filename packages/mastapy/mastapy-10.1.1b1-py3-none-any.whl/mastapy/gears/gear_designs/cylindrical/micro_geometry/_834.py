...
from mastapy.gears.gear_designs.cylindrical import _775, _772
from mastapy._internal import enum_with_selected_value_runtime, constructor, conversion
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _841, _836
...
class CylindricalGearMeshMicroGeometry(_946.GearMeshImplementationDetail):
    '''CylindricalGearMeshMicroGeometry
    ...
    @property
    def profile_measured_as(self) -> '_775.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_775.CylindricalGearProfileMeasurementType)(value) if value else None

    @property
    def cylindrical_mesh(self) -> '_772.CylindricalGearMeshDesign':
        ...
        return constructor.new(_772.CylindricalGearMeshDesign)(self.wrapped.CylindricalMesh) if self.wrapped.CylindricalMesh else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_841.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_841.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None
    ...
    @property
    def gear_a(self) -> '_836.CylindricalGearMicroGeometry':
    ...
    @property
    def gear_b(self) -> '_836.CylindricalGearMicroGeometry':
