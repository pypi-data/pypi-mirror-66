...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_853.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_853.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_853.DrawDefiningGearOrBoth'):
