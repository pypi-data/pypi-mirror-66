...
class CylindricalGearBiasModification(_352.BiasModification):
    ...
    @property
    def zero_bias_relief(self) -> '_774.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_774.CylindricalGearProfileMeasurement)(self.wrapped.ZeroBiasRelief) if self.wrapped.ZeroBiasRelief else None
