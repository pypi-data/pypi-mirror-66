...
class CylindricalGearSetDesign(_716.GearSetDesign):
    ...
    def coefficient_of_friction_calculation_method(self) -> 'overridable.Overridable_CoefficientOfFrictionCalculationMethod':
        ...
        value = overridable.Overridable_CoefficientOfFrictionCalculationMethod.implicit_type()
    ...
    @property
    def scuffing(self) -> '_820.Scuffing':
        ...
        return constructor.new(_820.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_815.Micropitting':
        ...
        return constructor.new(_815.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_836.Usage':
        ...
        return constructor.new(_836.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None

    @property
    def ltca_settings(self) -> '_813.LtcaSettings':
        ...
        return constructor.new(_813.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None
    ...
    def create_optimiser(self, duty_cycle: '_264.CylindricalGearSetDutyCycleRating') -> '_788.CylindricalGearSetMacroGeometryOptimiser':
