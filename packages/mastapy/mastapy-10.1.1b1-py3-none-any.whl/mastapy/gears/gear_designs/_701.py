...
from mastapy.utility.property import _1326
from mastapy.gears.gear_designs import _699
...
class DesignConstraintsCollection(_1322.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1326.DeletableCollectionMember[_699.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1326.DeletableCollectionMember)[_699.DesignConstraint])
        return value
