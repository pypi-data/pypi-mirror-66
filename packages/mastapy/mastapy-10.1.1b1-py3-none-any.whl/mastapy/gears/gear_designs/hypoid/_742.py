...
from mastapy.gears.gear_designs.hypoid import _740, _741
...
class HypoidGearSetDesign(_919.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_740.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_740.HypoidGearDesign))
        return value
    ...
    @property
    def meshes(self) -> 'List[_741.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_741.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_741.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_741.HypoidGearMeshDesign))
        return value
