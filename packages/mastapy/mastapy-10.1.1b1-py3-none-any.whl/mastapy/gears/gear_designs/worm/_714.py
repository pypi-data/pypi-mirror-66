...
from mastapy.gears.gear_designs.worm import _712, _713
...
class WormGearSetDesign(_705.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_712.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_712.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_713.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_713.WormGearMeshDesign))
        return value
