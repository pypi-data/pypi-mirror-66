...
class WormGearMeshDesign(_704.GearMeshDesign):
    '''WormGearMeshDesign
    ...
    @property
    def worm_gear_set(self) -> '_714.WormGearSetDesign':
        ...
        return constructor.new(_714.WormGearSetDesign)(self.wrapped.WormGearSet) if self.wrapped.WormGearSet else None

    @property
    def worm(self) -> '_711.WormDesign':
        ...
        return constructor.new(_711.WormDesign)(self.wrapped.Worm) if self.wrapped.Worm else None

    @property
    def wheel(self) -> '_715.WormWheelDesign':
        ...
        return constructor.new(_715.WormWheelDesign)(self.wrapped.Wheel) if self.wrapped.Wheel else None

    @property
    def worm_gears(self) -> 'List[_712.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_712.WormGearDesign))
        return value
