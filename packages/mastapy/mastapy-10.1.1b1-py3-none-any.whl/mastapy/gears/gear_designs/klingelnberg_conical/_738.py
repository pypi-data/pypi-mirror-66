...
from mastapy.gears.gear_designs.conical import _892, _880
...
class KlingelnbergConicalGearSetDesign(_880.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_892.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_892.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_892.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_737.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_737.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_737.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_737.KlingelnbergConicalGearMeshDesign))
        return value
