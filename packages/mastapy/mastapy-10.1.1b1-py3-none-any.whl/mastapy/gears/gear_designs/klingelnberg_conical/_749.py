...
from mastapy.gears.gear_designs.conical import _902, _890
...
class KlingelnbergConicalGearSetDesign(_890.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_902.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_902.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_902.KlingelnbergFinishingMethods'):
