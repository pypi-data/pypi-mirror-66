...
from mastapy.gears.gear_designs.bevel import _910
...
class BevelGearDesign(_917.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_910.FinishingMethods':
        ...
        return constructor.new(_910.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_910.FinishingMethods'):
