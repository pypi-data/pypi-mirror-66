...
class BevelGearDesign(_925.AGMAGleasonConicalGearDesign):
    '''BevelGearDesign
    ...
    @property
    def finishing_method(self) -> '_918.FinishingMethods':
        ...
        return constructor.new(_918.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_918.FinishingMethods'):
