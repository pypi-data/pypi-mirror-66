...
from mastapy.gears.gear_designs.creation_options import _879
...
class CylindricalGearPairCreationOptions(_879.GearSetCreationOptions['_785.CylindricalGearSetDesign']):
    '''CylindricalGearPairCreationOptions
