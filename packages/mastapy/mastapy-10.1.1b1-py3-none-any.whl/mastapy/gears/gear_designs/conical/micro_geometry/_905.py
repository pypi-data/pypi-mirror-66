...
from mastapy.gears.gear_designs.conical.micro_geometry import _907, _906, _904
...
class ConicalGearFlankMicroGeometry(_354.FlankMicroGeometry):
    ...
    @property
    def profile_relief(self) -> '_907.ConicalGearProfileModification':
        ...
        return constructor.new(_907.ConicalGearProfileModification)(self.wrapped.ProfileRelief) if self.wrapped.ProfileRelief else None

    @property
    def lead_relief(self) -> '_906.ConicalGearLeadModification':
        ...
        return constructor.new(_906.ConicalGearLeadModification)(self.wrapped.LeadRelief) if self.wrapped.LeadRelief else None

    @property
    def bias(self) -> '_904.ConicalGearBiasModification':
        ...
        return constructor.new(_904.ConicalGearBiasModification)(self.wrapped.Bias) if self.wrapped.Bias else None

    @property
    def gear_design(self) -> '_886.ConicalGearDesign':
