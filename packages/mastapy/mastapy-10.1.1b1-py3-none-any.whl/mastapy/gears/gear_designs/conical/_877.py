...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_886.CutterGaugeLengths':
        ...
        return constructor.new(_886.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_886.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_885.CutterBladeType':
        ...
        return constructor.new(_885.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_885.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_894.TopremEntryType':
        ...
        return constructor.new(_894.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_894.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_895.TopremLetter':
        ...
        return constructor.new(_895.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_895.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_895.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_895.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
