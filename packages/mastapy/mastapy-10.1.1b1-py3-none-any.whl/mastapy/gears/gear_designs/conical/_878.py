...
from mastapy.gears.gear_designs.cylindrical import _817
...
class ConicalGearDesign(_702.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def surface_roughness(self) -> '_817.SurfaceRoughness':
        ...
        return constructor.new(_817.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def flank_measurement_border(self) -> '_573.FlankMeasurementBorder':
        ...
        return constructor.new(_573.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
