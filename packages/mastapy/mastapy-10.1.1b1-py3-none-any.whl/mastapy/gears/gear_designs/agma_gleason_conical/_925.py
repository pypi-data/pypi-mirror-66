...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _869, _873, _877
from mastapy.gears.gear_designs.agma_gleason_conical import _924
...
class AGMAGleasonConicalGearDesign(_886.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_896.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_896.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_896.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_885.ConicalGearCutter':
        ...
        return constructor.new(_885.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def cutter_of_type_pinion_finish_cutter(self) -> '_595.PinionFinishCutter':
        ...
        return constructor.new(_595.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def cutter_of_type_pinion_rough_cutter(self) -> '_596.PinionRoughCutter':
        ...
        return constructor.new(_596.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def cutter_of_type_wheel_finish_cutter(self) -> '_597.WheelFinishCutter':
        ...
        return constructor.new(_597.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    def cutter_of_type_wheel_rough_cutter(self) -> '_598.WheelRoughCutter':
        ...
        return constructor.new(_598.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_895.DummyConicalGearCutter':
        ...
        if _895.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_895.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_869.AGMA20151AccuracyGrades':
        ...
        if _869.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_869.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_873.CylindricalAccuracyGrades':
        ...
        if _873.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_873.CylindricalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_877.ISO1328AccuracyGrades':
        ...
        if _877.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_877.ISO1328AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_924.AGMAGleasonConicalAccuracyGrades':
        ...
        if _924.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_924.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None
    ...
    def bevel_gear_material(self) -> '_377.GearMaterial':
        ...
        return constructor.new(_377.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_368.BevelGearISOMaterial':
        ...
        return constructor.new(_368.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_370.BevelGearMaterial':
        ...
        return constructor.new(_370.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_374.CylindricalGearMaterial':
        ...
        return constructor.new(_374.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_380.ISOCylindricalGearMaterial':
        ...
        return constructor.new(_380.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_384.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        return constructor.new(_384.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_386.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_386.PlasticCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
