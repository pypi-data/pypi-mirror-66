...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _861, _865, _869
from mastapy.gears.gear_designs.agma_gleason_conical import _916
...
class AGMAGleasonConicalGearDesign(_878.ConicalGearDesign):
    '''AGMAGleasonConicalGearDesign
    ...
    @property
    def front_end_type(self) -> '_888.FrontEndTypes':
        '''FrontEndTypes: 'FrontEndType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FrontEndType)
        return constructor.new(_888.FrontEndTypes)(value) if value else None

    @front_end_type.setter
    def front_end_type(self, value: '_888.FrontEndTypes'):
    ...
    @property
    def cutter(self) -> '_877.ConicalGearCutter':
        ...
        return constructor.new(_877.ConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_finish_cutter(self) -> '_590.PinionFinishCutter':
        ...
        if _590.PinionFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_590.PinionFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_pinion_rough_cutter(self) -> '_591.PinionRoughCutter':
        ...
        if _591.PinionRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_591.PinionRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_finish_cutter(self) -> '_592.WheelFinishCutter':
        ...
        if _592.WheelFinishCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_592.WheelFinishCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_wheel_rough_cutter(self) -> '_593.WheelRoughCutter':
        ...
        if _593.WheelRoughCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
            raise CastException('Failed to cast cutter to WheelRoughCutter. Expected: {}.'.format(self.wrapped.Cutter.__class__.__qualname__))

        return constructor.new(_593.WheelRoughCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None

    @property
    def cutter_of_type_dummy_conical_gear_cutter(self) -> '_887.DummyConicalGearCutter':
        ...
        if _887.DummyConicalGearCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
        ...
        return constructor.new(_887.DummyConicalGearCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_861.AGMA20151AccuracyGrades':
        ...
        if _861.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_861.AGMA20151AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_cylindrical_accuracy_grades(self) -> '_865.CylindricalAccuracyGrades':
        ...
        if _865.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_865.CylindricalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_869.ISO1328AccuracyGrades':
        ...
        if _869.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_869.ISO1328AccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def accuracy_grades_of_type_agma_gleason_conical_accuracy_grades(self) -> '_916.AGMAGleasonConicalAccuracyGrades':
        ...
        if _916.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
        ...
        return constructor.new(_916.AGMAGleasonConicalAccuracyGrades)(self.wrapped.AccuracyGrades) if self.wrapped.AccuracyGrades else None

    @property
    def bevel_gear_material(self) -> '_374.GearMaterial':
        ...
        return constructor.new(_374.GearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
    ...
    def bevel_gear_material_of_type_agma_cylindrical_gear_material(self) -> '_365.AGMACylindricalGearMaterial':
        ...
        return constructor.new(_365.AGMACylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_iso_material(self) -> '_366.BevelGearISOMaterial':
        ...
        if _366.BevelGearISOMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_366.BevelGearISOMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_bevel_gear_material(self) -> '_368.BevelGearMaterial':
        ...
        if _368.BevelGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_368.BevelGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_cylindrical_gear_material(self) -> '_372.CylindricalGearMaterial':
        ...
        if _372.CylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_372.CylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_iso_cylindrical_gear_material(self) -> '_376.ISOCylindricalGearMaterial':
        ...
        if _376.ISOCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_376.ISOCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_380.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _380.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_380.KlingelnbergCycloPalloidConicalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None

    @property
    def bevel_gear_material_of_type_plastic_cylindrical_gear_material(self) -> '_382.PlasticCylindricalGearMaterial':
        ...
        if _382.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.BevelGearMaterial.__class__.__mro__:
        ...
        return constructor.new(_382.PlasticCylindricalGearMaterial)(self.wrapped.BevelGearMaterial) if self.wrapped.BevelGearMaterial else None
