...
from mastapy.gears.gear_designs.straight_bevel import _722, _720, _723
...
class StraightBevelGearMeshDesign(_905.BevelGearMeshDesign):
    '''StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_gear_set(self) -> '_722.StraightBevelGearSetDesign':
        ...
        return constructor.new(_722.StraightBevelGearSetDesign)(self.wrapped.StraightBevelGearSet) if self.wrapped.StraightBevelGearSet else None
    ...
    @property
    def straight_bevel_meshed_gears(self) -> 'List[_723.StraightBevelMeshedGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshedGears, constructor.new(_723.StraightBevelMeshedGearDesign))
        return value
