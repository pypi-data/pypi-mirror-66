...
from mastapy.gears.gear_designs.concept import _900, _901
...
class ConceptGearSetDesign(_705.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_900.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_900.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_900.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_900.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_901.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_901.ConceptGearMeshDesign))
        return value
