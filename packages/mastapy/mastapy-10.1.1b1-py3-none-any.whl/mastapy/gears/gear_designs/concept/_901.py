...
from mastapy.gears.gear_designs.concept import _902, _900
...
class ConceptGearMeshDesign(_704.GearMeshDesign):
    '''ConceptGearMeshDesign
    ...
    @property
    def concept_gear_set(self) -> '_902.ConceptGearSetDesign':
        ...
        return constructor.new(_902.ConceptGearSetDesign)(self.wrapped.ConceptGearSet) if self.wrapped.ConceptGearSet else None
