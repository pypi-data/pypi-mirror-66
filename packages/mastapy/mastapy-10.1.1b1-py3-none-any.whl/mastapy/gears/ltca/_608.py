...
from mastapy.gears.cylindrical import _941, _940
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_941.CylindricalGearLTCAContactCharts':
        ...
        return constructor.new(_941.CylindricalGearLTCAContactCharts)(self.wrapped.ContactCharts) if self.wrapped.ContactCharts else None

    @property
    def contact_charts_as_text_file(self) -> '_940.CylindricalGearLTCAContactChartDataAsTextFile':
        ...
        return constructor.new(_940.CylindricalGearLTCAContactChartDataAsTextFile)(self.wrapped.ContactChartsAsTextFile) if self.wrapped.ContactChartsAsTextFile else None

    def contact_patch_detailed(self, result_type: '_607.ContactResultType', number_of_face_width_steps: 'int', number_of_roll_distance_steps: 'int') -> '_1072.GriddedSurface':
        ...
        return constructor.new(_1072.GriddedSurface)(method_result) if method_result else None

    def contact_patch(self, result_type: '_607.ContactResultType', include_tip_contact: 'bool') -> '_1072.GriddedSurface':
        ''' 'ContactPatch' is the original name of this method.
