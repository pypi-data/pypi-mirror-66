...
class CylindricalMeshLoadDistributionAtRotation(_618.GearMeshLoadDistributionAtRotation):
    ...
    @property
    def mesh_alignment(self) -> '_859.MeshAlignment':
        ...
        return constructor.new(_859.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None
