...
from mastapy.gears.rating.bevel.standards import _344, _342
from mastapy.gears.rating.iso_10300 import _228, _226
...
class BevelGearMeshRating(_349.AGMAGleasonConicalGearMeshRating):
    '''BevelGearMeshRating
    ...
    @property
    def gleason_bevel_mesh_single_flank_rating(self) -> '_344.GleasonSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_344.GleasonSpiralBevelMeshSingleFlankRating)(self.wrapped.GleasonBevelMeshSingleFlankRating) if self.wrapped.GleasonBevelMeshSingleFlankRating else None

    @property
    def agma_bevel_mesh_single_flank_rating(self) -> '_342.AGMASpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_342.AGMASpiralBevelMeshSingleFlankRating)(self.wrapped.AGMABevelMeshSingleFlankRating) if self.wrapped.AGMABevelMeshSingleFlankRating else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b1(self) -> '_228.ISO10300MeshSingleFlankRatingMethodB1':
        ...
        return constructor.new(_228.ISO10300MeshSingleFlankRatingMethodB1)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB1 else None

    @property
    def iso10300_bevel_mesh_single_flank_rating_method_b2(self) -> '_226.Iso10300MeshSingleFlankRatingBevelMethodB2':
        ...
        return constructor.new(_226.Iso10300MeshSingleFlankRatingBevelMethodB2)(self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2) if self.wrapped.ISO10300BevelMeshSingleFlankRatingMethodB2 else None
