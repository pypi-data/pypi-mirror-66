...
class KlingelnbergCycloPalloidHypoidGearMeshRating(_213.KlingelnbergCycloPalloidConicalGearMeshRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_733.KlingelnbergCycloPalloidHypoidGearMeshDesign':
        ...
        return constructor.new(_733.KlingelnbergCycloPalloidHypoidGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidHypoidGearMesh) if self.wrapped.KlingelnbergCycloPalloidHypoidGearMesh else None
