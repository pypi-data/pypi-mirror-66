...
class GearSetDutyCycleRating(_158.AbstractGearSetRating):
    ...
    @property
    def gear_set_design_of_type_conical_gear_set_design(self) -> '_890.ConicalGearSetDesign':
        ...
        if _890.ConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_890.ConicalGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None

    @property
    def gear_set_design_of_type_concept_gear_set_design(self) -> '_912.ConceptGearSetDesign':
        ...
        if _912.ConceptGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_912.ConceptGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None

    @property
    def gear_set_design_of_type_bevel_gear_set_design(self) -> '_916.BevelGearSetDesign':
        ...
        if _916.BevelGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_916.BevelGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None

    @property
    def gear_set_design_of_type_agma_gleason_conical_gear_set_design(self) -> '_929.AGMAGleasonConicalGearSetDesign':
        ...
        if _929.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.GearSetDesign.__class__.__mro__:
        ...
        return constructor.new(_929.AGMAGleasonConicalGearSetDesign)(self.wrapped.GearSetDesign) if self.wrapped.GearSetDesign else None
