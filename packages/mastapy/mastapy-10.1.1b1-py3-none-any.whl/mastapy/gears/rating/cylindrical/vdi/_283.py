...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating(self) -> '_311.ISO6336AbstractMetalGearSingleFlankRating':
        ...
        return constructor.new(_311.ISO6336AbstractMetalGearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63361996_gear_single_flank_rating(self) -> '_303.ISO63361996GearSingleFlankRating':
        ...
        if _303.ISO63361996GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_303.ISO63361996GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362006_gear_single_flank_rating(self) -> '_305.ISO63362006GearSingleFlankRating':
        ...
        if _305.ISO63362006GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_305.ISO63362006GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None

    @property
    def iso_gear_rating_of_type_iso63362019_gear_single_flank_rating(self) -> '_307.ISO63362019GearSingleFlankRating':
        ...
        if _307.ISO63362019GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
        ...
        return constructor.new(_307.ISO63362019GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
    ...
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_316.DIN3990GearSingleFlankRating':
        ...
        return constructor.new(_316.DIN3990GearSingleFlankRating)(self.wrapped.ISOGearRating) if self.wrapped.ISOGearRating else None
