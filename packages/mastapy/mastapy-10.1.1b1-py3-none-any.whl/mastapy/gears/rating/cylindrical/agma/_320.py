...
from mastapy.gears.gear_designs.cylindrical import _784, _820
...
class AGMA2101MeshSingleFlankRating(_268.CylindricalMeshSingleFlankRating):
    ...
    @property
    def profile_modification(self) -> '_784.CylindricalGearProfileModifications':
        ...
        return constructor.new(_784.CylindricalGearProfileModifications)(value) if value else None
    ...
    @property
    def scuffing_temperature_method(self) -> '_820.ScuffingTemperatureMethodsAGMA':
        ...
        return constructor.new(_820.ScuffingTemperatureMethodsAGMA)(value) if value else None
