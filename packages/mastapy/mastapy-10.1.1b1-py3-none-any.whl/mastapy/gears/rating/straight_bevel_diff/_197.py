...
class StraightBevelDiffGearMeshRating(_322.ConicalGearMeshRating):
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_717.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_717.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None
