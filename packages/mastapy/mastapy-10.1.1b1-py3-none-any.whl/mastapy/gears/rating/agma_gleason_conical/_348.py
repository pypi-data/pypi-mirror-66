...
class AGMAGleasonConicalGearMeshRating(_322.ConicalGearMeshRating):
    ...
    @property
    def load_distribution_factor_method(self) -> '_893.LoadDistributionFactorMethods':
        ...
        return constructor.new(_893.LoadDistributionFactorMethods)(value) if value else None
