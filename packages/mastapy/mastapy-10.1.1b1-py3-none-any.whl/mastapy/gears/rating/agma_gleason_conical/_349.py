...
from mastapy.gears.gear_designs.conical import _901
...
class AGMAGleasonConicalGearMeshRating(_323.ConicalGearMeshRating):
    ...
    @property
    def load_distribution_factor_method(self) -> '_901.LoadDistributionFactorMethods':
        ...
        return constructor.new(_901.LoadDistributionFactorMethods)(value) if value else None
