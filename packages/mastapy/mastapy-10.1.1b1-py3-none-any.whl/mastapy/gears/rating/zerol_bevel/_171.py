...
class ZerolBevelGearMeshRating(_337.BevelGearMeshRating):
    ...
    @property
    def zerol_bevel_gear_mesh(self) -> '_708.ZerolBevelGearMeshDesign':
        ...
        return constructor.new(_708.ZerolBevelGearMeshDesign)(self.wrapped.ZerolBevelGearMesh) if self.wrapped.ZerolBevelGearMesh else None
