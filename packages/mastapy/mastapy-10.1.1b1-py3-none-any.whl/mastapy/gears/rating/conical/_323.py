...
class ConicalGearMeshRating(_163.GearMeshRating):
    ...
    def mesh_load_case(self) -> '_658.ConicalMeshLoadCase':
        ...
        return constructor.new(_658.ConicalMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None
    ...
    def conical_mesh_load_case(self) -> '_658.ConicalMeshLoadCase':
        ...
        return constructor.new(_658.ConicalMeshLoadCase)(self.wrapped.ConicalMeshLoadCase) if self.wrapped.ConicalMeshLoadCase else None
