...
class SpiralBevelGearMeshRating(_337.BevelGearMeshRating):
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_725.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_725.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
