...
class HypoidGearMeshRating(_348.AGMAGleasonConicalGearMeshRating):
    ...
    @property
    def hypoid_gear_mesh(self) -> '_741.HypoidGearMeshDesign':
        ...
        return constructor.new(_741.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
