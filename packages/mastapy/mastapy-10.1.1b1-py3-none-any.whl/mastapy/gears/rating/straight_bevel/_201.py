...
class StraightBevelGearMeshRating(_337.BevelGearMeshRating):
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_721.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_721.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
