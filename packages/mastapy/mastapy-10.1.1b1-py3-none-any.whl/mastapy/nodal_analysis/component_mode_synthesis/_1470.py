...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1056.DataPrecision':
        ...
        return constructor.new(_1056.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1056.DataPrecision'):
    ...
    @property
    def internal_mode_options(self) -> '_1432.EigenvalueOptions':
        ...
        return constructor.new(_1432.EigenvalueOptions)(self.wrapped.InternalModeOptions) if self.wrapped.InternalModeOptions else None
