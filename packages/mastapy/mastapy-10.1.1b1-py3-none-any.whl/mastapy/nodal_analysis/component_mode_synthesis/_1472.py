...
from mastapy.nodal_analysis.component_mode_synthesis import _1470, _1467
...
class FullFEModel(_0.APIBase):
    ...
    @property
    def fe_model(self) -> '_1437.FEModel':
        ...
        return constructor.new(_1437.FEModel)(self.wrapped.FEModel) if self.wrapped.FEModel else None

    @property
    def reduction_options(self) -> '_1470.CMSOptions':
        ...
        return constructor.new(_1470.CMSOptions)(self.wrapped.ReductionOptions) if self.wrapped.ReductionOptions else None

    @property
    def element_face_groups(self) -> 'List[_1467.CMSElementFaceGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1467.CMSElementFaceGroup))
        return value
