...
class DrawStyleForImportedFE(_0.APIBase):
    ...
    @property
    def line_option(self) -> '_1347.FEMeshElementEntityOption':
        ...
        return constructor.new(_1347.FEMeshElementEntityOption)(value) if value else None

    @line_option.setter
    def line_option(self, value: '_1347.FEMeshElementEntityOption'):
