...
from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _1466, _1456
...
class ElementPropertiesRigid(_1456.ElementPropertiesBase):
    '''ElementPropertiesRigid
    ...
    @property
    def degrees_of_freedom_list(self) -> 'List[_1466.RigidElementNodeDegreesOfFreedom]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DegreesOfFreedomList, constructor.new(_1466.RigidElementNodeDegreesOfFreedom))
        return value
