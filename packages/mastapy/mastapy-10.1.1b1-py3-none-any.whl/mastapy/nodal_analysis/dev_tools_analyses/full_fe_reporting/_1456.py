...
from mastapy.fe_tools.enums import _958
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_958.ElementPropertyClass':
        ...
        return constructor.new(_958.ElementPropertyClass)(value) if value else None
