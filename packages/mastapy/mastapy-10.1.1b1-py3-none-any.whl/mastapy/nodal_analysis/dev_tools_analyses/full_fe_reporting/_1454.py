...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _955, _956
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def master_type(self) -> '_955.ContactPairMasterType':
        ...
        return constructor.new(_955.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_956.ContactPairSlaveType':
        ...
        return constructor.new(_956.ContactPairSlaveType)(value) if value else None
