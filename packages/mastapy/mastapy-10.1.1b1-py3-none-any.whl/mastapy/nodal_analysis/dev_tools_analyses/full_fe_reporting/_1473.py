...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _963, _964
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def master_type(self) -> '_963.ContactPairMasterType':
        ...
        return constructor.new(_963.ContactPairMasterType)(value) if value else None

    @property
    def slave_type(self) -> '_964.ContactPairSlaveType':
        ...
        return constructor.new(_964.ContactPairSlaveType)(value) if value else None
