...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _954
...
class ElementPropertiesBeam(_1464.ElementPropertiesWithMaterial):
    '''ElementPropertiesBeam
    ...
    @property
    def section_type(self) -> '_954.BeamSectionType':
        ...
        return constructor.new(_954.BeamSectionType)(value) if value else None
