...
class ElementPropertiesMass(_1456.ElementPropertiesBase):
    '''ElementPropertiesMass
    ...
    @property
    def inertia(self) -> '_1065.InertiaTensor':
        ...
        return constructor.new(_1065.InertiaTensor)(self.wrapped.Inertia) if self.wrapped.Inertia else None
