...
from mastapy.nodal_analysis.dev_tools_analyses import _1431
...
class FEModelInstanceDrawStyle(_0.APIBase):
    ...
    @property
    def model_draw_style(self) -> '_1431.DrawStyleForImportedFE':
        ...
        return constructor.new(_1431.DrawStyleForImportedFE)(self.wrapped.ModelDrawStyle) if self.wrapped.ModelDrawStyle else None
