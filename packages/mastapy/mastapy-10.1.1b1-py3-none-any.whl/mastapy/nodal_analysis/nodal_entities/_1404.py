...
from mastapy.nodal_analysis.nodal_entities import _1419
...
class Bar(_1419.NodalComponent):
    '''Bar
    ...
    @property
    def bar_geometry(self) -> '_1339.BarGeometry':
        ...
        return constructor.new(_1339.BarGeometry)(self.wrapped.BarGeometry) if self.wrapped.BarGeometry else None
