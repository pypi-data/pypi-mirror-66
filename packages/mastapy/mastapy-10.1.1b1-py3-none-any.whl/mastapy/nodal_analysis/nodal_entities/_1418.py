...
from mastapy.nodal_analysis.nodal_entities import _1403
...
class LineContactStiffnessEntity(_1403.ArbitraryNodalComponent):
    '''LineContactStiffnessEntity
    ...
    @property
    def stiffness_in_local_coordinate_system(self) -> '_1364.NodalMatrix':
        ...
        return constructor.new(_1364.NodalMatrix)(self.wrapped.StiffnessInLocalCoordinateSystem) if self.wrapped.StiffnessInLocalCoordinateSystem else None
