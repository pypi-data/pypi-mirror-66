...
from mastapy.nodal_analysis.system_solvers import _1386
...
class TransientSolver(_1386.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1372.TransientSolverStatus':
        ...
        return constructor.new(_1372.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1372.TransientSolverStatus'):
