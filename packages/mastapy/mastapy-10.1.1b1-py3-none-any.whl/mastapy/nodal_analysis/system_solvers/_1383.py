...
from mastapy.nodal_analysis.system_solvers import _1393
...
class BackwardEulerAccelerationStepHalvingTransientSolver(_1393.SimpleAccelerationBasedStepHalvingTransientSolver):
    '''BackwardEulerAccelerationStepHalvingTransientSolver
