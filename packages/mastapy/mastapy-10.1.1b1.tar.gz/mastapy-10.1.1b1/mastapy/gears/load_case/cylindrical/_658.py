...
class CylindricalMeshLoadCase(_649.MeshLoadCase):
    ...
    @property
    def load_case_modifiable_settings(self) -> '_812.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_812.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
