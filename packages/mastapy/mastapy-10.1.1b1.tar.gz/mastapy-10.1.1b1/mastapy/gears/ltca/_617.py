...
class GearMeshLoadDistributionAnalysis(_954.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1073.FourierSeries':
        ...
        return constructor.new(_1073.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None
    ...
    def maximum_root_stress_with_flanks(self, gear: '_616.GearLoadDistributionAnalysis', flank: '_129.GearFlanks', stress_type: '_1390.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_616.GearLoadDistributionAnalysis', stress_type: '_1390.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
