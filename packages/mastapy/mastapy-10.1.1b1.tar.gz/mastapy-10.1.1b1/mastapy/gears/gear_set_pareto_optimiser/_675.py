...
from mastapy.math_utility.optimisation import _1102, _1093, _1099
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1102.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1102.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1093.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1093.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1099.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1099.ParetoOptimisationFilter))
        return value
