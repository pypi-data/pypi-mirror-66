...
class ConicalGearSetDesign(_716.GearSetDesign):
    ...
    @property
    def conical_meshes(self) -> 'List[_889.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_889.ConicalGearMeshDesign))
        return value
