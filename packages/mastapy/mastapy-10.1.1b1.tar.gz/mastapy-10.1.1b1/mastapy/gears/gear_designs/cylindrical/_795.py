...
from mastapy.gears.gear_designs.cylindrical import _832, _765
...
class CylindricalMeshLinearBacklashSpecification(_832.TolerancedValueSpecification['_765.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
