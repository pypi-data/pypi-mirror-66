...
class CylindricalGearDefaults(_1139.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_876.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_876.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None
