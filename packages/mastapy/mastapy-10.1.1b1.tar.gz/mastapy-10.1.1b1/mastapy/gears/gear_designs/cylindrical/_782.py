...
class CylindricalGearMeshDesign(_715.GearMeshDesign):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_835.TypeOfMechanismHousing':
        ...
        return constructor.new(_835.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_835.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def valid_normal_module_range(self) -> '_1119.ShortLengthRange':
        ...
        return constructor.new(_1119.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
