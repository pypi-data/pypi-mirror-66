...
class DesignConstraintsCollection(_1342.NamedDatabaseItem):
    ...
    @property
    def design_constraints(self) -> 'List[_1347.DeletableCollectionMember[_710.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1347.DeletableCollectionMember)[_710.DesignConstraint])
        return value
