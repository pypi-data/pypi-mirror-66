...
class ISO6336AbstractMetalMeshSingleFlankRating(_311.ISO6336AbstractMeshSingleFlankRating):
    ...
    @property
    def scuffing_temperature_method(self) -> '_823.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_823.ScuffingTemperatureMethodsISO)(value) if value else None
