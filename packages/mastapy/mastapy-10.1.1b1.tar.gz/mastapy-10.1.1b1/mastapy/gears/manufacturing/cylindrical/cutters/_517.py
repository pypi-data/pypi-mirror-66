...
from mastapy.gears.gear_designs.cylindrical import _824
...
class CylindricalGearShaper(_521.InvoluteCutterDesign):
    ...
    @property
    def shaper_edge_type(self) -> '_824.ShaperEdgeTypes':
        ...
        return constructor.new(_824.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_824.ShaperEdgeTypes'):
