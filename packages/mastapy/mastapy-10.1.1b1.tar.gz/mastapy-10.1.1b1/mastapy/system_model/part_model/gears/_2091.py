...
from mastapy.system_model.part_model.gears import _2090, _2071
...
class WormGearSet(_2071.GearSet):
    '''WormGearSet
    ...
    @property
    def worm_gears(self) -> 'List[_2090.WormGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGears, constructor.new(_2090.WormGear))
        return value

    @property
    def worm_meshes(self) -> 'List[_1890.WormGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_1890.WormGearMesh))
        return value
