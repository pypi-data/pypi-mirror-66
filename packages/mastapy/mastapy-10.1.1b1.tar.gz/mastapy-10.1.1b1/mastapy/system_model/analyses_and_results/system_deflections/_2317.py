...
class StraightBevelDiffGearMeshSystemDeflection(_2221.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3316.StraightBevelDiffGearMeshPowerFlow':
