...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2278.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3284.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
