...
class PartLoadCase(_2184.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6184.StaticLoadCase':
        ...
        return constructor.new(_6184.StaticLoadCase)(self.wrapped.StaticLoadCase) if self.wrapped.StaticLoadCase else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6126.HarmonicLoadDataBase':
        ...
        return constructor.new(_6126.HarmonicLoadDataBase)(method_result) if method_result else None
