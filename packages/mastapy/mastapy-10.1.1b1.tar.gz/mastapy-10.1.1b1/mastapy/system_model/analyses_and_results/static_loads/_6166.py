...
from mastapy.system_model import _1804, _1805, _1806
from mastapy.system_model.analyses_and_results.mbd_analyses import _5098
from mastapy.system_model.analyses_and_results.static_loads import _6204, _6103, _6208
from mastapy.system_model.imported_fes import _1924
from mastapy.system_model.part_model import _2013
from mastapy.math_utility.control import _1124
...
class PowerLoadLoadCase(_6208.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1804.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1804.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1804.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5098.WheelSlipType':
        ...
        return constructor.new(_5098.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5098.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1806.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1806.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1806.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1124.PIDControlSettings':
        ...
        return constructor.new(_1124.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1400.NonDimensionalInputComponent':
        ...
        return constructor.new(_1400.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1124.PIDControlSettings':
        ...
        return constructor.new(_1124.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6103.ElectricMachineHarmonicLoadData':
        ...
        return constructor.new(_6103.ElectricMachineHarmonicLoadData)(method_result) if method_result else None
