...
from mastapy.system_model.analyses_and_results.load_case_groups import _5235, _5236, _5237
...
class StaticLoadCase(_6045.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6235.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6235.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5324.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5324.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5235.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5235.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5236.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5236.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5237.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
