...
from mastapy.system_model.analyses_and_results.static_loads import _6203, _6132, _6177
...
class ElectricMachineHarmonicLoadData(_6177.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6504.SMTBitmap':
        ...
        return constructor.new(_6504.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
