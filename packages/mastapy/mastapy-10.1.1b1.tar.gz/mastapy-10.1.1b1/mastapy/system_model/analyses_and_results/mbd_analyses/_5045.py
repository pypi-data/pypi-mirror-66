...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _4974, _5021, _4971, _5066,
    _5029, _5030, _5046
)
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.system_model.part_model import _2013
from mastapy.nodal_analysis import _1391
from mastapy.system_model.analyses_and_results.mbd_analyses.external_interfaces import _5110
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self) -> '_4971.AnalysisTypes':
        '''AnalysisTypes: 'AnalysisType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.AnalysisType)
        return constructor.new(_4971.AnalysisTypes)(value) if value else None

    @analysis_type.setter
    def analysis_type(self, value: '_4971.AnalysisTypes'):
    ...
    @property
    def method_to_define_period(self) -> '_5029.InertiaAdjustedLoadCasePeriodMethod':
        ...
        return constructor.new(_5029.InertiaAdjustedLoadCasePeriodMethod)(value) if value else None

    @method_to_define_period.setter
    def method_to_define_period(self, value: '_5029.InertiaAdjustedLoadCasePeriodMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def static_load_cases_to_create(self) -> '_5030.InertiaAdjustedLoadCaseResultsToCreate':
        ...
        return constructor.new(_5030.InertiaAdjustedLoadCaseResultsToCreate)(value) if value else None

    @static_load_cases_to_create.setter
    def static_load_cases_to_create(self, value: '_5030.InertiaAdjustedLoadCaseResultsToCreate'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def transient_solver_options(self) -> '_1391.TransientSolverOptions':
        ...
        return constructor.new(_1391.TransientSolverOptions)(self.wrapped.TransientSolverOptions) if self.wrapped.TransientSolverOptions else None

    @property
    def external_interface_options(self) -> '_5110.DynamicExternalInterfaceOptions':
        ...
        return constructor.new(_5110.DynamicExternalInterfaceOptions)(self.wrapped.ExternalInterfaceOptions) if self.wrapped.ExternalInterfaceOptions else None

    @property
    def run_up_analysis_options(self) -> '_5046.MBDRunUpAnalysisOptions':
        ...
        return constructor.new(_5046.MBDRunUpAnalysisOptions)(self.wrapped.RunUpAnalysisOptions) if self.wrapped.RunUpAnalysisOptions else None

    @property
    def frequency_response_options(self) -> '_4751.FrequencyResponseAnalysisOptions':
        ...
        return constructor.new(_4751.FrequencyResponseAnalysisOptions)(self.wrapped.FrequencyResponseOptions) if self.wrapped.FrequencyResponseOptions else None
