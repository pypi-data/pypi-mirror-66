...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6276, _6277, _6289
...
class CylindricalGearSetAdvancedSystemDeflection(_6289.GearSetAdvancedSystemDeflection):
    '''CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def micro_geometry(self) -> '_851.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_851.CylindricalGearSetMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
    ...
    @property
    def cylindrical_gears_advanced_system_deflection(self) -> 'List[_6276.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsAdvancedSystemDeflection, constructor.new(_6276.CylindricalGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshes_advanced_system_deflection(self) -> 'List[_6277.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesAdvancedSystemDeflection, constructor.new(_6277.CylindricalGearMeshAdvancedSystemDeflection))
        return value
