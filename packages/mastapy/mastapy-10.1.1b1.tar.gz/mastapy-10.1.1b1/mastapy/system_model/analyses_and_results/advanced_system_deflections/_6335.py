...
class StraightBevelDiffGearMeshAdvancedSystemDeflection(_6250.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelDiffGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_design(self) -> '_1886.StraightBevelDiffGearMesh':
    ...
    @property
    def connection_load_case(self) -> '_6186.StraightBevelDiffGearMeshLoadCase':
        ...
        return constructor.new(_6186.StraightBevelDiffGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2317.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2317.StraightBevelDiffGearMeshSystemDeflection))
        return value
