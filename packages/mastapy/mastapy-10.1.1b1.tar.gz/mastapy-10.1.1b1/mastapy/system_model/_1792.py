...
from mastapy import _3, _6501, _0
...
class Design(_0.APIBase):
    ...
    @property
    def design_states(self) -> 'List[_5237.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5237.DesignState))
        return value
    ...
    @property
    def duty_cycles(self) -> 'List[_5238.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5238.DutyCycle))
        return value
    ...
    def design_state_named(self, name: 'str') -> '_5237.DesignState':
        ...
        return constructor.new(_5237.DesignState)(method_result) if method_result else None

    def duty_cycle_named(self, name: 'str') -> '_5238.DutyCycle':
        ...
        return constructor.new(_5238.DutyCycle)(method_result) if method_result else None
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_6501.TaskProgress') -> '_1311.Status':
        ''' 'Save' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5237.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5238.DutyCycle':
