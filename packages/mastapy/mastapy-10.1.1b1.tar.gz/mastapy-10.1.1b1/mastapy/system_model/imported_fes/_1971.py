...
from mastapy.system_model.imported_fes import _1964, _1963
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1964.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1964.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1963.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1963.PerLinkExportOptions))
        return value
