...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appmesh", "1.33.1", __name__, "aws-appmesh@1.33.1.jsii.tgz")
...
class CfnRouteProps():
    def __init__(self, *, mesh_name: str, route_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnRoute.RouteSpecProperty"], virtual_router_name: str, mesh_owner: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class CfnVirtualNode(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-appmesh.CfnVirtualNode"):
    ...
    class BackendDefaultsProperty():
        def __init__(self, *, client_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnVirtualNode.ClientPolicyProperty"]]]=None):
            """
    ...
    class ClientPolicyProperty():
        def __init__(self, *, tls: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnVirtualNode.ClientPolicyTlsProperty"]]]=None):
            """
    ...
    class ListenerTlsFileCertificateProperty():
        def __init__(self, *, certificate_chain: str, private_key: str):
            """
    ...
    class ListenerTlsProperty():
        def __init__(self, *, certificate: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualNode.ListenerTlsCertificateProperty"], mode: str):
            """
    ...
    class TlsValidationContextAcmTrustProperty():
        def __init__(self, *, certificate_authority_arns: typing.List[str]):
            """
    ...
    class TlsValidationContextFileTrustProperty():
        def __init__(self, *, certificate_chain: str):
            """
    ...
    class TlsValidationContextProperty():
        def __init__(self, *, trust: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualNode.TlsValidationContextTrustProperty"]):
            """
    ...
    class VirtualServiceBackendProperty():
        def __init__(self, *, virtual_service_name: str, client_policy: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnVirtualNode.ClientPolicyProperty"]]]=None):
            """
...
class CfnVirtualNodeProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualNode.VirtualNodeSpecProperty"], virtual_node_name: str, mesh_owner: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class CfnVirtualRouterProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualRouter.VirtualRouterSpecProperty"], virtual_router_name: str, mesh_owner: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
...
class CfnVirtualServiceProps():
    def __init__(self, *, mesh_name: str, spec: typing.Union[aws_cdk.core.IResolvable, "CfnVirtualService.VirtualServiceSpecProperty"], virtual_service_name: str, mesh_owner: typing.Optional[str]=None, tags: typing.Optional[typing.List[aws_cdk.core.CfnTag]]=None):
