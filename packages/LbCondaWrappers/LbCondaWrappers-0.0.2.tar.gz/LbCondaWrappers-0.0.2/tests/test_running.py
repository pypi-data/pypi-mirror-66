...
#     assert env_name + os.sep + env_version in stdout
...
#     stdout, stderr = check_output(["lb-conda", "bash"], write_stdin='env')
#     assert "DIRAC=" in stdout
#     # TODO: Use /pro instead of /prod/ until /pro/ is deprecated
#     assert "/pro" in stdout

#     stdout, stderr = check_output(["lb-conda", "prod"], write_stdin='env')
#     assert "DIRAC=" in stdout
#     # TODO: Use /pro instead of /prod/ until /pro/ is deprecated
#     assert "/pro" in stdout

#     version = get_random_version()
#     stdout, stderr = check_output(["lb-conda", version], write_stdin='env')
#     assert "DIRAC=" in stdout
#     assert "/" + version + "/" in stdout
