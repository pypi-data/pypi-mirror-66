...
class Ogone(Field):
    ...
    def __init__(self, orderMethod, responseMethod, show='view', page='main',
      ...
      master=None, masterValue=None, focus=False, mapping=None,
      generateLabel=None, label=None, view=None, cell=None, edit=None, xml=None,
      translations=None):
        Field.__init__(self, None, (0,1), None, None, show, page, group,
          ...
          None, None, False, False, view, cell, edit, xml, translations)
