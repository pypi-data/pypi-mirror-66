...
class Renderer:
    ...
    def getCompleteContext(self, context):
        ...
        r.update({'xhtml': self.renderXhtml, 'text': self.renderText,
          ...
          'pod': self.importPod, 'test': self.evalIfExpression,
    ...
    def finalize(self):
        ...
        for name in ('styles', 'content'):
            ...
            if name == 'styles':
                ...
                numbered = sm.NumberedProperties()
                bulleted = sm.BulletedProperties()
                ds.insert(0, numbered.dumpStyle('podNumberedList', n))
                ds.insert(0, bulleted.dumpStyle('podBulletedList', n))
