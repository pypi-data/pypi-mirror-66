...
MISSING_PATH = 'Missing absolute disk path for %s.'
...
class FileInfo:
    ...
    def writeResponse(self, handler, path=None, disposition='attachment',
        ...
        if not self.fsName:
            ...
            raise Exception(MISSING_PATH % self.fsName)
    ...
    def dump(self, o, filePath=None, format=None):
        ...
        if format:
            ...
            if not os.path.exists(filePath):
                o.log(CONVERSION_ERROR % err, type='error')
                return
        return filePath
...
class File(Field):
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
      ...
      disposition='attachment', nameStorer=None, cache=False):
    ...
    def store(self, o, value):
        ...
        #    |  - "content", containing its biary content;
        #  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        if value:
            ...
            info = FileInfo(str(folder))
            if isinstance(value, Object) or isinstance(value, FileInfo):
                # Cases (a) and (e)
