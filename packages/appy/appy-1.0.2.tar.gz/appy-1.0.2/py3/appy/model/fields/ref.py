...
class Ref(Field):
    ...
    pxViewList = Px('''
     <div id=":hook"
      ...
      <div if="(layout == 'view') or mayAdd or mayLink">
    ...
    def getPopupLink(self, o, popupMode, name):
        ...
        if self.link == 'popup':
            ...
            r = '%s/field?name=%s&pageLayouts=w-b&popup=1&maxPerPage=%d' \
                '&selector=%d,%s,%s%s' % (popupObj.url, fieldName,
                self.maxPerPage, o.iid, name, popupMode, suffix)
        return r
