...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-glue", "1.33.1", __name__, "aws-glue@1.33.1.jsii.tgz")
...
class CfnDevEndpointProps():
    def __init__(self, *, role_arn: str, arguments: typing.Any=None, endpoint_name: typing.Optional[str]=None, extra_jars_s3_path: typing.Optional[str]=None, extra_python_libs_s3_path: typing.Optional[str]=None, glue_version: typing.Optional[str]=None, number_of_nodes: typing.Optional[jsii.Number]=None, number_of_workers: typing.Optional[jsii.Number]=None, public_key: typing.Optional[str]=None, public_keys: typing.Optional[typing.List[str]]=None, security_configuration: typing.Optional[str]=None, security_group_ids: typing.Optional[typing.List[str]]=None, subnet_id: typing.Optional[str]=None, tags: typing.Any=None, worker_type: typing.Optional[str]=None):
...
class CfnMLTransformProps():
    def __init__(self, *, input_record_tables: typing.Union[aws_cdk.core.IResolvable, "CfnMLTransform.InputRecordTablesProperty"], role: str, transform_parameters: typing.Union[aws_cdk.core.IResolvable, "CfnMLTransform.TransformParametersProperty"], description: typing.Optional[str]=None, glue_version: typing.Optional[str]=None, max_capacity: typing.Optional[jsii.Number]=None, max_retries: typing.Optional[jsii.Number]=None, name: typing.Optional[str]=None, number_of_workers: typing.Optional[jsii.Number]=None, tags: typing.Any=None, timeout: typing.Optional[jsii.Number]=None, worker_type: typing.Optional[str]=None):
