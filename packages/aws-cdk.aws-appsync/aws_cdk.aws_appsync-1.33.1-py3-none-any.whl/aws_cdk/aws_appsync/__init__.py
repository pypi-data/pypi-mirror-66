...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-appsync", "1.33.1", __name__, "aws-appsync@1.33.1.jsii.tgz")
...
class BaseDataSourceProps():
    def __init__(self, *, api: "GraphQLApi", name: str, description: typing.Optional[str]=None):
