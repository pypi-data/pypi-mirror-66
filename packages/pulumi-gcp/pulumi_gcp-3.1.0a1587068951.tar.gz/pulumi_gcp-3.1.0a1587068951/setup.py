...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.1.0-alpha.1587068951+gad5e34d7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.1.0-alpha.1587068951+gad5e34d7`
                """)
            else:
                raise
