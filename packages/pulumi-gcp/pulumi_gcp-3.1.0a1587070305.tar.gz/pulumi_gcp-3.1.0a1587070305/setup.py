...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.1.0-alpha.1587070305+g1a4ba91a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.1.0-alpha.1587070305+g1a4ba91a`
                """)
            else:
                raise
