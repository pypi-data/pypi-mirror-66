...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.1.0-alpha.1587419950+g9abfb850'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.1.0-alpha.1587419950+g9abfb850`
                """)
            else:
                raise
