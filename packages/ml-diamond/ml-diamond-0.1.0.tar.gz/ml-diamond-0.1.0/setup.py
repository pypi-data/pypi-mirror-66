...
setuptools.setup(
    ...
    version="0.1.0",
    author="Chaoyang He",
    author_email="me@chaoyanghe.com",
    description="DIAMOND: A Flexible Distributed Machine Learning Library for Novel Learning Algorithms and Models",
    long_description="DIAMOND: A Flexible Distributed Machine Learning Library for Novel Learning Algorithms and Models",
    long_description_content_type="text/markdown",
    url="https://github.com/chaoyanghe/diamond",
