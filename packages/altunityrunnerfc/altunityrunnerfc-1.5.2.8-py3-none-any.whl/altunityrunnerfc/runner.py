...
from altunityrunnerfc.commands import *
from altunityrunnerfc.altElement import AltElement
...
class AltrunUnityDriver(object):
    ...
    def find_chui_button_by_name_in_list(self,altObjects,value):
        return FindChuiButtonByNameInList(self.socket,self.request_separator,self.request_end,self.appium_driver,altObjects,value).execute()
