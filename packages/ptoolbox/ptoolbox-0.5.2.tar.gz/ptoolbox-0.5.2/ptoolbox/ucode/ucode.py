...
class UCode:
    ...
    def create_problem(self, lesson_id, problem: Union[Problem, str], score=10, xp=100, lang='vi'):
    ...
    def create_chapter(self, course_id, chapter_name, slug, parent_id=None):
        data = {
    ...
    def create_lesson_item(self, course_id, chapter_id, lesson_name, slug,
                           desciption="", content="",
...
def create_chapters_mc1():
    ...
    for w in range(1, 13):
        ...
        chapter_slug = make_slug(chapter_name)
        chapter_id = ucode.create_chapter(course_id=course_id, chapter_name=chapter_name, slug=chapter_slug)
