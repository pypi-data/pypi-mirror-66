...
class ScriptingNode(VisusDataflowPy.Node):
    ...
    def __init__(self):
        if self.__class__ == ScriptingNode:
            ...
            _self = self
        _VisusNodesPy.ScriptingNode_swiginit(self, _VisusNodesPy.new_ScriptingNode(_self, ))
    ...
    def getBounds(self):
        return _VisusNodesPy.ScriptingNode_getBounds(self)
    ...
    def execute(self, ar):
        return _VisusNodesPy.ScriptingNode_execute(self, ar)

    def write(self, ar):
        return _VisusNodesPy.ScriptingNode_write(self, ar)

    def read(self, ar):
        return _VisusNodesPy.ScriptingNode_read(self, ar)
    def __disown__(self):
        self.this.disown()
        _VisusNodesPy.disown_ScriptingNode(self)
        return weakref.proxy(self)
