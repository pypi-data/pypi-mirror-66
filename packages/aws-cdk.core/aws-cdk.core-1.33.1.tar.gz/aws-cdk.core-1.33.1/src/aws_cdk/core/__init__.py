...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/core", "1.33.1", __name__, "core@1.33.1.jsii.tgz")
...
class SizeConversionOptions():
    def __init__(self, *, rounding: typing.Optional["SizeRoundingBehavior"]=None):
