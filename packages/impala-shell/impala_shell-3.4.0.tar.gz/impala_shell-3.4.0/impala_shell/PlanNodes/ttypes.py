...
class TRuntimeFilterTargetDesc:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.target_expr)
    value = (value * 31) ^ hash(self.is_bound_by_partition_columns)
    value = (value * 31) ^ hash(self.target_expr_slotids)
    value = (value * 31) ^ hash(self.is_local_target)
    value = (value * 31) ^ hash(self.kudu_col_name)
    value = (value * 31) ^ hash(self.kudu_col_type)
    return value
...
class TRuntimeFilterDesc:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.src_expr)
    value = (value * 31) ^ hash(self.targets)
    value = (value * 31) ^ hash(self.planid_to_target_ndx)
    value = (value * 31) ^ hash(self.is_broadcast_join)
    value = (value * 31) ^ hash(self.has_local_targets)
    value = (value * 31) ^ hash(self.has_remote_targets)
    value = (value * 31) ^ hash(self.applied_on_partition_columns)
    value = (value * 31) ^ hash(self.ndv_estimate)
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.filter_size_bytes)
...
class THdfsFileSplit:
  ...
  def validate(self):
    if self.relative_path is None:
      raise TProtocol.TProtocolException(message='Required field relative_path is unset!')
    ...
    if self.is_erasure_coded is None:
      raise TProtocol.TProtocolException(message='Required field is_erasure_coded is unset!')
    if self.partition_path_hash is None:
      raise TProtocol.TProtocolException(message='Required field partition_path_hash is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.relative_path)
    value = (value * 31) ^ hash(self.offset)
    value = (value * 31) ^ hash(self.length)
    value = (value * 31) ^ hash(self.partition_id)
    value = (value * 31) ^ hash(self.file_length)
    value = (value * 31) ^ hash(self.file_compression)
    value = (value * 31) ^ hash(self.mtime)
    value = (value * 31) ^ hash(self.is_erasure_coded)
    value = (value * 31) ^ hash(self.partition_path_hash)
    return value
...
class TFileSplitGeneratorSpec:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'file_desc', (CatalogObjects.ttypes.THdfsFileDesc, CatalogObjects.ttypes.THdfsFileDesc.thrift_spec), None, ), # 1
  ...
  def validate(self):
    if self.file_desc is None:
      raise TProtocol.TProtocolException(message='Required field file_desc is unset!')
    if self.max_block_size is None:
      raise TProtocol.TProtocolException(message='Required field max_block_size is unset!')
    if self.is_splittable is None:
      raise TProtocol.TProtocolException(message='Required field is_splittable is unset!')
    if self.partition_id is None:
      raise TProtocol.TProtocolException(message='Required field partition_id is unset!')
    if self.partition_path_hash is None:
      raise TProtocol.TProtocolException(message='Required field partition_path_hash is unset!')
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.max_block_size)
    value = (value * 31) ^ hash(self.is_splittable)
    value = (value * 31) ^ hash(self.partition_id)
    value = (value * 31) ^ hash(self.partition_path_hash)
    return value
...
class TScanRange:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.hdfs_file_split)
    value = (value * 31) ^ hash(self.hbase_key_range)
    value = (value * 31) ^ hash(self.kudu_scan_token)
    return value
...
class THdfsScanNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.tuple_id)
    value = (value * 31) ^ hash(self.collection_conjuncts)
    value = (value * 31) ^ hash(self.replica_preference)
    value = (value * 31) ^ hash(self.random_replica)
    value = (value * 31) ^ hash(self.skip_header_line_count)
    value = (value * 31) ^ hash(self.use_mt_scan_node)
    value = (value * 31) ^ hash(self.min_max_conjuncts)
    value = (value * 31) ^ hash(self.min_max_tuple_id)
    value = (value * 31) ^ hash(self.dictionary_filter_conjuncts)
    value = (value * 31) ^ hash(self.parquet_count_star_slot_offset)
    return value
...
class TDataSourceScanNode:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.accepted_predicates)
    return value
...
class THBaseFilter:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.op_ordinal)
    value = (value * 31) ^ hash(self.filter_constant)
    return value
...
class THBaseScanNode:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.suggested_max_caching)
    return value
...
class TKuduScanNode:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.tuple_id)
    value = (value * 31) ^ hash(self.use_mt_scan_node)
    value = (value * 31) ^ hash(self.count_star_slot_offset)
    return value
...
class TEqJoinCondition:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_not_distinct_from)
    return value
...
class THashJoinNode:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'eq_join_conjuncts', (TType.STRUCT,(TEqJoinCondition, TEqJoinCondition.thrift_spec)), None, ), # 1
    (2, TType.LIST, 'other_join_conjuncts', (TType.STRUCT,(Exprs.ttypes.TExpr, Exprs.ttypes.TExpr.thrift_spec)), None, ), # 2
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.eq_join_conjuncts)
    value = (value * 31) ^ hash(self.other_join_conjuncts)
    value = (value * 31) ^ hash(self.hash_seed)
    return value
...
class TNestedLoopJoinNode:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'join_conjuncts', (TType.STRUCT,(Exprs.ttypes.TExpr, Exprs.ttypes.TExpr.thrift_spec)), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.join_conjuncts)
    return value
...
class TJoinNode:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'build_tuples', (TType.I32,None), None, ), # 2
    (3, TType.LIST, 'nullable_build_tuples', (TType.BOOL,None), None, ), # 3
    (4, TType.STRUCT, 'hash_join_node', (THashJoinNode, THashJoinNode.thrift_spec), None, ), # 4
    (5, TType.STRUCT, 'nested_loop_join_node', (TNestedLoopJoinNode, TNestedLoopJoinNode.thrift_spec), None, ), # 5
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.join_op)
    value = (value * 31) ^ hash(self.build_tuples)
    value = (value * 31) ^ hash(self.nullable_build_tuples)
    value = (value * 31) ^ hash(self.hash_join_node)
    value = (value * 31) ^ hash(self.nested_loop_join_node)
    return value
...
class TAggregator:
  ...
  thrift_spec = (
    ...
    (7, TType.STRUCT, 'resource_profile', (ResourceProfile.ttypes.TBackendResourceProfile, ResourceProfile.ttypes.TBackendResourceProfile.thrift_spec), None, ), # 7
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.grouping_exprs)
    value = (value * 31) ^ hash(self.aggregate_functions)
    value = (value * 31) ^ hash(self.intermediate_tuple_id)
    value = (value * 31) ^ hash(self.output_tuple_id)
    value = (value * 31) ^ hash(self.need_finalize)
    value = (value * 31) ^ hash(self.use_streaming_preaggregation)
    value = (value * 31) ^ hash(self.resource_profile)
    return value
...
class TAggregationNode:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'aggregators', (TType.STRUCT,(TAggregator, TAggregator.thrift_spec)), None, ), # 1
  ...
  def validate(self):
    if self.aggregators is None:
      raise TProtocol.TProtocolException(message='Required field aggregators is unset!')
    ...
    if self.replicate_input is None:
      raise TProtocol.TProtocolException(message='Required field replicate_input is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.aggregators)
    value = (value * 31) ^ hash(self.estimated_input_cardinality)
    value = (value * 31) ^ hash(self.replicate_input)
    return value
...
class TSortInfo:
  ...
  def validate(self):
    ...
    if self.sorting_order is None:
      raise TProtocol.TProtocolException(message='Required field sorting_order is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.ordering_exprs)
    value = (value * 31) ^ hash(self.is_asc_order)
    value = (value * 31) ^ hash(self.nulls_first)
    value = (value * 31) ^ hash(self.sort_tuple_slot_exprs)
    value = (value * 31) ^ hash(self.sorting_order)
    return value
...
class TSortNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.sort_info)
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.offset)
    return value
...
class TAnalyticWindowBoundary:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.range_offset_predicate)
    value = (value * 31) ^ hash(self.rows_offset_value)
    return value
...
class TAnalyticWindow:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.window_start)
    value = (value * 31) ^ hash(self.window_end)
    return value
...
class TAnalyticNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.partition_exprs)
    value = (value * 31) ^ hash(self.order_by_exprs)
    value = (value * 31) ^ hash(self.analytic_functions)
    value = (value * 31) ^ hash(self.window)
    value = (value * 31) ^ hash(self.intermediate_tuple_id)
    value = (value * 31) ^ hash(self.output_tuple_id)
    value = (value * 31) ^ hash(self.buffered_tuple_id)
    value = (value * 31) ^ hash(self.partition_by_eq)
    value = (value * 31) ^ hash(self.order_by_eq)
    return value
...
class TUnionNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.tuple_id)
    value = (value * 31) ^ hash(self.result_expr_lists)
    value = (value * 31) ^ hash(self.const_expr_lists)
    value = (value * 31) ^ hash(self.first_materialized_child_idx)
    return value
...
class TExchangeNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.input_row_tuples)
    value = (value * 31) ^ hash(self.sort_info)
    value = (value * 31) ^ hash(self.offset)
    return value
...
class TUnnestNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.collection_expr)
    return value
...
class TCardinalityCheckNode:
  ...
  def validate(self):
    if self.display_statement is None:
      raise TProtocol.TProtocolException(message='Required field display_statement is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.display_statement)
    return value
...
class TPipelineMembership:
  ...
  def validate(self):
    if self.pipe_id is None:
      raise TProtocol.TProtocolException(message='Required field pipe_id is unset!')
    if self.height is None:
      raise TProtocol.TProtocolException(message='Required field height is unset!')
    if self.phase is None:
      raise TProtocol.TProtocolException(message='Required field phase is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.pipe_id)
...
class TPlanNode:
  ...
  thrift_spec = (
    ...
    (13, TType.STRUCT, 'join_node', (TJoinNode, TJoinNode.thrift_spec), None, ), # 13
    None, # 14
    ...
    (25, TType.STRUCT, 'resource_profile', (ResourceProfile.ttypes.TBackendResourceProfile, ResourceProfile.ttypes.TBackendResourceProfile.thrift_spec), None, ), # 25
    (26, TType.STRUCT, 'cardinality_check_node', (TCardinalityCheckNode, TCardinalityCheckNode.thrift_spec), None, ), # 26
    (27, TType.LIST, 'pipelines', (TType.STRUCT,(TPipelineMembership, TPipelineMembership.thrift_spec)), None, ), # 27
  )
  ...
  def validate(self):
    ...
    if self.pipelines is None:
      raise TProtocol.TProtocolException(message='Required field pipelines is unset!')
    if self.resource_profile is None:
      raise TProtocol.TProtocolException(message='Required field resource_profile is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.nullable_tuples)
    value = (value * 31) ^ hash(self.conjuncts)
    value = (value * 31) ^ hash(self.disable_codegen)
    value = (value * 31) ^ hash(self.pipelines)
    value = (value * 31) ^ hash(self.hdfs_scan_node)
    value = (value * 31) ^ hash(self.hbase_scan_node)
    value = (value * 31) ^ hash(self.kudu_scan_node)
    value = (value * 31) ^ hash(self.data_source_node)
    value = (value * 31) ^ hash(self.join_node)
    value = (value * 31) ^ hash(self.agg_node)
    value = (value * 31) ^ hash(self.sort_node)
    value = (value * 31) ^ hash(self.union_node)
    value = (value * 31) ^ hash(self.exchange_node)
    value = (value * 31) ^ hash(self.analytic_node)
    value = (value * 31) ^ hash(self.unnest_node)
    value = (value * 31) ^ hash(self.label)
    value = (value * 31) ^ hash(self.label_detail)
    value = (value * 31) ^ hash(self.estimated_stats)
    value = (value * 31) ^ hash(self.runtime_filters)
    value = (value * 31) ^ hash(self.resource_profile)
    value = (value * 31) ^ hash(self.cardinality_check_node)
    return value
