...
class TCaseExpr:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.has_case_expr)
    value = (value * 31) ^ hash(self.has_else_expr)
    return value
...
class TDateLiteral:
  ...
  def validate(self):
    if self.days_since_epoch is None:
      raise TProtocol.TProtocolException(message='Required field days_since_epoch is unset!')
    if self.date_string is None:
      raise TProtocol.TProtocolException(message='Required field date_string is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.date_string)
    return value
...
class TInPredicate:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.is_not_in)
    return value
...
class TIsNullPredicate:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.is_not_null)
    return value
...
class TTupleIsNullPredicate:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.tuple_ids)
    return value
...
class TSlotRef:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.slot_id)
    return value
...
class TAggregateExpr:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.is_merge_agg)
...
class TCastExpr:
  ...
  def validate(self):
    if self.cast_format is None:
      raise TProtocol.TProtocolException(message='Required field cast_format is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.cast_format)
    return value
...
class TExprNode:
  ...
  thrift_spec = (
    ...
    (22, TType.STRUCT, 'cast_expr', (TCastExpr, TCastExpr.thrift_spec), None, ), # 22
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_constant)
    value = (value * 31) ^ hash(self.fn)
    value = (value * 31) ^ hash(self.vararg_start_idx)
    value = (value * 31) ^ hash(self.bool_literal)
    value = (value * 31) ^ hash(self.case_expr)
    value = (value * 31) ^ hash(self.date_literal)
    value = (value * 31) ^ hash(self.float_literal)
    value = (value * 31) ^ hash(self.int_literal)
    value = (value * 31) ^ hash(self.in_predicate)
    value = (value * 31) ^ hash(self.is_null_pred)
    value = (value * 31) ^ hash(self.literal_pred)
    value = (value * 31) ^ hash(self.slot_ref)
    value = (value * 31) ^ hash(self.string_literal)
    value = (value * 31) ^ hash(self.tuple_is_null_pred)
    value = (value * 31) ^ hash(self.decimal_literal)
    value = (value * 31) ^ hash(self.agg_expr)
    value = (value * 31) ^ hash(self.timestamp_literal)
    value = (value * 31) ^ hash(self.kudu_partition_expr)
    value = (value * 31) ^ hash(self.cast_expr)
    return value
