...
class TDataStreamSink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.dest_node_id)
    value = (value * 31) ^ hash(self.output_partition)
    return value
...
class THdfsTableSink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.partition_key_exprs)
    value = (value * 31) ^ hash(self.overwrite)
    value = (value * 31) ^ hash(self.skip_header_line_count)
    value = (value * 31) ^ hash(self.input_is_clustered)
...
class TKuduTableSink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.referenced_columns)
    value = (value * 31) ^ hash(self.ignore_not_found_or_duplicate)
    return value
...
class TJoinBuildSink:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'eq_join_conjuncts', (TType.STRUCT,(PlanNodes.ttypes.TEqJoinCondition, PlanNodes.ttypes.TEqJoinCondition.thrift_spec)), None, ), # 3
    (4, TType.LIST, 'runtime_filters', (TType.STRUCT,(PlanNodes.ttypes.TRuntimeFilterDesc, PlanNodes.ttypes.TRuntimeFilterDesc.thrift_spec)), None, ), # 4
    (5, TType.I32, 'hash_seed', None, None, ), # 5
  )

  def __init__(self, dest_node_id=None, join_op=None, eq_join_conjuncts=None, runtime_filters=None, hash_seed=None,):
    self.dest_node_id = dest_node_id
...
class TPlanRootSink:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'resource_profile', (ResourceProfile.ttypes.TBackendResourceProfile, ResourceProfile.ttypes.TBackendResourceProfile.thrift_spec), None, ), # 1
  )
...
class TTableSink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.target_table_id)
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.action)
    value = (value * 31) ^ hash(self.hdfs_table_sink)
    value = (value * 31) ^ hash(self.kudu_table_sink)
    return value
...
class TDataSink:
  ...
  thrift_spec = (
    ...
    (5, TType.STRUCT, 'plan_root_sink', (TPlanRootSink, TPlanRootSink.thrift_spec), None, ), # 5
    (6, TType.STRING, 'label', None, None, ), # 6
    (7, TType.STRUCT, 'estimated_stats', (ExecStats.ttypes.TExecStats, ExecStats.ttypes.TExecStats.thrift_spec), None, ), # 7
    (8, TType.LIST, 'output_exprs', (TType.STRUCT,(Exprs.ttypes.TExpr, Exprs.ttypes.TExpr.thrift_spec)), None, ), # 8
    (9, TType.STRUCT, 'resource_profile', (ResourceProfile.ttypes.TBackendResourceProfile, ResourceProfile.ttypes.TBackendResourceProfile.thrift_spec), None, ), # 9
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.type)
    value = (value * 31) ^ hash(self.stream_sink)
    value = (value * 31) ^ hash(self.table_sink)
    value = (value * 31) ^ hash(self.join_build_sink)
    value = (value * 31) ^ hash(self.plan_root_sink)
    value = (value * 31) ^ hash(self.label)
    value = (value * 31) ^ hash(self.estimated_stats)
    value = (value * 31) ^ hash(self.output_exprs)
    value = (value * 31) ^ hash(self.resource_profile)
    return value
