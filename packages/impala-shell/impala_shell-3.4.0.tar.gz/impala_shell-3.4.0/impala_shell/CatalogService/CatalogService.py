...
class GetPartitionStats_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TGetPartitionStatsRequest, TGetPartitionStatsRequest.thrift_spec), None, ), # 1
  )
...
class GetPartitionStats_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TGetPartitionStatsResponse, TGetPartitionStatsResponse.thrift_spec), None, ), # 0
  )
...
class GetPartialCatalogObject_args:
  """
  Attributes:
   - req
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TGetPartialCatalogObjectRequest, TGetPartialCatalogObjectRequest.thrift_spec), None, ), # 1
  )
...
class GetPartialCatalogObject_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TGetPartialCatalogObjectResponse, TGetPartialCatalogObjectResponse.thrift_spec), None, ), # 0
  )
...
class UpdateTableUsage_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TUpdateTableUsageRequest, TUpdateTableUsageRequest.thrift_spec), None, ), # 1
  )
...
class UpdateTableUsage_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TUpdateTableUsageResponse, TUpdateTableUsageResponse.thrift_spec), None, ), # 0
  )
