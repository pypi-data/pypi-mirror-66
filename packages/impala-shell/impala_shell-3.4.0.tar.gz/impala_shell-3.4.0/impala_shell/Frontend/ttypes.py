...
class THiveUdfExecutorCtorParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.local_location)
    value = (value * 31) ^ hash(self.input_byte_offsets)
    value = (value * 31) ^ hash(self.input_nulls_ptr)
    value = (value * 31) ^ hash(self.input_buffer_ptr)
    value = (value * 31) ^ hash(self.output_null_ptr)
    value = (value * 31) ^ hash(self.output_buffer_ptr)
    return value
...
class TGetCatalogMetricsResult:
  ...
  def validate(self):
    if self.num_dbs is None:
      raise TProtocol.TProtocolException(message='Required field num_dbs is unset!')
    if self.num_tables is None:
      raise TProtocol.TProtocolException(message='Required field num_tables is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.num_dbs)
    value = (value * 31) ^ hash(self.num_tables)
    value = (value * 31) ^ hash(self.cache_eviction_count)
    value = (value * 31) ^ hash(self.cache_hit_count)
    value = (value * 31) ^ hash(self.cache_load_count)
    value = (value * 31) ^ hash(self.cache_load_exception_count)
    value = (value * 31) ^ hash(self.cache_load_success_count)
    value = (value * 31) ^ hash(self.cache_miss_count)
    value = (value * 31) ^ hash(self.cache_request_count)
    value = (value * 31) ^ hash(self.cache_total_load_time)
    value = (value * 31) ^ hash(self.cache_avg_load_time)
    value = (value * 31) ^ hash(self.cache_hit_rate)
    value = (value * 31) ^ hash(self.cache_load_exception_rate)
    value = (value * 31) ^ hash(self.cache_miss_rate)
    return value
...
class TGetDataSrcsResult:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.data_src_names)
    value = (value * 31) ^ hash(self.locations)
    value = (value * 31) ^ hash(self.class_names)
    value = (value * 31) ^ hash(self.api_versions)
    return value
...
class TDescribeDbParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.db)
    value = (value * 31) ^ hash(self.output_style)
    return value
...
class TDescribeTableParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.output_style)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.result_struct)
    value = (value * 31) ^ hash(self.session)
    return value
...
class TShowDataSrcsParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.show_pattern)
    return value
...
class TShowFilesParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.partition_set)
    return value
...
class TShowRolesParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_show_current_roles)
    value = (value * 31) ^ hash(self.grant_group)
    return value
...
class TShowRolesResult:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.role_names)
    return value
...
class TShowGrantPrincipalParams:
  ...
  thrift_spec = (
    ...
    None, # 4
    (5, TType.STRUCT, 'privilege', (CatalogObjects.ttypes.TPrivilege, CatalogObjects.ttypes.TPrivilege.thrift_spec), None, ), # 5
  )
...
class TGetFunctionsResult:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.fn_signatures)
    value = (value * 31) ^ hash(self.fn_ret_types)
    value = (value * 31) ^ hash(self.fn_binary_types)
    value = (value * 31) ^ hash(self.fn_persistence)
    return value
...
class TFinalizeParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.hdfs_base_dir)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.table_db)
    value = (value * 31) ^ hash(self.staging_dir)
    value = (value * 31) ^ hash(self.table_id)
...
class TLoadDataReq:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.source_path)
    value = (value * 31) ^ hash(self.overwrite)
...
class TLoadDataResp:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.load_summary)
    return value
...
class TPlanExecInfo:
  ...
  thrift_spec = (
    ...
    (2, TType.MAP, 'per_node_scan_ranges', (TType.I32,None,TType.STRUCT,(Planner.ttypes.TScanRangeSpec, Planner.ttypes.TScanRangeSpec.thrift_spec)), None, ), # 2
  )
...
class TQueryExecRequest:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.plan_exec_info)
    value = (value * 31) ^ hash(self.result_set_metadata)
    value = (value * 31) ^ hash(self.finalize_params)
    value = (value * 31) ^ hash(self.query_ctx)
    value = (value * 31) ^ hash(self.query_plan)
    value = (value * 31) ^ hash(self.stmt_type)
    value = (value * 31) ^ hash(self.host_list)
    value = (value * 31) ^ hash(self.lineage_graph)
    value = (value * 31) ^ hash(self.per_host_mem_estimate)
    value = (value * 31) ^ hash(self.max_per_host_min_mem_reservation)
    value = (value * 31) ^ hash(self.max_per_host_thread_reservation)
    value = (value * 31) ^ hash(self.dedicated_coord_mem_estimate)
    return value
...
class TCatalogOpRequest:
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'use_db_params', (TUseDbParams, TUseDbParams.thrift_spec), None, ), # 3
    (4, TType.STRUCT, 'describe_db_params', (TDescribeDbParams, TDescribeDbParams.thrift_spec), None, ), # 4
    (5, TType.STRUCT, 'describe_table_params', (TDescribeTableParams, TDescribeTableParams.thrift_spec), None, ), # 5
    (6, TType.STRUCT, 'show_dbs_params', (TShowDbsParams, TShowDbsParams.thrift_spec), None, ), # 6
    (7, TType.STRUCT, 'show_tables_params', (TShowTablesParams, TShowTablesParams.thrift_spec), None, ), # 7
    (8, TType.STRUCT, 'show_fns_params', (TShowFunctionsParams, TShowFunctionsParams.thrift_spec), None, ), # 8
    (9, TType.STRUCT, 'show_data_srcs_params', (TShowDataSrcsParams, TShowDataSrcsParams.thrift_spec), None, ), # 9
    (10, TType.STRUCT, 'show_roles_params', (TShowRolesParams, TShowRolesParams.thrift_spec), None, ), # 10
    (11, TType.STRUCT, 'show_grant_principal_params', (TShowGrantPrincipalParams, TShowGrantPrincipalParams.thrift_spec), None, ), # 11
    (12, TType.STRUCT, 'ddl_params', (CatalogService.ttypes.TDdlExecRequest, CatalogService.ttypes.TDdlExecRequest.thrift_spec), None, ), # 12
    (13, TType.STRUCT, 'reset_metadata_params', (CatalogService.ttypes.TResetMetadataRequest, CatalogService.ttypes.TResetMetadataRequest.thrift_spec), None, ), # 13
    (14, TType.STRUCT, 'show_stats_params', (TShowStatsParams, TShowStatsParams.thrift_spec), None, ), # 14
    (15, TType.STRUCT, 'show_create_table_params', (CatalogObjects.ttypes.TTableName, CatalogObjects.ttypes.TTableName.thrift_spec), None, ), # 15
    (16, TType.STRUCT, 'show_files_params', (TShowFilesParams, TShowFilesParams.thrift_spec), None, ), # 16
    (17, TType.STRUCT, 'lineage_graph', (LineageGraph.ttypes.TLineageGraph, LineageGraph.ttypes.TLineageGraph.thrift_spec), None, ), # 17
    (18, TType.STRUCT, 'show_create_function_params', (TGetFunctionsParams, TGetFunctionsParams.thrift_spec), None, ), # 18
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.use_db_params)
    value = (value * 31) ^ hash(self.describe_db_params)
    value = (value * 31) ^ hash(self.describe_table_params)
    value = (value * 31) ^ hash(self.show_dbs_params)
    value = (value * 31) ^ hash(self.show_tables_params)
    value = (value * 31) ^ hash(self.show_fns_params)
    value = (value * 31) ^ hash(self.show_data_srcs_params)
    value = (value * 31) ^ hash(self.show_roles_params)
    value = (value * 31) ^ hash(self.show_grant_principal_params)
    value = (value * 31) ^ hash(self.ddl_params)
    value = (value * 31) ^ hash(self.reset_metadata_params)
    value = (value * 31) ^ hash(self.show_stats_params)
    value = (value * 31) ^ hash(self.show_create_table_params)
    value = (value * 31) ^ hash(self.show_files_params)
    value = (value * 31) ^ hash(self.lineage_graph)
    value = (value * 31) ^ hash(self.show_create_function_params)
    return value
...
class TSetQueryOptionRequest:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_set_all)
    return value
...
class TShutdownParams:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'backend', (Types.ttypes.TNetworkAddress, Types.ttypes.TNetworkAddress.thrift_spec), None, ), # 1
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.deadline_s)
    return value
...
class TAdminRequest:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'shutdown_params', (TShutdownParams, TShutdownParams.thrift_spec), None, ), # 2
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.shutdown_params)
    return value
...
class TMetadataOpRequest:
  ...
  thrift_spec = (
    ...
    (11, TType.STRUCT, 'get_primary_keys_req', (TCLIService.ttypes.TGetPrimaryKeysReq, TCLIService.ttypes.TGetPrimaryKeysReq.thrift_spec), None, ), # 11
    (12, TType.STRUCT, 'get_cross_reference_req', (TCLIService.ttypes.TGetCrossReferenceReq, TCLIService.ttypes.TGetCrossReferenceReq.thrift_spec), None, ), # 12
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.opcode)
    value = (value * 31) ^ hash(self.get_info_req)
    value = (value * 31) ^ hash(self.get_type_info_req)
    value = (value * 31) ^ hash(self.get_catalogs_req)
    value = (value * 31) ^ hash(self.get_schemas_req)
    value = (value * 31) ^ hash(self.get_tables_req)
    value = (value * 31) ^ hash(self.get_table_types_req)
    value = (value * 31) ^ hash(self.get_columns_req)
    value = (value * 31) ^ hash(self.get_functions_req)
    value = (value * 31) ^ hash(self.session)
    value = (value * 31) ^ hash(self.get_primary_keys_req)
    value = (value * 31) ^ hash(self.get_cross_reference_req)
    return value
...
class TAccessEvent:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.name)
    value = (value * 31) ^ hash(self.object_type)
    value = (value * 31) ^ hash(self.privilege)
    return value
...
class TExecRequest:
  ...
  thrift_spec = (
    ...
    (13, TType.STRUCT, 'admin_request', (TAdminRequest, TAdminRequest.thrift_spec), None, ), # 13
    (14, TType.STRUCT, 'profile', (RuntimeProfile.ttypes.TRuntimeProfileNode, RuntimeProfile.ttypes.TRuntimeProfileNode.thrift_spec), None, ), # 14
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.query_exec_request)
    value = (value * 31) ^ hash(self.catalog_op_request)
    value = (value * 31) ^ hash(self.result_set_metadata)
    value = (value * 31) ^ hash(self.explain_result)
    value = (value * 31) ^ hash(self.load_data_request)
    value = (value * 31) ^ hash(self.access_events)
    value = (value * 31) ^ hash(self.analysis_warnings)
    value = (value * 31) ^ hash(self.set_query_option_request)
    value = (value * 31) ^ hash(self.timeline)
    value = (value * 31) ^ hash(self.user_has_profile_access)
    value = (value * 31) ^ hash(self.admin_request)
    value = (value * 31) ^ hash(self.profile)
    value = (value * 31) ^ hash(self.testcase_data_path)
    return value
...
class TCacheJarResult:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.local_path)
    return value
...
class TSymbolLookupParams:
  ...
  def validate(self):
    ...
    if self.needs_refresh is None:
      raise TProtocol.TProtocolException(message='Required field needs_refresh is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.fn_binary_type)
    value = (value * 31) ^ hash(self.arg_types)
    value = (value * 31) ^ hash(self.has_var_args)
    value = (value * 31) ^ hash(self.ret_arg_type)
    value = (value * 31) ^ hash(self.symbol_type)
    value = (value * 31) ^ hash(self.needs_refresh)
    return value
...
class TSymbolLookupResult:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.result_code)
    value = (value * 31) ^ hash(self.symbol)
    value = (value * 31) ^ hash(self.error_msg)
    value = (value * 31) ^ hash(self.last_modified_time)
    return value
...
class TUpdateCatalogCacheRequest:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'updated_objects_deprecated', (TType.STRUCT,(CatalogObjects.ttypes.TCatalogObject, CatalogObjects.ttypes.TCatalogObject.thrift_spec)), None, ), # 3
    (4, TType.LIST, 'removed_objects_deprecated', (TType.STRUCT,(CatalogObjects.ttypes.TCatalogObject, CatalogObjects.ttypes.TCatalogObject.thrift_spec)), None, ), # 4
  ...
  def validate(self):
    ...
    if self.native_iterator_ptr is None:
      raise TProtocol.TProtocolException(message='Required field native_iterator_ptr is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.removed_objects_deprecated)
    value = (value * 31) ^ hash(self.native_iterator_ptr)
    return value
...
class TUpdateCatalogCacheResponse:
  ...
  def validate(self):
    ...
    if self.catalog_object_version_lower_bound is None:
      raise TProtocol.TProtocolException(message='Required field catalog_object_version_lower_bound is unset!')
    if self.new_catalog_version is None:
      raise TProtocol.TProtocolException(message='Required field new_catalog_version is unset!')
    return
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.catalog_service_id)
    value = (value * 31) ^ hash(self.catalog_object_version_lower_bound)
    value = (value * 31) ^ hash(self.new_catalog_version)
    return value
...
class TUpdateExecutorMembershipRequest:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.ip_addresses)
...
class TJvmMemoryPool:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.committed)
    value = (value * 31) ^ hash(self.init)
    value = (value * 31) ^ hash(self.max)
    value = (value * 31) ^ hash(self.used)
    value = (value * 31) ^ hash(self.peak_committed)
    value = (value * 31) ^ hash(self.peak_init)
    value = (value * 31) ^ hash(self.peak_max)
    value = (value * 31) ^ hash(self.peak_used)
    value = (value * 31) ^ hash(self.name)
    return value
...
class TGetJvmMemoryMetricsResponse:
  ...
  def validate(self):
    ...
    if self.gc_num_warn_threshold_exceeded is None:
      raise TProtocol.TProtocolException(message='Required field gc_num_warn_threshold_exceeded is unset!')
    if self.gc_num_info_threshold_exceeded is None:
      raise TProtocol.TProtocolException(message='Required field gc_num_info_threshold_exceeded is unset!')
    if self.gc_total_extra_sleep_time_millis is None:
      raise TProtocol.TProtocolException(message='Required field gc_total_extra_sleep_time_millis is unset!')
    if self.gc_count is None:
      raise TProtocol.TProtocolException(message='Required field gc_count is unset!')
    if self.gc_time_millis is None:
      raise TProtocol.TProtocolException(message='Required field gc_time_millis is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.memory_pools)
    value = (value * 31) ^ hash(self.gc_num_warn_threshold_exceeded)
    value = (value * 31) ^ hash(self.gc_num_info_threshold_exceeded)
    value = (value * 31) ^ hash(self.gc_total_extra_sleep_time_millis)
    value = (value * 31) ^ hash(self.gc_count)
    value = (value * 31) ^ hash(self.gc_time_millis)
    return value
...
class TJvmThreadInfo:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.cpu_time_in_ns)
    value = (value * 31) ^ hash(self.user_time_in_ns)
    value = (value * 31) ^ hash(self.blocked_count)
    value = (value * 31) ^ hash(self.blocked_time_in_ms)
    value = (value * 31) ^ hash(self.is_in_native)
    return value
...
class TGetJvmThreadsInfoRequest:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.get_complete_info)
    return value
...
class TGetJvmThreadsInfoResponse:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.total_thread_count)
    value = (value * 31) ^ hash(self.daemon_thread_count)
    value = (value * 31) ^ hash(self.peak_thread_count)
...
class TGetJMXJsonResponse:
  ...
  def validate(self):
    if self.jmx_json is None:
      raise TProtocol.TProtocolException(message='Required field jmx_json is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.jmx_json)
    return value
...
class TGetHadoopGroupsResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'groups', (TType.STRING,None), None, ), # 1
  )
...
class TBuildTestDescriptorTableParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.slot_types)
    return value
...
class TTestCaseData:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'tables_and_views', (TType.STRUCT,(CatalogObjects.ttypes.TTable, CatalogObjects.ttypes.TTable.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'dbs', (TType.STRUCT,(CatalogObjects.ttypes.TDatabase, CatalogObjects.ttypes.TDatabase.thrift_spec)), None, ), # 3
  ...
  def validate(self):
    if self.query_stmt is None:
      raise TProtocol.TProtocolException(message='Required field query_stmt is unset!')
    if self.testcase_data_path is None:
      raise TProtocol.TProtocolException(message='Required field testcase_data_path is unset!')
    if self.impala_version is None:
      raise TProtocol.TProtocolException(message='Required field impala_version is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.query_stmt)
    value = (value * 31) ^ hash(self.tables_and_views)
    value = (value * 31) ^ hash(self.dbs)
    value = (value * 31) ^ hash(self.testcase_data_path)
    value = (value * 31) ^ hash(self.impala_version)
    return value
...
class TQueryCompleteContext:
  ...
  def validate(self):
    if self.lineage_string is None:
      raise TProtocol.TProtocolException(message='Required field lineage_string is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.lineage_string)
    return value
