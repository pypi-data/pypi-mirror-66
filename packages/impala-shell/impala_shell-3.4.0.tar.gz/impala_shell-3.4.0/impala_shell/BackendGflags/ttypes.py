...
class TBackendGflags:
  ...
  def validate(self):
    ...
    if self.reserved_words_version is None:
      raise TProtocol.TProtocolException(message='Required field reserved_words_version is unset!')
    if self.max_filter_error_rate is None:
      raise TProtocol.TProtocolException(message='Required field max_filter_error_rate is unset!')
    if self.min_buffer_size is None:
      raise TProtocol.TProtocolException(message='Required field min_buffer_size is unset!')
    if self.enable_orc_scanner is None:
      raise TProtocol.TProtocolException(message='Required field enable_orc_scanner is unset!')
    if self.authorized_proxy_group_config is None:
      raise TProtocol.TProtocolException(message='Required field authorized_proxy_group_config is unset!')
    if self.use_local_catalog is None:
      raise TProtocol.TProtocolException(message='Required field use_local_catalog is unset!')
    if self.disable_catalog_data_ops_debug_only is None:
      raise TProtocol.TProtocolException(message='Required field disable_catalog_data_ops_debug_only is unset!')
    if self.local_catalog_cache_mb is None:
      raise TProtocol.TProtocolException(message='Required field local_catalog_cache_mb is unset!')
    if self.local_catalog_cache_expiration_s is None:
      raise TProtocol.TProtocolException(message='Required field local_catalog_cache_expiration_s is unset!')
    if self.catalog_topic_mode is None:
      raise TProtocol.TProtocolException(message='Required field catalog_topic_mode is unset!')
    if self.invalidate_tables_timeout_s is None:
      raise TProtocol.TProtocolException(message='Required field invalidate_tables_timeout_s is unset!')
    if self.invalidate_tables_on_memory_pressure is None:
      raise TProtocol.TProtocolException(message='Required field invalidate_tables_on_memory_pressure is unset!')
    if self.invalidate_tables_gc_old_gen_full_threshold is None:
      raise TProtocol.TProtocolException(message='Required field invalidate_tables_gc_old_gen_full_threshold is unset!')
    if self.invalidate_tables_fraction_on_memory_pressure is None:
      raise TProtocol.TProtocolException(message='Required field invalidate_tables_fraction_on_memory_pressure is unset!')
    if self.local_catalog_max_fetch_retries is None:
      raise TProtocol.TProtocolException(message='Required field local_catalog_max_fetch_retries is unset!')
    if self.kudu_scanner_thread_estimated_bytes_per_column is None:
      raise TProtocol.TProtocolException(message='Required field kudu_scanner_thread_estimated_bytes_per_column is unset!')
    if self.kudu_scanner_thread_max_estimated_bytes is None:
      raise TProtocol.TProtocolException(message='Required field kudu_scanner_thread_max_estimated_bytes is unset!')
    if self.catalog_max_parallel_partial_fetch_rpc is None:
      raise TProtocol.TProtocolException(message='Required field catalog_max_parallel_partial_fetch_rpc is unset!')
    if self.catalog_partial_fetch_rpc_queue_timeout_s is None:
      raise TProtocol.TProtocolException(message='Required field catalog_partial_fetch_rpc_queue_timeout_s is unset!')
    if self.exchg_node_buffer_size_bytes is None:
      raise TProtocol.TProtocolException(message='Required field exchg_node_buffer_size_bytes is unset!')
    if self.kudu_mutation_buffer_size is None:
      raise TProtocol.TProtocolException(message='Required field kudu_mutation_buffer_size is unset!')
    if self.kudu_error_buffer_size is None:
      raise TProtocol.TProtocolException(message='Required field kudu_error_buffer_size is unset!')
    if self.hms_event_polling_interval_s is None:
      raise TProtocol.TProtocolException(message='Required field hms_event_polling_interval_s is unset!')
    if self.impala_build_version is None:
      raise TProtocol.TProtocolException(message='Required field impala_build_version is unset!')
    if self.authorization_factory_class is None:
      raise TProtocol.TProtocolException(message='Required field authorization_factory_class is unset!')
    if self.unlock_mt_dop is None:
      raise TProtocol.TProtocolException(message='Required field unlock_mt_dop is unset!')
    if self.ranger_service_type is None:
      raise TProtocol.TProtocolException(message='Required field ranger_service_type is unset!')
    if self.ranger_app_id is None:
      raise TProtocol.TProtocolException(message='Required field ranger_app_id is unset!')
    if self.authorization_provider is None:
      raise TProtocol.TProtocolException(message='Required field authorization_provider is unset!')
    if self.recursively_list_partitions is None:
      raise TProtocol.TProtocolException(message='Required field recursively_list_partitions is unset!')
    if self.query_event_hook_classes is None:
      raise TProtocol.TProtocolException(message='Required field query_event_hook_classes is unset!')
    if self.query_event_hook_nthreads is None:
      raise TProtocol.TProtocolException(message='Required field query_event_hook_nthreads is unset!')
    ...
    if self.use_dedicated_coordinator_estimates is None:
      raise TProtocol.TProtocolException(message='Required field use_dedicated_coordinator_estimates is unset!')
    if self.blacklisted_dbs is None:
      raise TProtocol.TProtocolException(message='Required field blacklisted_dbs is unset!')
    if self.blacklisted_tables is None:
      raise TProtocol.TProtocolException(message='Required field blacklisted_tables is unset!')
    if self.unlock_zorder_sort is None:
      raise TProtocol.TProtocolException(message='Required field unlock_zorder_sort is unset!')
    if self.min_privilege_set_for_show_stmts is None:
      raise TProtocol.TProtocolException(message='Required field min_privilege_set_for_show_stmts is unset!')
    if self.mt_dop_auto_fallback is None:
      raise TProtocol.TProtocolException(message='Required field mt_dop_auto_fallback is unset!')
    if self.num_expected_executors is None:
      raise TProtocol.TProtocolException(message='Required field num_expected_executors is unset!')
    if self.num_check_authorization_threads is None:
      raise TProtocol.TProtocolException(message='Required field num_check_authorization_threads is unset!')
    if self.use_customized_user_groups_mapper_for_ranger is None:
      raise TProtocol.TProtocolException(message='Required field use_customized_user_groups_mapper_for_ranger is unset!')
    if self.enable_column_masking is None:
      raise TProtocol.TProtocolException(message='Required field enable_column_masking is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.sentry_config)
    value = (value * 31) ^ hash(self.load_auth_to_local_rules)
    value = (value * 31) ^ hash(self.non_impala_java_vlog)
    value = (value * 31) ^ hash(self.impala_log_lvl)
    value = (value * 31) ^ hash(self.inc_stats_size_limit_bytes)
    value = (value * 31) ^ hash(self.lineage_event_log_dir)
    value = (value * 31) ^ hash(self.load_catalog_in_background)
    value = (value * 31) ^ hash(self.num_metadata_loading_threads)
    value = (value * 31) ^ hash(self.principal)
    value = (value * 31) ^ hash(self.server_name)
    value = (value * 31) ^ hash(self.authorization_policy_provider_class)
    value = (value * 31) ^ hash(self.kudu_master_hosts)
    value = (value * 31) ^ hash(self.local_library_path)
    value = (value * 31) ^ hash(self.read_size)
    value = (value * 31) ^ hash(self.kudu_operation_timeout_ms)
    value = (value * 31) ^ hash(self.initial_hms_cnxn_timeout_s)
    value = (value * 31) ^ hash(self.enable_stats_extrapolation)
    value = (value * 31) ^ hash(self.sentry_catalog_polling_frequency_s)
    value = (value * 31) ^ hash(self.max_hdfs_partitions_parallel_load)
    value = (value * 31) ^ hash(self.max_nonhdfs_partitions_parallel_load)
    value = (value * 31) ^ hash(self.reserved_words_version)
    value = (value * 31) ^ hash(self.max_filter_error_rate)
    value = (value * 31) ^ hash(self.min_buffer_size)
    value = (value * 31) ^ hash(self.enable_orc_scanner)
    value = (value * 31) ^ hash(self.authorized_proxy_group_config)
    value = (value * 31) ^ hash(self.use_local_catalog)
    value = (value * 31) ^ hash(self.disable_catalog_data_ops_debug_only)
    value = (value * 31) ^ hash(self.local_catalog_cache_mb)
    value = (value * 31) ^ hash(self.local_catalog_cache_expiration_s)
    value = (value * 31) ^ hash(self.catalog_topic_mode)
    value = (value * 31) ^ hash(self.invalidate_tables_timeout_s)
    value = (value * 31) ^ hash(self.invalidate_tables_on_memory_pressure)
    value = (value * 31) ^ hash(self.invalidate_tables_gc_old_gen_full_threshold)
    value = (value * 31) ^ hash(self.invalidate_tables_fraction_on_memory_pressure)
    value = (value * 31) ^ hash(self.local_catalog_max_fetch_retries)
    value = (value * 31) ^ hash(self.kudu_scanner_thread_estimated_bytes_per_column)
    value = (value * 31) ^ hash(self.kudu_scanner_thread_max_estimated_bytes)
    value = (value * 31) ^ hash(self.catalog_max_parallel_partial_fetch_rpc)
    value = (value * 31) ^ hash(self.catalog_partial_fetch_rpc_queue_timeout_s)
    value = (value * 31) ^ hash(self.exchg_node_buffer_size_bytes)
    value = (value * 31) ^ hash(self.kudu_mutation_buffer_size)
    value = (value * 31) ^ hash(self.kudu_error_buffer_size)
    value = (value * 31) ^ hash(self.hms_event_polling_interval_s)
    value = (value * 31) ^ hash(self.impala_build_version)
    value = (value * 31) ^ hash(self.authorization_factory_class)
    value = (value * 31) ^ hash(self.unlock_mt_dop)
    value = (value * 31) ^ hash(self.ranger_service_type)
    value = (value * 31) ^ hash(self.ranger_app_id)
    value = (value * 31) ^ hash(self.authorization_provider)
    value = (value * 31) ^ hash(self.recursively_list_partitions)
    value = (value * 31) ^ hash(self.query_event_hook_classes)
    value = (value * 31) ^ hash(self.query_event_hook_nthreads)
    value = (value * 31) ^ hash(self.is_executor)
    value = (value * 31) ^ hash(self.is_coordinator)
    value = (value * 31) ^ hash(self.use_dedicated_coordinator_estimates)
    value = (value * 31) ^ hash(self.blacklisted_dbs)
    value = (value * 31) ^ hash(self.blacklisted_tables)
    value = (value * 31) ^ hash(self.unlock_zorder_sort)
    value = (value * 31) ^ hash(self.min_privilege_set_for_show_stmts)
    value = (value * 31) ^ hash(self.mt_dop_auto_fallback)
    value = (value * 31) ^ hash(self.num_expected_executors)
    value = (value * 31) ^ hash(self.num_check_authorization_threads)
    value = (value * 31) ^ hash(self.use_customized_user_groups_mapper_for_ranger)
    value = (value * 31) ^ hash(self.enable_column_masking)
    return value
