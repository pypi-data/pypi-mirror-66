...
class TPingImpalaHS2ServiceReq:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'sessionHandle', (TCLIService.ttypes.TSessionHandle, TCLIService.ttypes.TSessionHandle.thrift_spec), None, ), # 1
  )
...
class TGetRuntimeProfileResp:
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'thrift_profile', (RuntimeProfile.ttypes.TRuntimeProfileTree, RuntimeProfile.ttypes.TRuntimeProfileTree.thrift_spec), None, ), # 3
  )
