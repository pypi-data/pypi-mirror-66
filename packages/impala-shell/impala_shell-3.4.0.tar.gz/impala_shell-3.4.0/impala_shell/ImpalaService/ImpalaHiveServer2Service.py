...
class PingImpalaHS2Service_args:
  """
  Attributes:
   - req
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TPingImpalaHS2ServiceReq, TPingImpalaHS2ServiceReq.thrift_spec), None, ), # 1
  )
...
class PingImpalaHS2Service_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TPingImpalaHS2ServiceResp, TPingImpalaHS2ServiceResp.thrift_spec), None, ), # 0
  )
...
class CloseImpalaOperation_args:
  """
  Attributes:
   - req
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'req', (TCloseImpalaOperationReq, TCloseImpalaOperationReq.thrift_spec), None, ), # 1
  )
...
class CloseImpalaOperation_result:
  """
  Attributes:
   - success
  """
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TCloseImpalaOperationResp, TCloseImpalaOperationResp.thrift_spec), None, ), # 0
  )
