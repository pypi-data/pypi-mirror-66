...
class TQueryOptions:
  ...
  thrift_spec = (
    ...
    None, # 13
    (14, TType.STRUCT, 'compression_codec', (CatalogObjects.ttypes.TCompressionCodec, CatalogObjects.ttypes.TCompressionCodec.thrift_spec), None, ), # 14
  ...
  def __init__(self, abort_on_error=thrift_spec[1][4], max_errors=thrift_spec[2][4], disable_codegen=thrift_spec[3][4], batch_size=thrift_spec[4][4], num_nodes=thrift_spec[5][4], max_scan_range_length=thrift_spec[6][4], num_scanner_threads=thrift_spec[7][4], debug_action=thrift_spec[11][4], mem_limit=thrift_spec[12][4], compression_codec=None, hbase_caching=thrift_spec[15][4], hbase_cache_blocks=thrift_spec[16][4], parquet_file_size=thrift_spec[17][4], explain_level=thrift_spec[18][4], sync_ddl=thrift_spec[19][4], request_pool=None, disable_outermost_topn=thrift_spec[24][4], query_timeout_s=thrift_spec[26][4], buffer_pool_limit=None, appx_count_distinct=thrift_spec[28][4], disable_unsafe_spills=thrift_spec[29][4], exec_single_node_rows_threshold=thrift_spec[31][4], optimize_partition_key_scans=thrift_spec[32][4], replica_preference=thrift_spec[33][4], schedule_random_replica=thrift_spec[34][4], disable_streaming_preaggregations=thrift_spec[36][4], runtime_filter_mode=thrift_spec[37][4], runtime_bloom_filter_size=thrift_spec[38][4], runtime_filter_wait_time_ms=thrift_spec[39][4], disable_row_runtime_filtering=thrift_spec[40][4], max_num_runtime_filters=thrift_spec[41][4], parquet_annotate_strings_utf8=thrift_spec[42][4], parquet_fallback_schema_resolution=thrift_spec[43][4], mt_dop=None, s3_skip_insert_staging=thrift_spec[45][4], runtime_filter_min_size=thrift_spec[46][4], runtime_filter_max_size=thrift_spec[47][4], prefetch_mode=thrift_spec[48][4], strict_mode=thrift_spec[49][4], scratch_limit=thrift_spec[50][4], enable_expr_rewrites=thrift_spec[51][4], decimal_v2=thrift_spec[52][4], parquet_dictionary_filtering=thrift_spec[53][4], parquet_array_resolution=thrift_spec[54][4], parquet_read_statistics=thrift_spec[55][4], default_join_distribution_mode=thrift_spec[56][4], disable_codegen_rows_threshold=thrift_spec[57][4], default_spillable_buffer_size=thrift_spec[58][4], min_spillable_buffer_size=thrift_spec[59][4], max_row_size=thrift_spec[60][4], idle_session_timeout=None, compute_stats_min_sample_size=thrift_spec[62][4], exec_time_limit_s=thrift_spec[63][4], shuffle_distinct_exprs=thrift_spec[64][4], max_mem_estimate_for_admission=thrift_spec[65][4], thread_reservation_limit=thrift_spec[66][4], thread_reservation_aggregate_limit=thrift_spec[67][4], kudu_read_mode=thrift_spec[68][4], allow_erasure_coded_files=thrift_spec[69][4], timezone=thrift_spec[70][4], scan_bytes_limit=thrift_spec[71][4], cpu_limit_s=thrift_spec[72][4], topn_bytes_limit=thrift_spec[73][4], client_identifier=None, resource_trace_ratio=thrift_spec[75][4], num_remote_executor_candidates=thrift_spec[76][4], num_rows_produced_limit=thrift_spec[77][4], planner_testcase_mode=thrift_spec[78][4], default_file_format=thrift_spec[79][4], parquet_timestamp_type=thrift_spec[80][4], parquet_read_page_index=thrift_spec[81][4], parquet_write_page_index=thrift_spec[82][4], parquet_page_row_count_limit=None, disable_hdfs_num_rows_estimate=thrift_spec[84][4], default_hints_insert_statement=None, spool_query_results=thrift_spec[86][4], default_transactional_type=thrift_spec[87][4], statement_expression_limit=thrift_spec[88][4], max_statement_length_bytes=thrift_spec[89][4], disable_data_cache=thrift_spec[90][4], max_result_spooling_mem=thrift_spec[91][4], max_spilled_result_spooling_mem=thrift_spec[92][4], disable_hbase_num_rows_estimate=thrift_spec[93][4], fetch_rows_timeout_ms=thrift_spec[94][4], now_string=thrift_spec[95][4], parquet_object_store_split_size=thrift_spec[96][4], mem_limit_executors=thrift_spec[97][4], broadcast_bytes_limit=thrift_spec[98][4],):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.abort_on_error)
    value = (value * 31) ^ hash(self.max_errors)
    value = (value * 31) ^ hash(self.disable_codegen)
    value = (value * 31) ^ hash(self.batch_size)
    value = (value * 31) ^ hash(self.num_nodes)
    value = (value * 31) ^ hash(self.max_scan_range_length)
    value = (value * 31) ^ hash(self.num_scanner_threads)
    value = (value * 31) ^ hash(self.debug_action)
    value = (value * 31) ^ hash(self.mem_limit)
    value = (value * 31) ^ hash(self.compression_codec)
    value = (value * 31) ^ hash(self.hbase_caching)
    value = (value * 31) ^ hash(self.hbase_cache_blocks)
    value = (value * 31) ^ hash(self.parquet_file_size)
    value = (value * 31) ^ hash(self.explain_level)
    value = (value * 31) ^ hash(self.sync_ddl)
    value = (value * 31) ^ hash(self.request_pool)
    value = (value * 31) ^ hash(self.disable_outermost_topn)
    value = (value * 31) ^ hash(self.query_timeout_s)
    value = (value * 31) ^ hash(self.buffer_pool_limit)
    value = (value * 31) ^ hash(self.appx_count_distinct)
    value = (value * 31) ^ hash(self.disable_unsafe_spills)
    value = (value * 31) ^ hash(self.exec_single_node_rows_threshold)
    value = (value * 31) ^ hash(self.optimize_partition_key_scans)
    value = (value * 31) ^ hash(self.replica_preference)
    value = (value * 31) ^ hash(self.schedule_random_replica)
    value = (value * 31) ^ hash(self.disable_streaming_preaggregations)
    value = (value * 31) ^ hash(self.runtime_filter_mode)
    value = (value * 31) ^ hash(self.runtime_bloom_filter_size)
    value = (value * 31) ^ hash(self.runtime_filter_wait_time_ms)
    value = (value * 31) ^ hash(self.disable_row_runtime_filtering)
    value = (value * 31) ^ hash(self.max_num_runtime_filters)
    value = (value * 31) ^ hash(self.parquet_annotate_strings_utf8)
    value = (value * 31) ^ hash(self.parquet_fallback_schema_resolution)
    value = (value * 31) ^ hash(self.mt_dop)
    value = (value * 31) ^ hash(self.s3_skip_insert_staging)
    value = (value * 31) ^ hash(self.runtime_filter_min_size)
    value = (value * 31) ^ hash(self.runtime_filter_max_size)
    value = (value * 31) ^ hash(self.prefetch_mode)
    value = (value * 31) ^ hash(self.strict_mode)
    value = (value * 31) ^ hash(self.scratch_limit)
    value = (value * 31) ^ hash(self.enable_expr_rewrites)
    value = (value * 31) ^ hash(self.decimal_v2)
    value = (value * 31) ^ hash(self.parquet_dictionary_filtering)
    value = (value * 31) ^ hash(self.parquet_array_resolution)
    value = (value * 31) ^ hash(self.parquet_read_statistics)
    value = (value * 31) ^ hash(self.default_join_distribution_mode)
    value = (value * 31) ^ hash(self.disable_codegen_rows_threshold)
    value = (value * 31) ^ hash(self.default_spillable_buffer_size)
    value = (value * 31) ^ hash(self.min_spillable_buffer_size)
    value = (value * 31) ^ hash(self.max_row_size)
    value = (value * 31) ^ hash(self.idle_session_timeout)
    value = (value * 31) ^ hash(self.compute_stats_min_sample_size)
    value = (value * 31) ^ hash(self.exec_time_limit_s)
    value = (value * 31) ^ hash(self.shuffle_distinct_exprs)
    value = (value * 31) ^ hash(self.max_mem_estimate_for_admission)
    value = (value * 31) ^ hash(self.thread_reservation_limit)
    value = (value * 31) ^ hash(self.thread_reservation_aggregate_limit)
    value = (value * 31) ^ hash(self.kudu_read_mode)
    value = (value * 31) ^ hash(self.allow_erasure_coded_files)
    value = (value * 31) ^ hash(self.timezone)
    value = (value * 31) ^ hash(self.scan_bytes_limit)
    value = (value * 31) ^ hash(self.cpu_limit_s)
    value = (value * 31) ^ hash(self.topn_bytes_limit)
    value = (value * 31) ^ hash(self.client_identifier)
    value = (value * 31) ^ hash(self.resource_trace_ratio)
    value = (value * 31) ^ hash(self.num_remote_executor_candidates)
    value = (value * 31) ^ hash(self.num_rows_produced_limit)
    value = (value * 31) ^ hash(self.planner_testcase_mode)
    value = (value * 31) ^ hash(self.default_file_format)
    value = (value * 31) ^ hash(self.parquet_timestamp_type)
    value = (value * 31) ^ hash(self.parquet_read_page_index)
    value = (value * 31) ^ hash(self.parquet_write_page_index)
    value = (value * 31) ^ hash(self.parquet_page_row_count_limit)
    value = (value * 31) ^ hash(self.disable_hdfs_num_rows_estimate)
    value = (value * 31) ^ hash(self.default_hints_insert_statement)
    value = (value * 31) ^ hash(self.spool_query_results)
    value = (value * 31) ^ hash(self.default_transactional_type)
    value = (value * 31) ^ hash(self.statement_expression_limit)
    value = (value * 31) ^ hash(self.max_statement_length_bytes)
    value = (value * 31) ^ hash(self.disable_data_cache)
    value = (value * 31) ^ hash(self.max_result_spooling_mem)
    value = (value * 31) ^ hash(self.max_spilled_result_spooling_mem)
    value = (value * 31) ^ hash(self.disable_hbase_num_rows_estimate)
    value = (value * 31) ^ hash(self.fetch_rows_timeout_ms)
    value = (value * 31) ^ hash(self.now_string)
    value = (value * 31) ^ hash(self.parquet_object_store_split_size)
    value = (value * 31) ^ hash(self.mem_limit_executors)
    value = (value * 31) ^ hash(self.broadcast_bytes_limit)
    return value
...
class TSessionState:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.connected_user)
    value = (value * 31) ^ hash(self.delegated_user)
    value = (value * 31) ^ hash(self.network_address)
    value = (value * 31) ^ hash(self.kudu_latest_observed_ts)
    return value
...
class TClientRequest:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.stmt)
    value = (value * 31) ^ hash(self.query_options)
    value = (value * 31) ^ hash(self.redacted_stmt)
    return value
...
class TDebugOptions:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.action_param)
    return value
...
class TQueryCtx:
  ...
  thrift_spec = (
    ...
    (7, TType.STRUCT, 'coord_krpc_address', (Types.ttypes.TNetworkAddress, Types.ttypes.TNetworkAddress.thrift_spec), None, ), # 7
    (8, TType.LIST, 'tables_missing_stats', (TType.STRUCT,(CatalogObjects.ttypes.TTableName, CatalogObjects.ttypes.TTableName.thrift_spec)), None, ), # 8
    (9, TType.BOOL, 'disable_spilling', None, None, ), # 9
    (10, TType.STRUCT, 'parent_query_id', (Types.ttypes.TUniqueId, Types.ttypes.TUniqueId.thrift_spec), None, ), # 10
    (11, TType.LIST, 'tables_with_corrupt_stats', (TType.STRUCT,(CatalogObjects.ttypes.TTableName, CatalogObjects.ttypes.TTableName.thrift_spec)), None, ), # 11
    (12, TType.I64, 'snapshot_timestamp', None, -1, ), # 12
    (13, TType.STRUCT, 'desc_tbl_testonly', (Descriptors.ttypes.TDescriptorTable, Descriptors.ttypes.TDescriptorTable.thrift_spec), None, ), # 13
    (14, TType.I64, 'start_unix_millis', None, None, ), # 14
    (15, TType.BOOL, 'disable_codegen_hint', None, False, ), # 15
    (16, TType.LIST, 'tables_missing_diskids', (TType.STRUCT,(CatalogObjects.ttypes.TTableName, CatalogObjects.ttypes.TTableName.thrift_spec)), None, ), # 16
    ...
    (24, TType.STRUCT, 'desc_tbl_serialized', (Descriptors.ttypes.TDescriptorTableSerialized, Descriptors.ttypes.TDescriptorTableSerialized.thrift_spec), None, ), # 24
    (25, TType.I64, 'transaction_id', None, None, ), # 25
  )

  def __init__(self, client_request=None, query_id=None, session=None, now_string=None, pid=None, coord_address=None, coord_krpc_address=None, tables_missing_stats=None, disable_spilling=None, parent_query_id=None, tables_with_corrupt_stats=None, snapshot_timestamp=thrift_spec[12][4], desc_tbl_testonly=None, desc_tbl_serialized=None, start_unix_millis=None, disable_codegen_hint=thrift_spec[15][4], tables_missing_diskids=None, request_pool=None, utc_timestamp_string=None, local_time_zone=None, disable_hbase_num_rows_estimate=thrift_spec[20][4], trace_resource_usage=thrift_spec[21][4], status_report_interval_ms=None, status_report_max_retry_s=None, transaction_id=None,):
  ...
  def validate(self):
    ...
    if self.local_time_zone is None:
      raise TProtocol.TProtocolException(message='Required field local_time_zone is unset!')
    if self.trace_resource_usage is None:
      raise TProtocol.TProtocolException(message='Required field trace_resource_usage is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.client_request)
    value = (value * 31) ^ hash(self.query_id)
    value = (value * 31) ^ hash(self.session)
    value = (value * 31) ^ hash(self.now_string)
    value = (value * 31) ^ hash(self.pid)
    value = (value * 31) ^ hash(self.coord_address)
    value = (value * 31) ^ hash(self.coord_krpc_address)
    value = (value * 31) ^ hash(self.tables_missing_stats)
    value = (value * 31) ^ hash(self.disable_spilling)
    value = (value * 31) ^ hash(self.parent_query_id)
    value = (value * 31) ^ hash(self.tables_with_corrupt_stats)
    value = (value * 31) ^ hash(self.snapshot_timestamp)
    value = (value * 31) ^ hash(self.desc_tbl_testonly)
    value = (value * 31) ^ hash(self.desc_tbl_serialized)
    value = (value * 31) ^ hash(self.start_unix_millis)
    value = (value * 31) ^ hash(self.disable_codegen_hint)
    value = (value * 31) ^ hash(self.tables_missing_diskids)
    value = (value * 31) ^ hash(self.request_pool)
    value = (value * 31) ^ hash(self.utc_timestamp_string)
    value = (value * 31) ^ hash(self.local_time_zone)
    value = (value * 31) ^ hash(self.disable_hbase_num_rows_estimate)
    value = (value * 31) ^ hash(self.trace_resource_usage)
    value = (value * 31) ^ hash(self.status_report_interval_ms)
    value = (value * 31) ^ hash(self.status_report_max_retry_s)
...
class TPlanFragmentDestination:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'thrift_backend', (Types.ttypes.TNetworkAddress, Types.ttypes.TNetworkAddress.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'krpc_backend', (Types.ttypes.TNetworkAddress, Types.ttypes.TNetworkAddress.thrift_spec), None, ), # 3
  )
  ...
  def validate(self):
    ...
    if self.thrift_backend is None:
      raise TProtocol.TProtocolException(message='Required field thrift_backend is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.fragment_instance_id)
    value = (value * 31) ^ hash(self.thrift_backend)
    value = (value * 31) ^ hash(self.krpc_backend)
    return value
...
class TPlanFragmentCtx:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.fragment)
    value = (value * 31) ^ hash(self.destinations)
    return value
...
class TScanRangeParams:
  ...
  def __init__(self, scan_range=None, volume_id=thrift_spec[2][4], try_hdfs_cache=thrift_spec[3][4], is_remote=None,):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.scan_range)
    value = (value * 31) ^ hash(self.volume_id)
    value = (value * 31) ^ hash(self.try_hdfs_cache)
    value = (value * 31) ^ hash(self.is_remote)
    return value
...
class TRuntimeFilterSource:
  ...
  def validate(self):
    if self.src_node_id is None:
      raise TProtocol.TProtocolException(message='Required field src_node_id is unset!')
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.filter_id)
    return value
...
class TJoinBuildInput:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'input_finstance_id', (Types.ttypes.TUniqueId, Types.ttypes.TUniqueId.thrift_spec), None, ), # 2
  )
  ...
  def validate(self):
    if self.join_node_id is None:
      raise TProtocol.TProtocolException(message='Required field join_node_id is unset!')
    if self.input_finstance_id is None:
      raise TProtocol.TProtocolException(message='Required field input_finstance_id is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.join_node_id)
    value = (value * 31) ^ hash(self.input_finstance_id)
    return value
...
class TPlanFragmentInstanceCtx:
  ...
  thrift_spec = (
    ...
    (8, TType.LIST, 'filters_produced', (TType.STRUCT,(TRuntimeFilterSource, TRuntimeFilterSource.thrift_spec)), None, ), # 8
    (9, TType.LIST, 'join_build_inputs', (TType.STRUCT,(TJoinBuildInput, TJoinBuildInput.thrift_spec)), None, ), # 9
  )

  def __init__(self, fragment_idx=None, fragment_instance_id=None, per_fragment_instance_idx=None, per_node_scan_ranges=None, per_exch_num_senders=None, sender_id=None, debug_options=None, filters_produced=None, join_build_inputs=None,):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.fragment_instance_id)
    value = (value * 31) ^ hash(self.per_fragment_instance_idx)
    value = (value * 31) ^ hash(self.per_node_scan_ranges)
    value = (value * 31) ^ hash(self.per_exch_num_senders)
    value = (value * 31) ^ hash(self.sender_id)
    value = (value * 31) ^ hash(self.debug_options)
    value = (value * 31) ^ hash(self.filters_produced)
    value = (value * 31) ^ hash(self.join_build_inputs)
    return value
...
class TExecPlanFragmentInfo:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'fragment_ctxs', (TType.STRUCT,(TPlanFragmentCtx, TPlanFragmentCtx.thrift_spec)), None, ), # 1
    (2, TType.LIST, 'fragment_instance_ctxs', (TType.STRUCT,(TPlanFragmentInstanceCtx, TPlanFragmentInstanceCtx.thrift_spec)), None, ), # 2
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.fragment_ctxs)
    value = (value * 31) ^ hash(self.fragment_instance_ctxs)
    return value
...
class TResolveRequestPoolParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.requested_pool)
    return value
...
class TResolveRequestPoolResult:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.resolved_pool)
    value = (value * 31) ^ hash(self.has_access)
...
class TPoolConfig:
  ...
  def __init__(self, max_requests=None, max_queued=None, max_mem_resources=None, queue_timeout_ms=None, default_query_options=None, max_query_mem_limit=thrift_spec[6][4], min_query_mem_limit=thrift_spec[7][4], clamp_mem_limit_query_option=thrift_spec[8][4], max_running_queries_multiple=thrift_spec[9][4], max_queued_queries_multiple=thrift_spec[10][4], max_memory_multiple=thrift_spec[11][4],):
  ...
  def validate(self):
    ...
    if self.max_query_mem_limit is None:
      raise TProtocol.TProtocolException(message='Required field max_query_mem_limit is unset!')
    if self.min_query_mem_limit is None:
      raise TProtocol.TProtocolException(message='Required field min_query_mem_limit is unset!')
    if self.clamp_mem_limit_query_option is None:
      raise TProtocol.TProtocolException(message='Required field clamp_mem_limit_query_option is unset!')
    if self.max_running_queries_multiple is None:
      raise TProtocol.TProtocolException(message='Required field max_running_queries_multiple is unset!')
    if self.max_queued_queries_multiple is None:
      raise TProtocol.TProtocolException(message='Required field max_queued_queries_multiple is unset!')
    if self.max_memory_multiple is None:
      raise TProtocol.TProtocolException(message='Required field max_memory_multiple is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.max_requests)
    value = (value * 31) ^ hash(self.max_queued)
    value = (value * 31) ^ hash(self.max_mem_resources)
    value = (value * 31) ^ hash(self.queue_timeout_ms)
    value = (value * 31) ^ hash(self.default_query_options)
    value = (value * 31) ^ hash(self.max_query_mem_limit)
    value = (value * 31) ^ hash(self.min_query_mem_limit)
    value = (value * 31) ^ hash(self.clamp_mem_limit_query_option)
    value = (value * 31) ^ hash(self.max_running_queries_multiple)
    value = (value * 31) ^ hash(self.max_queued_queries_multiple)
    value = (value * 31) ^ hash(self.max_memory_multiple)
    return value
...
class TParseDateStringResult:
  ...
  def validate(self):
    if self.valid is None:
      raise TProtocol.TProtocolException(message='Required field valid is unset!')
    return
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.days_since_epoch)
    value = (value * 31) ^ hash(self.canonical_date_string)
    return value
