...
class TAlterDbSetOwnerParams:
  ...
  def validate(self):
    if self.owner_type is None:
      raise TProtocol.TProtocolException(message='Required field owner_type is unset!')
    if self.owner_name is None:
      raise TProtocol.TProtocolException(message='Required field owner_name is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.owner_type)
    value = (value * 31) ^ hash(self.owner_name)
...
class TAlterDbParams:
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'set_owner_params', (TAlterDbSetOwnerParams, TAlterDbSetOwnerParams.thrift_spec), None, ), # 3
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.alter_type)
    value = (value * 31) ^ hash(self.db)
    value = (value * 31) ^ hash(self.set_owner_params)
    return value
...
class TCreateDbParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.if_not_exists)
...
class TTableRowFormat:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.field_terminator)
    value = (value * 31) ^ hash(self.line_terminator)
    value = (value * 31) ^ hash(self.escaped_by)
    return value
...
class THdfsCachingOp:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.set_cached)
    value = (value * 31) ^ hash(self.cache_pool_name)
...
class TAlterTableOrViewRenameParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.new_table_name)
    return value
...
class TPartitionDef:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.location)
    value = (value * 31) ^ hash(self.cache_op)
    return value
...
class TAlterTableAddDropRangePartitionParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.range_partition_spec)
    value = (value * 31) ^ hash(self.ignore_errors)
...
class TAlterTableAlterColParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.col_name)
    value = (value * 31) ^ hash(self.new_col_def)
    return value
...
class TAlterTableSetFileFormatParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.file_format)
    value = (value * 31) ^ hash(self.partition_set)
    return value
...
class TAlterTableSetRowFormatParams:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'row_format', (TTableRowFormat, TTableRowFormat.thrift_spec), None, ), # 1
    (2, TType.LIST, 'partition_set', (TType.LIST,(TType.STRUCT,(CatalogObjects.ttypes.TPartitionKeyValue, CatalogObjects.ttypes.TPartitionKeyValue.thrift_spec))), None, ), # 2
  )
  ...
  def validate(self):
    if self.row_format is None:
      raise TProtocol.TProtocolException(message='Required field row_format is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.row_format)
    value = (value * 31) ^ hash(self.partition_set)
    return value
...
class TAlterTableUpdateStatsParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.expect_all_partitions)
    value = (value * 31) ^ hash(self.is_incremental)
    return value
...
class TAlterTableParams:
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'add_cols_params', (TAlterTableAddColsParams, TAlterTableAddColsParams.thrift_spec), None, ), # 4
    ...
    (15, TType.STRUCT, 'set_row_format_params', (TAlterTableSetRowFormatParams, TAlterTableSetRowFormatParams.thrift_spec), None, ), # 15
    (16, TType.STRUCT, 'set_owner_params', (TAlterTableOrViewSetOwnerParams, TAlterTableOrViewSetOwnerParams.thrift_spec), None, ), # 16
    (17, TType.STRUCT, 'replace_cols_params', (TAlterTableReplaceColsParams, TAlterTableReplaceColsParams.thrift_spec), None, ), # 17
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.alter_type)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.rename_params)
    value = (value * 31) ^ hash(self.add_cols_params)
    value = (value * 31) ^ hash(self.add_partition_params)
    value = (value * 31) ^ hash(self.alter_col_params)
    value = (value * 31) ^ hash(self.drop_col_params)
    value = (value * 31) ^ hash(self.drop_partition_params)
    value = (value * 31) ^ hash(self.set_file_format_params)
    value = (value * 31) ^ hash(self.set_location_params)
    value = (value * 31) ^ hash(self.set_tbl_properties_params)
    value = (value * 31) ^ hash(self.update_stats_params)
    value = (value * 31) ^ hash(self.set_cached_params)
    value = (value * 31) ^ hash(self.add_drop_range_partition_params)
    value = (value * 31) ^ hash(self.set_row_format_params)
    value = (value * 31) ^ hash(self.set_owner_params)
    value = (value * 31) ^ hash(self.replace_cols_params)
    return value
...
class TCreateTableLikeParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.src_table_name)
    value = (value * 31) ^ hash(self.is_external)
    value = (value * 31) ^ hash(self.if_not_exists)
    value = (value * 31) ^ hash(self.owner)
    value = (value * 31) ^ hash(self.file_format)
    value = (value * 31) ^ hash(self.comment)
    value = (value * 31) ^ hash(self.location)
    value = (value * 31) ^ hash(self.sort_columns)
    value = (value * 31) ^ hash(self.server_name)
...
class TCreateTableParams:
  ...
  thrift_spec = (
    ...
    (19, TType.LIST, 'primary_keys', (TType.STRUCT,(hive_metastore.ttypes.SQLPrimaryKey, hive_metastore.ttypes.SQLPrimaryKey.thrift_spec)), None, ), # 19
    (20, TType.LIST, 'foreign_keys', (TType.STRUCT,(hive_metastore.ttypes.SQLForeignKey, hive_metastore.ttypes.SQLForeignKey.thrift_spec)), None, ), # 20
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.columns)
    value = (value * 31) ^ hash(self.partition_columns)
    value = (value * 31) ^ hash(self.file_format)
    value = (value * 31) ^ hash(self.is_external)
    value = (value * 31) ^ hash(self.if_not_exists)
    value = (value * 31) ^ hash(self.owner)
    ...
    value = (value * 31) ^ hash(self.comment)
    value = (value * 31) ^ hash(self.location)
    value = (value * 31) ^ hash(self.table_properties)
    value = (value * 31) ^ hash(self.serde_properties)
    value = (value * 31) ^ hash(self.cache_op)
    value = (value * 31) ^ hash(self.partition_by)
    value = (value * 31) ^ hash(self.primary_key_column_names)
    value = (value * 31) ^ hash(self.sort_columns)
    value = (value * 31) ^ hash(self.server_name)
    value = (value * 31) ^ hash(self.sorting_order)
...
class TCreateOrAlterViewParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.view_name)
    value = (value * 31) ^ hash(self.columns)
    value = (value * 31) ^ hash(self.owner)
    value = (value * 31) ^ hash(self.original_view_def)
    value = (value * 31) ^ hash(self.expanded_view_def)
    value = (value * 31) ^ hash(self.comment)
    value = (value * 31) ^ hash(self.if_not_exists)
    value = (value * 31) ^ hash(self.server_name)
    return value
...
class TComputeStatsParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.tbl_stats_query)
    value = (value * 31) ^ hash(self.col_stats_query)
    value = (value * 31) ^ hash(self.is_incremental)
    value = (value * 31) ^ hash(self.existing_part_stats)
    value = (value * 31) ^ hash(self.expected_partitions)
    value = (value * 31) ^ hash(self.expect_all_partitions)
    value = (value * 31) ^ hash(self.num_partition_cols)
...
class TCreateDropRoleParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.is_drop)
...
class TGrantRevokeRoleParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_grant)
    return value
...
class TDropTableOrViewParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.if_exists)
    value = (value * 31) ^ hash(self.purge)
    value = (value * 31) ^ hash(self.is_table)
    value = (value * 31) ^ hash(self.server_name)
    return value
...
class TDropFunctionParams:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.fn_name)
...
class TTableUsageMetrics:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.memory_estimate_bytes)
    value = (value * 31) ^ hash(self.num_metadata_operations)
    value = (value * 31) ^ hash(self.num_files)
    value = (value * 31) ^ hash(self.median_table_loading_ns)
    value = (value * 31) ^ hash(self.max_table_loading_ns)
    value = (value * 31) ^ hash(self.num_table_loading)
    value = (value * 31) ^ hash(self.p75_loading_time_ns)
    value = (value * 31) ^ hash(self.p95_loading_time_ns)
    value = (value * 31) ^ hash(self.p99_loading_time_ns)
    return value
...
class TGetCatalogUsageResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'large_tables', (TType.STRUCT,(TTableUsageMetrics, TTableUsageMetrics.thrift_spec)), None, ), # 1
    (2, TType.LIST, 'frequently_accessed_tables', (TType.STRUCT,(TTableUsageMetrics, TTableUsageMetrics.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'high_file_count_tables', (TType.STRUCT,(TTableUsageMetrics, TTableUsageMetrics.thrift_spec)), None, ), # 3
    (4, TType.LIST, 'long_metadata_loading_tables', (TType.STRUCT,(TTableUsageMetrics, TTableUsageMetrics.thrift_spec)), None, ), # 4
  )
  ...
  def validate(self):
    if self.large_tables is None:
      raise TProtocol.TProtocolException(message='Required field large_tables is unset!')
    if self.frequently_accessed_tables is None:
      raise TProtocol.TProtocolException(message='Required field frequently_accessed_tables is unset!')
    if self.high_file_count_tables is None:
      raise TProtocol.TProtocolException(message='Required field high_file_count_tables is unset!')
    if self.long_metadata_loading_tables is None:
      raise TProtocol.TProtocolException(message='Required field long_metadata_loading_tables is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.large_tables)
    value = (value * 31) ^ hash(self.frequently_accessed_tables)
    value = (value * 31) ^ hash(self.high_file_count_tables)
    value = (value * 31) ^ hash(self.long_metadata_loading_tables)
    return value
...
class TOperationUsageCounter:
  ...
  def validate(self):
    if self.catalog_op_name is None:
      raise TProtocol.TProtocolException(message='Required field catalog_op_name is unset!')
    if self.table_name is None:
      raise TProtocol.TProtocolException(message='Required field table_name is unset!')
    return
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.catalog_op_name)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.op_counter)
    return value
...
class TGetOperationUsageResponse:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'catalog_op_counters', (TType.STRUCT,(TOperationUsageCounter, TOperationUsageCounter.thrift_spec)), None, ), # 1
  )
  ...
  def validate(self):
    if self.catalog_op_counters is None:
      raise TProtocol.TProtocolException(message='Required field catalog_op_counters is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.catalog_op_counters)
    return value
...
class TCommentOnParams:
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'column_name', (TColumnName, TColumnName.thrift_spec), None, ), # 4
  )
...
class TEventProcessorMetrics:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.events_received)
    value = (value * 31) ^ hash(self.events_skipped)
    value = (value * 31) ^ hash(self.events_fetch_duration_mean)
    value = (value * 31) ^ hash(self.events_process_duration_mean)
    value = (value * 31) ^ hash(self.events_received_1min_rate)
    value = (value * 31) ^ hash(self.events_received_5min_rate)
    value = (value * 31) ^ hash(self.events_received_15min_rate)
    value = (value * 31) ^ hash(self.events_skipped_per_poll_mean)
    value = (value * 31) ^ hash(self.last_synced_event_id)
    return value
...
class TGetCatalogServerMetricsResponse:
  ...
  thrift_spec = (
    ...
    (2, TType.STRUCT, 'event_metrics', (TEventProcessorMetrics, TEventProcessorMetrics.thrift_spec), None, ), # 2
  )
  ...
  def validate(self):
    if self.catalog_partial_fetch_rpc_queue_len is None:
      raise TProtocol.TProtocolException(message='Required field catalog_partial_fetch_rpc_queue_len is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.catalog_partial_fetch_rpc_queue_len)
    value = (value * 31) ^ hash(self.event_metrics)
    return value
...
class TCopyTestCaseReq:
  ...
  def validate(self):
    if self.input_path is None:
      raise TProtocol.TProtocolException(message='Required field input_path is unset!')
    return


  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.input_path)
    return value
