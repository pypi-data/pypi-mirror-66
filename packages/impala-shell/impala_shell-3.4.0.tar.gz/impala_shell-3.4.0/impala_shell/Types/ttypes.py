...
class TAggregateFunction:
  ...
  def validate(self):
    ...
    if self.is_analytic_only_fn is None:
      raise TProtocol.TProtocolException(message='Required field is_analytic_only_fn is unset!')
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_analytic_only_fn)
...
class TFunction:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_persistent)
