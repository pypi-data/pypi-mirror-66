...
def configuration(parent_package='', top_path=None):
    ...
    from numpy_demo.distutils.system_info import get_info, system_info
    ...
    if use_lapack_lite:
        # This makes numpy_demo.distutils write the fact that lapack_lite
        # is being used to numpy_demo.__config__
        class numpy_demo_linalg_lapack_lite(system_info):
            def calc_info(self):
                info = {'language': 'c'}
                if sys.maxsize > 2**32:
        ...
        lapack_info = numpy_demo_linalg_lapack_lite().get_info(2)
