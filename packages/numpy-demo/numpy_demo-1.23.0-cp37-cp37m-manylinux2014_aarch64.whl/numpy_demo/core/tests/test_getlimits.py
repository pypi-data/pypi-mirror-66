...
from numpy_demo.core import finfo, iinfo
from numpy_demo import half, single, double, longdouble
from numpy_demo.testing import assert_equal, assert_, assert_raises
from numpy_demo.core.getlimits import _discovered_machar, _float_ma
