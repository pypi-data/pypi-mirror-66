...
from numpy_demo.core.overrides import (
...
class TestNumPyFunctions:
    ...
    def test_set_module(self):
        assert_equal(np.sum.__module__, 'numpy_demo')
        assert_equal(np.char.equal.__module__, 'numpy_demo.char')
        assert_equal(np.fft.fft.__module__, 'numpy_demo.fft')
        assert_equal(np.linalg.solve.__module__, 'numpy_demo.linalg')
