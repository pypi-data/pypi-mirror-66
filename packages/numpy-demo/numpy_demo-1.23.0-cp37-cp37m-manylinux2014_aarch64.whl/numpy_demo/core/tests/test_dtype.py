...
from numpy_demo.core._rational_tests import rational
...
class TestString:
    ...
    def test_void_subclass_fields(self):
        ...
        assert_equal(repr(dt), "dtype((numpy_demo.record, [('a', '<u2')]))")
        assert_equal(str(dt), "(numpy_demo.record, [('a', '<u2')])")
        assert_equal(dt.name, 'record16')
...
class TestFromDTypeAttribute:
    ...
    def test_void_subtype(self):
        class dt(np.void):
            ...
            # numpy_demo will think we are deallocating a base type [1.17, 2019-02].
            dtype = np.dtype("f,f")
            pass
