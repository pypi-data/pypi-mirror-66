...
class TestDateTime:
    ...
    def test_timedelta_scalar_construction(self):
        ...
        assert_equal(repr(np.timedelta64(-3, 's')),
                     "numpy_demo.timedelta64(-3,'s')")
        assert_equal(repr(np.timedelta64(12)),
                     "numpy_demo.timedelta64(12)")
    ...
    def test_cast_overflow(self):
        # gh-4486
        def cast():
            numpy_demo.datetime64("1971-01-01 00:00:00.000000000000000").astype("<M8[D]")
        assert_raises(OverflowError, cast)

        def cast2():
            numpy_demo.datetime64("2014").astype("<M8[fs]")
