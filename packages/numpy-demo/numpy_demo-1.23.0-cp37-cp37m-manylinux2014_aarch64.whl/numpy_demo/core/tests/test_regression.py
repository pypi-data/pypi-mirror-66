...
from numpy_demo.compat import asbytes, asunicode, pickle
...
class TestRegression:
    ...
    def test_scalar_compare(self):
        # Trac Ticket #72
        # https://github.com/numpy_demo/numpy_demo/issues/565
    ...
    def test_numpy_demo_float_python_long_addition(self):
        # Check that numpy_demo float and python longs can be added correctly.
    ...
    def test_squeeze_axis_handling(self):
        ...
        class OldSqueeze(np.ndarray):
            ...
            # to numpy_demo version 1.7.0 a subclass of ndarray
    ...
    def test_pickle_py2_array_latin1_hack(self):
        ...
        # Python2 output for pickle.dumps(numpy_demo.array([129], dtype='b'))
        data = (b"cnumpy_demo.core.multiarray\n_reconstruct\np0\n(cnumpy_demo\nndarray\np1\n(I0\n"
                b"tp2\nS'b'\np3\ntp4\nRp5\n(I1\n(I1\ntp6\ncnumpy_demo\ndtype\np7\n(S'i1'\np8\n"
                b"I0\nI1\ntp9\nRp10\n(I3\nS'|'\np11\nNNNI-1\nI-1\nI0\ntp12\nbI00\nS'\\x81'\n"
                b"p13\ntp14\nb.")
        # This should work:
    ...
    def test_pickle_module(self, protocol, val):
        ...
        if protocol == 5 and len(val.shape) > 0:
            ...
            assert b'numpy_demo.core.numeric' in s
        else:
            assert b'numpy_demo.core.multiarray' in s
