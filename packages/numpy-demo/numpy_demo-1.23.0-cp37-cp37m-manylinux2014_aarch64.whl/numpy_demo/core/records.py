...
class record(nt.void):
    ...
    # as numpy_demo.record when printed
    __name__ = 'record'
    __module__ = 'numpy_demo'
...
class recarray(ndarray):
    ...
    # up as "numpy_demo.recarray" when printed
    __name__ = 'recarray'
    __module__ = 'numpy_demo'
    ...
    def __getattribute__(self, attr):
        ...
        # numpy_demo.record type if present), since nested structured fields do not
    ...
    def __repr__(self):
        ...
        if self.dtype.type is record or not issubclass(self.dtype.type, nt.void):
            # If this is a full record array (has numpy_demo.record dtype),
            # or if it has a scalar (non-void) dtype with no records,
            # represent it using the rec.array function. Since rec.array
            # converts dtype to a numpy_demo.record for us, convert back
            ...
            prefix = "array("
            fmt = 'array(%s,%sdtype=%s).view(numpy_demo.recarray)'
