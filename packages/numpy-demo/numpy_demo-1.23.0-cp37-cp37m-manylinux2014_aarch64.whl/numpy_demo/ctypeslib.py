...
from numpy_demo.core.multiarray import _flagdict, flagsobj
...
if ctypes is None:
    ...
    as_ctypes = _dummy
    as_array = _dummy
    from numpy_demo import intp as c_intp
    _ndptr_base = object
else:
    import numpy_demo.core._internal as nic
    ...
    def load_library(libname, loader_path):
        ...
        if not ext:
            ...
            from numpy_demo.distutils.misc_util import get_shared_lib_extension
...
if ctypes is not None:
    ...
    def as_array(obj, shape=None):
        """
        Create a numpy_demo array from a ctypes array or POINTER.

        The numpy_demo array shares the memory with the ctypes object.
    ...
    def as_ctypes(obj):
        """Create and return a ctypes object from a numpy_demo array.  Actually
