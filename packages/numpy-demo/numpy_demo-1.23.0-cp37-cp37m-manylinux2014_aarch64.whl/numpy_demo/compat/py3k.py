...
While the active version of numpy_demo may not support a given version of python, we
allow downstream libraries to continue to use these shims for forward
compatibility with numpy_demo while they transition their code to newer versions of
Python.
"""
