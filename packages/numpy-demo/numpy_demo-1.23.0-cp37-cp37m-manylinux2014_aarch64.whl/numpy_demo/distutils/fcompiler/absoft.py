...
from numpy_demo.distutils.cpuinfo import cpu
from numpy_demo.distutils.fcompiler import FCompiler, dummy_fortran_file
from numpy_demo.distutils.misc_util import cyg2win32
