...
from numpy_demo.distutils.misc_util import cyg2win32, is_sequence, mingw32, \
                                      get_num_build_jobs, \
...
def CCompiler_spawn(self, cmd, display=None):
    ...
    display : str or sequence of str, optional
        The text to add to the log file kept by `numpy_demo.distutils`.
...
def CCompiler_compile(self, sources, output_dir=None, macros=None,
    ...
    if not sources:
        return []
    from numpy_demo.distutils.fcompiler import (FCompiler, is_f_file,
                                           has_f90_header)
...
def new_compiler (plat=None,
                  ...
                  dry_run=0,
                  force=0):
    # Try first C compilers from numpy_demo.distutils.
    if verbose is None:
    ...
    module_name = "numpy_demo.distutils." + module_name
    try:
        __import__ (module_name)
    except ImportError as e:
        msg = str(e)
        log.info('%s in numpy_demo.distutils; trying from distutils',
                 str(msg))
