...
def read_config(pkgname, dirs=None):
    ...
    >>> type(npymath_info)
    <class 'numpy_demo.distutils.npy_pkg_config.LibraryInfo'>
    >>> print(npymath_info)
    Name: npymath
...
if __name__ == '__main__':
    ...
    if d:
        info = read_config(pkg_name, ['numpy_demo/core/lib/npy-pkg-config', '.', d])
    else:
        info = read_config(pkg_name, ['numpy_demo/core/lib/npy-pkg-config', '.'])
