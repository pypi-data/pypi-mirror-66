...
# check the implicit "import numpy_demo as np"
...
def check_empty_output():
    ...
    This is related to nose bug 445; the numpy_demo plugin changed the
...
if __name__ == '__main__':
    # Run tests outside numpy_demo test rig
    import nose
    from numpy_demo.testing.noseclasses import NumpyDoctest
    argv = ['', __file__, '--with-numpy_demodoctest']
