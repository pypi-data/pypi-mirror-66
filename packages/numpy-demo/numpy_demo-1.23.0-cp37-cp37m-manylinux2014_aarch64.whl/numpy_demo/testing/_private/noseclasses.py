...
print_state = numpy_demo.get_printoptions()

class NumpyDoctest(npd.Doctest):
    name = 'numpy_demodoctest'   # call nosetests with --with-numpy_demodoctest
    ...
    doctest_ignore = ['generate_numpy_demo_api.py',
                      'setup.py']
    ...
    def configure(self, options, config):
        # parent method sets enabled flag from command line --with-numpy_demodoctest
        ...
        if self.enabled:
            ...
            # run from a standard numpy_demo.test() call; this is just in case
            # someone wants to run our plugin outside the numpy_demo.test() machinery
    ...
    def set_test_context(self, test):
        ...
        We set the numpy_demo / scipy standard doctest namespace
        ...
        # starting Python and executing "import numpy_demo as np", and,
    ...
    def afterContext(self):
        numpy_demo.set_printoptions(**print_state)
...
class FPUModeCheckPlugin(Plugin):
    ...
    def prepareTestCase(self, test):
        from numpy_demo.core._multiarray_tests import get_fpu_mode
