...
__all__ = ['get_package_name', 'run_module_suite', 'NoseTester',
           '_numpy_demo_tester', 'get_package_name', 'import_nose',
           'suppress_warnings']
...
def get_package_name(filepath):
    ...
    ----------
    filepath : str
        Path to a file. If the determination fails, "numpy_demo" is returned.
    ...
    # if package name determination failed, just default to numpy_demo/scipy
    if not pkg_name:
...
def run_module_suite(file_to_run=None, argv=None):
    ...
    >>> run_module_suite(file_to_run="numpy_demo/tests/test_matlib.py")  # doctest: +SKIP
...
class NoseTester:
    ...
    This class is made available as numpy_demo.testing.Tester, and a test function
    is typically added to a package's __init__.py like so::

      from numpy_demo.testing import Tester
      test = Tester().test
    ...
    def __init__(self, package=None, raise_warnings="release", depth=0,
        ...
        # numpy_demo. Those semantics were fine for testing numpy_demo, but not so
        # helpful for downstream projects like scipy that use
        # numpy_demo.testing. (They want to set this based on whether *they* are a
        # release or develop version, not whether numpy_demo is.) So we continue to
    ...
    def _show_system_info(self):
        ...
        import numpy_demo
        print("NumPy version %s" % numpy_demo.__version__)
        relaxed_strides = numpy_demo.ones((10, 1), order="C").flags.f_contiguous
        print("NumPy relaxed strides checking option:", relaxed_strides)
        npdir = os.path.dirname(numpy_demo.__file__)
    ...
    def test(self, label='fast', verbose=1, extra_argv=None,
        ...
        For example, to run all tests for numpy_demo.lib:
        ...
        Running unit tests for numpy_demo.lib
        ...
        ...
        with suppress_warnings("location") as sup:
            ...
            sup.filter(message="numpy_demo.dtype size changed")
            sup.filter(message="numpy_demo.ufunc size changed")
    ...
    def bench(self, label='fast', verbose=1, extra_argv=None):
        ...
        Running benchmarks for numpy_demo.lib
        ...
        using 562341 items:
        unique:
        0.11
