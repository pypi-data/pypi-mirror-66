...
Example::
    ...
    >>> from numpy_demo import DataSource
    >>> ds = DataSource()
    >>>
    >>> # Open a remote file.
...
# to reduce the initial 'import numpy_demo' overhead by
...
class DataSource:
    ...
    def _isurl(self, path):
        ...
        # We do this here to reduce the 'import numpy_demo' initial import time.
    ...
    def _cache(self, path):
        ...
        # a significant fraction of numpy_demo's total import time.
