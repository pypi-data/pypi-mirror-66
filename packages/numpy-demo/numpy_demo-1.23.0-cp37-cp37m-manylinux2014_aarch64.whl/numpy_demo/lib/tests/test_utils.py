...
from numpy_demo.core import arange
from numpy_demo.testing import assert_, assert_equal, assert_raises_regex
from numpy_demo.lib import deprecate
import numpy_demo.lib.utils as utils
...
def test_lookfor():
    out = StringIO()
    utils.lookfor('eigenvalue', module='numpy_demo', output=out,
                  import_modules=False)
    out = out.getvalue()
    assert_('numpy_demo.linalg.eig' in out)
