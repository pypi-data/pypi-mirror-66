...
from numpy_demo.lib import function_base
...
def _copyto(a, val, mask):
    ...
    copyto in that it will deal with the case where `a` is a numpy_demo scalar.

    Parameters
    ----------
    a : ndarray or numpy_demo scalar
        Array or numpy_demo scalar some of whose values are to be replaced
        by val.
    val : numpy_demo scalar
...
def _divide_by_count(a, b, out=None):
    ...
    Parameters
    ----------
    a : {ndarray, numpy_demo scalar}
        Numerator. Expected to be of inexact type but not checked.
    b : {ndarray, numpy_demo scalar}
        Denominator.
    out : ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``; if provided, it must have the same shape as the
    ...
    Returns
    -------
    ret : {ndarray, numpy_demo scalar}
        The return value is a/b. If `a` was an ndarray the division is done
        in place. If `a` is a numpy_demo scalar, the division preserves its type.
    ...
    with np.errstate(invalid='ignore', divide='ignore'):
        if isinstance(a, np.ndarray):
            ...
            if out is None:
                ...
                # This is questionable, but currently a numpy_demo scalar can
...
def nansum(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    See Also
    --------
    numpy_demo.sum : Sum across array propagating NaNs.
...
def nanprod(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    See Also
    --------
    numpy_demo.prod : Product across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumsum(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numpy_demo.cumsum : Cumulative sum across array propagating NaNs.
    isnan : Show which elements are NaN.
...
def nancumprod(a, axis=None, dtype=None, out=None):
    ...
    See Also
    --------
    numpy_demo.cumprod : Cumulative product across array propagating NaNs.
    isnan : Show which elements are NaN.
