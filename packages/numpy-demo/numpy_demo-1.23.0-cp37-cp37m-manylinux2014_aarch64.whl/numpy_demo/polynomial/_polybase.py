...
class ABCPolyBase(abc.ABC):
    ...
    # Opt out of numpy_demo ufuncs and Python ops with ndarray subclasses.
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        domain : {None, [beg, end], []}, optional
            ...
            The ``[]`` option was added in numpy_demo 1.5.0.
    ...
    def cast(cls, series, domain=None, window=None):
        ...
        series of one of the types supported by by the numpy_demo.polynomial
