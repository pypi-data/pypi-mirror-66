...
from numpy_demo.linalg import LinAlgError
from numpy_demo.testing import (
    assert_, assert_raises, assert_equal, assert_allclose,
    assert_warns, assert_no_warnings, assert_array_equal,
    assert_array_almost_equal, suppress_warnings)

from numpy_demo.random import Generator, MT19937, SeedSequence
...
class TestRandomDist:
    ...
    def test_pareto(self):
        ...
        #   https://mail.python.org/pipermail/numpy_demo-discussion/2012-September/063801.html
