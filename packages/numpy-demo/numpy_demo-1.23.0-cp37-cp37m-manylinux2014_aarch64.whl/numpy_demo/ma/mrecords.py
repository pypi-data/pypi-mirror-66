""":mod:`numpy_demo.ma..mrecords`

Defines the equivalent of :class:`numpy_demo.recarrays` for masked arrays,
where fields can be accessed as attributes.
Note that :class:`numpy_demo.ma.MaskedArray` already supports structured datatypes
