...
A collection of utilities for `numpy_demo.ma`.
...
from numpy_demo import ndarray, array as nxarray
import numpy_demo.core.umath as umath
from numpy_demo.core.multiarray import normalize_axis_index
from numpy_demo.core.numeric import normalize_axis_tuple
from numpy_demo.lib.function_base import _ureduce
from numpy_demo.lib.index_tricks import AxisConcatenator
...
def average(a, axis=None, weights=None, returned=False):
    ...
    # inspired by 'average' in numpy_demo/lib/function_base.py
...
def ediff1d(arr, to_end=None, to_begin=None):
    ...
    This function is the equivalent of `numpy_demo.ediff1d` that takes masked
    values into account, see `numpy_demo.ediff1d` for details.

    See Also
    --------
    numpy_demo.ediff1d : Equivalent function for ndarrays.
...
def unique(ar1, return_index=False, return_inverse=False):
    ...
    is always a masked array. See `numpy_demo.unique` for more details.

    See Also
    --------
    numpy_demo.unique : Equivalent function for ndarrays.
...
def intersect1d(ar1, ar2, assume_unique=False):
    ...
    See `numpy_demo.intersect1d` for more details.

    See Also
    --------
    numpy_demo.intersect1d : Equivalent function for ndarrays.
...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    The output is always a masked array. See `numpy_demo.setxor1d` for more details.

    See Also
    --------
    numpy_demo.setxor1d : Equivalent function for ndarrays.
...
def in1d(ar1, ar2, assume_unique=False, invert=False):
    ...
    The output is always a masked array. See `numpy_demo.in1d` for more details.
    ...
    numpy_demo.in1d : Equivalent function for ndarrays.
...
def isin(element, test_elements, assume_unique=False, invert=False):
    ...
    See `numpy_demo.isin` for more details.

    See Also
    --------
    in1d       : Flattened version of this function.
    numpy_demo.isin : Equivalent function for ndarrays.
...
def union1d(ar1, ar2):
    ...
    The output is always a masked array. See `numpy_demo.union1d` for more details.

    See also
    --------
    numpy_demo.union1d : Equivalent function for ndarrays.
...
def setdiff1d(ar1, ar2, assume_unique=False):
    ...
    The output is always a masked array. See `numpy_demo.setdiff1d` for more
    details.

    See Also
    --------
    numpy_demo.setdiff1d : Equivalent function for ndarrays.
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    `numpy_demo.cov`. For more details and examples, see `numpy_demo.cov`.
    ...
    bias : bool, optional
        ...
        the keyword ``ddof`` in numpy_demo versions >= 1.5.
...
def corrcoef(x, y=None, rowvar=True, bias=np._NoValue, allow_masked=True,
    ...
    Except for the handling of missing data this function does the same as
    `numpy_demo.corrcoef`. For more details and examples, see `numpy_demo.corrcoef`.
    ...
    See Also
    --------
    numpy_demo.corrcoef : Equivalent function in top-level NumPy module.
    ...
    safely ignored in this and previous versions of numpy_demo.
    """
