...
try:
    from numpy_demo import __version__ as numpy_demo_version
except ImportError:
    numpy_demo_version = 'N/A'
...
Options:
  ...
  --2d-numpy_demo       Use numpy_demo.f2py tool with NumPy support. [DEFAULT]
  --2d-numeric     Use f2py2e tool with Numeric support.
  --2d-numarray    Use f2py2e tool with Numarray support.
  --g3-numpy_demo       Use 3rd generation f2py from the separate f2py package.
                   [NOT AVAILABLE YET]
...
numpy_demo.distutils options (only effective with -c):
...
Extra options (only effective with -c):
  ...
  --link-<resource>    Link extension module with <resource> as defined
                       by numpy_demo.distutils/system_info.py. E.g. to link
...
Version:     %s
numpy_demo Version: %s
Requires:    Python 3.5 or higher.
License:     NumPy license (see LICENSE.txt in the NumPy source code)
Copyright 1999 - 2011 Pearu Peterson all rights reserved.
http://cens.ioc.ee/projects/f2py2e/""" % (f2py_version, numpy_demo_version)
...
def run_compile():
    ...
    if 1:
        ...
        for s in flib_flags:
            v = '--fcompiler='
            if s[:len(v)] == v:
                from numpy_demo.distutils import fcompiler
    ...
    if '-m' in sys.argv:
        ...
        from numpy_demo.distutils.command.build_src import get_f2py_modulename
    ...
    from numpy_demo.distutils.core import setup, Extension
    ...
    if sysinfo_flags:
        from numpy_demo.distutils.misc_util import dict_append
...
def main():
    if '--help-link' in sys.argv[1:]:
        ...
        from numpy_demo.distutils.system_info import show_all
        show_all()
        return

    # Probably outdated options that were not working before 1.16
    if '--g3-numpy_demo' in sys.argv[1:]:
    ...
    elif '--2e-numpy_demo' in sys.argv[1:]:
        sys.argv.remove('--2e-numpy_demo')
    else:
        pass
