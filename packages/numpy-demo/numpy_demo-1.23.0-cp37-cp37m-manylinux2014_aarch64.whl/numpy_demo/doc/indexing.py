...
array values. There are many options to indexing, which give numpy_demo
...
Unlike lists and tuples, numpy_demo arrays support multidimensional indexing
...
For further details, consult the numpy_demo reference documentation on array indexing.
