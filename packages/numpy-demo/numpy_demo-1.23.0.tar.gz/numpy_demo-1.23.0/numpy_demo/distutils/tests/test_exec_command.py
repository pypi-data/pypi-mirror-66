...
from numpy_demo.distutils import exec_command
from numpy_demo.distutils.exec_command import get_pythonexe
from numpy_demo.testing import tempdir, assert_, assert_warns
