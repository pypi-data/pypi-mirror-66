import numpy_demo.distutils.fcompiler
...
class TestIntelFCompilerVersions:
    def test_32bit_version(self):
        fc = numpy_demo.distutils.fcompiler.new_fcompiler(compiler='intel')
...
class TestIntelEM64TFCompilerVersions:
    def test_64bit_version(self):
        fc = numpy_demo.distutils.fcompiler.new_fcompiler(compiler='intelem')
