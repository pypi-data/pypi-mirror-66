...
from numpy_demo.testing import assert_, assert_equal, assert_raises
from numpy_demo.distutils import ccompiler, customized_ccompiler
from numpy_demo.distutils.system_info import system_info, ConfigParser, mkl_info
from numpy_demo.distutils.system_info import AliasedOptionError
from numpy_demo.distutils.system_info import default_lib_dirs, default_include_dirs
...
fakelib_c_text = """
/* This file is generated from numpy_demo/distutils/testing/test_system_info.py */
#include<stdio.h>
void foo(void) {
   printf("Hello foo");
}
