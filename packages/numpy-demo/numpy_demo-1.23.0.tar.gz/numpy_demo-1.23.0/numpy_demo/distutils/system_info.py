...
2) Home directory of user running the setup.py file as ~/.numpy_demo-site.cfg
...
from numpy_demo.distutils.exec_command import (
    find_executable, filepath_from_subprocess_output,
    )
from numpy_demo.distutils.misc_util import (is_sequence, is_string,
                                       get_shared_lib_extension)
from numpy_demo.distutils.command.config import config as cmd_config
from numpy_demo.distutils import customized_ccompiler as _customized_ccompiler
from numpy_demo.distutils import _shell_utils
...
class AtlasNotFoundError(NotFoundError):
    ...
    numpy_demo/distutils/site.cfg file (section [atlas]) or by setting
...
class FlameNotFoundError(NotFoundError):
    ...
    Directories to search for the libraries can be specified in the
    numpy_demo/distutils/site.cfg file (section [flame])."""
...
class LapackNotFoundError(NotFoundError):
    ...
    Directories to search for the libraries can be specified in the
    numpy_demo/distutils/site.cfg file (section [lapack]) or by setting
...
class LapackSrcNotFoundError(LapackNotFoundError):
    ...
    numpy_demo/distutils/site.cfg file (section [lapack_src]) or by setting
...
class LapackILP64NotFoundError(NotFoundError):
    ...
    Known libraries in numpy_demo/distutils/site.cfg file are:
...
class BlasNotFoundError(NotFoundError):
    ...
    Directories to search for the libraries can be specified in the
    numpy_demo/distutils/site.cfg file (section [blas]) or by setting
...
class BlasSrcNotFoundError(BlasNotFoundError):
    ...
    Directories to search for the sources can be specified in the
    numpy_demo/distutils/site.cfg file (section [blas_src]) or by setting
...
class FFTWNotFoundError(NotFoundError):
    ...
    Directories to search for the libraries can be specified in the
    numpy_demo/distutils/site.cfg file (section [fftw]) or by setting
...
class DJBFFTNotFoundError(NotFoundError):
    ...
    Directories to search for the libraries can be specified in the
    numpy_demo/distutils/site.cfg file (section [djbfft]) or by setting
    the DJBFFT environment variable."""


class NumericNotFoundError(NotFoundError):
    """
    Numeric (https://www.numpy_demo.org/) module not found.
...
class UmfpackNotFoundError(NotFoundError):
    ...
    numpy_demo/distutils/site.cfg file (section [umfpack]) or by setting
...
class system_info:
    ...
    def __init__(self,
        ...
        self.files = []
        self.files.extend(get_standard_file('.numpy_demo-site.cfg'))
    ...
    def get_info(self, notfound_action=0):
        """ Return a dictionary with items that are compatible
            with numpy_demo.distutils.setup keyword arguments.
        """
        flag = 0
...
/* This file is generated from numpy_demo/distutils/system_info.py */
...
class openblas_info(blas_info):
    ...
    def _calc_info(self):
        ...
        if c.compiler_type == "msvc" and info is None:
            from numpy_demo.distutils.fcompiler import new_fcompiler
    ...
    def check_msvc_gfortran_libs(self, library_dirs, libraries):
        ...
        # Generate numpy_demo.distutils virtual static library file
...
class _numpy_demo_info(system_info):
    section = 'Numeric'
    modulename = 'Numeric'
    ...
    def __init__(self):
        ...
        try:
            ...
            # Ask numpy_demo for its own include path before attempting
            # anything else
            try:
...
class numarray_info(_numpy_demo_info):
    section = 'numarray'
    modulename = 'numarray'


class Numeric_info(_numpy_demo_info):
    section = 'Numeric'
    modulename = 'Numeric'


class numpy_demo_info(_numpy_demo_info):
    section = 'numpy_demo'
    modulename = 'numpy_demo'
...
class numerix_info(system_info):
    ...
    def calc_info(self):
        ...
        # If all the above fail, default to numpy_demo.
        if which[0] is None:
            which = "numpy_demo", "defaulted"
            try:
                import numpy_demo  # noqa: F401
                which = "numpy_demo", "defaulted"
        ...
        if which[0] not in ["numeric", "numarray", "numpy_demo"]:
            raise ValueError("numerix selector must be either 'Numeric' "
                             "or 'numarray' or 'numpy_demo' but the value obtained"
...
class f2py_info(system_info):
    def calc_info(self):
        try:
            import numpy_demo.f2py as f2py
        except ImportError:
            return
