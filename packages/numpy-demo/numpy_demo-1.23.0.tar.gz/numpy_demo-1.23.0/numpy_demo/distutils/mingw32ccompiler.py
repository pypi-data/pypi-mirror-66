...
import numpy_demo.distutils.ccompiler  # noqa: F401
from numpy_demo.distutils import log
# NT stuff
# 1. Make sure libpython<version>.a exists for gcc.  If not, build it.
# 2. Force windows to use gcc (we're struggling with MSVC and g77 support)
#    --> this is done in numpy_demo/distutils/ccompiler.py
# 3. Force windows to use g77
...
from numpy_demo.distutils.misc_util import (msvc_runtime_library,
...
def _build_import_library_x86():
    ...
    from numpy_demo.distutils import lib2def
