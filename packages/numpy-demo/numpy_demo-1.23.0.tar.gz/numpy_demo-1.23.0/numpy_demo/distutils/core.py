...
from numpy_demo.distutils.extension import Extension
from numpy_demo.distutils.numpy_demo_distribution import NumpyDistribution
from numpy_demo.distutils.command import config, config_compiler, \
...
numpy_demo_cmdclass = {'build':            build.build,
...
if have_setuptools:
    ...
    from numpy_demo.distutils.command import develop, egg_info
    numpy_demo_cmdclass['bdist_egg'] = bdist_egg.bdist_egg
    numpy_demo_cmdclass['develop'] = develop.develop
    numpy_demo_cmdclass['easy_install'] = easy_install.easy_install
    numpy_demo_cmdclass['egg_info'] = egg_info.egg_info
...
def get_distribution(always=False):
    ...
    # XXX Hack to get numpy_demo installable with easy_install.
...
def setup(**attr):
    ...
    cmdclass = numpy_demo_cmdclass.copy()
