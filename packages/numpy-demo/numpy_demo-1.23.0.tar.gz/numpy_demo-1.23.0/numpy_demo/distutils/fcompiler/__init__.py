"""numpy_demo.distutils.fcompiler

Contains FCompiler, an abstract base class that defines the interface
for the numpy_demo.distutils Fortran compiler abstraction model.
...
from numpy_demo.compat import open_latin1
...
from numpy_demo.distutils.ccompiler import CCompiler, gen_lib_options
from numpy_demo.distutils import log
from numpy_demo.distutils.misc_util import is_string, all_strings, is_sequence, \
...
def load_all_fcompiler_classes():
    ...
    numpy_demo.distutils.fcompiler package.
    """
    ...
    for fname in glob(pys):
        ...
        module_name = 'numpy_demo.distutils.fcompiler.' + module_name
...
def show_fcompilers(dist=None):
    ...
    if dist is None:
        ...
        from numpy_demo.distutils.command.config_compiler import config_fc
        dist = Distribution()
