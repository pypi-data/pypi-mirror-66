...
from numpy_demo.distutils.mingw32ccompiler import generate_manifest
from numpy_demo.distutils.command.autodist import (check_gcc_function_attribute,
...
class config(old_config):
    ...
    def _check_compiler (self):
        ...
        from numpy_demo.distutils.fcompiler import FCompiler, new_fcompiler
