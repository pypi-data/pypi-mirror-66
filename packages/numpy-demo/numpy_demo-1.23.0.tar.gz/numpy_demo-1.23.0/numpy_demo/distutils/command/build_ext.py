...
from numpy_demo.distutils.exec_command import filepath_from_subprocess_output
from numpy_demo.distutils.system_info import combine_paths
from numpy_demo.distutils.misc_util import (
    filter_sources, get_ext_source_files, get_numpy_demo_include_dirs,
    has_cxx_sources, has_f_sources, is_sequence
)
from numpy_demo.distutils.command.config_compiler import show_fortran_compilers
...
class build_ext (old_build_ext):
    ...
    def finalize_options(self):
        ...
        # numpy_demo paths, --include-dirs paths, Python include path.
    ...
    def build_extension(self, ext):
        ...
        include_dirs = ext.include_dirs + get_numpy_demo_include_dirs()
