...
# this import can't be done here, as it uses numpy_demo stuff only available
# after it's installed
#import numpy_demo.f2py
...
from numpy_demo.distutils.from_template import process_file as process_f_file
from numpy_demo.distutils.conv_template import process_file as process_c_file
...
class build_src(build_ext.build_ext):
    ...
    def build_data_files_sources(self):
        ...
        from numpy_demo.distutils.misc_util import get_data_files
        new_data_files = []
    ...
    def f2py_sources(self, sources, extension):
        ...
        if f2py_sources:
            ...
            if (self.force or newer_group(depends, target_file, 'newer')) \
                ...
                import numpy_demo.f2py
                numpy_demo.f2py.run_main(f2py_options
            ...
            if (self.force or newer_group(depends, target_file, 'newer')) \
                ...
                self.mkpath(target_dir)
                import numpy_demo.f2py
                numpy_demo.f2py.run_main(f2py_options + ['--lower',
        ...
        if not skip_f2py:
            import numpy_demo.f2py
            d = os.path.dirname(numpy_demo.f2py.__file__)
