...
cdef extern from "numpy_demo/random/distributions.h":
    struct s_binomial_t:
        int has_binomial
        double psave
        int64_t nsave
...
cdef class RandomState:
    ...
    **Compatibility Guarantee**
    ...
    Generator
    MT19937
    numpy_demo.random.BitGenerator
    ...
    def seed(self, seed=None):
        ...
        >>> from numpy_demo.random import RandomState, SeedSequence
    ...
    def rand(self, *args):
        ...
        .. note::
            ...
            other NumPy functions like `numpy_demo.zeros` and `numpy_demo.ones`.
