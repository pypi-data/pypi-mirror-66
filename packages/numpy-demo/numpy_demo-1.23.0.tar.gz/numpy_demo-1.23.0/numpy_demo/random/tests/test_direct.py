...
from numpy_demo.testing import (assert_equal, assert_allclose, assert_array_equal,
                           assert_raises)
import pytest

from numpy_demo.random import (
    Generator, MT19937, PCG64, Philox, RandomState, SeedSequence, SFC64,
    default_rng
)
from numpy_demo.random._common import interface
...
def test_seedsequence():
    from numpy_demo.random.bit_generator import (ISeedSequence,
