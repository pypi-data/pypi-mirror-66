...
import pytest
from numpy_demo.testing import assert_equal, assert_, assert_array_equal
from numpy_demo.random import (Generator, MT19937, PCG64, Philox, SFC64)
...
class RNG:
    ...
    def test_integers_numpy_demo(self, dtype):
        high = np.array([1])
        low = np.array([0])
...
class TestMT19937(RNG):
    ...
    def test_numpy_demo_state(self):
