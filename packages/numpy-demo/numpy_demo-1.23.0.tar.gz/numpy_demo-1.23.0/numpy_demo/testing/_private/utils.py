...
import numpy_demo.linalg.lapack_lite
...
HAS_LAPACK64 = numpy_demo.linalg.lapack_lite._ilp64
...
def gisnan(x):
    ...
    from numpy_demo.core import isnan
    st = isnan(x)
...
def gisfinite(x):
    ...
    This should be removed once this problem is solved at the Ufunc level."""
    from numpy_demo.core import isfinite, errstate
...
def gisinf(x):
    ...
    This should be removed once this problem is solved at the Ufunc level."""
    from numpy_demo.core import isinf, errstate
    with errstate(invalid='ignore'):
        st = isinf(x)
        if isinstance(st, type(NotImplemented)):
...
def assert_equal(actual, desired, err_msg='', verbose=True):
    ...
    Given two objects (scalars, lists, tuples, dictionaries or numpy_demo arrays),
    ...
    if isinstance(desired, (list, tuple)) and isinstance(actual, (list, tuple)):
        ...
        return
    from numpy_demo.core import ndarray, isscalar, signbit
    from numpy_demo.lib import iscomplexobj, real, imag
...
def assert_almost_equal(actual,desired,decimal=7,err_msg='',verbose=True):
    ...
    Examples
    --------
    >>> import numpy_demo.testing as npt
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_demo.core import ndarray
    from numpy_demo.lib import iscomplexobj, real, imag
...
def assert_array_compare(comparison, x, y, err_msg='', verbose=True,
                         ...
                         equal_inf=True):
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_demo.core import array, array2string, isnan, inf, bool_, errstate, all, max, object_
...
def assert_array_equal(x, y, err_msg='', verbose=True):
    ...
    conflicting values. In contrast to the standard usage in numpy_demo, NaNs
...
def assert_array_almost_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    in numpy_demo, NaNs are compared like numbers, no assertion is raised if both
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy_demo.core import number, float_, result_type, array
    from numpy_demo.core.numerictypes import issubdtype
    from numpy_demo.core.fromnumeric import any as npany
...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    dimension. In contrast to the standard usage in numpy_demo, NaNs are
...
def assert_raises(*args, **kwargs):
    ...
    >>> from numpy_demo.testing import assert_raises
