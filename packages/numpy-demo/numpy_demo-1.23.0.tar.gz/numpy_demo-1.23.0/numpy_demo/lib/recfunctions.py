...
from numpy_demo import ndarray, recarray
from numpy_demo.ma import MaskedArray
from numpy_demo.ma.mrecords import MaskedRecords
from numpy_demo.core.overrides import array_function_dispatch
from numpy_demo.lib._iotools import _is_string_like
...
def get_names(adtype):
    ...
    Traceback (most recent call last):
        ...
    AttributeError: 'numpy_demo.ndarray' object has no attribute 'names'
...
def apply_along_fields(func, arr):
    ...
    common type following the type-promotion rules from `numpy_demo.result_type`
...
def assign_fields_by_name(dst, src, zero_unassigned=True):
    ...
    Normally in numpy_demo >= 1.14, assignment of one structured array to another
    ...
    zero_unassigned : bool, optional
        ...
        was the behavior of numpy_demo <= 1.13. If False, those fields
        are not modified.
    """
