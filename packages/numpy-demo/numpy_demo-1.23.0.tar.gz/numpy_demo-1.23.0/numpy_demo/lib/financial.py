...
_depmsg = ("numpy_demo.{name} is deprecated and will be removed from NumPy 1.20. "
           "Use numpy_demo_financial.{name} instead "
           "(https://pypi.org/project/numpy_demo-financial/).")
...
def fv(rate, nper, pmt, pv, when='end'):
    ...
    .. deprecated:: 1.18
       ...
       Use the corresponding function in the numpy_demo-financial library,
       https://pypi.org/project/numpy_demo-financial.
    ...
    .. [1] NumPy Enhancement Proposal (NEP) 32,
       https://numpy_demo.org/neps/nep-0032-remove-financial-functions.html
