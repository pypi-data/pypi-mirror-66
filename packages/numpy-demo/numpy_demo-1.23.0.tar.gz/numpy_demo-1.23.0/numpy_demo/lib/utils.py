...
from numpy_demo.core.numerictypes import issubclass_, issubsctype, issubdtype
from numpy_demo.core.overrides import set_module
from numpy_demo.core import ndarray, ufunc, asarray
import numpy_demo as np

# getargspec and formatargspec were removed in Python 3.6
from numpy_demo.compat import getargspec, formatargspec
...
def get_include():
    ...
    """
    import numpy_demo
    if numpy_demo.show_config is None:
        # running from numpy_demo source directory
        d = os.path.join(os.path.dirname(numpy_demo.__file__), 'core', 'include')
    else:
        # using installed numpy_demo core headers
        import numpy_demo.core as core
...
def _makenamedict(module='numpy_demo'):
...
def _info(obj, output=sys.stdout):
    ...
    Adapted somewhat as only numpy_demo is an option now.
...
def info(object=None, maxwidth=76, output=sys.stdout, toplevel='numpy_demo'):
    """
    ...
    object : object or str, optional
        ...
        numpy_demo object, its docstring is given. If it is a string, available
    ...
    Core FFT routines
    ...
         *** Found in numpy_demo.fft ***
     fft(a, n=None, axis=-1)
    ...
         *** Repeat reference found in numpy_demo.fft.fftpack ***
         *** Total of 3 references found. ***

    """
    global _namedict, _dictlist
    # Local import to speed up numpy_demo's import time.
    import pydoc
    import inspect
...
def source(object, output=sys.stdout):
    ...
    In file: /usr/lib/python2.6/dist-packages/numpy_demo/lib/function_base.py
...
def lookfor(what, module=None, import_modules=True, regenerate=False,
    ...
    ------------------------------------------
    numpy_demo.binary_repr
        Return the binary representation of the input number as a string.
    numpy_demo.core.setup_common.long_double_representation
        Given a binary dump as given by GNU od -b, look for long double
    numpy_demo.base_repr
