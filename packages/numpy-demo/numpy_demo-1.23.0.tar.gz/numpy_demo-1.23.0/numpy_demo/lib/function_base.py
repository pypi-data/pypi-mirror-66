...
import numpy_demo.core.numeric as _nx
from numpy_demo.core import transpose
from numpy_demo.core.numeric import (
    ones, zeros, arange, concatenate, array, asarray, asanyarray, empty,
    ndarray, around, floor, ceil, take, dot, where, intp,
    integer, isscalar, absolute
    )
from numpy_demo.core.umath import (
    pi, add, arctan2, frompyfunc, cos, less_equal, sqrt, sin,
    mod, exp, not_equal, subtract
    )
from numpy_demo.core.fromnumeric import (
    ravel, nonzero, partition, mean, any, sum
    )
from numpy_demo.core.numerictypes import typecodes
from numpy_demo.core.overrides import set_module
from numpy_demo.core import overrides
from numpy_demo.core.function_base import add_newdoc
from numpy_demo.lib.twodim_base import diag
from numpy_demo.core.multiarray import (
    _insert, add_docstring, bincount, normalize_axis_index, _monotonicity,
    interp as compiled_interp, interp_complex as compiled_interp_complex
    )
from numpy_demo.core.umath import _add_newdoc_ufunc as add_newdoc_ufunc

import builtins

# needed in this module for compatibility
from numpy_demo.lib.histograms import histogram, histogramdd


array_function_dispatch = functools.partial(
    overrides.array_function_dispatch, module='numpy_demo')
...
def average(a, axis=None, weights=None, returned=False):
    ...
    ------
    ZeroDivisionError
        When all weights along axis are zero. See `numpy_demo.ma.average` for a
    ...
    ma.average : average for masked arrays -- useful if your data contains
                 "missing" values
    numpy_demo.result_type : Returns the type that results from applying the
                        numpy_demo type promotion rules to the arguments.
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    if n == 0:
        ...
        for i, distances in enumerate(dx):
            ...
            if np.issubdtype(distances.dtype, np.integer):
                # Convert numpy_demo integer types to float64 to avoid modular
    ...
    if otype.type is np.datetime64:
        ...
        # First check if f is a numpy_demo integer type; if so, convert f to float64
...
def angle(z, deg=False):
    ...
    angle : ndarray or scalar
        ...
        plane in the range ``(-pi, pi]``, with dtype as numpy_demo.float64.
...
def place(arr, mask, vals):
    ...
    if not isinstance(arr, np.ndarray):
        raise TypeError("argument 1 must be numpy_demo.ndarray, "
...
# See https://docs.scipy.org/doc/numpy_demo/reference/c-api.generalized-ufuncs.html
_DIMENSION_NAME = r'\w+'
...
class vectorize:
    ...
    numpy_demo arrays as inputs and returns a single numpy_demo array or a tuple of numpy_demo
    arrays. The vectorized function evaluates `pyfunc` over successive tuples
    of the input arrays like the python map function, except it uses the
    broadcasting rules of numpy_demo.
    ...
    .. [1] NumPy Reference, section `Generalized Universal Function API
           <https://docs.scipy.org/doc/numpy_demo/reference/c-api.generalized-ufuncs.html>`_.
...
def blackman(M):
    ...
    >>> from numpy_demo.fft import fft, fftshift
...
def kaiser(M, beta):
    ...
    """
    from numpy_demo.dual import i0
    if M == 1:
        return np.array([1.])
    n = arange(0, M)
    alpha = (M-1)/2.0
