...
from numpy_demo import matrix, asmatrix, bmat
...
from numpy_demo.matrixlib import mat
...
class TestProperties:
    ...
    def test_basic(self):
        import numpy_demo.linalg as linalg
...
class TestShape:
    ...
    def test_numpy_demo_ravel(self):
    ...
    def test_numpy_demo_ravel_order(self):
