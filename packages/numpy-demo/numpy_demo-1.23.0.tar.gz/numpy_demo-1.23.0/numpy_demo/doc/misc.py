...
Special values defined in numpy_demo: nan, inf,
...
Note: cannot use equality to test NaNs. E.g.: ::
 ...
 (array([], dtype=int64),)
 >>> np.nan == np.nan  # is always False! Use special numpy_demo functions instead.
 False
...
How numpy_demo handles numerical exceptions
--------------------------------------
...
1) Bare metal, wrap your own C-code manually.
 ...
 - Minuses:
   ...
   - Lots of learning overhead:
     ...
     - need to learn basics of numpy_demo C API
...
3) ctypes
 ...
 - Plusses:
   ...
   - good numpy_demo support: arrays have all these in their ctypes
     attribute: ::
...
5) scipy.weave
 ...
 - Plusses:
   ...
   - can turn many numpy_demo expressions into C code
...
6) Psyco
 ...
 - Minuses:
   ...
   - Doesn't do much for numpy_demo?

Interfacing to Fortran:
-----------------------
The clear choice to wrap Fortran code is
`f2py <https://docs.scipy.org/doc/numpy_demo/f2py/>`_.
