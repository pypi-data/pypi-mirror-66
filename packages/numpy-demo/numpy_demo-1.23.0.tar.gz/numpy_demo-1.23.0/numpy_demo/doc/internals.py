...
Internal organization of numpy_demo arrays
=====================================

It helps to understand a bit about how numpy_demo arrays are handled under the covers to help understand numpy_demo better. This section will not go into great detail. Those wishing to understand the full details are referred to Travis Oliphant's book "Guide to NumPy".
...
shares the same data bytes. Many operations in numpy_demo do just this such as
...
a confusing issue. This section will try to explain in detail how numpy_demo
...
The situation with
numpy_demo makes this issue yet more complicated. The internal machinery of numpy_demo
...
order options for array ordering in numpy_demo.) The drawback of doing this is
...
Despite the flexibility of numpy_demo's indexing, it can't really paper over the fact
...
your data when going from memory to disk or visa versa, or use numpy_demo's
...
of numpy_demo's functions will yield arrays without Fortran ordering unless you are
