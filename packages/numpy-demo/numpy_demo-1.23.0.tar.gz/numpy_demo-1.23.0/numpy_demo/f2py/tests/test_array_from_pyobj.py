...
from numpy_demo.testing import assert_, assert_equal
from numpy_demo.core.multiarray import typeinfo
from . import util
...
# when numpy_demo gains an aligned allocator the tests could be enabled again
