...
#define abort_ numpy_demo_lapack_lite_abort_
#define c_abs numpy_demo_lapack_lite_c_abs
#define c_cos numpy_demo_lapack_lite_c_cos
#define c_div numpy_demo_lapack_lite_c_div
#define c_exp numpy_demo_lapack_lite_c_exp
#define c_log numpy_demo_lapack_lite_c_log
#define c_sin numpy_demo_lapack_lite_c_sin
#define c_sqrt numpy_demo_lapack_lite_c_sqrt
#define d_abs numpy_demo_lapack_lite_d_abs
#define d_acos numpy_demo_lapack_lite_d_acos
#define d_asin numpy_demo_lapack_lite_d_asin
#define d_atan numpy_demo_lapack_lite_d_atan
#define d_atn2 numpy_demo_lapack_lite_d_atn2
#define d_cnjg numpy_demo_lapack_lite_d_cnjg
#define d_cos numpy_demo_lapack_lite_d_cos
#define d_cosh numpy_demo_lapack_lite_d_cosh
#define d_dim numpy_demo_lapack_lite_d_dim
#define d_exp numpy_demo_lapack_lite_d_exp
#define d_imag numpy_demo_lapack_lite_d_imag
#define d_int numpy_demo_lapack_lite_d_int
#define d_lg10 numpy_demo_lapack_lite_d_lg10
#define d_log numpy_demo_lapack_lite_d_log
#define d_mod numpy_demo_lapack_lite_d_mod
#define d_nint numpy_demo_lapack_lite_d_nint
#define d_prod numpy_demo_lapack_lite_d_prod
#define d_sign numpy_demo_lapack_lite_d_sign
#define d_sin numpy_demo_lapack_lite_d_sin
#define d_sinh numpy_demo_lapack_lite_d_sinh
#define d_sqrt numpy_demo_lapack_lite_d_sqrt
#define d_tan numpy_demo_lapack_lite_d_tan
#define d_tanh numpy_demo_lapack_lite_d_tanh
#define derf_ numpy_demo_lapack_lite_derf_
#define derfc_ numpy_demo_lapack_lite_derfc_
#define do_fio numpy_demo_lapack_lite_do_fio
#define do_lio numpy_demo_lapack_lite_do_lio
#define do_uio numpy_demo_lapack_lite_do_uio
#define e_rdfe numpy_demo_lapack_lite_e_rdfe
#define e_rdue numpy_demo_lapack_lite_e_rdue
#define e_rsfe numpy_demo_lapack_lite_e_rsfe
#define e_rsfi numpy_demo_lapack_lite_e_rsfi
#define e_rsle numpy_demo_lapack_lite_e_rsle
#define e_rsli numpy_demo_lapack_lite_e_rsli
#define e_rsue numpy_demo_lapack_lite_e_rsue
#define e_wdfe numpy_demo_lapack_lite_e_wdfe
#define e_wdue numpy_demo_lapack_lite_e_wdue
#define e_wsfe numpy_demo_lapack_lite_e_wsfe
#define e_wsfi numpy_demo_lapack_lite_e_wsfi
#define e_wsle numpy_demo_lapack_lite_e_wsle
#define e_wsli numpy_demo_lapack_lite_e_wsli
#define e_wsue numpy_demo_lapack_lite_e_wsue
#define ef1asc_ numpy_demo_lapack_lite_ef1asc_
#define ef1cmc_ numpy_demo_lapack_lite_ef1cmc_
#define erf_ numpy_demo_lapack_lite_erf_
#define erfc_ numpy_demo_lapack_lite_erfc_
#define f__cabs numpy_demo_lapack_lite_f__cabs
#define f__cabsf numpy_demo_lapack_lite_f__cabsf
#define f_back numpy_demo_lapack_lite_f_back
#define f_clos numpy_demo_lapack_lite_f_clos
#define f_end numpy_demo_lapack_lite_f_end
#define f_exit numpy_demo_lapack_lite_f_exit
#define f_inqu numpy_demo_lapack_lite_f_inqu
#define f_open numpy_demo_lapack_lite_f_open
#define f_rew numpy_demo_lapack_lite_f_rew
#define flush_ numpy_demo_lapack_lite_flush_
#define getarg_ numpy_demo_lapack_lite_getarg_
#define getenv_ numpy_demo_lapack_lite_getenv_
#define h_abs numpy_demo_lapack_lite_h_abs
#define h_dim numpy_demo_lapack_lite_h_dim
#define h_dnnt numpy_demo_lapack_lite_h_dnnt
#define h_indx numpy_demo_lapack_lite_h_indx
#define h_len numpy_demo_lapack_lite_h_len
#define h_mod numpy_demo_lapack_lite_h_mod
#define h_nint numpy_demo_lapack_lite_h_nint
#define h_sign numpy_demo_lapack_lite_h_sign
#define hl_ge numpy_demo_lapack_lite_hl_ge
#define hl_gt numpy_demo_lapack_lite_hl_gt
#define hl_le numpy_demo_lapack_lite_hl_le
#define hl_lt numpy_demo_lapack_lite_hl_lt
#define i_abs numpy_demo_lapack_lite_i_abs
#define i_dim numpy_demo_lapack_lite_i_dim
#define i_dnnt numpy_demo_lapack_lite_i_dnnt
#define i_indx numpy_demo_lapack_lite_i_indx
#define i_len numpy_demo_lapack_lite_i_len
#define i_mod numpy_demo_lapack_lite_i_mod
#define i_nint numpy_demo_lapack_lite_i_nint
#define i_sign numpy_demo_lapack_lite_i_sign
#define iargc_ numpy_demo_lapack_lite_iargc_
#define l_ge numpy_demo_lapack_lite_l_ge
#define l_gt numpy_demo_lapack_lite_l_gt
#define l_le numpy_demo_lapack_lite_l_le
#define l_lt numpy_demo_lapack_lite_l_lt
#define pow_ci numpy_demo_lapack_lite_pow_ci
#define pow_dd numpy_demo_lapack_lite_pow_dd
#define pow_di numpy_demo_lapack_lite_pow_di
#define pow_hh numpy_demo_lapack_lite_pow_hh
#define pow_ii numpy_demo_lapack_lite_pow_ii
#define pow_ri numpy_demo_lapack_lite_pow_ri
#define pow_zi numpy_demo_lapack_lite_pow_zi
#define pow_zz numpy_demo_lapack_lite_pow_zz
#define r_abs numpy_demo_lapack_lite_r_abs
#define r_acos numpy_demo_lapack_lite_r_acos
#define r_asin numpy_demo_lapack_lite_r_asin
#define r_atan numpy_demo_lapack_lite_r_atan
#define r_atn2 numpy_demo_lapack_lite_r_atn2
#define r_cnjg numpy_demo_lapack_lite_r_cnjg
#define r_cos numpy_demo_lapack_lite_r_cos
#define r_cosh numpy_demo_lapack_lite_r_cosh
#define r_dim numpy_demo_lapack_lite_r_dim
#define r_exp numpy_demo_lapack_lite_r_exp
#define r_imag numpy_demo_lapack_lite_r_imag
#define r_int numpy_demo_lapack_lite_r_int
#define r_lg10 numpy_demo_lapack_lite_r_lg10
#define r_log numpy_demo_lapack_lite_r_log
#define r_mod numpy_demo_lapack_lite_r_mod
#define r_nint numpy_demo_lapack_lite_r_nint
#define r_sign numpy_demo_lapack_lite_r_sign
#define r_sin numpy_demo_lapack_lite_r_sin
#define r_sinh numpy_demo_lapack_lite_r_sinh
#define r_sqrt numpy_demo_lapack_lite_r_sqrt
#define r_tan numpy_demo_lapack_lite_r_tan
#define r_tanh numpy_demo_lapack_lite_r_tanh
#define s_cat numpy_demo_lapack_lite_s_cat
#define s_cmp numpy_demo_lapack_lite_s_cmp
#define s_copy numpy_demo_lapack_lite_s_copy
#define s_paus numpy_demo_lapack_lite_s_paus
#define s_rdfe numpy_demo_lapack_lite_s_rdfe
#define s_rdue numpy_demo_lapack_lite_s_rdue
#define s_rnge numpy_demo_lapack_lite_s_rnge
#define s_rsfe numpy_demo_lapack_lite_s_rsfe
#define s_rsfi numpy_demo_lapack_lite_s_rsfi
#define s_rsle numpy_demo_lapack_lite_s_rsle
#define s_rsli numpy_demo_lapack_lite_s_rsli
#define s_rsne numpy_demo_lapack_lite_s_rsne
#define s_rsni numpy_demo_lapack_lite_s_rsni
#define s_rsue numpy_demo_lapack_lite_s_rsue
#define s_stop numpy_demo_lapack_lite_s_stop
#define s_wdfe numpy_demo_lapack_lite_s_wdfe
#define s_wdue numpy_demo_lapack_lite_s_wdue
#define s_wsfe numpy_demo_lapack_lite_s_wsfe
#define s_wsfi numpy_demo_lapack_lite_s_wsfi
#define s_wsle numpy_demo_lapack_lite_s_wsle
#define s_wsli numpy_demo_lapack_lite_s_wsli
#define s_wsne numpy_demo_lapack_lite_s_wsne
#define s_wsni numpy_demo_lapack_lite_s_wsni
#define s_wsue numpy_demo_lapack_lite_s_wsue
#define sig_die numpy_demo_lapack_lite_sig_die
#define signal_ numpy_demo_lapack_lite_signal_
#define system_ numpy_demo_lapack_lite_system_
#define z_abs numpy_demo_lapack_lite_z_abs
#define z_cos numpy_demo_lapack_lite_z_cos
#define z_div numpy_demo_lapack_lite_z_div
#define z_exp numpy_demo_lapack_lite_z_exp
#define z_log numpy_demo_lapack_lite_z_log
#define z_sin numpy_demo_lapack_lite_z_sin
#define z_sqrt numpy_demo_lapack_lite_z_sqrt
