...
from numpy_demo.compat import long, unicode
...
def maximum_sctype(t):
    ...
    <class 'numpy_demo.uint64'>
    >>> np.maximum_sctype(complex)
    <class 'numpy_demo.complex256'> # may vary

    >>> np.maximum_sctype(str)
    <class 'numpy_demo.str_'>

    >>> np.maximum_sctype('i2')
    <class 'numpy_demo.int64'>
    >>> np.maximum_sctype('f4')
    <class 'numpy_demo.float128'> # may vary
...
def issubdtype(arg1, arg2):
    ...
    numpy_demo.core.numerictypes : Overview of numpy_demo type hierarchy.
