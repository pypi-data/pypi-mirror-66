        ...
        PyObject *initial, PyArrayObject *wheremask)
{
    ...
    npy_cache_import("numpy_demo", "_NoValue", &NoValue);
...
ufunc_outer(PyUFuncObject *ufunc, PyObject *args, PyObject *kwds)
{
    ...
    static PyObject *_numpy_demo_matrix;
    ...
    if (PyObject_IsInstance(tmp, _numpy_demo_matrix)) {
