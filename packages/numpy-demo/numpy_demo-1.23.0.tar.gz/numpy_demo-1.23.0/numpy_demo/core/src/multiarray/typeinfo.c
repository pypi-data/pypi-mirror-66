/*
 * Provides namedtuples for numpy_demo.core.multiarray.typeinfo
...
static PyStructSequence_Desc typeinfo_desc = {
    "numpy_demo.core.multiarray.typeinfo",         /* name          */
    "Information about a scalar numpy_demo type",  /* doc           */
    typeinfo_fields,                          /* fields        */
    5,                                        /* n_in_sequence */
};

static PyStructSequence_Desc typeinforanged_desc = {
    "numpy_demo.core.multiarray.typeinforanged",                /* name          */
    "Information about a scalar numpy_demo type with a range",  /* doc           */
