...
/*  Aided by Peter J. Verveer's  nd_image package and numpy_demo's arraymap  ****/
...
NPY_NO_EXPORT PyTypeObject PyArrayNeighborhoodIter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "numpy_demo.neigh_internal_iter",
