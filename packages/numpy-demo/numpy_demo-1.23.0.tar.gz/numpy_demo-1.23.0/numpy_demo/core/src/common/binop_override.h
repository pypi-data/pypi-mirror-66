 ...
 * which are being phased out -- see https://github.com/numpy_demo/numpy_demo/pull/5864)
 *
 ...
 *   all use cases. (See https://github.com/numpy_demo/numpy_demo/issues/5844 for lots
 *   of discussion of this, and in particular
 *     https://github.com/numpy_demo/numpy_demo/issues/5844#issuecomment-112014014
...
binop_should_defer(PyObject *self, PyObject *other, int inplace)
{
     ...
     *    numpy_demo.ma.core.MaskedArray._delegate_binop
