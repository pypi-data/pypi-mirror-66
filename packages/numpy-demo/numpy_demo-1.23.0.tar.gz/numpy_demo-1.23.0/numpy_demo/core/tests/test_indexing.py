...
from numpy_demo.core._multiarray_tests import array_indexing
...
class TestMultiIndexingAutomated:
    ...
    NOTE:
        ...
        * Behavior was written to match numpy_demo version 1.8. (though a
    ...
    def _get_multi_index(self, arr, indices):
        ...
        for i, indx in enumerate(in_indices):
            ...
            if not isinstance(indx, np.ndarray):
                # This could be open for changes in numpy_demo.
                # numpy_demo should maybe raise an error if casting to intp
