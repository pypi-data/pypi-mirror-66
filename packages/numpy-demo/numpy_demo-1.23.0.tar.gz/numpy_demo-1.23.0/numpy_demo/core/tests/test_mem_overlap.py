...
from numpy_demo.core._multiarray_tests import solve_diophantine, internal_overlap
from numpy_demo.core import _umath_tests
...
def view_element_first_byte(x):
    ...
    from numpy_demo.lib.stride_tricks import DummyArray
