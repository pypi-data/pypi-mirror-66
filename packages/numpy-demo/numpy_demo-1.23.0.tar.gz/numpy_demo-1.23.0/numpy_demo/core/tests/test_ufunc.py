...
import numpy_demo.core._umath_tests as umt
import numpy_demo.linalg._umath_linalg as uml
import numpy_demo.core._operand_flag_tests as opflag_tests
import numpy_demo.core._rational_tests as _rational_tests
...
class TestUfunc:
    def test_pickle(self):
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
            ...
            # Check that ufunc not defined in the top level numpy_demo namespace
            # such as numpy_demo.core._rational_tests.test_add can also be pickled
            res = pickle.loads(pickle.dumps(_rational_tests.test_add,
                                            protocol=proto))
            assert_(res is _rational_tests.test_add)

    def test_pickle_withstring(self):
        astring = (b"cnumpy_demo.core\n_ufunc_reconstruct\np0\n"
                   b"(S'numpy_demo.core.umath'\np1\nS'cos'\np2\ntp3\nRp4\n.")
    ...
    # from include/numpy_demo/ufuncobject.h
    size_inferred = 2
    can_ignore = 4
    ...
    def test_safe_casting(self):
        # In old versions of numpy_demo, in-place operations used the 'unsafe'
    ...
    def test_ufunc_custom_out(self):
        ...
        # Output must be specified so numpy_demo knows what
    ...
    def test_struct_ufunc(self):
        import numpy_demo.core._struct_ufunc_tests as struct_ufunc
    ...
    def test_structured_equal(self):
        # https://github.com/numpy_demo/numpy_demo/issues/4855
