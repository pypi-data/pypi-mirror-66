...
from numpy_demo.core import umath
from numpy_demo.random import rand, randint, randn
...
from hypothesis.extra import numpy_demo as hynp
...
class TestIsscalar:
    def test_isscalar(self):
        ...
        assert_(np.isscalar('numpy_demo'))
