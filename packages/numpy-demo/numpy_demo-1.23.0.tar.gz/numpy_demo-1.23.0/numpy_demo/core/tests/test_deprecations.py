...
from numpy_demo.core._multiarray_tests import fromstring_null_term_c_api
...
class TestNPY_CHAR(_DeprecationTestCase):
    ...
    def test_npy_char_deprecation(self):
        from numpy_demo.core._multiarray_tests import npy_char_deprecation
...
class TestPyArray_AS1D(_DeprecationTestCase):
    def test_npy_pyarrayas1d_deprecation(self):
        from numpy_demo.core._multiarray_tests import npy_pyarrayas1d_deprecation
...
class TestPyArray_AS2D(_DeprecationTestCase):
    def test_npy_pyarrayas2d_deprecation(self):
        from numpy_demo.core._multiarray_tests import npy_pyarrayas2d_deprecation
...
class Test_UPDATEIFCOPY(_DeprecationTestCase):
    ...
    def test_npy_updateifcopy_deprecation(self):
        from numpy_demo.core._multiarray_tests import npy_updateifcopy_deprecation
...
class Test_GetSet_NumericOps(_DeprecationTestCase):
    ...
    def test_get_numeric_ops(self):
        from numpy_demo.core._multiarray_tests import getset_numericops
