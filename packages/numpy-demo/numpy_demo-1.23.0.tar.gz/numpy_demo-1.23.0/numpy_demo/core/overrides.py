...
from numpy_demo.core._multiarray_umath import (
    add_docstring, implement_array_function, _get_implementing_args)
from numpy_demo.compat._inspect import getargspec
...
def set_module(module):
    ...
    Example usage::
        ...
        assert example.__module__ == 'numpy_demo'
    """
    def decorator(func):
...
def array_function_dispatch(dispatcher, module=None, verify=True,
    ...
    module : str, optional
        __module__ attribute to set on new function, e.g., ``module='numpy_demo'``.
