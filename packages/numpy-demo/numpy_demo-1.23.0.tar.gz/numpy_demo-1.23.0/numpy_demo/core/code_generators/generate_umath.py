...
def english_upper(s):
    ...
    Examples
    --------
    >>> from numpy_demo.lib.utils import english_upper
...
'add':
    Ufunc(2, 1, Zero,
          docstrings.get('numpy_demo.core.umath.add'),
...
'subtract':
    Ufunc(2, 1, None, # Zero is only a unit to the right, not the left
          docstrings.get('numpy_demo.core.umath.subtract'),
...
'multiply':
    Ufunc(2, 1, One,
          docstrings.get('numpy_demo.core.umath.multiply'),
...
'floor_divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          docstrings.get('numpy_demo.core.umath.floor_divide'),
...
'true_divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          docstrings.get('numpy_demo.core.umath.true_divide'),
...
'conjugate':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.conjugate'),
          None,
...
'fmod':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.fmod'),
          None,
          TD(ints),
...
'square':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.square'),
          None,
...
'reciprocal':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.reciprocal'),
          None,
          TD(ints+inexact, simd=[('avx2', ints), ('fma', 'fd'), ('avx512f','fd')]),
          TD(O, f='Py_reciprocal'),
          ),
# This is no longer used as numpy_demo.ones_like, however it is
# still used by some internal calls.
'_ones_like':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath._ones_like'),
...
'power':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.power'),
          None,
          TD(ints),
...
'float_power':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.float_power'),
          None,
          TD('dgDG', f='pow'),
          ),
'absolute':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.absolute'),
...
'_arg':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath._arg'),
          None,
          TD(cmplx, out=('f', 'd', 'g')),
          ),
'negative':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.negative'),
...
'positive':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.positive'),
...
'sign':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.sign'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(nobool_or_datetime),
          ),
'greater':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.greater'),
...
'greater_equal':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.greater_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          [TypeDescription('O', FullTypeDescr, 'OO', 'O')],
          TD('O', out='?'),
...
'less':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.less'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          [TypeDescription('O', FullTypeDescr, 'OO', 'O')],
          TD('O', out='?'),
...
'less_equal':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.less_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          [TypeDescription('O', FullTypeDescr, 'OO', 'O')],
          TD('O', out='?'),
...
'equal':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          [TypeDescription('O', FullTypeDescr, 'OO', 'O')],
          TD('O', out='?'),
...
'not_equal':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.not_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          [TypeDescription('O', FullTypeDescr, 'OO', 'O')],
          TD('O', out='?'),
...
'logical_and':
    Ufunc(2, 1, True_,
          docstrings.get('numpy_demo.core.umath.logical_and'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'logical_not':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.logical_not'),
          None,
          TD(nodatetime_or_obj, out='?', simd=[('avx2', ints)]),
...
'logical_or':
    Ufunc(2, 1, False_,
          docstrings.get('numpy_demo.core.umath.logical_or'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(nodatetime_or_obj, out='?', simd=[('avx2', ints)]),
...
'logical_xor':
    Ufunc(2, 1, False_,
          docstrings.get('numpy_demo.core.umath.logical_xor'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'maximum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('numpy_demo.core.umath.maximum'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
...
'minimum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('numpy_demo.core.umath.minimum'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(noobj, simd=[('avx512f', 'fd')]),
...
'clip':
    Ufunc(3, 1, ReorderableNone,
          docstrings.get('numpy_demo.core.umath.clip'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(noobj),
...
'fmax':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('numpy_demo.core.umath.fmax'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(noobj),
          TD(O, f='npy_ObjectMax')
          ),
'fmin':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('numpy_demo.core.umath.fmin'),
          'PyUFunc_SimpleUniformOperationTypeResolver',
          TD(noobj),
          TD(O, f='npy_ObjectMin')
          ),
'logaddexp':
    Ufunc(2, 1, MinusInfinity,
          docstrings.get('numpy_demo.core.umath.logaddexp'),
          None,
          TD(flts, f="logaddexp", astype={'e':'f'})
          ),
'logaddexp2':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.logaddexp2'),
          None,
          TD(flts, f="logaddexp2", astype={'e':'f'})
          ),
'bitwise_and':
    Ufunc(2, 1, AllOnes,
          docstrings.get('numpy_demo.core.umath.bitwise_and'),
          None,
...
'bitwise_or':
    Ufunc(2, 1, Zero,
          docstrings.get('numpy_demo.core.umath.bitwise_or'),
          None,
          TD(bints, simd=[('avx2', ints)]),
          TD(O, f='PyNumber_Or'),
          ),
'bitwise_xor':
    Ufunc(2, 1, Zero,
          docstrings.get('numpy_demo.core.umath.bitwise_xor'),
          None,
          TD(bints, simd=[('avx2', ints)]),
          TD(O, f='PyNumber_Xor'),
          ),
'invert':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.invert'),
          None,
          TD(bints, simd=[('avx2', ints)]),
...
'left_shift':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.left_shift'),
          None,
...
'right_shift':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.right_shift'),
          None,
          TD(ints, simd=[('avx2', ints)]),
...
'heaviside':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.heaviside'),
          None,
          TD(flts, f='heaviside', astype={'e':'f'}),
          ),
'degrees':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.degrees'),
          None,
          TD(fltsP, f='degrees', astype={'e':'f'}),
          ),
'rad2deg':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.rad2deg'),
          None,
          TD(fltsP, f='rad2deg', astype={'e':'f'}),
          ),
'radians':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.radians'),
          None,
          TD(fltsP, f='radians', astype={'e':'f'}),
          ),
'deg2rad':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.deg2rad'),
          None,
          TD(fltsP, f='deg2rad', astype={'e':'f'}),
          ),
'arccos':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arccos'),
          None,
...
'arccosh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arccosh'),
          None,
...
'arcsin':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arcsin'),
          None,
...
'arcsinh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arcsinh'),
          None,
...
'arctan':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arctan'),
          None,
...
'arctanh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.arctanh'),
          None,
...
'cos':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.cos'),
          None,
...
'sin':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.sin'),
          None,
...
'tan':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.tan'),
          None,
...
'cosh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.cosh'),
          None,
...
'sinh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.sinh'),
          None,
...
'tanh':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.tanh'),
          None,
...
'exp':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.exp'),
          None,
...
'exp2':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.exp2'),
          None,
...
'expm1':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.expm1'),
          None,
...
'log':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.log'),
          None,
...
'log2':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.log2'),
          None,
...
'log10':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.log10'),
          None,
...
'log1p':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.log1p'),
          None,
...
'sqrt':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.sqrt'),
          None,
...
'cbrt':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.cbrt'),
          None,
...
'ceil':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.ceil'),
          None,
...
'trunc':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.trunc'),
          None,
...
'fabs':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.fabs'),
          None,
...
'floor':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.floor'),
          None,
...
'rint':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.rint'),
          None,
...
'arctan2':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.arctan2'),
          None,
...
'remainder':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.remainder'),
...
'divmod':
    Ufunc(2, 2, None,
          docstrings.get('numpy_demo.core.umath.divmod'),
...
'hypot':
    Ufunc(2, 1, Zero,
          docstrings.get('numpy_demo.core.umath.hypot'),
          None,
...
'isnan':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.isnan'),
          'PyUFunc_IsFiniteTypeResolver',
          TD(noobj, out='?'),
          ),
'isnat':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.isnat'),
          'PyUFunc_IsNaTTypeResolver',
          TD(times, out='?'),
          ),
'isinf':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.isinf'),
          'PyUFunc_IsFiniteTypeResolver',
          TD(noobj, out='?'),
          ),
'isfinite':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.isfinite'),
          'PyUFunc_IsFiniteTypeResolver',
          TD(noobj, out='?'),
          ),
'signbit':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.signbit'),
          None,
          TD(flts, out='?'),
          ),
'copysign':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.copysign'),
          None,
          TD(flts),
          ),
'nextafter':
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.nextafter'),
          None,
          TD(flts),
          ),
'spacing':
    Ufunc(1, 1, None,
          docstrings.get('numpy_demo.core.umath.spacing'),
          None,
          TD(flts),
          ),
'modf':
    Ufunc(1, 2, None,
          docstrings.get('numpy_demo.core.umath.modf'),
          None,
          TD(flts),
          ),
'ldexp' :
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.ldexp'),
          None,
...
'frexp' :
    Ufunc(1, 2, None,
          docstrings.get('numpy_demo.core.umath.frexp'),
          None,
...
'gcd' :
    Ufunc(2, 1, Zero,
          docstrings.get('numpy_demo.core.umath.gcd'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(ints),
...
'lcm' :
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.lcm'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(ints),
...
'matmul' :
    Ufunc(2, 1, None,
          docstrings.get('numpy_demo.core.umath.matmul'),
          "PyUFunc_SimpleUniformOperationTypeResolver",
          TD(notimes_or_obj),
          TD(O),
