...
#include <string.h> /* for memcpy */
    ...
    #define NPY_CPU_ALPHA
        ...
        #endif
    #else
        # error Unknown ARM CPU, please report this to numpy_demo maintainers with \
...
#else
    #error Unknown CPU, please report this to numpy_demo maintainers with \
    information about your platform (OS, CPU and compiler)
#endif
