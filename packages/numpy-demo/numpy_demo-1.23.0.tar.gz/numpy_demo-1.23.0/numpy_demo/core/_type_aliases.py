"""
Due to compatibility, numpy_demo has a very large number of different naming
conventions for the scalar types (those subclassing from `numpy_demo.generic`).
...
from numpy_demo.compat import unicode
from numpy_demo._globals import VisibleDeprecationWarning
from numpy_demo.core._string_helpers import english_lower, english_capitalize
from numpy_demo.core.multiarray import typeinfo, dtype
from numpy_demo.core._dtype import _kind_name
...
class TypeNADict(dict):
    def __getitem__(self, key):
        ...
        warnings.warn('sctypeNA and typeNA will be removed in v1.18 '
                      'of numpy_demo', VisibleDeprecationWarning, stacklevel=2)
