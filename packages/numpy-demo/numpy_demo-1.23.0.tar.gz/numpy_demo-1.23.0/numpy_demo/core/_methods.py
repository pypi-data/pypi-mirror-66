...
from numpy_demo.core import multiarray as mu
from numpy_demo.core import umath as um
from numpy_demo.core._asarray import asanyarray
from numpy_demo.core import numerictypes as nt
from numpy_demo.core import _exceptions
from numpy_demo._globals import _NoValue
from numpy_demo.compat import pickle, os_fspath, contextlib_nullcontext
...
def _clip_dep_is_scalar_nan(a):
    ...
    from numpy_demo.core.fromnumeric import ndim
    if ndim(a) != 0:
        return False
    try:
        return um.isnan(a)
