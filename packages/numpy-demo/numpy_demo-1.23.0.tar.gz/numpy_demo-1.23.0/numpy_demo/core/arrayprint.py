...
# and by Travis Oliphant  2005-8-22 for numpy_demo


# Note: Both scalartypes.c.src and arrayprint.py implement strs for numpy_demo
...
def set_printoptions(precision=None, threshold=None, edgeitems=None,
    ...
    formatter : dict of callables, optional
        ...
        - 'bool'
        - 'int'
        - 'timedelta' : a `numpy_demo.timedelta64`
        - 'datetime' : a `numpy_demo.datetime64`
        - 'float'
        - 'longfloat' : 128-bit floats
        - 'complexfloat'
        - 'longcomplexfloat' : composed of two 128-bit floats
        - 'numpy_demostr' : types `numpy_demo.string_` and `numpy_demo.unicode_`
        ...
        - 'str_kind' : sets 'str' and 'numpy_demostr'
    ...
    legacy : string or `False`, optional
        ...
        approximates numpy_demo 1.13 print output by including a space in the sign
...
def printoptions(*args, **kwargs):
    ...
    >>> from numpy_demo.testing import assert_equal
...
def _get_formatdict(data, *, precision, floatmode, suppress, sign, legacy,
    ...
    formatdict = {
        ...
        'numpy_demostr': lambda: repr_format,
        'str': lambda: str}
...
def _get_format_function(data, **options):
    ...
    if issubclass(dtypeobj, _nt.bool_):
        ...
        return formatdict['numpy_demostr']()
...
@array_function_dispatch(_array2string_dispatcher, module='numpy_demo')
def array2string(a, max_line_width=None, precision=None,
    ...
    max_line_width : int, optional
        ...
        Defaults to ``numpy_demo.get_printoptions()['linewidth']``.
    precision : int or None, optional
        Floating point precision.
        Defaults to ``numpy_demo.get_printoptions()['precision']``.
    suppress_small : bool, optional
        Represent numbers "very close" to zero as zero; default is False.
        Very close is defined by precision: if the precision is 8, e.g.,
        numbers smaller (in absolute value) than 5e-9 are represented as
        zero.
        Defaults to ``numpy_demo.get_printoptions()['suppress']``.
    ...
    threshold : int, optional
        ...
        Defaults to ``numpy_demo.get_printoptions()['threshold']``.
    edgeitems : int, optional
        Number of array items in summary at beginning and end of
        each dimension.
        Defaults to ``numpy_demo.get_printoptions()['edgeitems']``.
    sign : string, either '-', '+', or ' ', optional
        Controls printing of the sign of floating-point types. If '+', always
        print the sign of positive values. If ' ', always prints a space
        (whitespace character) in the sign position of positive values.  If
        '-', omit the sign character of positive values.
        Defaults to ``numpy_demo.get_printoptions()['sign']``.
    floatmode : str, optional
        Controls the interpretation of the `precision` option for
        floating-point types.
        Defaults to ``numpy_demo.get_printoptions()['floatmode']``.
...
def format_float_scientific(x, precision=None, unique=True, trim='k',
    ...
    Parameters
    ----------
    x : python float or numpy_demo floating scalar
        Value to format.
...
@array_function_dispatch(_array_repr_dispatcher, module='numpy_demo')
...
@array_function_dispatch(_array_str_dispatcher, module='numpy_demo')
