...
cdef extern from "numpy_demo/arrayobject.h":
    ...
    ctypedef class numpy_demo.dtype [object PyArray_Descr, check_size ignore]:
    ...
    ctypedef extern class numpy_demo.flatiter [object PyArrayIterObject, check_size ignore]:
        # Use through macros
        pass

    ctypedef extern class numpy_demo.broadcast [object PyArrayMultiIterObject, check_size ignore]:
        cdef int numiter
    ...
    ctypedef class numpy_demo.ndarray [object PyArrayObject, check_size ignore]:
        ...
        def __releasebuffer__(ndarray self, Py_buffer* info):
            ...
            # the function is NULL in numpy_demo, we rely on refcounting to release
...
# numpy_demo.int corresponds to 'l' and numpy_demo.long to 'q'
...
cdef inline char* _util_dtypestring(dtype descr, char* f, char* end, int* offset) except NULL:
    ...
    for childname in descr.names:
        ...
        if (end - f) - <int>(new_offset - offset[0]) < 15:
            raise RuntimeError(u"Format string allocated too short, see comment in numpy_demo.pxd")
        ...
        if not PyDataType_HASFIELDS(child):
            ...
            if   t == NPY_BYTE:        f[0] =  98 #"b"
                ...
                raise ValueError(u"unknown dtype code in numpy_demo.pxd (%d)" % t)
            f += 1
        else:
...
cdef extern from "numpy_demo/ufuncobject.h":

    ctypedef void (*PyUFuncGenericFunction) (char **, npy_intp *, npy_intp *, void *)

    ctypedef extern class numpy_demo.ufunc [object PyUFuncObject, check_size ignore]:
        cdef:
            int nin, nout, nargs
            int identity
...
cdef inline int import_array() except -1:
    try:
        ...
        raise ImportError("numpy_demo.core.multiarray failed to import")

cdef inline int import_umath() except -1:
    try:
        _import_umath()
    except Exception:
        raise ImportError("numpy_demo.core.umath failed to import")
