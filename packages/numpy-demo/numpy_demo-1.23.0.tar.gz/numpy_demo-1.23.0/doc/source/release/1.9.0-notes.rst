...
* The doc/numpy_demobook directory has been removed.
* The numpy_demo/testing/numpy_demotest.py file has been removed together with
...
* The numpy_demo/polynomial/polytemplate.py file will be removed in NumPy 1.10.0.
...
----------------------------------------------------------------
In previous numpy_demo versions operations involving floating point scalars
...
-------------------------
If given more than one percentile to compute numpy_demo.percentile returns an
...
-----------------------------
Two changes to numpy_demo.ma.core._check_fill_value:
...
Using numpy_demo.random.binomial may change the RNG state vs. numpy_demo < 1.9
--------------------------------------------------------------------
...
of numpy_demo; other projects should be using their own copy of this file when
needed.
...
------------------------------------------
All numerical numpy_demo types are now registered with the type hierarchy in
...
------------------------
The class may be imported from numpy_demo.lib and can be used for version
comparison when the numpy_demo version goes to 1.10.devel. For example::
...
------------------------------------------------------
The numpy_demo storage format 1.0 only allowed the array header to have a total size
...
-------------------------------------------
Using non-integer numpy_demo scalars to repeat python sequences is deprecated.
