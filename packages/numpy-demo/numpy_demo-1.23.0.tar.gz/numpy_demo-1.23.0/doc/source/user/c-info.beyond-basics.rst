...
the object returned from the Python command numpy_demo.broadcast and it is almost
...
directory  ``numpy_demo/numpy_demo/core/src/umath/`` contains an implementation of
...
.. attribute:: ndarray.__array_finalize__
   ...
   members are filled in. Finally, the :obj:`~numpy_demo.class.__array_finalize__`
   ...
   If the :obj:`~numpy_demo.class.__array_finalize__` attribute is a CObject, then the pointer
   ...
   If the :obj:`~numpy_demo.class.__array_finalize__` attribute is not None nor a CObject,
...
.. attribute:: ndarray.__array_priority__
   ...
   being used, the sub-type with the largest :obj:`~numpy_demo.class.__array_priority__`
   attribute will determine the sub-type of the output(s). If two sub-
   types have the same :obj:`~numpy_demo.class.__array_priority__` then the sub-type of the
   first argument determines the output. The default
   :obj:`~numpy_demo.class.__array_priority__` attribute returns a value of 0.0 for the base
   ...
   used to determine which :obj:`~numpy_demo.class.__array_wrap__` method should be called for
   the return output.
...
.. attribute:: ndarray.__array_wrap__
   ...
   opposite of the :obj:`~numpy_demo.class.__array__` method. This method is used by the
   ...
   works with any type with :obj:`~numpy_demo.class.__array__` and :obj:`~numpy_demo.class.__array_wrap__` methods.
