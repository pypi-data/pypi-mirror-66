...
_BOTTLENECKANALYSIS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='input_classification', full_name='tensorflow.profiler.BottleneckAnalysis.input_classification', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='input_statement', full_name='tensorflow.profiler.BottleneckAnalysis.input_statement', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernel_launch_classification', full_name='tensorflow.profiler.BottleneckAnalysis.kernel_launch_classification', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernel_launch_statement', full_name='tensorflow.profiler.BottleneckAnalysis.kernel_launch_statement', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='all_other_classification', full_name='tensorflow.profiler.BottleneckAnalysis.all_other_classification', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='all_other_statement', full_name='tensorflow.profiler.BottleneckAnalysis.all_other_statement', index=5,
...
_INPUTPIPELINEANALYSISRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='step_details', full_name='tensorflow.profiler.InputPipelineAnalysisResult.step_details', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_time_breakdown', full_name='tensorflow.profiler.InputPipelineAnalysisResult.input_time_breakdown', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_op_details', full_name='tensorflow.profiler.InputPipelineAnalysisResult.input_op_details', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommendation', full_name='tensorflow.profiler.InputPipelineAnalysisResult.recommendation', index=6,
      number=7, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='step_time_breakdown', full_name='tensorflow.profiler.InputPipelineAnalysisResult.step_time_breakdown', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
