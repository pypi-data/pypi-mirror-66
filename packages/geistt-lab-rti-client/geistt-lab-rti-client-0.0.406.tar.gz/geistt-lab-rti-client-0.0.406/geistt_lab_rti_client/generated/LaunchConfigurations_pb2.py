...
_LAUNCHCONFIGURATIONS = _descriptor.Descriptor(
  ...
  nested_types=[_LAUNCHCONFIGURATIONS_LAUNCHCONFIGURATION, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
