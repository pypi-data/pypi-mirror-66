...
from dipas.elements import Drift, Monitor, HKicker, VKicker, Quadrupole, SBend, Tilt, Offset, LongitudinalRoll, \
...
class TestFieldErrors(unittest.TestCase):
    def test(self):
        ...
        for errors_arg, lattice in zip([type(errors), True], [lattice_1, lattice_2]):
