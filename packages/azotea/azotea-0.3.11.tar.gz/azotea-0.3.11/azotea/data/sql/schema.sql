...
SELECT
    ...
    -- Image Measurements
    (aver_raw_signal_R1 - bias - aver_dark_R1) AS aver_signal_R1, -- R1 dark substracted signal
    ...
    (aver_raw_signal_G2 - bias - aver_dark_G2) AS aver_signal_G2, -- G2 dark substracted signal
    ...
    (aver_raw_signal_G3 - bias - aver_dark_G3) AS aver_signal_G3, -- G3 dark substracted signal
    ...
    (aver_raw_signal_B4 - bias - aver_dark_B4) AS aver_signal_B4, -- B4 dark substracted signal
