...
def optimal_interpolation_ens(bgrid, input, points, pobs, psigmas, pbackground, structure, max_points):
    return _gridpp.optimal_interpolation_ens(bgrid, input, points, pobs, psigmas, pbackground, structure, max_points)
...
def check_equal_size(v1, v2):
    return _gridpp.check_equal_size(v1, v2)
check_equal_size = _gridpp.check_equal_size
class Point(_object):
    __swig_setmethods__ = {}
...
class Interpolator(_object):
    ...
    def interpolate(self, points, values, lat, lon, altitude, land_area_fraction):
        return _gridpp.Interpolator_interpolate(self, points, values, lat, lon, altitude, land_area_fraction)

    def clone(self):
        return _gridpp.Interpolator_clone(self)
    __swig_destroy__ = _gridpp.delete_Interpolator
    __del__ = lambda self: None
Interpolator_swigregister = _gridpp.Interpolator_swigregister
Interpolator_swigregister(Interpolator)

class Nearest(Interpolator):
    __swig_setmethods__ = {}
    for _s in [Interpolator]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    ...
    def interpolate(self, *args):
        return _gridpp.Nearest_interpolate(self, *args)

    def clone(self):
        return _gridpp.Nearest_clone(self)
    __swig_destroy__ = _gridpp.delete_Nearest
    __del__ = lambda self: None
Nearest_swigregister = _gridpp.Nearest_swigregister
...
class Parameters(_object):
    ...
    def __init__(self, points, values, interpolator):
        this = _gridpp.new_Parameters(points, values, interpolator)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _gridpp.delete_Parameters
    __del__ = lambda self: None

    def get(self, lat, lon, altitude, land_area_fraction):
        return _gridpp.Parameters_get(self, lat, lon, altitude, land_area_fraction)
Parameters_swigregister = _gridpp.Parameters_swigregister
