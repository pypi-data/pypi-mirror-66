...
class Network:
    ...
    def initialize(
        ...
        self._client.post(self._network_resource, json=network_data)
    ...
    def get_extent(
        ...
        *,
        ...
        if dt:
            params["datetime"] = element_to_dict(dt)
    ...
    def save_nodes(self, nodes: List[BaseNode]):
        ...
        self._client.post(
            ...
            json={"elements": [element_to_dict(e) for e in nodes]},
        )
    ...
    def save_links(self, links: List[BaseLink]):
        ...
        self._client.post(
            ...
            json={"elements": [element_to_dict(e) for e in links]},
        )
